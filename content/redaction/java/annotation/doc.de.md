...
############################# Header ############################
title: "So entfernen Sie Anmerkungen aus DOC-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigieren Sie DOC-Anmerkungen mithilfe regulärer Ausdrücke in Java"
      content_left: |
      ...
      title_right: "Entfernen Sie vertrauliche Daten aus DOC Kommentaren"
      content_right: |
