...
############################# Header ############################
title: "Cara Menghapus Anotasi dari File DOC menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOC Anotasi menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari DOC Komentar"
      content_right: |
