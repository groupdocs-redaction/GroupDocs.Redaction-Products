...
############################# Header ############################
title: "How to Remove Annotations from DOC Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOC Annotations using Regular Expressions in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from DOC Comments"
      content_right: |
