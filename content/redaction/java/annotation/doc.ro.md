...
############################# Header ############################
title: "Cum să eliminați adnotările din fișierele DOC folosind expresii regulate și Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactați DOC adnotări folosind expresii regulate în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din comentariile DOC"
      content_right: |
