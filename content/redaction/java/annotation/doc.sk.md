...
############################# Header ############################
title: "Ako odstrániť anotácie zo súborov DOC pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Úprava DOC anotácií pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z DOC komentárov"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) a nahrajte súbor DOC
