...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak DOC Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak DOC Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "DOC Yorumdan Hassas Verileri Kaldır"
      content_right: |
