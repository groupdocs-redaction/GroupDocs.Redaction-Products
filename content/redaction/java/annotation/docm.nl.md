...
############################# Header ############################
title: "Annotaties verwijderen uit DOCM-bestanden met reguliere expressies en Java"
...
steps:
    enable: true
    block:
    - title_left: "Bewerk DOCM annotaties met reguliere expressies in Java"
      content_left: |
      ...
      title_right: "Verwijder gevoelige gegevens uit DOCM-opmerkingen"
      content_right: |
