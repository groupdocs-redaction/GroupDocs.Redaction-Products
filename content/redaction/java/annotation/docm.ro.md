...
############################# Header ############################
title: "Cum să eliminați adnotările din fișierele DOCM folosind expresii regulate și Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactați DOCM adnotări folosind expresii regulate în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din comentariile DOCM"
      content_right: |
