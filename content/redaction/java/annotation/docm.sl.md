...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek DOCM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite DOCM opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev DOCM"
      content_right: |
