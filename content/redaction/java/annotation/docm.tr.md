...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak DOCM Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak DOCM Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "DOCM Yorumdan Hassas Verileri Kaldır"
      content_right: |
