...
############################# Header ############################
title: "Come rimuovere le annotazioni dai file DOCX utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura annotazioni DOCX utilizzando le espressioni regolari in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da DOCX commenti"
      content_right: |
