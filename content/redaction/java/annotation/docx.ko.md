...
############################# Header ############################
title: "정규 표현식 및 Java을 사용하여 DOCX 파일에서 주석을 제거하는 방법"
...
steps:
    enable: true
    block:
    - title_left: "Java에서 정규 표현식을 사용하여 DOCX 주석 수정"
      content_left: |
      ...
      title_right: "DOCX 댓글에서 민감한 데이터 제거"
      content_right: |
