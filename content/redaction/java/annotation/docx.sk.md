...
############################# Header ############################
title: "Ako odstrániť anotácie zo súborov DOCX pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Úprava DOCX anotácií pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z DOCX komentárov"
      content_right: |
