...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek DOCX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite DOCX opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev DOCX"
      content_right: |
