...
############################# Header ############################
title: "Cara Menghapus Anotasi dari File DOT menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOT Anotasi menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari DOT Komentar"
      content_right: |
