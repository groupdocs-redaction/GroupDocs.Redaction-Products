...
############################# Header ############################
title: "Come rimuovere le annotazioni dai file DOT utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura annotazioni DOT utilizzando le espressioni regolari in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da DOT commenti"
      content_right: |
