...
############################# Header ############################
title: "Cara Mengalih Keluar Anotasi daripada DOT Fail menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi DOT Anotasi menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada DOT Komen"
      content_right: |
