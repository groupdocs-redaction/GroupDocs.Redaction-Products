...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek DOT z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite DOT opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev DOT"
      content_right: |
