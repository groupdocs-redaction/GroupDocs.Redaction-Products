...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak DOT Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak DOT Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "DOT Yorumdan Hassas Verileri Kaldır"
      content_right: |
