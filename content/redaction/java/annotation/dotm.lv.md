...
############################# Header ############################
title: "Kā noņemt piezīmes no DOTM failiem, izmantojot regulārās izteiksmes un Java"
...
steps:
    enable: true
    block:
    - title_left: "Rediģēt DOTM anotācijas, izmantojot regulārās izteiksmes pakalpojumā Java"
      content_left: |
      ...
      title_right: "Noņemiet sensitīvos datus no DOTM komentāriem"
      content_right: |
