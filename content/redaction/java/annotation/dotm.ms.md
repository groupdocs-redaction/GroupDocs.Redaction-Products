...
############################# Header ############################
title: "Cara Mengalih Keluar Anotasi daripada DOTM Fail menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi DOTM Anotasi menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada DOTM Komen"
      content_right: |
