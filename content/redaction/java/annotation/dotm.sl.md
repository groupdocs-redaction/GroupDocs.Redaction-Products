...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek DOTM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite DOTM opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev DOTM"
      content_right: |
