...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak DOTM Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak DOTM Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "DOTM Yorumdan Hassas Verileri Kaldır"
      content_right: |
