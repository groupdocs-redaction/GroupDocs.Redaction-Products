...
############################# Header ############################
title: "Come rimuovere le annotazioni dai file DOTX utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura annotazioni DOTX utilizzando le espressioni regolari in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da DOTX commenti"
      content_right: |
