...
############################# Header ############################
title: "Kā noņemt piezīmes no DOTX failiem, izmantojot regulārās izteiksmes un Java"
...
steps:
    enable: true
    block:
    - title_left: "Rediģēt DOTX anotācijas, izmantojot regulārās izteiksmes pakalpojumā Java"
      content_left: |
      ...
      title_right: "Noņemiet sensitīvos datus no DOTX komentāriem"
      content_right: |
