...
draft: false
path: "ru/redaction/java/annotation/dotx"
otherformats: CSV DOC DOCM DOCX DOT DOTM PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Редактировать аннотации DOTX с помощью регулярных выражений в Java"
...
############################# Header ############################
title: "Как удалить аннотации из файлов DOTX с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактирование аннотаций DOTX с использованием регулярных выражений в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из комментариев DOTX"
      content_right: |
