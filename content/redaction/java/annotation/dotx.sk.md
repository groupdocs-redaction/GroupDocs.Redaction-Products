...
############################# Header ############################
title: "Ako odstrániť anotácie zo súborov DOTX pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Úprava DOTX anotácií pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z DOTX komentárov"
      content_right: |
