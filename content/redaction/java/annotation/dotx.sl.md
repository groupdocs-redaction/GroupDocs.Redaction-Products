...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek DOTX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite DOTX opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev DOTX"
      content_right: |
