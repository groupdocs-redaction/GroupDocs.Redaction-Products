...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak DOTX Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak DOTX Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "DOTX Yorumdan Hassas Verileri Kaldır"
      content_right: |
