...
############################# Header ############################
title: "Come rimuovere le annotazioni dai file PDF utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura annotazioni PDF utilizzando le espressioni regolari in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da PDF commenti"
      content_right: |
