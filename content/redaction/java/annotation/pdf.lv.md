...
############################# Header ############################
title: "Kā noņemt piezīmes no PDF failiem, izmantojot regulārās izteiksmes un Java"
...
steps:
    enable: true
    block:
    - title_left: "Rediģēt PDF anotācijas, izmantojot regulārās izteiksmes pakalpojumā Java"
      content_left: |
      ...
      title_right: "Noņemiet sensitīvos datus no PDF komentāriem"
      content_right: |
        * Izveidojiet klases [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) gadījumu un augšupielādējiet PDF failu
