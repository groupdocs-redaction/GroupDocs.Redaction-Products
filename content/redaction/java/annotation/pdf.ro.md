...
############################# Header ############################
title: "Cum să eliminați adnotările din fișierele PDF folosind expresii regulate și Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactați PDF adnotări folosind expresii regulate în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din comentariile PDF"
      content_right: |
