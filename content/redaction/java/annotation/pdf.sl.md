...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek PDF z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite PDF opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev PDF"
      content_right: |
