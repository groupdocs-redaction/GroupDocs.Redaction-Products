...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PDF Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak PDF Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "PDF Yorumdan Hassas Verileri Kaldır"
      content_right: |
