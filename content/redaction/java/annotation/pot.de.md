...
############################# Header ############################
title: "So entfernen Sie Anmerkungen aus POT-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigieren Sie POT-Anmerkungen mithilfe regulärer Ausdrücke in Java"
      content_left: |
      ...
      title_right: "Entfernen Sie vertrauliche Daten aus POT Kommentaren"
      content_right: |
