...
draft: false
path: "es/redaction/java/annotation/pot"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactar POT anotaciones a través de expresiones regulares en Java"
...
############################# Header ############################
title: "Cómo quitar anotaciones de archivos POT usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar POT anotaciones usando expresiones regulares en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de POT comentarios"
      content_right: |
