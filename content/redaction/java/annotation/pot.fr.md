...
draft: false
path: "fr/redaction/java/annotation/pot"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Masquer les annotations POT via une expression régulière dans Java"
...
############################# Header ############################
title: "Comment supprimer les annotations des fichiers POT à l'aide d'expressions régulières et de Java"
...
steps:
    enable: true
    block:
    - title_left: "Masquer les annotations POT à l'aide d'expressions régulières dans Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de POT commentaires"
      content_right: |
