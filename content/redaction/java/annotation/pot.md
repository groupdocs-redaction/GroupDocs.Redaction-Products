...
############################# Header ############################
title: "How to Remove Annotations from POT Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact POT Annotations using Regular Expressions in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from POT Comments"
      content_right: |
