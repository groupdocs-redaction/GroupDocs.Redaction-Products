...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek POT z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite POT opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev POT"
      content_right: |
