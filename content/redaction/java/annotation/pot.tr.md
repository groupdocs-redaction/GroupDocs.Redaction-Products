...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak POT Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak POT Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "POT Yorumdan Hassas Verileri Kaldır"
      content_right: |
