...
draft: false
path: "es/redaction/java/annotation/potm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactar POTM anotaciones a través de expresiones regulares en Java"
...
############################# Header ############################
title: "Cómo quitar anotaciones de archivos POTM usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar POTM anotaciones usando expresiones regulares en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de POTM comentarios"
      content_right: |
