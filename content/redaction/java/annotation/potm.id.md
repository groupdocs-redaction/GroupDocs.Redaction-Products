...
############################# Header ############################
title: "Cara Menghapus Anotasi dari File POTM menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact POTM Anotasi menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari POTM Komentar"
      content_right: |
