...
############################# Header ############################
title: "Come rimuovere le annotazioni dai file POTM utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura annotazioni POTM utilizzando le espressioni regolari in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da POTM commenti"
      content_right: |
