...
############################# Header ############################
title: "正規表現と Java を使用して POTM ファイルから注釈を削除する方法"
...
steps:
    enable: true
    block:
    - title_left: "Java の正規表現を使用して POTM 注釈​​を編集します"
      content_left: |
      ...
      title_right: "POTM 件のコメントから機密データを削除"
      content_right: |
