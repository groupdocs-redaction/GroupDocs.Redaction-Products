...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek POTM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite POTM opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev POTM"
      content_right: |
