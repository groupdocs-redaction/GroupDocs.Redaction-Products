...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak POTM Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak POTM Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "POTM Yorumdan Hassas Verileri Kaldır"
      content_right: |
