...
############################# Header ############################
title: "How to Remove Annotations from PPS Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPS Annotations using Regular Expressions in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from PPS Comments"
      content_right: |
