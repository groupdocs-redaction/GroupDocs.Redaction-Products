...
############################# Header ############################
title: "Cum să eliminați adnotările din fișierele PPS folosind expresii regulate și Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactați PPS adnotări folosind expresii regulate în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din comentariile PPS"
      content_right: |
