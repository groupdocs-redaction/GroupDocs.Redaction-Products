...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PPS Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak PPS Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "PPS Yorumdan Hassas Verileri Kaldır"
      content_right: |
