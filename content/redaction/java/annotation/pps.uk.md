...
############################# Header ############################
title: "Як видалити анотації з файлів PPS за допомогою регулярних виразів і Java"
...
steps:
    enable: true
    block:
    - title_left: "Відредагуйте PPS анотації за допомогою регулярних виразів у Java"
      content_left: |
      ...
      title_right: "Видаліть конфіденційні дані з коментарів PPS"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) і завантажте файл PPS
