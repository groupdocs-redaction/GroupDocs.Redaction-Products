...
draft: false
path: "es/redaction/java/annotation/ppsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactar PPSM anotaciones a través de expresiones regulares en Java"
...
############################# Header ############################
title: "Cómo quitar anotaciones de archivos PPSM usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar PPSM anotaciones usando expresiones regulares en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de PPSM comentarios"
      content_right: |
