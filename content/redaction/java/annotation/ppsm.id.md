...
############################# Header ############################
title: "Cara Menghapus Anotasi dari File PPSM menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPSM Anotasi menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari PPSM Komentar"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & upload PPSM file
