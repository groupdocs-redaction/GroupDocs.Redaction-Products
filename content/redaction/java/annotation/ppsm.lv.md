...
############################# Header ############################
title: "Kā noņemt piezīmes no PPSM failiem, izmantojot regulārās izteiksmes un Java"
...
steps:
    enable: true
    block:
    - title_left: "Rediģēt PPSM anotācijas, izmantojot regulārās izteiksmes pakalpojumā Java"
      content_left: |
      ...
      title_right: "Noņemiet sensitīvos datus no PPSM komentāriem"
      content_right: |
        * Izveidojiet klases [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) gadījumu un augšupielādējiet PPSM failu
