...
############################# Header ############################
title: "Cum să eliminați adnotările din fișierele PPSM folosind expresii regulate și Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactați PPSM adnotări folosind expresii regulate în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din comentariile PPSM"
      content_right: |
