...
draft: false
path: "ru/redaction/java/annotation/ppsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Редактировать аннотации PPSM с помощью регулярных выражений в Java"
...
############################# Header ############################
title: "Как удалить аннотации из файлов PPSM с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактирование аннотаций PPSM с использованием регулярных выражений в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из комментариев PPSM"
      content_right: |
