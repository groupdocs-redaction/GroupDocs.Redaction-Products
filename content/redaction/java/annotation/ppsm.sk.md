...
############################# Header ############################
title: "Ako odstrániť anotácie zo súborov PPSM pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Úprava PPSM anotácií pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z PPSM komentárov"
      content_right: |
