...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek PPSM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite PPSM opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev PPSM"
      content_right: |
