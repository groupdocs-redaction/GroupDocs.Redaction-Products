...
draft: false
path: "de/redaction/java/annotation/ppsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redigieren Sie PPSX-Anmerkungen über reguläre Ausdrücke in Java"
...
############################# Header ############################
title: "So entfernen Sie Anmerkungen aus PPSX-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigieren Sie PPSX-Anmerkungen mithilfe regulärer Ausdrücke in Java"
      content_left: |
      ...
      title_right: "Entfernen Sie vertrauliche Daten aus PPSX Kommentaren"
      content_right: |
