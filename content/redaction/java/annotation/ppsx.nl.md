...
############################# Header ############################
title: "Annotaties verwijderen uit PPSX-bestanden met reguliere expressies en Java"
...
steps:
    enable: true
    block:
    - title_left: "Bewerk PPSX annotaties met reguliere expressies in Java"
      content_left: |
      ...
      title_right: "Verwijder gevoelige gegevens uit PPSX-opmerkingen"
      content_right: |
