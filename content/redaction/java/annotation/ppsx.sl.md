...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek PPSX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite PPSX opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev PPSX"
      content_right: |
