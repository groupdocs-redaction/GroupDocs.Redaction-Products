...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PPSX Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak PPSX Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "PPSX Yorumdan Hassas Verileri Kaldır"
      content_right: |
