...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek PPT z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite PPT opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev PPT"
      content_right: |
