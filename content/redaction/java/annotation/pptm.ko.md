...
############################# Header ############################
title: "정규 표현식 및 Java을 사용하여 PPTM 파일에서 주석을 제거하는 방법"
...
steps:
    enable: true
    block:
    - title_left: "Java에서 정규 표현식을 사용하여 PPTM 주석 수정"
      content_left: |
      ...
      title_right: "PPTM 댓글에서 민감한 데이터 제거"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) 클래스 인스턴스 생성 및 PPTM 파일 업로드
