...
############################# Header ############################
title: "Cara Mengalih Keluar Anotasi daripada PPTM Fail menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi PPTM Anotasi menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada PPTM Komen"
      content_right: |
