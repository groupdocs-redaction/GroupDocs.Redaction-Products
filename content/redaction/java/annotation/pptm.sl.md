...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek PPTM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite PPTM opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev PPTM"
      content_right: |
