...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PPTM Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak PPTM Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "PPTM Yorumdan Hassas Verileri Kaldır"
      content_right: |
