...
draft: false
path: "uk/redaction/java/annotation/pptm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Редагувати PPTM анотації за допомогою регулярного виразу в Java"
...
############################# Header ############################
title: "Як видалити анотації з файлів PPTM за допомогою регулярних виразів і Java"
...
steps:
    enable: true
    block:
    - title_left: "Відредагуйте PPTM анотації за допомогою регулярних виразів у Java"
      content_left: |
      ...
      title_right: "Видаліть конфіденційні дані з коментарів PPTM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) і завантажте файл PPTM
