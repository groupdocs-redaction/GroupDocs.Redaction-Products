...
draft: false
path: "de/redaction/java/annotation/pptx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redigieren Sie PPTX-Anmerkungen über reguläre Ausdrücke in Java"
...
############################# Header ############################
title: "So entfernen Sie Anmerkungen aus PPTX-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigieren Sie PPTX-Anmerkungen mithilfe regulärer Ausdrücke in Java"
      content_left: |
      ...
      title_right: "Entfernen Sie vertrauliche Daten aus PPTX Kommentaren"
      content_right: |
