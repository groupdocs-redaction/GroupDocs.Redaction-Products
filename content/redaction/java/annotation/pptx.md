...
############################# Header ############################
title: "How to Remove Annotations from PPTX Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPTX Annotations using Regular Expressions in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from PPTX Comments"
      content_right: |
