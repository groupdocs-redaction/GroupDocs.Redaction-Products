...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PPTX Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak PPTX Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "PPTX Yorumdan Hassas Verileri Kaldır"
      content_right: |
