...
############################# Header ############################
title: "Annotaties verwijderen uit XLS-bestanden met reguliere expressies en Java"
...
steps:
    enable: true
    block:
    - title_left: "Bewerk XLS annotaties met reguliere expressies in Java"
      content_left: |
      ...
      title_right: "Verwijder gevoelige gegevens uit XLS-opmerkingen"
      content_right: |
        * Maak een instantie van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload XLS-bestand
