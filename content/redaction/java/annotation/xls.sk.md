...
############################# Header ############################
title: "Ako odstrániť anotácie zo súborov XLS pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Úprava XLS anotácií pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z XLS komentárov"
      content_right: |
