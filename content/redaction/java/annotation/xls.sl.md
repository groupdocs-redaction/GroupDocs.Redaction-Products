...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek XLS z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite XLS opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev XLS"
      content_right: |
