...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLS Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak XLS Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "XLS Yorumdan Hassas Verileri Kaldır"
      content_right: |
