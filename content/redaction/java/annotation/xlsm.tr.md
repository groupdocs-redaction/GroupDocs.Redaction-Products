...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLSM Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak XLSM Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "XLSM Yorumdan Hassas Verileri Kaldır"
      content_right: |
