...
draft: false
path: "de/redaction/java/annotation/xlsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLT XLTM XLTX  

############################# Head ############################
head_title: "Redigieren Sie XLSX-Anmerkungen über reguläre Ausdrücke in Java"
...
############################# Header ############################
title: "So entfernen Sie Anmerkungen aus XLSX-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigieren Sie XLSX-Anmerkungen mithilfe regulärer Ausdrücke in Java"
      content_left: |
      ...
      title_right: "Entfernen Sie vertrauliche Daten aus XLSX Kommentaren"
      content_right: |
