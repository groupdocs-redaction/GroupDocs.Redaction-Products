...
draft: false
path: "es/redaction/java/annotation/xlsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactar XLSX anotaciones a través de expresiones regulares en Java"
...
############################# Header ############################
title: "Cómo quitar anotaciones de archivos XLSX usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar XLSX anotaciones usando expresiones regulares en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de XLSX comentarios"
      content_right: |
