...
############################# Header ############################
title: "How to Remove Annotations from XLSX Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSX Annotations using Regular Expressions in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from XLSX Comments"
      content_right: |
