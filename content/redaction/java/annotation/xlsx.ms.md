...
############################# Header ############################
title: "Cara Mengalih Keluar Anotasi daripada XLSX Fail menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi XLSX Anotasi menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada XLSX Komen"
      content_right: |
