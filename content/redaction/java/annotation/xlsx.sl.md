...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek XLSX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite XLSX opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev XLSX"
      content_right: |
