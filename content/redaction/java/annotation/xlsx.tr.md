...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLSX Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak XLSX Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "XLSX Yorumdan Hassas Verileri Kaldır"
      content_right: |
