...
draft: false
path: "es/redaction/java/annotation/xlt"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLTM XLTX  

############################# Head ############################
head_title: "Redactar XLT anotaciones a través de expresiones regulares en Java"
...
############################# Header ############################
title: "Cómo quitar anotaciones de archivos XLT usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar XLT anotaciones usando expresiones regulares en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de XLT comentarios"
      content_right: |
