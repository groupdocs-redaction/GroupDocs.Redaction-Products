...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek XLT z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite XLT opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev XLT"
      content_right: |
