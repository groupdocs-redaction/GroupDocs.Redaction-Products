...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLT Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak XLT Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "XLT Yorumdan Hassas Verileri Kaldır"
      content_right: |
