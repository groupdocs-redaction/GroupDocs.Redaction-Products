...
draft: false
path: "fr/redaction/java/annotation/xltm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTX  

############################# Head ############################
head_title: "Masquer les annotations XLTM via une expression régulière dans Java"
...
############################# Header ############################
title: "Comment supprimer les annotations des fichiers XLTM à l'aide d'expressions régulières et de Java"
...
steps:
    enable: true
    block:
    - title_left: "Masquer les annotations XLTM à l'aide d'expressions régulières dans Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de XLTM commentaires"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier XLTM
