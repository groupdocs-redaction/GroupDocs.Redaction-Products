...
############################# Header ############################
title: "Ako odstrániť anotácie zo súborov XLTM pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Úprava XLTM anotácií pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z XLTM komentárov"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) a nahrajte súbor XLTM
