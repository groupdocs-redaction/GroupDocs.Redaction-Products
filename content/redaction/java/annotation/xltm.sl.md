...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek XLTM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite XLTM opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev XLTM"
      content_right: |
