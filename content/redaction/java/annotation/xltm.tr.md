...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLTM Dosyadan Ek Açıklamalar Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler Kullanarak XLTM Ek Açıklamayı Düzeltin"
      content_left: |
      ...
      title_right: "XLTM Yorumdan Hassas Verileri Kaldır"
      content_right: |
