...
############################# Header ############################
title: "Kā noņemt piezīmes no XLTX failiem, izmantojot regulārās izteiksmes un Java"
...
steps:
    enable: true
    block:
    - title_left: "Rediģēt XLTX anotācijas, izmantojot regulārās izteiksmes pakalpojumā Java"
      content_left: |
      ...
      title_right: "Noņemiet sensitīvos datus no XLTX komentāriem"
      content_right: |
        * Izveidojiet klases [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) gadījumu un augšupielādējiet XLTX failu
