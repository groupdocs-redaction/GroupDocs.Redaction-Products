...
############################# Header ############################
title: "Kako odstraniti opombe iz datotek XLTX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredite XLTX opombe z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz komentarjev XLTX"
      content_right: |
