...
head_title: "Redact CSV Text melalui Exact Phrase/Regular Expression di Java"
...
title: "Cara Redact, Sembunyikan atau Hapus Teks dari CSV File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact CSV Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari CSV"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & unggah file CSV
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di CSV"
      content_left: |
        Contoh berikut memungkinkan pengguna untuk melakukan redaksi peka huruf besar-kecil fase yang tepat untuk menghapus atau menyembunyikan potongan teks tertentu di dalam dokumen. Secara default, pencarian untuk fase yang tepat tidak peka huruf besar/kecil. 
    ...
    - title_left: "Redact Teks di CSV melalui Kotak Warna"
      content_left: |
