...
############################# Head ############################
head_title: "Redact CSV Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from CSV Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact CSV Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from CSV"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in CSV"
      content_left: |
        The following example enables users to perform exact phase case-sensitive redaction to remove or hide a particular chuck of text inside a document. By default, search for exact phase is case insensitive. 
    ...
    - title_left: "Redact Text in CSV via Color Box"
      content_left: |
