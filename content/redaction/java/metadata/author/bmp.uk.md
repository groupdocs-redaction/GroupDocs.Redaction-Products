...
draft: false
path: "uk/redaction/java/metadata/author/bmp"
...
ad_description: "Відредагувати Author Name з BMP метаданих у Java"
############################# Head ############################
head_title: "Видалити АБО оновити ім'я автора з BMP метаданих у Java"
...
############################# Header ############################
title: "Видалити АБО оновити ім'я автора з метаданих BMP в Java"
...
steps:
    ...
    - title_left: "Редагувати BMP Метадані в Java"
      content_left: |
        Наступний код дозволяє шукати та редагувати конфіденційні дані з документа BMP. Ви можете встановити область редагування, встановивши фільтр, наприклад, MetadataFilter.Author. Він залишить збіги регулярних виразів скасованими у всіх елементах метаданих, крім властивості «Author»: 
