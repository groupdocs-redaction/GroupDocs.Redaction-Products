...
draft: false
path: "ru/redaction/java/metadata/author/doc"
...
ad_description: "Исправить имя автора из метаданных DOC в Java"

############################# Head ############################
head_title: "Удалить ИЛИ обновить имя автора из метаданных DOC в Java"
...
############################# Header ############################
title: "Удалить ИЛИ обновить имя автора из метаданных DOC в Java"
...
steps:
    ...
    - title_left: "Редактировать метаданные DOC в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа DOC. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Author. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Автор": 
    ...
    - title_left: "Удалить метаданные Author в Java"
      ...
      title_right: "Удалить метаданные DOC"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл DOC
