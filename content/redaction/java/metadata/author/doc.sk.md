...
draft: false
path: "sk/redaction/java/metadata/author/doc"
...
ad_description: "Redigovať Author Name z DOC Metaúdajov v Java"
############################# Head ############################
head_title: "Odstrániť alebo aktualizovať meno autora z DOC metaúdajov v Java"
...
############################# Header ############################
title: "Odstrániť alebo aktualizovať meno autora z DOC metaúdajov v Java"
...
steps:
    ...
    - title_left: "Redigovať DOC Metaúdaje v Java"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu DOC. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadaTafilter.author. Zhody regulárnych výrazov ponechá späť vo všetkých položkách metaúdajov okrem vlastnosti „Autor“: 
