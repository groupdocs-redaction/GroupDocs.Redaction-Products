...
draft: false
path: "ko/redaction/java/metadata/author/docm"
...
ad_description: "Java 에 있는 DOCM 메타데이터에서 Author Name 를 수정했습니다."
############################# Head ############################
head_title: "Java 의 DOCM 메타데이터에서 작성자 이름 제거 또는 업데이트"
head_description: "GroupDocs.Redaction s는 필터를 사용하여 모든 메타데이터 속성을 검색 및 교체/제거할 수 있는 유연한 API를 제공합니다."

############################# Header ############################
title: "Java 의 DOCM 메타데이터에서 작성자 이름 제거 또는 업데이트"
