...
draft: false
path: "ko/redaction/java/metadata/author/dot"
...
ad_description: "Java 에 있는 DOT 메타데이터에서 Author Name 를 수정했습니다."
############################# Head ############################
head_title: "Java 의 DOT 메타데이터에서 작성자 이름 제거 또는 업데이트"
head_description: "GroupDocs.Redaction s는 필터를 사용하여 모든 메타데이터 속성을 검색 및 교체/제거할 수 있는 유연한 API를 제공합니다."

############################# Header ############################
title: "Java 의 DOT 메타데이터에서 작성자 이름 제거 또는 업데이트"
...
steps:
    ...
    - title_left: "Java 에서 DOT 메타데이터를 수정했습니다."
      content_left: |
        다음 코드를 사용하면 DOT 문서에서 민감한 데이터를 검색하고 삭제할 수 있습니다.필터 (예: MetadataFilter.Author) 를 설정하여 교정 범위를 설정할 수 있습니다.그러면 “Author” 속성을 제외한 모든 메타데이터 항목에서 정규 표현식 일치가 취소된 상태로 남습니다. 
