...
ad_description: "Redact Author Name from DOTM Metadata in Java"

############################# Head ############################
head_title: "Remove OR Update Author Name from DOTM Metadata in Java"
...
############################# Header ############################
title: "Remove OR Update Author Name From DOTM Metadata In Java"
...
steps:
    ...
    - title_left: "Redact DOTM Metadata in Java"
      content_left: |
        Following code allows you to search and redact sensitive data from a DOTM document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Author. It will leave the regular expressions matches undone in all metadata items, except “Author” property:
