...
draft: false
path: "uk/redaction/java/metadata/author/potm"
...
ad_description: "Відредагувати Author Name з POTM метаданих у Java"
############################# Head ############################
head_title: "Видалити АБО оновити ім'я автора з POTM метаданих у Java"
...
############################# Header ############################
title: "Видалити АБО оновити ім'я автора з метаданих POTM в Java"
...
steps:
    ...
    - title_left: "Редагувати POTM Метадані в Java"
      content_left: |
        Наступний код дозволяє шукати та редагувати конфіденційні дані з документа POTM. Ви можете встановити область редагування, встановивши фільтр, наприклад, MetadataFilter.Author. Він залишить збіги регулярних виразів скасованими у всіх елементах метаданих, крім властивості «Author»: 
