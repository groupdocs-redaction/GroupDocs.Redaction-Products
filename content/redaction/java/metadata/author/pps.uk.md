...
draft: false
path: "uk/redaction/java/metadata/author/pps"
...
ad_description: "Відредагувати Author Name з PPS метаданих у Java"
############################# Head ############################
head_title: "Видалити АБО оновити ім'я автора з PPS метаданих у Java"
...
############################# Header ############################
title: "Видалити АБО оновити ім'я автора з метаданих PPS в Java"
...
steps:
    ...
    - title_left: "Редагувати PPS Метадані в Java"
      content_left: |
        Наступний код дозволяє шукати та редагувати конфіденційні дані з документа PPS. Ви можете встановити область редагування, встановивши фільтр, наприклад, MetadataFilter.Author. Він залишить збіги регулярних виразів скасованими у всіх елементах метаданих, крім властивості «Author»: 
