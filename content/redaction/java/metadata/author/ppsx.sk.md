...
draft: false
path: "sk/redaction/java/metadata/author/ppsx"
...
ad_description: "Redigovať Author Name z PPSX Metaúdajov v Java"
############################# Head ############################
head_title: "Odstrániť alebo aktualizovať meno autora z PPSX metaúdajov v Java"
...
############################# Header ############################
title: "Odstrániť alebo aktualizovať meno autora z PPSX metaúdajov v Java"
...
steps:
    ...
    - title_left: "Redigovať PPSX Metaúdaje v Java"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu PPSX. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadaTafilter.author. Zhody regulárnych výrazov ponechá späť vo všetkých položkách metaúdajov okrem vlastnosti „Autor“: 
