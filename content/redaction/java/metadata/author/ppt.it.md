...
draft: false
path: "it/redaction/java/metadata/author/ppt"
...
ad_description: "Modifica Author Name dai metadati PPT in Java"
############################# Head ############################
head_title: "Rimuovi o aggiorna il nome dell'autore dai metadati PPT in Java"
...
############################# Header ############################
title: "Rimuovi o aggiorna il nome dell'autore dai metadati PPT in Java"
...
steps:
    ...
    - title_left: "Modificare i metadati PPT in Java"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento PPT. Puoi impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.author. Lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Autore»: 
