...
draft: false
path: "hi/redaction/java/metadata/author/pptm"
...
ad_description: "Java में PPTM मेटाडेटा से Author Name को संपादित करें"
############################# Head ############################
head_title: "Java में PPTM मेटाडेटा से लेखक का नाम हटाएं या अपडेट करें"
...
############################# Header ############################
title: "Java में PPTM मेटाडेटा से लेखक का नाम हटाएं या अपडेट करें"
...
steps:
    ...
    - title_left: "Java में PPTM मेटाडेटा को फिर से बनाना"
      content_left: |
        निम्नलिखित कोड से आप PPTM दस्तावेज़ से संवेदनशील डेटा खोज सकते हैं और उसे संपादित कर सकते हैं। आप फ़िल्टर सेट करके रिडक्शन की गुंजाइश सेट कर सकते हैं, उदाहरण के लिए metadataFilter.Author। यह “लेखक” संपत्ति को छोड़कर, सभी मेटाडेटा आइटम में नियमित अभिव्यक्तियों के मिलान को पूर्ववत छोड़ देगा: 
