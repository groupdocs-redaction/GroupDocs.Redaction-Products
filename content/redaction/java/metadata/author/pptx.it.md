...
draft: false
path: "it/redaction/java/metadata/author/pptx"
...
ad_description: "Modifica Author Name dai metadati PPTX in Java"
############################# Head ############################
head_title: "Rimuovi o aggiorna il nome dell'autore dai metadati PPTX in Java"
...
############################# Header ############################
title: "Rimuovi o aggiorna il nome dell'autore dai metadati PPTX in Java"
...
steps:
    ...
    - title_left: "Modificare i metadati PPTX in Java"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento PPTX. Puoi impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.author. Lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Autore»: 
