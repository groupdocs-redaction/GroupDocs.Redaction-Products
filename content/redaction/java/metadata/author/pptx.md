...
draft: false
path: "redaction/java/metadata/author/pptx"
...
ad_description: "Redact Author Name from PPTX Metadata in Java"
############################# Head ############################
head_title: "Remove OR Update Author Name from PPTX Metadata in Java"
...
############################# Header ############################
title: "Remove OR Update Author Name From PPTX Metadata In Java"
...
steps:
    ...
    - title_left: "Redact PPTX Metadata in Java"
      content_left: |
        Following code allows you to search and redact sensitive data from a PPTX document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Author. It will leave the regular expressions matches undone in all metadata items, except "Author" property: 
