...
draft: false
path: "zh/redaction/java/metadata/author/rtf"
...
ad_description: "从 Java 中的 RTF 元数据中编辑 Author Name"
############################# Head ############################
head_title: "从 Java 的 RTF 元数据中删除或更新作者姓名"
head_description: "GroupDocs.Redaction s 提供了灵活的 API，允许使用过滤器搜索和替换/删除任何元数据属性。"

############################# Header ############################
title: "从 Java 的 RTF 元数据中删除或更新作者姓名"
