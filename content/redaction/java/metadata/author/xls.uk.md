...
draft: false
path: "uk/redaction/java/metadata/author/xls"
...
ad_description: "Відредагувати Author Name з XLS метаданих у Java"
############################# Head ############################
head_title: "Видалити АБО оновити ім'я автора з XLS метаданих у Java"
...
############################# Header ############################
title: "Видалити АБО оновити ім'я автора з метаданих XLS в Java"
...
steps:
    ...
    - title_left: "Редагувати XLS Метадані в Java"
      content_left: |
        Наступний код дозволяє шукати та редагувати конфіденційні дані з документа XLS. Ви можете встановити область редагування, встановивши фільтр, наприклад, MetadataFilter.Author. Він залишить збіги регулярних виразів скасованими у всіх елементах метаданих, крім властивості «Author»: 
