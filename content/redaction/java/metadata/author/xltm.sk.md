...
draft: false
path: "sk/redaction/java/metadata/author/xltm"
...
ad_description: "Redigovať Author Name z XLTM Metaúdajov v Java"
############################# Head ############################
head_title: "Odstrániť alebo aktualizovať meno autora z XLTM metaúdajov v Java"
...
############################# Header ############################
title: "Odstrániť alebo aktualizovať meno autora z XLTM metaúdajov v Java"
...
steps:
    ...
    - title_left: "Redigovať XLTM Metaúdaje v Java"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu XLTM. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadaTafilter.author. Zhody regulárnych výrazov ponechá späť vo všetkých položkách metaúdajov okrem vlastnosti „Autor“: 
    ...
    - title_left: "Odstrániť metaúdaje autora v Java"
      ...
      title_right: "Vymazať XLTM Metaúdaje"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLTM
