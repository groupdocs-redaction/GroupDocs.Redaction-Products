...
draft: false
path: "fr/redaction/java/metadata/category/bmp"
...
ad_description: "Rédiger le nom de la catégorie à partir des métadonnées BMP dans Java"
############################# Head ############################
head_title: "Rédiger le nom de la catégorie à partir des métadonnées BMP dans Java"
...
############################# Header ############################
title: "Rédiger le nom de la catégorie à partir des métadonnées BMP dans Java"
...
steps:
    ...
    - title_left: "Supprimer BMP métadonnées dans Java"
      content_left: |
      ...
      title_right: "Effacer les métadonnées de catégorie du fichier BMP"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier BMP
