...
draft: false
path: "it/redaction/java/metadata/category/bmp"
...
ad_description: "Modifica il nome della categoria dai metadati BMP in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati BMP in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati BMP in Java"
...
steps:
    ...
    - title_left: "Rimuovi BMP metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file BMP"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file BMP
