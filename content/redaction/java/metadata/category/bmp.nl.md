...
draft: false
path: "nl/redaction/java/metadata/category/bmp"
...
ad_description: "Categorienaam redigeren uit BMP metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit BMP metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit BMP metagegevens in Java"
...
steps:
    ...
    - title_left: "BMP metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het BMP -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het BMP -bestand
