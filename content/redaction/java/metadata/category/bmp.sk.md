...
draft: false
path: "sk/redaction/java/metadata/category/bmp"
...
ad_description: "Redigovať názov kategórie z BMP Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z BMP Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z BMP Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť BMP metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru BMP"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload BMP
