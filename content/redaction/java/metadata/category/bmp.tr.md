...
draft: false
path: "tr/redaction/java/metadata/category/bmp"
...
ad_description: "Java içindeki BMP Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki BMP Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki BMP Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki BMP Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini BMP Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve BMP dosyasını yükleyin
