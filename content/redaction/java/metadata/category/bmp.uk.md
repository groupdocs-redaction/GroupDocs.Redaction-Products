...
draft: false
path: "uk/redaction/java/metadata/category/bmp"
...
ad_description: "Відредагувати назву категорії з BMP метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з BMP метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з BMP метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані BMP в Java"
      ...
      title_right: "Видалити метадані категорії з файлу BMP"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл BMP
