...
draft: false
path: "de/redaction/java/metadata/category/doc"
...
ad_description: "Kategorienamen aus DOC Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus DOC Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus DOC Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "DOC Metadaten in Java entfernen"
      content_left: |
      ...
      title_right: "Kategorie-Metadaten aus DOC -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei DOC hoch
