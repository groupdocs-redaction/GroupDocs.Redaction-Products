...
draft: false
path: "nl/redaction/java/metadata/category/doc"
...
ad_description: "Categorienaam redigeren uit DOC metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit DOC metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit DOC metagegevens in Java"
...
steps:
    ...
    - title_left: "DOC metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het DOC -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOC -bestand
