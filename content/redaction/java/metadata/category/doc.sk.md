...
draft: false
path: "sk/redaction/java/metadata/category/doc"
...
ad_description: "Redigovať názov kategórie z DOC Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z DOC Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z DOC Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť DOC metaúdaje v Java"
      content_left: |
      ...
      title_right: "Vymazať metadáta kategórie zo súboru DOC"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOC
