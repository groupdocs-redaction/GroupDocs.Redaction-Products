...
draft: false
path: "tr/redaction/java/metadata/category/doc"
...
ad_description: "Java içindeki DOC Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki DOC Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki DOC Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki DOC Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini DOC Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve DOC dosyasını yükleyin
