...
draft: false
path: "uk/redaction/java/metadata/category/doc"
...
ad_description: "Відредагувати назву категорії з DOC метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з DOC метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з DOC метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані DOC в Java"
      ...
      title_right: "Видалити метадані категорії з файлу DOC"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл DOC
