...
draft: false
path: "fr/redaction/java/metadata/category/docm"
...
ad_description: "Rédiger le nom de la catégorie à partir des métadonnées DOCM dans Java"
############################# Head ############################
head_title: "Rédiger le nom de la catégorie à partir des métadonnées DOCM dans Java"
...
############################# Header ############################
title: "Rédiger le nom de la catégorie à partir des métadonnées DOCM dans Java"
...
steps:
    ...
    - title_left: "Supprimer DOCM métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées de catégorie du fichier DOCM"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOCM
