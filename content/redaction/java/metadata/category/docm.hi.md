...
draft: false
path: "hi/redaction/java/metadata/category/docm"
...
ad_description: "Java में DOCM मेटाडेटा से श्रेणी का नाम फिर से बनाएँ"
############################# Head ############################
head_title: "Java में DOCM मेटाडेटा से श्रेणी का नाम फिर से बनाएँ"
...
############################# Header ############################
title: "Java में DOCM मेटाडेटा से श्रेणी का नाम फिर से बनाएँ"
...
steps:
    ...
    - title_left: "Java में DOCM मेटाडेटा को फिर से बनाना"
      content_left: |
        निम्नलिखित कोड से आप DOCM दस्तावेज़ से संवेदनशील डेटा खोज सकते हैं और उसे संपादित कर सकते हैं। आप फ़िल्टर सेट करके संपादन के लिए गुंजाइश सेट कर सकते हैं, उदाहरण के लिए metadataFilter.category के लिए। - यह “श्रेणी” संपत्ति को छोड़कर, सभी मेटाडेटा आइटम में नियमित अभिव्यक्तियों के मिलान को पूर्ववत छोड़ देगा: 
    ...
    - title_left: "Java में DOCM मेटाडेटा हटाएं"
      ...
      title_right: "DOCM फ़ाइल से श्रेणी मेटाडेटा मिटाएँ"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) वर्ग का एक उदाहरण बनाएं और DOCM फ़ाइल अपलोड करें
