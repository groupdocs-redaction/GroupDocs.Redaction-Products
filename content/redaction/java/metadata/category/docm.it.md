...
draft: false
path: "it/redaction/java/metadata/category/docm"
...
ad_description: "Modifica il nome della categoria dai metadati DOCM in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati DOCM in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati DOCM in Java"
...
steps:
    ...
    - title_left: "Rimuovi DOCM metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file DOCM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file DOCM
