...
draft: false
path: "lv/redaction/java/metadata/category/docm"
...
ad_description: "Readēt kategorijas nosaukumu no DOCM metadatiem Java"
############################# Head ############################
head_title: "Readēt kategorijas nosaukumu no DOCM metadatiem Java"
...
############################# Header ############################
title: "Readēt kategorijas nosaukumu no DOCM metadatiem Java"
...
steps:
    ...
    - title_left: "Noņemt DOCM metadatus Java"
      content_left: |
      ...
      title_right: "Dzēst kategorijas metadatus no DOCM faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOCM faila instanci
