...
draft: false
path: "nl/redaction/java/metadata/category/docm"
...
ad_description: "Categorienaam redigeren uit DOCM metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit DOCM metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit DOCM metagegevens in Java"
...
steps:
    ...
    - title_left: "DOCM metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het DOCM -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOCM -bestand
