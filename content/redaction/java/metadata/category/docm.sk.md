...
draft: false
path: "sk/redaction/java/metadata/category/docm"
...
ad_description: "Redigovať názov kategórie z DOCM Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z DOCM Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z DOCM Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť DOCM metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru DOCM"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOCM
