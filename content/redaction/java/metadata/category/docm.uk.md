...
draft: false
path: "uk/redaction/java/metadata/category/docm"
...
ad_description: "Відредагувати назву категорії з DOCM метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з DOCM метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з DOCM метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані DOCM в Java"
      ...
      title_right: "Видалити метадані категорії з файлу DOCM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл DOCM
