...
draft: false
path: "de/redaction/java/metadata/category/docx"
...
ad_description: "Kategorienamen aus DOCX Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus DOCX Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus DOCX Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "DOCX Metadaten in Java entfernen"
      content_left: |
      ...
      title_right: "Kategorie-Metadaten aus DOCX -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei DOCX hoch
