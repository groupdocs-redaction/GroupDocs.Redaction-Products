...
draft: false
path: "es/redaction/java/metadata/category/docx"
...
ad_description: "Redactar el nombre de la categoría de los metadatos de DOCX en Java"
############################# Head ############################
head_title: "Redactar el nombre de la categoría de los metadatos de DOCX en Java"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de DOCX en Java"
...
steps:
    ...
    - title_left: "Eliminar DOCX metadatos en Java"
      ...
      title_right: "Borrar metadatos de categoría del archivo DOCX"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo DOCX
