...
draft: false
path: "fr/redaction/java/metadata/category/docx"
...
ad_description: "Rédiger le nom de la catégorie à partir des métadonnées DOCX dans Java"
############################# Head ############################
head_title: "Rédiger le nom de la catégorie à partir des métadonnées DOCX dans Java"
...
############################# Header ############################
title: "Rédiger le nom de la catégorie à partir des métadonnées DOCX dans Java"
...
steps:
    ...
    - title_left: "Supprimer DOCX métadonnées dans Java"
      content_left: |
      ...
      title_right: "Effacer les métadonnées de catégorie du fichier DOCX"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOCX
