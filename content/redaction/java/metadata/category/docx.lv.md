...
draft: false
path: "lv/redaction/java/metadata/category/docx"
...
ad_description: "Readēt kategorijas nosaukumu no DOCX metadatiem Java"
############################# Head ############################
head_title: "Readēt kategorijas nosaukumu no DOCX metadatiem Java"
...
############################# Header ############################
title: "Readēt kategorijas nosaukumu no DOCX metadatiem Java"
...
steps:
    ...
    - title_left: "Noņemt DOCX metadatus Java"
      content_left: |
      ...
      title_right: "Dzēst kategorijas metadatus no DOCX faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOCX faila instanci
