...
ad_description: "Redact Category Name from DOCX Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from DOCX Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from DOCX Metadata in Java"
...
steps:
    ...
    - title_left: "Remove DOCX Metadata in Java"
      ...
      title_right: "Erase Category Metadata from DOCX File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOCX file
