...
draft: false
path: "ms/redaction/java/metadata/category/docx"
...
ad_description: "Redact Nama Kategori dari DOCX Metadata dalam Java"
############################# Head ############################
head_title: "Redact Nama Kategori dari DOCX Metadata dalam Java"
...
############################# Header ############################
title: "Redact Nama Kategori dari DOCX Metadata dalam Java"
...
steps:
    ...
    - title_left: "Keluarkan Metadata DOCX dalam Java"
      ...
      title_right: "Padamkan Metadata Kategori dari DOCX Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail DOCX
