...
draft: false
path: "sk/redaction/java/metadata/category/docx"
...
ad_description: "Redigovať názov kategórie z DOCX Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z DOCX Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z DOCX Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť DOCX metaúdaje v Java"
      content_left: |
      ...
      title_right: "Vymazať metadáta kategórie zo súboru DOCX"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOCX
