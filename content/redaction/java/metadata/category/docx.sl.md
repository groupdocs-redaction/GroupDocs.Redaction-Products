...
draft: false
path: "sl/redaction/java/metadata/category/docx"
...
ad_description: "Ime kategorije uredi iz DOCX metapodatkov v Java"
############################# Head ############################
head_title: "Ime kategorije uredi iz DOCX metapodatkov v Java"
...
############################# Header ############################
title: "Ime kategorije uredi iz DOCX metapodatkov v Java"
...
steps:
    ...
    - title_left: "Odstrani DOCX metapodatke v Java"
      ...
      title_right: "Izbriši metapodatke kategorije iz datoteke DOCX"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko DOCX
