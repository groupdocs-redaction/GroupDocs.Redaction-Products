...
draft: false
path: "tr/redaction/java/metadata/category/docx"
...
ad_description: "Java içindeki DOCX Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki DOCX Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki DOCX Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki DOCX Meta Verileri Kaldır"
      ...
      title_right: "Kategori Meta Verilerini DOCX Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve DOCX dosyasını yükleyin
