...
draft: false
path: "uk/redaction/java/metadata/category/docx"
...
ad_description: "Відредагувати назву категорії з DOCX метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з DOCX метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з DOCX метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані DOCX в Java"
      ...
      title_right: "Видалити метадані категорії з файлу DOCX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл DOCX
