...
draft: false
path: "de/redaction/java/metadata/category/dot"
...
ad_description: "Kategorienamen aus DOT Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus DOT Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus DOT Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "DOT Metadaten in Java entfernen"
      ...
      title_right: "Kategorie-Metadaten aus DOT -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei DOT hoch
