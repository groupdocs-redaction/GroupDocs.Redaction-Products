...
draft: false
path: "it/redaction/java/metadata/category/dot"
...
ad_description: "Modifica il nome della categoria dai metadati DOT in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati DOT in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati DOT in Java"
...
steps:
    ...
    - title_left: "Rimuovi DOT metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file DOT"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file DOT
