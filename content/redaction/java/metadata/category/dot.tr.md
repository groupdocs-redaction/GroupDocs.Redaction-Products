...
draft: false
path: "tr/redaction/java/metadata/category/dot"
...
ad_description: "Java içindeki DOT Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki DOT Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki DOT Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki DOT Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini DOT Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve DOT dosyasını yükleyin
