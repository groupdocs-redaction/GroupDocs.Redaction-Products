...
draft: false
path: "es/redaction/java/metadata/category/dotm"
...
ad_description: "Redactar el nombre de la categoría de los metadatos de DOTM en Java"
############################# Head ############################
head_title: "Redactar el nombre de la categoría de los metadatos de DOTM en Java"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de DOTM en Java"
...
steps:
    ...
    - title_left: "Eliminar DOTM metadatos en Java"
      content_left: |
      ...
      title_right: "Borrar metadatos de categoría del archivo DOTM"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo DOTM
