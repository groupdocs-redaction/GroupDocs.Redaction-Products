...
draft: false
path: "it/redaction/java/metadata/category/dotm"
...
ad_description: "Modifica il nome della categoria dai metadati DOTM in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati DOTM in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati DOTM in Java"
...
steps:
    ...
    - title_left: "Rimuovi DOTM metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file DOTM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file DOTM
