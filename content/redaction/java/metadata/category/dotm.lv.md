...
draft: false
path: "lv/redaction/java/metadata/category/dotm"
...
ad_description: "Readēt kategorijas nosaukumu no DOTM metadatiem Java"
############################# Head ############################
head_title: "Readēt kategorijas nosaukumu no DOTM metadatiem Java"
...
############################# Header ############################
title: "Readēt kategorijas nosaukumu no DOTM metadatiem Java"
...
steps:
    ...
    - title_left: "Noņemt DOTM metadatus Java"
      content_left: |
      ...
      title_right: "Dzēst kategorijas metadatus no DOTM faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOTM faila instanci
