...
draft: false
path: "ru/redaction/java/metadata/category/dotm"
...
ad_description: "Исправить название категории из метаданных DOTM в Java"
############################# Head ############################
head_title: "Редактировать название категории из метаданных DOTM в Java"
...
############################# Header ############################
title: "Редактировать название категории из метаданных DOTM в Java"
...
steps:
    ...
    - title_left: "Редактировать метаданные DOTM в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа DOTM. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Category. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Категория": 
    ...
    - title_left: "Удалить метаданные DOTM в Java"
      ...
      title_right: "Удалить метаданные категории из файла DOTM"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл DOTM.
