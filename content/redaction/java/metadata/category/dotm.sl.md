...
draft: false
path: "sl/redaction/java/metadata/category/dotm"
...
ad_description: "Ime kategorije uredi iz DOTM metapodatkov v Java"
############################# Head ############################
head_title: "Ime kategorije uredi iz DOTM metapodatkov v Java"
...
############################# Header ############################
title: "Ime kategorije uredi iz DOTM metapodatkov v Java"
...
steps:
    ...
    - title_left: "Uredij DOTM Metapodatke v Java"
      content_left: |
        Naslednja koda omogoča iskanje in redigiranje občutljivih podatkov iz dokumenta DOTM. Obseg za redigiranje lahko nastavite tako, da nastavite filter, npr. na metafilter.Category. - ujemanja regularnih izrazov bodo razveljavljena v vseh metapodatkovnih elementih, razen lastnosti« Kategorija »: 
    ...
    - title_left: "Odstrani DOTM metapodatke v Java"
      ...
      title_right: "Izbriši metapodatke kategorije iz datoteke DOTM"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko DOTM
