...
draft: false
path: "tr/redaction/java/metadata/category/dotm"
...
ad_description: "Java içindeki DOTM Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki DOTM Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki DOTM Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki DOTM Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini DOTM Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve DOTM dosyasını yükleyin
