...
draft: false
path: "uk/redaction/java/metadata/category/dotm"
...
ad_description: "Відредагувати назву категорії з DOTM метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з DOTM метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з DOTM метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані DOTM в Java"
      ...
      title_right: "Видалити метадані категорії з файлу DOTM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл DOTM
