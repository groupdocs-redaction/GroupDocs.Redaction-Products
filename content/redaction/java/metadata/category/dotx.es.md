...
draft: false
path: "es/redaction/java/metadata/category/dotx"
...
ad_description: "Redactar el nombre de la categoría de los metadatos de DOTX en Java"
############################# Head ############################
head_title: "Redactar el nombre de la categoría de los metadatos de DOTX en Java"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de DOTX en Java"
...
steps:
    ...
    - title_left: "Eliminar DOTX metadatos en Java"
      content_left: |
      ...
      title_right: "Borrar metadatos de categoría del archivo DOTX"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo DOTX
