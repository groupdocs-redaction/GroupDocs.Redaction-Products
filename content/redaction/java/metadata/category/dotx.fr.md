...
draft: false
path: "fr/redaction/java/metadata/category/dotx"
...
ad_description: "Rédiger le nom de la catégorie à partir des métadonnées DOTX dans Java"
############################# Head ############################
head_title: "Rédiger le nom de la catégorie à partir des métadonnées DOTX dans Java"
...
############################# Header ############################
title: "Rédiger le nom de la catégorie à partir des métadonnées DOTX dans Java"
...
steps:
    ...
    - title_left: "Supprimer DOTX métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées de catégorie du fichier DOTX"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOTX
