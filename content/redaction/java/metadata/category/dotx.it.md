...
draft: false
path: "it/redaction/java/metadata/category/dotx"
...
ad_description: "Modifica il nome della categoria dai metadati DOTX in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati DOTX in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati DOTX in Java"
...
steps:
    ...
    - title_left: "Rimuovi DOTX metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file DOTX"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file DOTX
