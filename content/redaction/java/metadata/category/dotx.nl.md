...
draft: false
path: "nl/redaction/java/metadata/category/dotx"
...
ad_description: "Categorienaam redigeren uit DOTX metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit DOTX metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit DOTX metagegevens in Java"
...
steps:
    ...
    - title_left: "DOTX metagegevens verwijderen in Java"
      content_left: |
      ...
      title_right: "Metagegevens van categorieën uit het DOTX -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOTX -bestand
