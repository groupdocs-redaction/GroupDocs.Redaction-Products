...
draft: false
path: "ru/redaction/java/metadata/category/dotx"
...
ad_description: "Исправить название категории из метаданных DOTX в Java"
############################# Head ############################
head_title: "Редактировать название категории из метаданных DOTX в Java"
...
############################# Header ############################
title: "Редактировать название категории из метаданных DOTX в Java"
...
steps:
    ...
    - title_left: "Удалить метаданные DOTX в Java"
      ...
      title_right: "Удалить метаданные категории из файла DOTX"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл DOTX.
