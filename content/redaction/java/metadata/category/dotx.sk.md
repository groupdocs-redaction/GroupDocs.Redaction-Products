...
draft: false
path: "sk/redaction/java/metadata/category/dotx"
...
ad_description: "Redigovať názov kategórie z DOTX Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z DOTX Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z DOTX Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť DOTX metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru DOTX"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOTX
