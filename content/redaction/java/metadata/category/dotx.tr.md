...
draft: false
path: "tr/redaction/java/metadata/category/dotx"
...
ad_description: "Java içindeki DOTX Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki DOTX Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki DOTX Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki DOTX Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini DOTX Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve DOTX dosyasını yükleyin
