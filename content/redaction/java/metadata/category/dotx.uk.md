...
draft: false
path: "uk/redaction/java/metadata/category/dotx"
...
ad_description: "Відредагувати назву категорії з DOTX метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з DOTX метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з DOTX метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані DOTX в Java"
      ...
      title_right: "Видалити метадані категорії з файлу DOTX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл DOTX
