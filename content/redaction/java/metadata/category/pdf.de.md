...
draft: false
path: "de/redaction/java/metadata/category/pdf"
...
ad_description: "Kategorienamen aus PDF Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus PDF Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus PDF Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "PDF Metadaten in Java entfernen"
      content_left: |
      ...
      title_right: "Kategorie-Metadaten aus PDF -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei PDF hoch
