...
draft: false
path: "it/redaction/java/metadata/category/pdf"
...
ad_description: "Modifica il nome della categoria dai metadati PDF in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati PDF in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati PDF in Java"
...
steps:
    ...
    - title_left: "Rimuovi PDF metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file PDF"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file PDF
