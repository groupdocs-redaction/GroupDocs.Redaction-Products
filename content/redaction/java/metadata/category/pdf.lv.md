...
draft: false
path: "lv/redaction/java/metadata/category/pdf"
...
ad_description: "Readēt kategorijas nosaukumu no PDF metadatiem Java"
############################# Head ############################
head_title: "Readēt kategorijas nosaukumu no PDF metadatiem Java"
...
############################# Header ############################
title: "Readēt kategorijas nosaukumu no PDF metadatiem Java"
...
steps:
    ...
    - title_left: "Noņemt PDF metadatus Java"
      content_left: |
      ...
      title_right: "Dzēst kategorijas metadatus no PDF faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PDF faila instanci
