...
draft: false
path: "ms/redaction/java/metadata/category/pdf"
...
ad_description: "Redact Nama Kategori dari PDF Metadata dalam Java"
############################# Head ############################
head_title: "Redact Nama Kategori dari PDF Metadata dalam Java"
...
############################# Header ############################
title: "Redact Nama Kategori dari PDF Metadata dalam Java"
...
steps:
    ...
    - title_left: "Keluarkan Metadata PDF dalam Java"
      ...
      title_right: "Padamkan Metadata Kategori dari PDF Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail PDF
