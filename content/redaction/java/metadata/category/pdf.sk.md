...
draft: false
path: "sk/redaction/java/metadata/category/pdf"
...
ad_description: "Redigovať názov kategórie z PDF Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z PDF Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z PDF Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť PDF metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru PDF"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PDF
