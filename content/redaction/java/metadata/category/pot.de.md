...
draft: false
path: "de/redaction/java/metadata/category/pot"
...
ad_description: "Kategorienamen aus POT Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus POT Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus POT Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "POT Metadaten in Java entfernen"
      ...
      title_right: "Kategorie-Metadaten aus POT -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei POT hoch
