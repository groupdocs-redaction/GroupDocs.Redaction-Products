...
draft: false
path: "it/redaction/java/metadata/category/pot"
...
ad_description: "Modifica il nome della categoria dai metadati POT in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati POT in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati POT in Java"
...
steps:
    ...
    - title_left: "Rimuovi POT metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file POT"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file POT
