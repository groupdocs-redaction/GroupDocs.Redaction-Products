...
draft: false
path: "tr/redaction/java/metadata/category/pot"
...
ad_description: "Java içindeki POT Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki POT Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki POT Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki POT Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini POT Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve POT dosyasını yükleyin
