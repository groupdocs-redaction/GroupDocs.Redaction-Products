...
draft: false
path: "uk/redaction/java/metadata/category/pot"
...
ad_description: "Відредагувати назву категорії з POT метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з POT метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з POT метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані POT в Java"
      ...
      title_right: "Видалити метадані категорії з файлу POT"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл POT
