...
draft: false
path: "fr/redaction/java/metadata/category/potm"
...
ad_description: "Rédiger le nom de la catégorie à partir des métadonnées POTM dans Java"
############################# Head ############################
head_title: "Rédiger le nom de la catégorie à partir des métadonnées POTM dans Java"
...
############################# Header ############################
title: "Rédiger le nom de la catégorie à partir des métadonnées POTM dans Java"
...
steps:
    ...
    - title_left: "Supprimer POTM métadonnées dans Java"
      content_left: |
      ...
      title_right: "Effacer les métadonnées de catégorie du fichier POTM"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier POTM
