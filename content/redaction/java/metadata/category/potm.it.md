...
draft: false
path: "it/redaction/java/metadata/category/potm"
...
ad_description: "Modifica il nome della categoria dai metadati POTM in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati POTM in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati POTM in Java"
...
steps:
    ...
    - title_left: "Rimuovi POTM metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file POTM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file POTM
