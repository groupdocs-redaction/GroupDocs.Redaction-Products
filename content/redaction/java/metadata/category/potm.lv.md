...
draft: false
path: "lv/redaction/java/metadata/category/potm"
...
ad_description: "Readēt kategorijas nosaukumu no POTM metadatiem Java"
############################# Head ############################
head_title: "Readēt kategorijas nosaukumu no POTM metadatiem Java"
...
############################# Header ############################
title: "Readēt kategorijas nosaukumu no POTM metadatiem Java"
...
steps:
    ...
    - title_left: "Noņemt POTM metadatus Java"
      content_left: |
      ...
      title_right: "Dzēst kategorijas metadatus no POTM faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt POTM faila instanci
