...
draft: false
path: "nl/redaction/java/metadata/category/potm"
...
ad_description: "Categorienaam redigeren uit POTM metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit POTM metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit POTM metagegevens in Java"
...
steps:
    ...
    - title_left: "POTM metagegevens verwijderen in Java"
      content_left: |
      ...
      title_right: "Metagegevens van categorieën uit het POTM -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het POTM -bestand
