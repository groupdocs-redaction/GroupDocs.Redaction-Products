...
draft: false
path: "sk/redaction/java/metadata/category/potm"
...
ad_description: "Redigovať názov kategórie z POTM Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z POTM Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z POTM Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť POTM metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru POTM"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload POTM
