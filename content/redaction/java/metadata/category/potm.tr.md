...
draft: false
path: "tr/redaction/java/metadata/category/potm"
...
ad_description: "Java içindeki POTM Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki POTM Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki POTM Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki POTM Meta Verileri Kaldır"
      ...
      title_right: "Kategori Meta Verilerini POTM Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve POTM dosyasını yükleyin
