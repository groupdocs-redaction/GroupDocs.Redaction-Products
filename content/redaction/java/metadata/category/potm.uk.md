...
draft: false
path: "uk/redaction/java/metadata/category/potm"
...
ad_description: "Відредагувати назву категорії з POTM метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з POTM метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з POTM метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані POTM в Java"
      ...
      title_right: "Видалити метадані категорії з файлу POTM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл POTM
