...
draft: false
path: "es/redaction/java/metadata/category/pps"
...
ad_description: "Redactar el nombre de la categoría de los metadatos de PPS en Java"
############################# Head ############################
head_title: "Redactar el nombre de la categoría de los metadatos de PPS en Java"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de PPS en Java"
...
steps:
    ...
    - title_left: "Eliminar PPS metadatos en Java"
      content_left: |
      ...
      title_right: "Borrar metadatos de categoría del archivo PPS"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo PPS
