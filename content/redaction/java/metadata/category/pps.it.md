...
draft: false
path: "it/redaction/java/metadata/category/pps"
...
ad_description: "Modifica il nome della categoria dai metadati PPS in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati PPS in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati PPS in Java"
...
steps:
    ...
    - title_left: "Rimuovi PPS metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file PPS"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file PPS
