...
ad_description: "Redact Category Name from PPS Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from PPS Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from PPS Metadata in Java"
...
steps:
    ...
    - title_left: "Remove PPS Metadata in Java"
      ...
      title_right: "Erase Category Metadata from PPS File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPS file
