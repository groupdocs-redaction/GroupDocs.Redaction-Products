...
draft: false
path: "sk/redaction/java/metadata/category/pps"
...
ad_description: "Redigovať názov kategórie z PPS Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z PPS Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z PPS Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť PPS metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru PPS"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPS
