...
draft: false
path: "sl/redaction/java/metadata/category/pps"
...
ad_description: "Ime kategorije uredi iz PPS metapodatkov v Java"
############################# Head ############################
head_title: "Ime kategorije uredi iz PPS metapodatkov v Java"
...
############################# Header ############################
title: "Ime kategorije uredi iz PPS metapodatkov v Java"
...
steps:
    ...
    - title_left: "Odstrani PPS metapodatke v Java"
      ...
      title_right: "Izbriši metapodatke kategorije iz datoteke PPS"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko PPS
