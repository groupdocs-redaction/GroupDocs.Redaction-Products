...
draft: false
path: "tr/redaction/java/metadata/category/pps"
...
ad_description: "Java içindeki PPS Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki PPS Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki PPS Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki PPS Meta Verileri Kaldır"
      ...
      title_right: "Kategori Meta Verilerini PPS Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve PPS dosyasını yükleyin
