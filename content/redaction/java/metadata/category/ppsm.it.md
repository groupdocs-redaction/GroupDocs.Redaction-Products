...
draft: false
path: "it/redaction/java/metadata/category/ppsm"
...
ad_description: "Modifica il nome della categoria dai metadati PPSM in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati PPSM in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati PPSM in Java"
...
steps:
    ...
    - title_left: "Rimuovi PPSM metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file PPSM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file PPSM
