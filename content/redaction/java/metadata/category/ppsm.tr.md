...
draft: false
path: "tr/redaction/java/metadata/category/ppsm"
...
ad_description: "Java içindeki PPSM Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki PPSM Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki PPSM Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki PPSM Meta Verileri Kaldır"
      ...
      title_right: "Kategori Meta Verilerini PPSM Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve PPSM dosyasını yükleyin
