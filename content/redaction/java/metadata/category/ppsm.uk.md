...
draft: false
path: "uk/redaction/java/metadata/category/ppsm"
...
ad_description: "Відредагувати назву категорії з PPSM метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з PPSM метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з PPSM метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані PPSM в Java"
      ...
      title_right: "Видалити метадані категорії з файлу PPSM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл PPSM
