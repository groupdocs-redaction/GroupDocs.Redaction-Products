...
draft: false
path: "it/redaction/java/metadata/category/ppsx"
...
ad_description: "Modifica il nome della categoria dai metadati PPSX in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati PPSX in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati PPSX in Java"
...
steps:
    ...
    - title_left: "Modificare i metadati PPSX in Java"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento PPSX. Puoi impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.Category. - lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Category»: 
    ...
    - title_left: "Rimuovi PPSX metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file PPSX"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file PPSX
