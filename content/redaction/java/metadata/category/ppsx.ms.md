...
draft: false
path: "ms/redaction/java/metadata/category/ppsx"
...
ad_description: "Redact Nama Kategori dari PPSX Metadata dalam Java"
############################# Head ############################
head_title: "Redact Nama Kategori dari PPSX Metadata dalam Java"
...
############################# Header ############################
title: "Redact Nama Kategori dari PPSX Metadata dalam Java"
...
steps:
    ...
    - title_left: "Keluarkan Metadata PPSX dalam Java"
      ...
      title_right: "Padamkan Metadata Kategori dari PPSX Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail PPSX
