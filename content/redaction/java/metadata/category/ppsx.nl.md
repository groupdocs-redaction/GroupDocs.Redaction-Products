...
draft: false
path: "nl/redaction/java/metadata/category/ppsx"
...
ad_description: "Categorienaam redigeren uit PPSX metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit PPSX metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit PPSX metagegevens in Java"
...
steps:
    ...
    - title_left: "PPSX metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het PPSX -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het PPSX -bestand
