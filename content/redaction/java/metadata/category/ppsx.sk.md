...
draft: false
path: "sk/redaction/java/metadata/category/ppsx"
...
ad_description: "Redigovať názov kategórie z PPSX Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z PPSX Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z PPSX Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť PPSX metaúdaje v Java"
      content_left: |
      ...
      title_right: "Vymazať metadáta kategórie zo súboru PPSX"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPSX
