...
draft: false
path: "tr/redaction/java/metadata/category/ppsx"
...
ad_description: "Java içindeki PPSX Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki PPSX Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki PPSX Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki PPSX Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini PPSX Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve PPSX dosyasını yükleyin
