...
draft: false
path: "uk/redaction/java/metadata/category/ppsx"
...
ad_description: "Відредагувати назву категорії з PPSX метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з PPSX метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з PPSX метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані PPSX в Java"
      ...
      title_right: "Видалити метадані категорії з файлу PPSX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл PPSX
