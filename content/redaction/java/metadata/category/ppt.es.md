...
draft: false
path: "es/redaction/java/metadata/category/ppt"
...
ad_description: "Redactar el nombre de la categoría de los metadatos de PPT en Java"
############################# Head ############################
head_title: "Redactar el nombre de la categoría de los metadatos de PPT en Java"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de PPT en Java"
...
steps:
    ...
    - title_left: "Eliminar PPT metadatos en Java"
      ...
      title_right: "Borrar metadatos de categoría del archivo PPT"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo PPT
