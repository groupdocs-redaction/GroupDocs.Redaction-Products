...
draft: false
path: "tr/redaction/java/metadata/category/ppt"
...
ad_description: "Java içindeki PPT Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki PPT Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki PPT Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki PPT Meta Verileri Kaldır"
      ...
      title_right: "Kategori Meta Verilerini PPT Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve PPT dosyasını yükleyin
