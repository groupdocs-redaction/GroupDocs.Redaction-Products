...
draft: false
path: "de/redaction/java/metadata/category/pptm"
...
ad_description: "Kategorienamen aus PPTM Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus PPTM Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus PPTM Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "PPTM Metadaten in Java entfernen"
      content_left: |
      ...
      title_right: "Kategorie-Metadaten aus PPTM -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei PPTM hoch
