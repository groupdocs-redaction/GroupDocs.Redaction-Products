...
draft: false
path: "it/redaction/java/metadata/category/pptm"
...
ad_description: "Modifica il nome della categoria dai metadati PPTM in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati PPTM in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati PPTM in Java"
...
steps:
    ...
    - title_left: "Rimuovi PPTM metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file PPTM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file PPTM
