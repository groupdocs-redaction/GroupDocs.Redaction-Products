...
ad_description: "Redact Category Name from PPTM Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from PPTM Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from PPTM Metadata in Java"
...
steps:
    ...
    - title_left: "Remove PPTM Metadata in Java"
      ...
      title_right: "Erase Category Metadata from PPTM File "
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPTM file
