...
draft: false
path: "tr/redaction/java/metadata/category/pptm"
...
ad_description: "Java içindeki PPTM Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki PPTM Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki PPTM Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki PPTM Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini PPTM Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve PPTM dosyasını yükleyin
