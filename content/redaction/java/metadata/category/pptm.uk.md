...
draft: false
path: "uk/redaction/java/metadata/category/pptm"
...
ad_description: "Відредагувати назву категорії з PPTM метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з PPTM метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з PPTM метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані PPTM в Java"
      ...
      title_right: "Видалити метадані категорії з файлу PPTM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл PPTM
