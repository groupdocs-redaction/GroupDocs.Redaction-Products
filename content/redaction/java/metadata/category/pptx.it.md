...
draft: false
path: "it/redaction/java/metadata/category/pptx"
...
ad_description: "Modifica il nome della categoria dai metadati PPTX in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati PPTX in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati PPTX in Java"
...
steps:
    ...
    - title_left: "Rimuovi PPTX metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file PPTX"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file PPTX
