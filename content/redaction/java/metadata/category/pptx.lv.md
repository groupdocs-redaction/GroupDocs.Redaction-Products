...
draft: false
path: "lv/redaction/java/metadata/category/pptx"
...
ad_description: "Readēt kategorijas nosaukumu no PPTX metadatiem Java"
############################# Head ############################
head_title: "Readēt kategorijas nosaukumu no PPTX metadatiem Java"
...
############################# Header ############################
title: "Readēt kategorijas nosaukumu no PPTX metadatiem Java"
...
steps:
    ...
    - title_left: "Noņemt PPTX metadatus Java"
      ...
      title_right: "Dzēst kategorijas metadatus no PPTX faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPTX faila instanci
