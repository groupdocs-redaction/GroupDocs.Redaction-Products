...
draft: false
path: "ms/redaction/java/metadata/category/pptx"
...
ad_description: "Redact Nama Kategori dari PPTX Metadata dalam Java"
############################# Head ############################
head_title: "Redact Nama Kategori dari PPTX Metadata dalam Java"
...
############################# Header ############################
title: "Redact Nama Kategori dari PPTX Metadata dalam Java"
...
steps:
    ...
    - title_left: "Keluarkan Metadata PPTX dalam Java"
      ...
      title_right: "Padamkan Metadata Kategori dari PPTX Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail PPTX
