...
draft: false
path: "nl/redaction/java/metadata/category/pptx"
...
ad_description: "Categorienaam redigeren uit PPTX metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit PPTX metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit PPTX metagegevens in Java"
...
steps:
    ...
    - title_left: "PPTX metagegevens verwijderen in Java"
      content_left: |
      ...
      title_right: "Metagegevens van categorieën uit het PPTX -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het PPTX -bestand
