...
draft: false
path: "sk/redaction/java/metadata/category/pptx"
...
ad_description: "Redigovať názov kategórie z PPTX Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z PPTX Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z PPTX Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť PPTX metaúdaje v Java"
      content_left: |
      ...
      title_right: "Vymazať metadáta kategórie zo súboru PPTX"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPTX
