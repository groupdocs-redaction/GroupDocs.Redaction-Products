...
draft: false
path: "tr/redaction/java/metadata/category/pptx"
...
ad_description: "Java içindeki PPTX Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki PPTX Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki PPTX Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki PPTX Meta Verileri Kaldır"
      ...
      title_right: "Kategori Meta Verilerini PPTX Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve PPTX dosyasını yükleyin
