...
draft: false
path: "uk/redaction/java/metadata/category/pptx"
...
ad_description: "Відредагувати назву категорії з PPTX метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з PPTX метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з PPTX метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані PPTX в Java"
      ...
      title_right: "Видалити метадані категорії з файлу PPTX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл PPTX
