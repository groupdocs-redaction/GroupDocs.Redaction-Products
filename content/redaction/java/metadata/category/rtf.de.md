...
draft: false
path: "de/redaction/java/metadata/category/rtf"
...
ad_description: "Kategorienamen aus RTF Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus RTF Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus RTF Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "RTF Metadaten in Java entfernen"
      content_left: |
      ...
      title_right: "Kategorie-Metadaten aus RTF -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei RTF hoch
