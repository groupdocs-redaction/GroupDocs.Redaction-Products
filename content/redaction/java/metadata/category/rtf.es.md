...
draft: false
path: "es/redaction/java/metadata/category/rtf"
...
ad_description: "Redactar el nombre de la categoría de los metadatos de RTF en Java"
############################# Head ############################
head_title: "Redactar el nombre de la categoría de los metadatos de RTF en Java"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de RTF en Java"
...
steps:
    ...
    - title_left: "Eliminar RTF metadatos en Java"
      ...
      title_right: "Borrar metadatos de categoría del archivo RTF"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo RTF
