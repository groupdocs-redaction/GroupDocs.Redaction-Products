...
draft: false
path: "it/redaction/java/metadata/category/rtf"
...
ad_description: "Modifica il nome della categoria dai metadati RTF in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati RTF in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati RTF in Java"
...
steps:
    ...
    - title_left: "Rimuovi RTF metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file RTF"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file RTF
