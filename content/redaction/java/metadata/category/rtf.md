...
ad_description: "Redact Category Name from RTF Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from RTF Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from RTF Metadata in Java"
...
steps:
    ...
    - title_left: "Remove RTF Metadata in Java"
      ...
      title_right: "Erase Category Metadata from RTF File "
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload RTF file
