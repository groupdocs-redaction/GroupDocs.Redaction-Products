...
draft: false
path: "nl/redaction/java/metadata/category/rtf"
...
ad_description: "Categorienaam redigeren uit RTF metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit RTF metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit RTF metagegevens in Java"
...
steps:
    ...
    - title_left: "RTF metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het RTF -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het RTF -bestand
