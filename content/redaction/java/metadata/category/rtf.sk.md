...
draft: false
path: "sk/redaction/java/metadata/category/rtf"
...
ad_description: "Redigovať názov kategórie z RTF Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z RTF Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z RTF Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť RTF metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru RTF"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload RTF
