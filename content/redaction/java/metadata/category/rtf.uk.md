...
draft: false
path: "uk/redaction/java/metadata/category/rtf"
...
ad_description: "Відредагувати назву категорії з RTF метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з RTF метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з RTF метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані RTF в Java"
      ...
      title_right: "Видалити метадані категорії з файлу RTF"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл RTF
