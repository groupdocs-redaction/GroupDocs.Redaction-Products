...
draft: false
path: "de/redaction/java/metadata/category/xls"
...
ad_description: "Kategorienamen aus XLS Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus XLS Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus XLS Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "XLS Metadaten in Java entfernen"
      content_left: |
      ...
      title_right: "Kategorie-Metadaten aus XLS -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei XLS hoch
