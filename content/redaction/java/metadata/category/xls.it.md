...
draft: false
path: "it/redaction/java/metadata/category/xls"
...
ad_description: "Modifica il nome della categoria dai metadati XLS in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati XLS in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati XLS in Java"
...
steps:
    ...
    - title_left: "Rimuovi XLS metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file XLS"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLS
