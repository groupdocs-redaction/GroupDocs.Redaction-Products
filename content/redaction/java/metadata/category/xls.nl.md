...
draft: false
path: "nl/redaction/java/metadata/category/xls"
...
ad_description: "Categorienaam redigeren uit XLS metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit XLS metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit XLS metagegevens in Java"
...
steps:
    ...
    - title_left: "XLS metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het XLS -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLS -bestand
