...
draft: false
path: "sk/redaction/java/metadata/category/xls"
...
ad_description: "Redigovať názov kategórie z XLS Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z XLS Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z XLS Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť XLS metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru XLS"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLS
