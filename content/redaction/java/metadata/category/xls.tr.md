...
draft: false
path: "tr/redaction/java/metadata/category/xls"
...
ad_description: "Java içindeki XLS Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki XLS Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki XLS Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki Meta Verileri Redact XLS"
      content_left: |
        Aşağıdaki kod, XLS belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.category. - “Category” özelliği hariç tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri bırakacaktır: 
    ...
    - title_left: "Java içindeki XLS Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini XLS Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLS dosyasını yükleyin
