...
draft: false
path: "uk/redaction/java/metadata/category/xls"
...
ad_description: "Відредагувати назву категорії з XLS метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з XLS метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з XLS метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані XLS в Java"
      ...
      title_right: "Видалити метадані категорії з файлу XLS"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл XLS
