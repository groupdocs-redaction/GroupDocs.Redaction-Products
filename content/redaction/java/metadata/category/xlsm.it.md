...
draft: false
path: "it/redaction/java/metadata/category/xlsm"
...
ad_description: "Modifica il nome della categoria dai metadati XLSM in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati XLSM in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati XLSM in Java"
...
steps:
    ...
    - title_left: "Rimuovi XLSM metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file XLSM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLSM
