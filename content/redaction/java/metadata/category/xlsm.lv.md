...
draft: false
path: "lv/redaction/java/metadata/category/xlsm"
...
ad_description: "Readēt kategorijas nosaukumu no XLSM metadatiem Java"
############################# Head ############################
head_title: "Readēt kategorijas nosaukumu no XLSM metadatiem Java"
...
############################# Header ############################
title: "Readēt kategorijas nosaukumu no XLSM metadatiem Java"
...
steps:
    ...
    - title_left: "Noņemt XLSM metadatus Java"
      content_left: |
      ...
      title_right: "Dzēst kategorijas metadatus no XLSM faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLSM faila instanci
