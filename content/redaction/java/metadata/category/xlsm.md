...
ad_description: "Redact Category Name from XLSM Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from XLSM Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from XLSM Metadata in Java"
...
steps:
    ...
    - title_left: "Remove XLSM Metadata in Java"
      ...
      title_right: "Erase Category Metadata from XLSM File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLSM file
