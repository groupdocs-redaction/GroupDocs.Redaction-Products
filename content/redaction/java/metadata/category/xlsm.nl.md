...
draft: false
path: "nl/redaction/java/metadata/category/xlsm"
...
ad_description: "Categorienaam redigeren uit XLSM metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit XLSM metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit XLSM metagegevens in Java"
...
steps:
    ...
    - title_left: "XLSM metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het XLSM -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLSM -bestand
