...
draft: false
path: "ru/redaction/java/metadata/category/xlsm"
...
ad_description: "Исправить название категории из метаданных XLSM в Java"

############################# Head ############################
head_title: "Редактировать название категории из метаданных XLSM в Java"
...
############################# Header ############################
title: "Редактировать название категории из метаданных XLSM в Java"
...
steps:
    ...
    - title_left: "Редактировать метаданные XLSM в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа XLSM. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Category. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Категория": 
    ...
    - title_left: "Удалить метаданные XLSM в Java"
      ...
      title_right: "Удалить метаданные категории из файла XLSM"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл XLSM.
