...
draft: false
path: "sk/redaction/java/metadata/category/xlsm"
...
ad_description: "Redigovať názov kategórie z XLSM Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z XLSM Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z XLSM Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť XLSM metaúdaje v Java"
      content_left: |
      ...
      title_right: "Vymazať metadáta kategórie zo súboru XLSM"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLSM
