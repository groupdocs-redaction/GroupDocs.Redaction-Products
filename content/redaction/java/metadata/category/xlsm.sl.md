...
draft: false
path: "sl/redaction/java/metadata/category/xlsm"
...
ad_description: "Ime kategorije uredi iz XLSM metapodatkov v Java"
############################# Head ############################
head_title: "Ime kategorije uredi iz XLSM metapodatkov v Java"
...
############################# Header ############################
title: "Ime kategorije uredi iz XLSM metapodatkov v Java"
...
steps:
    ...
    - title_left: "Uredij XLSM Metapodatke v Java"
      content_left: |
        Naslednja koda omogoča iskanje in redigiranje občutljivih podatkov iz dokumenta XLSM. Obseg za redigiranje lahko nastavite tako, da nastavite filter, npr. na metafilter.Category. - ujemanja regularnih izrazov bodo razveljavljena v vseh metapodatkovnih elementih, razen lastnosti« Kategorija »: 
    ...
    - title_left: "Odstrani XLSM metapodatke v Java"
      ...
      title_right: "Izbriši metapodatke kategorije iz datoteke XLSM"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko XLSM
