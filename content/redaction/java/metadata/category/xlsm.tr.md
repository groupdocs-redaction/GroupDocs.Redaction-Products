...
draft: false
path: "tr/redaction/java/metadata/category/xlsm"
...
ad_description: "Java içindeki XLSM Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki XLSM Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki XLSM Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki XLSM Meta Verileri Kaldır"
      ...
      title_right: "Kategori Meta Verilerini XLSM Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLSM dosyasını yükleyin
