...
draft: false
path: "uk/redaction/java/metadata/category/xlsm"
...
ad_description: "Відредагувати назву категорії з XLSM метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з XLSM метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з XLSM метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані XLSM в Java"
      ...
      title_right: "Видалити метадані категорії з файлу XLSM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл XLSM
