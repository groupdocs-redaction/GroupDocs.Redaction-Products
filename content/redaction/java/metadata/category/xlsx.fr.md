...
draft: false
path: "fr/redaction/java/metadata/category/xlsx"
...
ad_description: "Rédiger le nom de la catégorie à partir des métadonnées XLSX dans Java"
############################# Head ############################
head_title: "Rédiger le nom de la catégorie à partir des métadonnées XLSX dans Java"
...
############################# Header ############################
title: "Rédiger le nom de la catégorie à partir des métadonnées XLSX dans Java"
...
steps:
    ...
    - title_left: "Supprimer XLSX métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées de catégorie du fichier XLSX"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier XLSX
