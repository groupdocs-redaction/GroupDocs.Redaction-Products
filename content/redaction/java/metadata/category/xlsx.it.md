...
draft: false
path: "it/redaction/java/metadata/category/xlsx"
...
ad_description: "Modifica il nome della categoria dai metadati XLSX in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati XLSX in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati XLSX in Java"
...
steps:
    ...
    - title_left: "Rimuovi XLSX metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file XLSX"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLSX
