...
draft: false
path: "lv/redaction/java/metadata/category/xlsx"
...
ad_description: "Readēt kategorijas nosaukumu no XLSX metadatiem Java"
############################# Head ############################
head_title: "Readēt kategorijas nosaukumu no XLSX metadatiem Java"
...
############################# Header ############################
title: "Readēt kategorijas nosaukumu no XLSX metadatiem Java"
...
steps:
    ...
    - title_left: "Noņemt XLSX metadatus Java"
      content_left: |
      ...
      title_right: "Dzēst kategorijas metadatus no XLSX faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLSX faila instanci
