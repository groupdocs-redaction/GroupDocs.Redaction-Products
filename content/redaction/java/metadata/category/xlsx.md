...
draft: false
path: "redaction/java/metadata/category/xlsx"
...
ad_description: "Redact Category Name from XLSX Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from XLSX Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from XLSX Metadata in Java"
...
steps:
    ...
    - title_left: "Remove XLSX Metadata in Java"
      content_left: |
      ...
      title_right: "Erase Category Metadata from XLSX File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLSX file
