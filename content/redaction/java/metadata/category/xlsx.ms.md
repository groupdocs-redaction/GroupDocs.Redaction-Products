...
draft: false
path: "ms/redaction/java/metadata/category/xlsx"
...
ad_description: "Redact Nama Kategori dari XLSX Metadata dalam Java"
############################# Head ############################
head_title: "Redact Nama Kategori dari XLSX Metadata dalam Java"
...
############################# Header ############################
title: "Redact Nama Kategori dari XLSX Metadata dalam Java"
...
steps:
    ...
    - title_left: "Keluarkan Metadata XLSX dalam Java"
      ...
      title_right: "Padamkan Metadata Kategori dari XLSX Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail XLSX
