...
draft: false
path: "nl/redaction/java/metadata/category/xlsx"
...
ad_description: "Categorienaam redigeren uit XLSX metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit XLSX metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit XLSX metagegevens in Java"
...
steps:
    enable: true
    block:
    - title_left: "XLSX Metagegevens redigeren in Java"
      content_left: |
    ...
    - title_left: "XLSX metagegevens verwijderen in Java"
      content_left: |
      ...
      title_right: "Metagegevens van categorieën uit het XLSX -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLSX -bestand
