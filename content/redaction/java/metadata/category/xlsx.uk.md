...
draft: false
path: "uk/redaction/java/metadata/category/xlsx"
...
ad_description: "Відредагувати назву категорії з XLSX метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з XLSX метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з XLSX метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані XLSX в Java"
      ...
      title_right: "Видалити метадані категорії з файлу XLSX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл XLSX
