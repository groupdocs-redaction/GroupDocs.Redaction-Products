...
draft: false
path: "es/redaction/java/metadata/category/xlt"
...
ad_description: "Redactar el nombre de la categoría de los metadatos de XLT en Java"
############################# Head ############################
head_title: "Redactar el nombre de la categoría de los metadatos de XLT en Java"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de XLT en Java"
...
steps:
    ...
    - title_left: "Eliminar XLT metadatos en Java"
      ...
      title_right: "Borrar metadatos de categoría del archivo XLT"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo XLT
