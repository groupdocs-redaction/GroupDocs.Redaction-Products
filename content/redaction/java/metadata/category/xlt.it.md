...
draft: false
path: "it/redaction/java/metadata/category/xlt"
...
ad_description: "Modifica il nome della categoria dai metadati XLT in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati XLT in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati XLT in Java"
...
steps:
    ...
    - title_left: "Rimuovi XLT metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file XLT"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLT
