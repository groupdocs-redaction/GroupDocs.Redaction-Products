...
ad_description: "Redact Category Name from XLT Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from XLT Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from XLT Metadata in Java"
...
steps:
    ...
    - title_left: "Remove XLT Metadata in Java"
      content_left: |
      ...
      title_right: "Erase Category Metadata from XLT File "
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLT file
