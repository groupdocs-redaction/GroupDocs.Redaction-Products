...
draft: false
path: "nl/redaction/java/metadata/category/xlt"
...
ad_description: "Categorienaam redigeren uit XLT metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit XLT metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit XLT metagegevens in Java"
...
steps:
    ...
    - title_left: "XLT metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het XLT -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLT -bestand
