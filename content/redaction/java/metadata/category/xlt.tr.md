...
draft: false
path: "tr/redaction/java/metadata/category/xlt"
...
ad_description: "Java içindeki XLT Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki XLT Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki XLT Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki XLT Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini XLT Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLT dosyasını yükleyin
