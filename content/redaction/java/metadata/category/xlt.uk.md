...
draft: false
path: "uk/redaction/java/metadata/category/xlt"
...
ad_description: "Відредагувати назву категорії з XLT метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з XLT метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з XLT метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані XLT в Java"
      ...
      title_right: "Видалити метадані категорії з файлу XLT"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл XLT
