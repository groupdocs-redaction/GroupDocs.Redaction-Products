...
draft: false
path: "de/redaction/java/metadata/category/xltm"
...
ad_description: "Kategorienamen aus XLTM Metadaten in Java redigieren"
############################# Head ############################
head_title: "Kategorienamen aus XLTM Metadaten in Java redigieren"
...
############################# Header ############################
title: "Kategorienamen aus XLTM Metadaten in Java redigieren"
...
steps:
    ...
    - title_left: "XLTM Metadaten in Java entfernen"
      ...
      title_right: "Kategorie-Metadaten aus XLTM -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei XLTM hoch
