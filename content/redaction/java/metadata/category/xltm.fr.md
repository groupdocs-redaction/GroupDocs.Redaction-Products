...
draft: false
path: "fr/redaction/java/metadata/category/xltm"
...
ad_description: "Rédiger le nom de la catégorie à partir des métadonnées XLTM dans Java"
############################# Head ############################
head_title: "Rédiger le nom de la catégorie à partir des métadonnées XLTM dans Java"
...
############################# Header ############################
title: "Rédiger le nom de la catégorie à partir des métadonnées XLTM dans Java"
...
steps:
    ...
    - title_left: "Supprimer XLTM métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées de catégorie du fichier XLTM"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier XLTM
