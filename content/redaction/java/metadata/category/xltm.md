...
ad_description: "Redact Category Name from XLTM Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from XLTM Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from XLTM Metadata in Java"
...
steps:
    ...
    - title_left: "Remove XLTM Metadata in Java"
      ...
      title_right: "Erase Category Metadata from XLTM File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLTM file
