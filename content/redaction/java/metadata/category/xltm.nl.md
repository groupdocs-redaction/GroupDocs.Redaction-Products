...
draft: false
path: "nl/redaction/java/metadata/category/xltm"
...
ad_description: "Categorienaam redigeren uit XLTM metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit XLTM metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit XLTM metagegevens in Java"
...
steps:
    ...
    - title_left: "XLTM metagegevens verwijderen in Java"
      content_left: |
      ...
      title_right: "Metagegevens van categorieën uit het XLTM -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLTM -bestand
