...
draft: false
path: "sk/redaction/java/metadata/category/xltm"
...
ad_description: "Redigovať názov kategórie z XLTM Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z XLTM Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z XLTM Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť XLTM metaúdaje v Java"
      content_left: |
      ...
      title_right: "Vymazať metadáta kategórie zo súboru XLTM"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLTM
