...
draft: false
path: "uk/redaction/java/metadata/category/xltm"
...
ad_description: "Відредагувати назву категорії з XLTM метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з XLTM метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з XLTM метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані XLTM в Java"
      ...
      title_right: "Видалити метадані категорії з файлу XLTM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл XLTM
