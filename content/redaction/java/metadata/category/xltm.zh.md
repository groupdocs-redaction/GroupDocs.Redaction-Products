...
draft: false
path: "zh/redaction/java/metadata/category/xltm"
...
ad_description: "从 Java 中的 XLTM 元数据中删除类别名称"
############################# Head ############################
head_title: "从 Java 中的 XLTM 元数据中删除类别名称"
head_description: "GroupDocs.Redaction s 提供了灵活的 API，允许使用过滤器搜索和替换/删除任何元数据属性。"

############################# Header ############################
title: "从 Java 中的 XLTM 元数据中删除类别名称"
