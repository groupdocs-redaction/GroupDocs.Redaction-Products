...
draft: false
path: "es/redaction/java/metadata/category/xltx"
...
ad_description: "Redactar el nombre de la categoría de los metadatos de XLTX en Java"
############################# Head ############################
head_title: "Redactar el nombre de la categoría de los metadatos de XLTX en Java"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de XLTX en Java"
...
steps:
    ...
    - title_left: "Eliminar XLTX metadatos en Java"
      ...
      title_right: "Borrar metadatos de categoría del archivo XLTX"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo XLTX
