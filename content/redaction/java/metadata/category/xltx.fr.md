...
draft: false
path: "fr/redaction/java/metadata/category/xltx"
...
ad_description: "Rédiger le nom de la catégorie à partir des métadonnées XLTX dans Java"
############################# Head ############################
head_title: "Rédiger le nom de la catégorie à partir des métadonnées XLTX dans Java"
...
############################# Header ############################
title: "Rédiger le nom de la catégorie à partir des métadonnées XLTX dans Java"
...
steps:
    ...
    - title_left: "Supprimer XLTX métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées de catégorie du fichier XLTX"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier XLTX
