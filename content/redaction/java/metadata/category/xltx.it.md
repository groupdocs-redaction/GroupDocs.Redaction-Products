...
draft: false
path: "it/redaction/java/metadata/category/xltx"
...
ad_description: "Modifica il nome della categoria dai metadati XLTX in Java"
############################# Head ############################
head_title: "Modifica il nome della categoria dai metadati XLTX in Java"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati XLTX in Java"
...
steps:
    ...
    - title_left: "Rimuovi XLTX metadati in Java"
      ...
      title_right: "Cancella i metadati delle categorie dal file XLTX"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLTX
