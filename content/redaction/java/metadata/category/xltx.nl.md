...
draft: false
path: "nl/redaction/java/metadata/category/xltx"
...
ad_description: "Categorienaam redigeren uit XLTX metagegevens in Java"
############################# Head ############################
head_title: "Categorienaam redigeren uit XLTX metagegevens in Java"
...
############################# Header ############################
title: "Categorienaam redigeren uit XLTX metagegevens in Java"
...
steps:
    ...
    - title_left: "XLTX metagegevens verwijderen in Java"
      ...
      title_right: "Metagegevens van categorieën uit het XLTX -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLTX -bestand
