...
ad_description: "Удалить название категории из метаданных XLTX в Java"
############################# Head ############################
head_title: "Редактировать название категории из метаданных XLTX в Java"
...
############################# Header ############################
title: "Редактировать название категории из метаданных XLTX в Java"
...
steps:
    ...
    - title_left: "Удалить метаданные XLTX в Java"
      ...
      title_right: "Удалить метаданные категории из файла XLTX "
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл XLTX.
