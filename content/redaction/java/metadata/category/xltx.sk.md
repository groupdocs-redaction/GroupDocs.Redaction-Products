...
draft: false
path: "sk/redaction/java/metadata/category/xltx"
...
ad_description: "Redigovať názov kategórie z XLTX Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov kategórie z XLTX Metaúdajov v Java"
...
############################# Header ############################
title: "Redigovať názov kategórie z XLTX Metaúdajov v Java"
...
steps:
    ...
    - title_left: "Odstrániť XLTX metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta kategórie zo súboru XLTX"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLTX
