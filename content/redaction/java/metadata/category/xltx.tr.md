...
draft: false
path: "tr/redaction/java/metadata/category/xltx"
...
ad_description: "Java içindeki XLTX Meta Verilerden Kategori Adını Redakt"
############################# Head ############################
head_title: "Java içindeki XLTX Meta Verilerden Kategori Adını Redakt"
...
############################# Header ############################
title: "Java içindeki XLTX Meta Verilerden Kategori Adını Redakt"
...
steps:
    ...
    - title_left: "Java içindeki XLTX Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "Kategori Meta Verilerini XLTX Dosyasından Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLTX dosyasını yükleyin
