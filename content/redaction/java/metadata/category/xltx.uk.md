...
draft: false
path: "uk/redaction/java/metadata/category/xltx"
...
ad_description: "Відредагувати назву категорії з XLTX метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву категорії з XLTX метаданих у Java"
...
############################# Header ############################
title: "Відредагувати назву категорії з XLTX метаданих у Java"
...
steps:
    ...
    - title_left: "Видалити метадані XLTX в Java"
      ...
      title_right: "Видалити метадані категорії з файлу XLTX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл XLTX
