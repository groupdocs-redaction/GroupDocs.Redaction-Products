...
draft: false
path: "lv/redaction/java/metadata/company/bmp"
...
ad_description: "Redakt uzņēmuma nosaukumu no BMP metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt BMP faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no BMP dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
