...
draft: false
path: "sk/redaction/java/metadata/company/bmp"
...
ad_description: "Redigovať názov spoločnosti z BMP Metaúdajov v Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Redigovať metaúdaje súboru BMP"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu BMP. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na Metadatafilter.company. Zhody regulárnych výrazov ponechá nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Spoločnosť“: 
