...
draft: false
path: "lv/redaction/java/metadata/company/doc"
...
ad_description: "Redakt uzņēmuma nosaukumu no DOC metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt DOC faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOC dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
