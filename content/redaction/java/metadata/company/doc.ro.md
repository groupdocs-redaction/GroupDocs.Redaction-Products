...
draft: false
path: "ro/redaction/java/metadata/company/doc"
...
ad_description: "Redactă numele companiei din DOC Metadate în Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Redacția metadatelor fișierului DOC"
      content_left: |
        Codul următor vă permite să căutați și să redactați date sensibile dintr-un document DOC. Puteți seta domeniul de redactare setând filtrul, de exemplu, la MetadataFilter.Company. Va lăsa neanulate potrivirile expresiilor obișnuite în toate elementele de metadate, cu excepția proprietății „Companie”: 
