...
draft: false
path: "lv/redaction/java/metadata/company/docm"
...
ad_description: "Redakt uzņēmuma nosaukumu no DOCM metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt DOCM faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOCM dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
