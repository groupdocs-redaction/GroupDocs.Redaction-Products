...
draft: false
path: "tr/redaction/java/metadata/company/docm"
...
ad_description: "Java içindeki DOCM Meta Verilerden Şirket Adını Redakt Etme"
############################# Head ############################
...
steps:
    ...
    - title_left: "DOCM Dosyasının Meta Verilerini Redakt Et"
      content_left: |
        Aşağıdaki kod, DOCM belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örneğin MetadataFilter.company. “Şirket” özelliği hariç, tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri bırakacaktır: 
