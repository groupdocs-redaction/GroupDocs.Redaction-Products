...
draft: false
path: "ja/redaction/java/metadata/company/docx"
...
ad_description: "JavaのDOCXメタデータから会社名を編集"
...
############################# Header ############################
title: "JavaでのDOCXドキュメントからのメタデータ編集"
