...
draft: false
path: "lv/redaction/java/metadata/company/docx"
...
ad_description: "Redakt uzņēmuma nosaukumu no DOCX metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt DOCX faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOCX dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
