...
draft: false
path: "tr/redaction/java/metadata/company/dot"
...
ad_description: "Java içindeki DOT Meta Verilerden Şirket Adını Redakt Etme"
############################# Head ############################
...
steps:
    ...
    - title_left: "DOT Dosyasının Meta Verilerini Redakt Et"
      content_left: |
        Aşağıdaki kod, DOT belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örneğin MetadataFilter.company. “Şirket” özelliği hariç, tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri bırakacaktır: 
