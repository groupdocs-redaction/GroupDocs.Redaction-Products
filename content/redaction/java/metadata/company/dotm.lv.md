...
draft: false
path: "lv/redaction/java/metadata/company/dotm"
...
ad_description: "Redakt uzņēmuma nosaukumu no DOTM metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt DOTM faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOTM dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
