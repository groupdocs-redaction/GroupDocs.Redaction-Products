...
draft: false
path: "lv/redaction/java/metadata/company/dotx"
...
ad_description: "Redakt uzņēmuma nosaukumu no DOTX metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt DOTX faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOTX dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
