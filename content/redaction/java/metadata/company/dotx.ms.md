...
draft: false
path: "ms/redaction/java/metadata/company/dotx"
...
ad_description: "Redact Nama Syarikat dari DOTX Metadata dalam Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Redact Metadata DOTX Fail"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen DOTX. Anda boleh menetapkan skop untuk redaksi dengan menetapkan penapis, mis. Kepada Metadatafilter.company. Ia akan meninggalkan padanan ungkapan biasa dibatalkan dalam semua item metadata, kecuali harta “Syarikat”: 
