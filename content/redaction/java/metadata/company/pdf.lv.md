...
draft: false
path: "lv/redaction/java/metadata/company/pdf"
...
ad_description: "Redakt uzņēmuma nosaukumu no PDF metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt PDF faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PDF dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
