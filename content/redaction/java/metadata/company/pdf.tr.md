...
draft: false
path: "tr/redaction/java/metadata/company/pdf"
...
ad_description: "Java içindeki PDF Meta Verilerden Şirket Adını Redakt Etme"
############################# Head ############################
...
steps:
    ...
    - title_left: "PDF Dosyasının Meta Verilerini Redakt Et"
      content_left: |
        Aşağıdaki kod, PDF belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örneğin MetadataFilter.company. “Şirket” özelliği hariç, tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri bırakacaktır: 
