...
draft: false
path: "de/redaction/java/metadata/company/pot"
...
ad_description: "Firmenname aus POT Metadaten in Java redigieren"
############################# Head ############################
...
steps:
    ...
    - title_left: "Metadaten der Datei POT redigieren"
      content_left: |
        Mit dem folgenden Code können Sie vertrauliche Daten in einem POT -Dokument suchen und redigieren. Sie können den Umfang der Schwärzung festlegen, indem Sie den Filter setzen, z. B. auf MetadataFilter.company. Die Treffer mit regulären Ausdrücken werden in allen Metadatenelementen außer der Eigenschaft „Company“ rückgängig gemacht: 
