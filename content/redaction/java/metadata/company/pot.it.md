...
draft: false
path: "it/redaction/java/metadata/company/pot"
...
ad_description: "Modifica il nome della società dai metadati POT in Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Modificare i metadati del file POT"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento POT. È possibile impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.company. Lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Company»: 
