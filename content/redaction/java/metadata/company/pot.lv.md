...
draft: false
path: "lv/redaction/java/metadata/company/pot"
...
ad_description: "Redakt uzņēmuma nosaukumu no POT metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt POT faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no POT dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
