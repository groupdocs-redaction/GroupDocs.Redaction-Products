...
draft: false
path: "lv/redaction/java/metadata/company/potm"
...
ad_description: "Redakt uzņēmuma nosaukumu no POTM metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt POTM faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no POTM dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
