...
draft: false
path: "nl/redaction/java/metadata/company/potm"
...
ad_description: "Bedrijfsnaam redigeren uit POTM metagegevens in Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Metagegevens van POTM -bestand redigeren"
      content_left: |
        Met de volgende code kunt u gevoelige gegevens in een POTM -document doorzoeken en redigeren. U kunt het bereik voor de redactie instellen door een filter in te stellen, bijvoorbeeld op Metadatafilter.company. De overeenkomsten met reguliere expressies worden in alle metagegevensitems ongedaan gemaakt, behalve in de eigenschap „Company”: 
