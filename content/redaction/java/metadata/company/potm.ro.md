...
draft: false
path: "ro/redaction/java/metadata/company/potm"
...
ad_description: "Redactă numele companiei din POTM Metadate în Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Redacția metadatelor fișierului POTM"
      content_left: |
        Codul următor vă permite să căutați și să redactați date sensibile dintr-un document POTM. Puteți seta domeniul de redactare setând filtrul, de exemplu, la MetadataFilter.Company. Va lăsa neanulate potrivirile expresiilor obișnuite în toate elementele de metadate, cu excepția proprietății „Companie”: 
