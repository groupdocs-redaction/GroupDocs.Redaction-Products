...
draft: false
path: "lv/redaction/java/metadata/company/pps"
...
ad_description: "Redakt uzņēmuma nosaukumu no PPS metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt PPS faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPS dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
