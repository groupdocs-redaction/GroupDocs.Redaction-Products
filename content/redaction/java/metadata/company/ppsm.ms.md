...
draft: false
path: "ms/redaction/java/metadata/company/ppsm"
...
ad_description: "Redact Nama Syarikat dari PPSM Metadata dalam Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Redact Metadata PPSM Fail"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen PPSM. Anda boleh menetapkan skop untuk redaksi dengan menetapkan penapis, mis. Kepada Metadatafilter.company. Ia akan meninggalkan padanan ungkapan biasa dibatalkan dalam semua item metadata, kecuali harta “Syarikat”: 
