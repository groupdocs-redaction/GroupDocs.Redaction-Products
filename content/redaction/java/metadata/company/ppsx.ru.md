...
draft: false
path: "ru/redaction/java/metadata/company/ppsx"
...
ad_description: "Исправить название компании из метаданных PPSX в Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Редактировать метаданные файла PPSX"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа PPSX. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Company. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Компания": 
