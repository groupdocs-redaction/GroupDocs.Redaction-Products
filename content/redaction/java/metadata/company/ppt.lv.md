...
draft: false
path: "lv/redaction/java/metadata/company/ppt"
...
ad_description: "Redakt uzņēmuma nosaukumu no PPT metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt PPT faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPT dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
