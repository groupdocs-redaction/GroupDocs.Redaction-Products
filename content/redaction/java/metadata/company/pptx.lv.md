...
draft: false
path: "lv/redaction/java/metadata/company/pptx"
...
ad_description: "Redakt uzņēmuma nosaukumu no PPTX metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt PPTX faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPTX dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
