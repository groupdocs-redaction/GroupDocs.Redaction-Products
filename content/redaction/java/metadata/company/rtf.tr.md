...
draft: false
path: "tr/redaction/java/metadata/company/rtf"
...
ad_description: "Java içindeki RTF Meta Verilerden Şirket Adını Redakt Etme"
############################# Head ############################
head_title: "Java içindeki RTF Belgeden Meta Veri Redaksiyonu"
...
############################# Header ############################
title: "Java içindeki RTF Belgeden Meta Veri Redaksiyonu"
...
steps:
    enable: true
    block:
    - title_left: "RTF Dosyasının Meta Verilerini Redakt Et"
      content_left: |
        Aşağıdaki kod, RTF belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örneğin MetadataFilter.company. “Şirket” özelliği hariç, tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri bırakacaktır: 
