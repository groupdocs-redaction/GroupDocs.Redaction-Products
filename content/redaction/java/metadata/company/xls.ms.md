...
draft: false
path: "ms/redaction/java/metadata/company/xls"
...
ad_description: "Redact Nama Syarikat dari XLS Metadata dalam Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Redact Metadata XLS Fail"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen XLS. Anda boleh menetapkan skop untuk redaksi dengan menetapkan penapis, mis. Kepada Metadatafilter.company. Ia akan meninggalkan padanan ungkapan biasa dibatalkan dalam semua item metadata, kecuali harta “Syarikat”: 
