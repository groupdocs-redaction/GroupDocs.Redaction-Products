...
draft: false
path: "lv/redaction/java/metadata/company/xlsm"
...
ad_description: "Redakt uzņēmuma nosaukumu no XLSM metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt XLSM faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLSM dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
