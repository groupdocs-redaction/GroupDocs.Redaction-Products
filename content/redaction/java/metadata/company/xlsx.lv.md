...
draft: false
path: "lv/redaction/java/metadata/company/xlsx"
...
ad_description: "Redakt uzņēmuma nosaukumu no XLSX metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt XLSX faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLSX dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
