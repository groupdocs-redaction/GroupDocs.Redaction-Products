...
draft: false
path: "ru/redaction/java/metadata/company/xlsx"
...
ad_description: "Исправить название компании из метаданных XLSX в Java"
...
steps:
    ...
    - title_left: "Редактировать метаданные файла XLSX"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа XLSX. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Company. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Компания": 
