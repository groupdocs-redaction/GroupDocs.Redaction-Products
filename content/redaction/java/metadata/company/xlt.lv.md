...
draft: false
path: "lv/redaction/java/metadata/company/xlt"
...
ad_description: "Redakt uzņēmuma nosaukumu no XLT metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt XLT faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLT dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
