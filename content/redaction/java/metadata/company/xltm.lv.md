...
draft: false
path: "lv/redaction/java/metadata/company/xltm"
...
ad_description: "Redakt uzņēmuma nosaukumu no XLTM metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt XLTM faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLTM dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
