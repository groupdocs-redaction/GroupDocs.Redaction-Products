...
draft: false
path: "lv/redaction/java/metadata/company/xltx"
...
ad_description: "Redakt uzņēmuma nosaukumu no XLTX metadatiem Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt XLTX faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLTX dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.company. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Uzņēmums” rekvizītu: 
