...
draft: false
path: "tr/redaction/java/metadata/company/xltx"
...
ad_description: "Java içindeki XLTX Meta Verilerden Şirket Adını Redakt Etme"
############################# Head ############################
...
steps:
    ...
    - title_left: "XLTX Dosyasının Meta Verilerini Redakt Et"
      content_left: |
        Aşağıdaki kod, XLTX belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örneğin MetadataFilter.company. “Şirket” özelliği hariç, tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri bırakacaktır: 
