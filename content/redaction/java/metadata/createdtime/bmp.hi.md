...
draft: false
path: "hi/redaction/java/metadata/createdtime/bmp"
...
ad_description: "Java में BMP दस्तावेज़ से मेटाडेटा रिडक्शन"
############################# Head ############################
head_title: "Java में BMP दस्तावेज़ से मेटाडेटा रिडक्शन"
...
############################# Header ############################
title: "Java में BMP दस्तावेज़ से मेटाडेटा रिडक्शन"
...
steps:
    ...
    - title_left: "Java में क्रिएटटाइम मेटाडेटा हटाएं"
      ...
      title_right: "BMP मेटाडेटा को कैसे मिटाएं"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) वर्ग का एक उदाहरण बनाएं और BMP फ़ाइल अपलोड करें
