...
draft: false
path: "lv/redaction/java/metadata/createdtime/docm"
...
ad_description: "Metadatu redakcija no DOCM Dokumenta Java"
############################# Head ############################
head_title: "Metadatu redakcija no DOCM Dokumenta Java"
...
############################# Header ############################
title: "Metadatu redakcija no DOCM Dokumenta Java"
...
steps:
    ...
    - title_left: "Noņemt Createdtime metadatus Java"
      ...
      title_right: "Kā izdzēst DOCM metadatus"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOCM faila instanci
