...
draft: false
path: "nl/redaction/java/metadata/createdtime/docm"
...
ad_description: "Redactie van metagegevens uit DOCM -document in Java"
############################# Head ############################
head_title: "Redactie van metagegevens uit DOCM -document in Java"
...
############################# Header ############################
title: "Redactie van metagegevens uit DOCM -document in Java"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens van DOCM -bestand redigeren"
      content_left: |
    ...
    - title_left: "Verwijder de metagegevens van Createdtime in Java"
      ...
      title_right: "Hoe kan ik DOCM metagegevens wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOCM -bestand
