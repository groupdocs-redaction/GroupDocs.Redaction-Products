...
draft: false
path: "ms/redaction/java/metadata/createdtime/docx"
...
ad_description: "Redaksi Metadata Daripada Dokumen DOCX dalam Java"
############################# Head ############################
head_title: "Redaksi Metadata Daripada Dokumen DOCX dalam Java"
...
############################# Header ############################
title: "Redaksi Metadata Daripada Dokumen DOCX dalam Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact Metadata DOCX Fail"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen DOCX. Anda boleh menetapkan skop untuk redaksi dengan menetapkan penapis, mis. Ke Metadatafilter.createdTime. Ia akan meninggalkan padanan ungkapan biasa dibatalkan dalam semua item metadata, kecuali harta “CreatedTime”: 
    ...
    - title_left: "Keluarkan Metadata CreatedTime dalam Java"
      ...
      title_right: "Cara Memadamkan Metadata DOCX"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail DOCX
