...
draft: false
path: "nl/redaction/java/metadata/createdtime/docx"
...
ad_description: "Redactie van metagegevens uit DOCX -document in Java"
############################# Head ############################
head_title: "Redactie van metagegevens uit DOCX -document in Java"
...
############################# Header ############################
title: "Redactie van metagegevens uit DOCX -document in Java"
...
steps:
    ...
    - title_left: "Verwijder de metagegevens van Createdtime in Java"
      ...
      title_right: "Hoe kan ik DOCX metagegevens wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOCX -bestand
