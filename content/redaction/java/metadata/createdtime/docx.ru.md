...
draft: false
path: "ru/redaction/java/metadata/createdtime/docx"
...
ad_description: "Редактирование метаданных из документа DOCX в Java"

############################# Head ############################
head_title: "Редактирование метаданных из документа DOCX в Java"
...
############################# Header ############################
title: "Редактирование метаданных из документа DOCX в Java"
...
steps:
    ...
    - title_left: "Удалить метаданные Createdtime в Java"
      ...
      title_right: "Как стереть метаданные DOCX"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл DOCX.
