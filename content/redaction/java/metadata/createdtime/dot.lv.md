...
draft: false
path: "lv/redaction/java/metadata/createdtime/dot"
...
ad_description: "Metadatu redakcija no DOT Dokumenta Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Realizēt DOT faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOT dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.CreatedTime. Tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu: 
    ...
    - title_left: "Noņemt Createdtime metadatus Java"
      ...
      title_right: "Kā izdzēst DOT metadatus"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOT faila instanci
