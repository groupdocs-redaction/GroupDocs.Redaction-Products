...
draft: false
path: "sk/redaction/java/metadata/createdtime/dotm"
...
ad_description: "Redakcia metadát z dokumentu DOTM v Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Redigovať metaúdaje súboru DOTM"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu DOTM. Rozsah redigovania môžete nastaviť nastavením filtra, napr. na Metadatafilter.CreatedTime. Zhody regulárnych výrazov ponechá späť vo všetkých položkách metaúdajov okrem vlastnosti „Createdtime“: 
    ...
    - title_left: "Odstrániť metadáta Createdtime v Java"
      ...
      title_right: "Ako vymazať DOTM metaúdaje"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOTM
