...
draft: false
path: "lv/redaction/java/metadata/createdtime/dotx"
...
ad_description: "Metadatu redakcija no DOTX Dokumenta Java"
############################# Head ############################
head_title: "Metadatu redakcija no DOTX Dokumenta Java"
...
############################# Header ############################
title: "Metadatu redakcija no DOTX Dokumenta Java"
...
steps:
    enable: true
    block:
    - title_left: "Realizēt DOTX faila metadatus"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOTX dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.CreatedTime. Tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu: 
    ...
    - title_left: "Noņemt Createdtime metadatus Java"
      ...
      title_right: "Kā izdzēst DOTX metadatus"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOTX faila instanci
