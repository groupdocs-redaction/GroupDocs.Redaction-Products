...
draft: false
path: "sk/redaction/java/metadata/createdtime/potm"
...
ad_description: "Redakcia metadát z dokumentu POTM v Java"
############################# Head ############################
head_title: "Redakcia metadát z dokumentu POTM v Java"
...
############################# Header ############################
title: "Redakcia metadát z dokumentu POTM v Java"
...
steps:
    ...
    - title_left: "Odstrániť metadáta Createdtime v Java"
      ...
      title_right: "Ako vymazať POTM metaúdaje"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload POTM
