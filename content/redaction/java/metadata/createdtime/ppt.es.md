...
draft: false
path: "es/redaction/java/metadata/createdtime/ppt"
...
ad_description: "Redacción de metadatos del documento PPT en Java"
############################# Head ############################
head_title: "Redacción de metadatos del documento PPT en Java"
...
############################# Header ############################
title: "Redacción de metadatos del documento PPT en Java"
...
steps:
    ...
    - title_left: "Eliminar los metadatos de Createdtime en Java"
      ...
      title_right: "Cómo borrar los metadatos de PPT"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo PPT
