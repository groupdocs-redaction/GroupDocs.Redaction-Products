...
draft: false
path: "lv/redaction/java/metadata/createdtime/ppt"
...
ad_description: "Metadatu redakcija no PPT Dokumenta Java"
############################# Head ############################
head_title: "Metadatu redakcija no PPT Dokumenta Java"
...
############################# Header ############################
title: "Metadatu redakcija no PPT Dokumenta Java"
...
steps:
    ...
    - title_left: "Noņemt Createdtime metadatus Java"
      ...
      title_right: "Kā izdzēst PPT metadatus"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPT faila instanci
