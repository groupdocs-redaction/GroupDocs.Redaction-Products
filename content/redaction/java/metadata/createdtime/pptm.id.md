...
draft: false
path: "id/redaction/java/metadata/createdtime/pptm"
...
steps:
    ...
    - title_left: "Redact Metadata dari PPTM File"
      content_left: |
        Kode berikut memungkinkan Anda untuk mencari dan menyunting data sensitif dari dokumen PPTM. Anda dapat mengatur ruang lingkup untuk redaksi dengan mengatur filter, mis. ke MetadataFilter.Createdtime. Ini akan membuat kecocokan ekspresi reguler dibatalkan di semua item metadata, kecuali properti "Createdtime": 
    ...
    - title_left: "Hapus Metadata Createdtime di Java"
      ...
      title_right: "Cara Menghapus Metadata PPTM"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & unggah file PPTM
