...
draft: false
path: "uk/redaction/java/metadata/createdtime/rtf"
...
ad_description: "Редагування метаданих з документа RTF в Java"
############################# Head ############################
head_title: "Редагування метаданих з документа RTF в Java"
...
############################# Header ############################
title: "Редагування метаданих з документа RTF в Java"
...
steps:
    ...
    - title_left: "Видалення створених метаданих часу в Java"
      ...
      title_right: "Як стерти метадані RTF"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл RTF
