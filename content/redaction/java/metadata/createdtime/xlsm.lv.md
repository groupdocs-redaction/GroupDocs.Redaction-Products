...
draft: false
path: "lv/redaction/java/metadata/createdtime/xlsm"
...
ad_description: "Metadatu redakcija no XLSM Dokumenta Java"
############################# Head ############################
head_title: "Metadatu redakcija no XLSM Dokumenta Java"
...
############################# Header ############################
title: "Metadatu redakcija no XLSM Dokumenta Java"
...
steps:
    ...
    - title_left: "Noņemt Createdtime metadatus Java"
      ...
      title_right: "Kā izdzēst XLSM metadatus"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLSM faila instanci
