...
draft: false
path: "tr/redaction/java/metadata/createdtime/xlsm"
...
ad_description: "Java içindeki XLSM Belgeden Meta Veri Redaksiyonu"
############################# Head ############################
head_title: "Java içindeki XLSM Belgeden Meta Veri Redaksiyonu"
...
############################# Header ############################
title: "Java içindeki XLSM Belgeden Meta Veri Redaksiyonu"
...
steps:
    ...
    - title_left: "Java içindeki Createdtime Meta Verilerini Kaldır"
      ...
      title_right: "XLSM Meta Veriler Nasıl Silinebilir"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLSM dosyasını yükleyin
