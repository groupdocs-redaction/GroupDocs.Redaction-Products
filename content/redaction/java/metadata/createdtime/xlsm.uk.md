...
draft: false
path: "uk/redaction/java/metadata/createdtime/xlsm"
...
ad_description: "Редагування метаданих з документа XLSM в Java"
############################# Head ############################
head_title: "Редагування метаданих з документа XLSM в Java"
...
############################# Header ############################
title: "Редагування метаданих з документа XLSM в Java"
...
steps:
    ...
    - title_left: "Видалення створених метаданих часу в Java"
      ...
      title_right: "Як стерти метадані XLSM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл XLSM
