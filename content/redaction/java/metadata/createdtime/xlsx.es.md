...
draft: false
path: "es/redaction/java/metadata/createdtime/xlsx"
...
ad_description: "Redacción de metadatos del documento XLSX en Java"
############################# Head ############################
...
steps:
    ...
    - title_left: "Redactar los metadatos del archivo XLSX"
      content_left: |
        El siguiente código te permite buscar y eliminar datos confidenciales de un documento XLSX. Puedes establecer el alcance de la redacción configurando un filtro, por ejemplo, en MetadataFilter.createdTime. Dejará sin efecto las coincidencias de las expresiones regulares en todos los elementos de metadatos, excepto en la propiedad «Createdtime»: 
    ...
    - title_left: "Eliminar los metadatos de Createdtime en Java"
      ...
      title_right: "Cómo borrar los metadatos de XLSX"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo XLSX
