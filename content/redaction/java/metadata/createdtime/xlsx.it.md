...
draft: false
path: "it/redaction/java/metadata/createdtime/xlsx"
...
ad_description: "Revisione dei metadati dal documento XLSX in Java"
############################# Head ############################
head_title: "Revisione dei metadati dal documento XLSX in Java"
...
############################# Header ############################
title: "Revisione dei metadati dal documento XLSX in Java"
...
steps:
    ...
    - title_left: "Rimuovi i metadati Createdtime in Java"
      ...
      title_right: "Come cancellare XLSX metadati"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLSX
