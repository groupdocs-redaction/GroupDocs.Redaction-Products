...
draft: false
path: "lv/redaction/java/metadata/createdtime/xlsx"
...
ad_description: "Metadatu redakcija no XLSX Dokumenta Java"
############################# Head ############################
head_title: "Metadatu redakcija no XLSX Dokumenta Java"
...
############################# Header ############################
title: "Metadatu redakcija no XLSX Dokumenta Java"
...
steps:
    ...
    - title_left: "Noņemt Createdtime metadatus Java"
      ...
      title_right: "Kā izdzēst XLSX metadatus"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLSX faila instanci
