...
draft: false
path: "ru/redaction/java/metadata/createdtime/xlsx"
...
ad_description: "Редактирование метаданных из документа XLSX в Java"

############################# Head ############################
head_title: "Редактирование метаданных из документа XLSX в Java"
...
############################# Header ############################
title: "Редактирование метаданных из документа XLSX в Java"
...
steps:
    ...
    - title_left: "Удалить метаданные Createdtime в Java"
      ...
      title_right: "Как стереть метаданные XLSX"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл XLSX.
