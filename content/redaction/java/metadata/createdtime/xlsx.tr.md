...
draft: false
path: "tr/redaction/java/metadata/createdtime/xlsx"
...
ad_description: "Java içindeki XLSX Belgeden Meta Veri Redaksiyonu"
############################# Head ############################
head_title: "Java içindeki XLSX Belgeden Meta Veri Redaksiyonu"
...
############################# Header ############################
title: "Java içindeki XLSX Belgeden Meta Veri Redaksiyonu"
...
steps:
    ...
    - title_left: "Java içindeki Createdtime Meta Verilerini Kaldır"
      ...
      title_right: "XLSX Meta Veriler Nasıl Silinebilir"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLSX dosyasını yükleyin
