...
draft: false
path: "id/redaction/java/metadata/createdtime/xlt"
...
steps:
    ...
    - title_left: "Hapus Metadata Createdtime di Java"
      ...
      title_right: "Cara Menghapus Metadata XLT"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & unggah file XLT
