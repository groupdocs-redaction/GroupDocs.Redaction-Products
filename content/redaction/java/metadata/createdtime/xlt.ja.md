...
draft: false
path: "ja/redaction/java/metadata/createdtime/xlt"
...
ad_description: "JavaのXLTドキュメントからのメタデータ編集"
...
############################# Header ############################
title: "JavaでのXLTドキュメントからのメタデータ編集"
