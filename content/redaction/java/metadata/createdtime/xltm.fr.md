...
draft: false
path: "fr/redaction/java/metadata/createdtime/xltm"
...
ad_description: "Rédaction de métadonnées à partir d'un document XLTM dans Java"
############################# Head ############################
head_title: "Rédaction de métadonnées à partir d'un document XLTM dans Java"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document XLTM dans Java"
...
steps:
    ...
    - title_left: "Supprimer les métadonnées Createdtime dans Java"
      ...
      title_right: "Comment effacer XLTM métadonnées"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier XLTM
