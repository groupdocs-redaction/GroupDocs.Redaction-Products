...
draft: false
path: "nl/redaction/java/metadata/description/doc"
...
ad_description: "Metagegevens over de beschrijving redigeren uit een DOC -bestand in Java"
############################# Head ############################
head_title: "Metagegevens over de beschrijving redigeren uit een DOC -bestand in Java"
...
############################# Header ############################
title: "Metagegevens over de beschrijving redigeren uit een DOC -bestand in Java"
...
steps:
    ...
    - title_left: "Een metadataveld wissen in Java"
      ...
      title_right: "Het metadataveld DOC verwijderen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOC -bestand
