...
draft: false
path: "sk/redaction/java/metadata/description/doc"
...
ad_description: "Redigovať metadáta popisu zo súboru DOC v Java"
############################# Head ############################
head_title: "Redigovať metadáta popisu zo súboru DOC v Java"
...
############################# Header ############################
title: "Redigovať metadáta popisu zo súboru DOC v Java"
...
steps:
    ...
    - title_left: "Aktualizácia poľa metaúdajov popisu"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu DOC. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadataFilter.description. Zhody regulárnych výrazov ponechá nedokončené vo všetkých položkách metaúdajov, okrem vlastnosti „Popis“: 
    ...
    - title_left: "Vymazanie poľa metaúdajov v Java"
      ...
      title_right: "Odstrániť pole metaúdajov DOC"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOC
