...
draft: false
path: "lv/redaction/java/metadata/description/docm"
...
ad_description: "Redakt apraksta metadatus no DOCM faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no DOCM faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no DOCM faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt DOCM metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOCM faila instanci
