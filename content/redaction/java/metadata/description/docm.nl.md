...
draft: false
path: "nl/redaction/java/metadata/description/docm"
...
ad_description: "Metagegevens over de beschrijving redigeren uit een DOCM -bestand in Java"
############################# Head ############################
head_title: "Metagegevens over de beschrijving redigeren uit een DOCM -bestand in Java"
...
############################# Header ############################
title: "Metagegevens over de beschrijving redigeren uit een DOCM -bestand in Java"
...
steps:
    ...
    - title_left: "Een metadataveld wissen in Java"
      ...
      title_right: "Het metadataveld DOCM verwijderen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOCM -bestand
