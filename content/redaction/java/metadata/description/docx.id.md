...
draft: false
path: "id/redaction/java/metadata/description/docx"
...
############################# Head ############################
head_title: "Redact Metadata Deskripsi dari File DOCX di Java"
...
############################# Header ############################
title: "Redact Metadata Deskripsi dari File DOCX di Java"
...
steps:
    ...
    - title_left: "Hapus Bidang Metadata di Java"
      ...
      title_right: "Hapus DOCX Bidang Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & unggah file DOCX
