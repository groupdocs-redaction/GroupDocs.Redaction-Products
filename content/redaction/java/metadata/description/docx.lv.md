...
draft: false
path: "lv/redaction/java/metadata/description/docx"
...
ad_description: "Redakt apraksta metadatus no DOCX faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no DOCX faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no DOCX faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt DOCX metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOCX faila instanci
