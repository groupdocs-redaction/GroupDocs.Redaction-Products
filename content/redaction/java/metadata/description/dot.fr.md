...
draft: false
path: "fr/redaction/java/metadata/description/dot"
...
ad_description: "Rédiger les métadonnées de description d'un fichier DOT dans Java"
############################# Head ############################
head_title: "Rédiger les métadonnées de description d'un fichier DOT dans Java"
...
############################# Header ############################
title: "Rédiger les métadonnées de description d'un fichier DOT dans Java"
...
steps:
    ...
    - title_left: "Mettre à jour le champ de métadonnées de description"
      ...
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOT
    ...
    - title_left: "Effacer un champ de métadonnées dans Java"
      ...
      title_right: "Supprimer le champ de métadonnées DOT"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOT
