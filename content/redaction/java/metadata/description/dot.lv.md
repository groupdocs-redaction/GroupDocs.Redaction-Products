...
draft: false
path: "lv/redaction/java/metadata/description/dot"
...
ad_description: "Redakt apraksta metadatus no DOT faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no DOT faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no DOT faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt DOT metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOT faila instanci
