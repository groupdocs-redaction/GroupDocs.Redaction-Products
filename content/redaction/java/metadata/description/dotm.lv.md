...
draft: false
path: "lv/redaction/java/metadata/description/dotm"
...
ad_description: "Redakt apraksta metadatus no DOTM faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no DOTM faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no DOTM faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt DOTM metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOTM faila instanci
