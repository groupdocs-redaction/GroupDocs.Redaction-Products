...
draft: false
path: "lv/redaction/java/metadata/description/dotx"
...
ad_description: "Redakt apraksta metadatus no DOTX faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no DOTX faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no DOTX faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt DOTX metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOTX faila instanci
