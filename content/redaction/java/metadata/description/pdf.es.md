...
draft: false
path: "es/redaction/java/metadata/description/pdf"
...
ad_description: "Redacte los metadatos de la descripción de un archivo PDF en Java"
############################# Head ############################
head_title: "Redacte los metadatos de la descripción de un archivo PDF en Java"
...
############################# Header ############################
title: "Redacte los metadatos de la descripción de un archivo PDF en Java"
...
steps:
    ...
    - title_left: "Borrar un campo de metadatos en Java"
      ...
      title_right: "Eliminar campo de metadatos PDF"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo PDF
