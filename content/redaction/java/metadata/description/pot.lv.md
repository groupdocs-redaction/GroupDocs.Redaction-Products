...
draft: false
path: "lv/redaction/java/metadata/description/pot"
...
ad_description: "Redakt apraksta metadatus no POT faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no POT faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no POT faila Java"
...
steps:
    ...
    - title_left: "Apraksta metadatu lauka atjaunināšana"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no POT dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.Description. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Apraksts” rekvizītu: 
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt POT metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt POT faila instanci
