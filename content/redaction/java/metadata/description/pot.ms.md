...
draft: false
path: "ms/redaction/java/metadata/description/pot"
...
ad_description: "Sunting Metadata Penerangan daripada Fail POT dalam Java"
############################# Head ############################
head_title: "Redact Description Metadata daripada fail POT dalam Java"
...
############################# Header ############################
title: "Redact Description Metadata daripada fail POT dalam Java"
...
steps:
    ...
    - title_left: "Mengemas kini Penerangan Metadata Field"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen POT. Anda boleh menetapkan skop untuk redaksi dengan menetapkan penapis, mis. Ke Metadatafilter.description. Ia akan meninggalkan padanan ungkapan biasa dibatalkan dalam semua item metadata, kecuali sifat “Penerangan”: 
    ...
    - title_left: "Padamkan Medan Metadata dalam Java"
      ...
      title_right: "Alih Keluar POT Metadata Field"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail POT
