...
draft: false
path: "lv/redaction/java/metadata/description/potm"
...
ad_description: "Redakt apraksta metadatus no POTM faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no POTM faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no POTM faila Java"
...
steps:
    ...
    - title_left: "Apraksta metadatu lauka atjaunināšana"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no POTM dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.Description. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Apraksts” rekvizītu: 
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt POTM metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt POTM faila instanci
