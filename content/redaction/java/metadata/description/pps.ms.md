...
draft: false
path: "ms/redaction/java/metadata/description/pps"
...
ad_description: "Sunting Metadata Penerangan daripada Fail PPS dalam Java"
############################# Head ############################
head_title: "Redact Description Metadata daripada fail PPS dalam Java"
...
############################# Header ############################
title: "Redact Description Metadata daripada fail PPS dalam Java"
...
steps:
    ...
    - title_left: "Padamkan Medan Metadata dalam Java"
      ...
      title_right: "Alih Keluar PPS Metadata Field"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail PPS
