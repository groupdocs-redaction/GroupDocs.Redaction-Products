...
draft: false
path: "tr/redaction/java/metadata/description/pps"
...
ad_description: "Java içindeki PPS Dosyasından Açıklama Meta Verilerini Redakt"
############################# Head ############################
head_title: "Java içindeki PPS Dosyasından Açıklama Meta Verilerini Redakt"
...
############################# Header ############################
title: "Java içindeki PPS Dosyasından Açıklama Meta Verilerini Redakt"
...
steps:
    ...
    - title_left: "Açıklama Meta Veri Alanını Güncelleme"
      content_left: |
        Aşağıdaki kod, PPS belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak, örneğin MetadataFilter.Description olarak ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz. “Açıklama” özelliği hariç, tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri alır: 
    ...
    - title_left: "Java içindeki bir Meta Veri Alanını Sil"
      ...
      title_right: "PPS Meta Veri Alanını Kaldır"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve PPS dosyasını yükleyin
