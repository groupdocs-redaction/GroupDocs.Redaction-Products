...
draft: false
path: "lv/redaction/java/metadata/description/ppsm"
...
ad_description: "Redakt apraksta metadatus no PPSM faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no PPSM faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no PPSM faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt PPSM metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPSM faila instanci
