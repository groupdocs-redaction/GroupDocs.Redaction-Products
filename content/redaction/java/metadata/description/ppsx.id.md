...
draft: false
path: "id/redaction/java/metadata/description/ppsx"
...
ad_description: ""
############################# Head ############################
head_title: "Redact Metadata Deskripsi dari File PPSX di Java"
...
############################# Header ############################
title: "Redact Metadata Deskripsi dari File PPSX di Java"
...
steps:
    ...
    - title_left: "Hapus Bidang Metadata di Java"
      ...
      title_right: "Hapus PPSX Bidang Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & unggah file PPSX
