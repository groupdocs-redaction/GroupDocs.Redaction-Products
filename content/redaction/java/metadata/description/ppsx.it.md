...
draft: false
path: "it/redaction/java/metadata/description/ppsx"
...
ad_description: "Oscura i metadati della descrizione da un file PPSX in Java"
############################# Head ############################
head_title: "Oscura i metadati della descrizione da un file PPSX in Java"
...
############################# Header ############################
title: "Oscura i metadati della descrizione da un file PPSX in Java"
...
steps:
    ...
    - title_left: "Aggiornamento del campo dei metadati della descrizione"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento PPSX. È possibile impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.description. Lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Descrizione»: 
    ...
    - title_left: "Cancellare un campo di metadati in Java"
      ...
      title_right: "Rimuovi campo metadati PPSX"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file PPSX
