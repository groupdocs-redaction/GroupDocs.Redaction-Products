...
draft: false
path: "lv/redaction/java/metadata/description/ppsx"
...
ad_description: "Redakt apraksta metadatus no PPSX faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no PPSX faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no PPSX faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt PPSX metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPSX faila instanci
