...
draft: false
path: "lv/redaction/java/metadata/description/ppt"
...
ad_description: "Redakt apraksta metadatus no PPT faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no PPT faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no PPT faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt PPT metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPT faila instanci
