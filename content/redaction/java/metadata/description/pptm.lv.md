...
draft: false
path: "lv/redaction/java/metadata/description/pptm"
...
ad_description: "Redakt apraksta metadatus no PPTM faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no PPTM faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no PPTM faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt PPTM metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPTM faila instanci
