...
ad_description: "Redact Description Metadata from a PPTM File in Java"

############################# Head ############################
head_title: "Redact Description Metadata from a PPTM File in Java"
...
############################# Header ############################
title: "Redact Description Metadata from a PPTM File in Java"
...
steps:
    ...
    - title_left: "Erase a Metadata Field in Java"
      ...
      title_right: "Remove PPTM Metadata Field"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPTM file
