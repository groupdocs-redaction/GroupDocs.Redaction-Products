...
draft: false
path: "de/redaction/java/metadata/description/rtf"
...
ad_description: "Beschreibungsmetadaten aus einer RTF -Datei in Java redigieren"
############################# Head ############################
head_title: "Beschreibungsmetadaten aus einer RTF -Datei in Java redigieren"
...
############################# Header ############################
title: "Beschreibungsmetadaten aus einer RTF -Datei in Java redigieren"
...
steps:
    ...
    - title_left: "Lösche ein Metadatenfeld in Java"
      ...
      title_right: "RTF Metadatenfeld entfernen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei RTF hoch
