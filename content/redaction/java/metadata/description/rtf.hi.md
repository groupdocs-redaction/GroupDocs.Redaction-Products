...
draft: false
path: "hi/redaction/java/metadata/description/rtf"
...
ad_description: "Java में RTF फ़ाइल से विवरण मेटाडेटा को संपादित करें"
############################# Head ############################
head_title: "Java में RTF फ़ाइल से विवरण मेटाडेटा को संपादित करें"
...
############################# Header ############################
title: "Java में RTF फ़ाइल से विवरण मेटाडेटा को संपादित करें"
...
steps:
    ...
    - title_left: "विवरण मेटाडेटा फ़ील्ड अपडेट किया जा रहा है"
      content_left: |
        निम्नलिखित कोड से आप RTF दस्तावेज़ से संवेदनशील डेटा खोज सकते हैं और उसे संपादित कर सकते हैं। आप फ़िल्टर सेट करके संशोधन की गुंजाइश सेट कर सकते हैं, उदाहरण के लिए metadataFilter.description के लिए। यह “विवरण” संपत्ति को छोड़कर, सभी मेटाडेटा आइटम में नियमित अभिव्यक्तियों के मिलान को पूर्ववत छोड़ देगा: 
    ...
    - title_left: "Java में मेटाडेटा फ़ील्ड मिटाएं"
      ...
      title_right: "RTF मेटाडेटा फ़ील्ड हटाएं"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) वर्ग का एक उदाहरण बनाएं और RTF फ़ाइल अपलोड करें
