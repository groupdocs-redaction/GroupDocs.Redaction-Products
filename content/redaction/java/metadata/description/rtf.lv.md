...
draft: false
path: "lv/redaction/java/metadata/description/rtf"
...
ad_description: "Redakt apraksta metadatus no RTF faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no RTF faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no RTF faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt RTF metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt RTF faila instanci
