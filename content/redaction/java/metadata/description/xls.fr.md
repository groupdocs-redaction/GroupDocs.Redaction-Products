...
draft: false
path: "fr/redaction/java/metadata/description/xls"
...
ad_description: "Rédiger les métadonnées de description d'un fichier XLS dans Java"
############################# Head ############################
head_title: "Rédiger les métadonnées de description d'un fichier XLS dans Java"
...
############################# Header ############################
title: "Rédiger les métadonnées de description d'un fichier XLS dans Java"
...
steps:
    ...
    - title_left: "Mettre à jour le champ de métadonnées de description"
      ...
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier XLS
    ...
    - title_left: "Effacer un champ de métadonnées dans Java"
      ...
      title_right: "Supprimer le champ de métadonnées XLS"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier XLS
