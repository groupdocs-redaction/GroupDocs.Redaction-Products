...
draft: false
path: "lv/redaction/java/metadata/description/xls"
...
ad_description: "Redakt apraksta metadatus no XLS faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no XLS faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no XLS faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt XLS metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLS faila instanci
