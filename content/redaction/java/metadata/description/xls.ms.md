...
draft: false
path: "ms/redaction/java/metadata/description/xls"
...
ad_description: "Sunting Metadata Penerangan daripada Fail XLS dalam Java"
############################# Head ############################
head_title: "Redact Description Metadata daripada fail XLS dalam Java"
...
############################# Header ############################
title: "Redact Description Metadata daripada fail XLS dalam Java"
...
steps:
    ...
    - title_left: "Padamkan Medan Metadata dalam Java"
      ...
      title_right: "Alih Keluar XLS Metadata Field"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail XLS
