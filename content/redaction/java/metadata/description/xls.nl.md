...
draft: false
path: "nl/redaction/java/metadata/description/xls"
...
ad_description: "Metagegevens over de beschrijving redigeren uit een XLS -bestand in Java"
############################# Head ############################
head_title: "Metagegevens over de beschrijving redigeren uit een XLS -bestand in Java"
...
############################# Header ############################
title: "Metagegevens over de beschrijving redigeren uit een XLS -bestand in Java"
...
steps:
    ...
    - title_left: "Metagegevensveld voor beschrijving bijwerken"
      content_left: |
        Met de volgende code kunt u gevoelige gegevens in een XLS -document doorzoeken en redigeren. U kunt het bereik voor de redactie instellen door een filter in te stellen, bijvoorbeeld op MetadataFilter.Description. De overeenkomsten met reguliere expressies blijven in alle metagegevensitems ongedaan, met uitzondering van de eigenschap „Description”: 
    ...
    - title_left: "Een metadataveld wissen in Java"
      ...
      title_right: "Het metadataveld XLS verwijderen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLS -bestand
