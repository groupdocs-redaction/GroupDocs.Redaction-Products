...
draft: false
path: "sl/redaction/java/metadata/description/xls"
...
ad_description: "Uredij metapodatke opisa iz datoteke XLS v Java"
############################# Head ############################
head_title: "Uredij metapodatke opisa iz datoteke XLS v Java"
...
############################# Header ############################
title: "Uredij metapodatke opisa iz datoteke XLS v Java"
...
steps:
    ...
    - title_left: "Posodabljanje polja metapodatkov opisa"
      content_left: |
        Naslednja koda omogoča iskanje in redigiranje občutljivih podatkov iz dokumenta XLS. Obseg za redakcijo lahko nastavite tako, da nastavite filter, npr. na metafilter.Description. V vseh metapodatkovnih elementih bo ostala razveljavljena ujemanja regularnih izrazov, razen lastnosti« Opis »: 
    ...
    - title_left: "Izbrišite polje metapodatkov v Java"
      ...
      title_right: "Odstrani XLS metapodatkovno polje"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko XLS
