...
draft: false
path: "it/redaction/java/metadata/description/xlsm"
...
ad_description: "Oscura i metadati della descrizione da un file XLSM in Java"
############################# Head ############################
head_title: "Oscura i metadati della descrizione da un file XLSM in Java"
...
############################# Header ############################
title: "Oscura i metadati della descrizione da un file XLSM in Java"
...
steps:
    ...
    - title_left: "Cancellare un campo di metadati in Java"
      ...
      title_right: "Rimuovi campo metadati XLSM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLSM
