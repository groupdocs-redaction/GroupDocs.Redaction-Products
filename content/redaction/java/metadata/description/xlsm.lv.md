...
draft: false
path: "lv/redaction/java/metadata/description/xlsm"
...
ad_description: "Redakt apraksta metadatus no XLSM faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no XLSM faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no XLSM faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt XLSM metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLSM faila instanci
