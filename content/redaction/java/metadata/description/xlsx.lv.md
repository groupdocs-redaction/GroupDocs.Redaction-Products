...
draft: false
path: "lv/redaction/java/metadata/description/xlsx"
...
ad_description: "Redakt apraksta metadatus no XLSX faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no XLSX faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no XLSX faila Java"
...
steps:
    ...
    - title_left: "Apraksta metadatu lauka atjaunināšana"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLSX dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.Description. Tas atstās regulārās izteiksmes atbilstības atsaukt visos metadatu vienumos, izņemot “Apraksts” rekvizītu: 
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt XLSX metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLSX faila instanci
