...
draft: false
path: "tr/redaction/java/metadata/description/xlsx"
...
ad_description: "Java içindeki XLSX Dosyasından Açıklama Meta Verilerini Redakt"
############################# Head ############################
head_title: "Java içindeki XLSX Dosyasından Açıklama Meta Verilerini Redakt"
...
############################# Header ############################
title: "Java içindeki XLSX Dosyasından Açıklama Meta Verilerini Redakt"
...
steps:
    ...
    - title_left: "Java içindeki bir Meta Veri Alanını Sil"
      ...
      title_right: "XLSX Meta Veri Alanını Kaldır"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLSX dosyasını yükleyin
