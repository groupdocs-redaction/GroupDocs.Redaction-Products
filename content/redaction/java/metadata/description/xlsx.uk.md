...
draft: false
path: "uk/redaction/java/metadata/description/xlsx"
...
ad_description: "Відредагувати метадані опису з файлу XLSX у Java"
############################# Head ############################
head_title: "Відредагувати метадані опису з файлу XLSX у Java"
...
############################# Header ############################
title: "Відредагувати метадані опису з файлу XLSX у Java"
...
steps:
    ...
    - title_left: "Оновлення поля метаданих опису"
      content_left: |
        Наступний код дозволяє шукати та редагувати конфіденційні дані з документа XLSX. Ви можете встановити область редагування, встановивши фільтр, наприклад, MetadataFilter.Description. Він залишить збіги регулярних виразів скасованими у всіх елементах метаданих, крім властивості «Description»: 
    ...
    - title_left: "Стерти поле метаданих у Java"
      ...
      title_right: "Видалити поле метаданих XLSX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл XLSX
