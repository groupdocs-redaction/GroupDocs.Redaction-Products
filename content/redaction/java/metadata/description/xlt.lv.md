...
draft: false
path: "lv/redaction/java/metadata/description/xlt"
...
ad_description: "Redakt apraksta metadatus no XLT faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no XLT faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no XLT faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt XLT metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLT faila instanci
