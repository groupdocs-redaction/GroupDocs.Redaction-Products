...
draft: false
path: "ko/redaction/java/metadata/description/xltm"
...
ad_description: "Java 의 XLTM 파일에서 설명 메타데이터 수정"
############################# Head ############################
head_title: "Java 의 XLTM 파일에서 설명 메타데이터를 수정합니다."
head_description: "GroupDocs.Redaction s는 필터를 사용하여 모든 메타데이터 속성을 검색 및 교체/제거할 수 있는 유연한 API를 제공합니다."

############################# Header ############################
title: "Java 의 XLTM 파일에서 설명 메타데이터를 수정합니다."
...
steps:
    ...
    - title_left: "설명 메타데이터 필드 업데이트"
      ...
      content_right: |
        ...
        * 필터를 설정하여 수정 범위를 설정합니다 (예: 메타데이터 필터 사용). 아래 코드의 설명
