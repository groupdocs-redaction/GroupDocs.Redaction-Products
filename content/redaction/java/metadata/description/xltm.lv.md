...
draft: false
path: "lv/redaction/java/metadata/description/xltm"
...
ad_description: "Redakt apraksta metadatus no XLTM faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no XLTM faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no XLTM faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt XLTM metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLTM faila instanci
