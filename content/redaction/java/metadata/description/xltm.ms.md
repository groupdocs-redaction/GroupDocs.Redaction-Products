...
draft: false
path: "ms/redaction/java/metadata/description/xltm"
...
ad_description: "Sunting Metadata Penerangan daripada Fail XLTM dalam Java"
############################# Head ############################
head_title: "Redact Description Metadata daripada fail XLTM dalam Java"
...
############################# Header ############################
title: "Redact Description Metadata daripada fail XLTM dalam Java"
...
steps:
    ...
    - title_left: "Padamkan Medan Metadata dalam Java"
      ...
      title_right: "Alih Keluar XLTM Metadata Field"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail XLTM
