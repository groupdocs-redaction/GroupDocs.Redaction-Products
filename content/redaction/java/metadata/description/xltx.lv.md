...
draft: false
path: "lv/redaction/java/metadata/description/xltx"
...
ad_description: "Redakt apraksta metadatus no XLTX faila Java"
############################# Head ############################
head_title: "Redakt apraksta metadatus no XLTX faila Java"
...
############################# Header ############################
title: "Redakt apraksta metadatus no XLTX faila Java"
...
steps:
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt XLTX metadatu lauku"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLTX faila instanci
