...
draft: false
path: "tr/redaction/java/metadata/description/xltx"
...
ad_description: "Java içindeki XLTX Dosyasından Açıklama Meta Verilerini Redakt"
############################# Head ############################
head_title: "Java içindeki XLTX Dosyasından Açıklama Meta Verilerini Redakt"
...
############################# Header ############################
title: "Java içindeki XLTX Dosyasından Açıklama Meta Verilerini Redakt"
...
steps:
    ...
    - title_left: "Java içindeki bir Meta Veri Alanını Sil"
      ...
      title_right: "XLTX Meta Veri Alanını Kaldır"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLTX dosyasını yükleyin
