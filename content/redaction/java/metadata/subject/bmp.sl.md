...
draft: false
path: "sl/redaction/java/metadata/subject/bmp"
...
ad_description: "Spreredimo metapodatke o predmetu iz datoteke BMP v Java"
############################# Head ############################
head_title: "Uredij metapodatke o predmetu iz datoteke BMP v Java"
...
############################# Header ############################
title: "Uredij metapodatke o predmetu iz datoteke BMP v Java"
...
steps:
    ...
    - title_left: "Izbrišite polje metapodatkov v Java"
      ...
      title_right: "Odstrani BMP metapodatke prek GroupDocs.Redaction"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko BMP
