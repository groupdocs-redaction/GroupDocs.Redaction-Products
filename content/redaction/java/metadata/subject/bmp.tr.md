...
draft: false
path: "tr/redaction/java/metadata/subject/bmp"
...
ad_description: "Java içindeki BMP Dosyasından Konu Meta Verilerini Redakte Edin"
############################# Head ############################
head_title: "Java içindeki BMP Dosyasından Konu Meta Verilerini Redakte Edin"
...
############################# Header ############################
title: "Java içindeki BMP Dosyasından Konu Meta Verilerini Redakte Edin"
...
steps:
    ...
    - title_left: "Java içindeki bir Meta Veri Alanını Sil"
      ...
      title_right: "BMP Meta Verileri GroupDocs.Redaction Üzerinden Kaldır"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve BMP dosyasını yükleyin
