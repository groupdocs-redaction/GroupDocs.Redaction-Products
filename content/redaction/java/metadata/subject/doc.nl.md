...
draft: false
path: "nl/redaction/java/metadata/subject/doc"
...
ad_description: "Metagegevens van een onderwerp redigeren uit een DOC bestand in Java"
############################# Head ############################
head_title: "Metagegevens van een onderwerp redigeren uit een DOC -bestand in Java"
...
############################# Header ############################
title: "Metagegevens van een onderwerp redigeren uit een DOC -bestand in Java"
...
steps:
    ...
    - title_left: "Metagegevens voor onderwerpen bijwerken in Java"
      content_left: |
        Met de volgende code kunt u gevoelige gegevens in een DOC -document doorzoeken en redigeren. U kunt het bereik voor de redactie instellen door een filter in te stellen, bijvoorbeeld op MetadataFilter.Subject. De overeenkomsten met reguliere expressies blijven in alle metagegevensitems ongedaan, met uitzondering van de eigenschap „Onderwerp”: 

      title_right: "Hoe redigeer je DOC metagegevens"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOC -bestand
    ...
    - title_left: "Een metadataveld wissen in Java"
      ...
      title_right: "DOC Metagegevens verwijderen via GroupDocs.Redaction"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOC -bestand
