...
draft: false
path: "nl/redaction/java/metadata/subject/docm"
...
ad_description: "Metagegevens van een onderwerp redigeren uit een DOCM bestand in Java"
############################# Head ############################
head_title: "Metagegevens van een onderwerp redigeren uit een DOCM -bestand in Java"
...
############################# Header ############################
title: "Metagegevens van een onderwerp redigeren uit een DOCM -bestand in Java"
...
steps:
    ...
    - title_left: "Metagegevens voor onderwerpen bijwerken in Java"
      ...
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOCM -bestand
    ...
    - title_left: "Een metadataveld wissen in Java"
      ...
      title_right: "DOCM Metagegevens verwijderen via GroupDocs.Redaction"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOCM -bestand
