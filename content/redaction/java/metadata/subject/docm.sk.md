...
draft: false
path: "sk/redaction/java/metadata/subject/docm"
...
ad_description: "Redigovať metadáta predmetu zo súboru DOCM v Java"
############################# Head ############################
head_title: "Redigovať metadáta predmetu zo súboru DOCM v Java"
...
############################# Header ############################
title: "Redigovať metadáta predmetu zo súboru DOCM v Java"
...
steps:
    ...
    - title_left: "Vymazanie poľa metaúdajov v Java"
      ...
      title_right: "Odstrániť DOCM Metadáta Cez GroupDocs.Redaction"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOCM
