...
ad_description: "Редактировать метаданные субъекта из файла DOT в Java"
############################# Head ############################
head_title: "Редактировать метаданные субъекта из файла DOT в Java"
...
############################# Header ############################
title: "Редактировать метаданные субъекта из файла DOT в Java"
...
steps:
    ...
    - title_left: "Обновление метаданных темы в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа DOT. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Subject. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства «Subject»:
    ...
    - title_left: "Удалить поле метаданных в Java"
      ...
      title_right: "Удалить метаданные DOT через GroupDocs.Redaction"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл DOT
