...
draft: false
path: "hi/redaction/java/metadata/subject/dotm"
...
ad_description: "Java में DOTM फ़ाइल से विषय मेटाडेटा को संपादित करें"
############################# Head ############################
head_title: "Java में DOTM फ़ाइल से विषय मेटाडेटा को संपादित करें"
...
############################# Header ############################
title: "Java में DOTM फ़ाइल से विषय मेटाडेटा को संपादित करें"
...
steps:
    ...
    - title_left: "Java में विषय मेटाडेटा अपडेट करना"
      content_left: |
        निम्नलिखित कोड से आप DOTM दस्तावेज़ से संवेदनशील डेटा खोज सकते हैं और उसे संपादित कर सकते हैं। आप फ़िल्टर सेट करके रिडक्शन के लिए स्कोप सेट कर सकते हैं, उदाहरण के लिए metadataFilter.subject पर। यह “विषय” संपत्ति को छोड़कर, सभी मेटाडेटा आइटम में नियमित अभिव्यक्तियों के मिलान को पूर्ववत छोड़ देगा: 
    ...
    - title_left: "Java में मेटाडेटा फ़ील्ड मिटाएं"
      ...
      title_right: "GroupDocs.Redaction के ज़रिए DOTM मेटाडेटा हटाएं"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) वर्ग का एक उदाहरण बनाएं और DOTM फ़ाइल अपलोड करें
