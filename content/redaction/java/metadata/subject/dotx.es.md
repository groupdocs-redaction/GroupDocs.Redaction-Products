...
draft: false
path: "es/redaction/java/metadata/subject/dotx"
...
ad_description: "Redacte los metadatos del asunto de un archivo DOTX en Java"
############################# Head ############################
head_title: "Redacte los metadatos del asunto de un archivo DOTX en Java"
...
############################# Header ############################
title: "Redacte los metadatos del asunto de un archivo DOTX en Java"
...
steps:
    ...
    - title_left: "Borrar un campo de metadatos en Java"
      ...
      title_right: "Eliminar DOTX metadatos a través de GroupDocs.Redaction"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo DOTX
