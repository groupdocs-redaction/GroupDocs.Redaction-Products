...
draft: false
path: "it/redaction/java/metadata/subject/dotx"
...
ad_description: "Oscura i metadati dell'oggetto da un file DOTX in Java"
############################# Head ############################
head_title: "Oscurare i metadati dell'oggetto da un file DOTX in Java"
...
############################# Header ############################
title: "Oscurare i metadati dell'oggetto da un file DOTX in Java"
...
steps:
    ...
    - title_left: "Cancellare un campo di metadati in Java"
      ...
      title_right: "Rimuovi DOTX metadati tramite GroupDocs.Redaction"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file DOTX
