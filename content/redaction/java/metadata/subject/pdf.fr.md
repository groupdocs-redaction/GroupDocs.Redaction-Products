...
draft: false
path: "fr/redaction/java/metadata/subject/pdf"
...
ad_description: "Rédiger les métadonnées du sujet à partir d'un fichier PDF dans Java"
############################# Head ############################
head_title: "Rédiger les métadonnées du sujet à partir d'un fichier PDF dans Java"
...
############################# Header ############################
title: "Rédiger les métadonnées du sujet à partir d'un fichier PDF dans Java"
...
steps:
    ...
    - title_left: "Effacer un champ de métadonnées dans Java"
      ...
      title_right: "Supprimer PDF métadonnées via GroupDocs.Redaction"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier PDF
