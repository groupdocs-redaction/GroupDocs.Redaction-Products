...
draft: false
path: "lv/redaction/java/metadata/subject/pdf"
...
ad_description: "Realizēt tēmas metadatus no PDF faila Java"
############################# Head ############################
head_title: "Realizēt tēmas metadatus no PDF faila Java"
...
############################# Header ############################
title: "Realizēt tēmas metadatus no PDF faila Java"
...
steps:
    ...
    - title_left: "Tēma metadatu atjaunināšana Java"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PDF dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.Subject. Tas atstās regulāro izteiksmju atbilstības atsaukt visos metadatu vienumos, izņemot rekvizītu “Tēma”: 
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt PDF metadatus, izmantojot GroupDocs.Redaction"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PDF faila instanci
