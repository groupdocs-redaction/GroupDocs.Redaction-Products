...
draft: false
path: "sk/redaction/java/metadata/subject/pdf"
...
ad_description: "Redigovať metadáta predmetu zo súboru PDF v Java"
############################# Head ############################
head_title: "Redigovať metadáta predmetu zo súboru PDF v Java"
...
############################# Header ############################
title: "Redigovať metadáta predmetu zo súboru PDF v Java"
...
steps:
    ...
    - title_left: "Vymazanie poľa metaúdajov v Java"
      ...
      title_right: "Odstrániť PDF Metadáta Cez GroupDocs.Redaction"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PDF
