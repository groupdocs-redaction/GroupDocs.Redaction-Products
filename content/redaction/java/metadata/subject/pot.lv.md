...
draft: false
path: "lv/redaction/java/metadata/subject/pot"
...
ad_description: "Realizēt tēmas metadatus no POT faila Java"
############################# Head ############################
head_title: "Realizēt tēmas metadatus no POT faila Java"
...
############################# Header ############################
title: "Realizēt tēmas metadatus no POT faila Java"
...
steps:
    ...
    - title_left: "Tēma metadatu atjaunināšana Java"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no POT dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.Subject. Tas atstās regulāro izteiksmju atbilstības atsaukt visos metadatu vienumos, izņemot rekvizītu “Tēma”: 

      title_right: "Kā rediģēt POT metadatus"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt POT faila instanci
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt POT metadatus, izmantojot GroupDocs.Redaction"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt POT faila instanci
