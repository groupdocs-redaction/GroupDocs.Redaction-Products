...
draft: false
path: "it/redaction/java/metadata/subject/potm"
...
ad_description: "Oscura i metadati dell'oggetto da un file POTM in Java"
############################# Head ############################
head_title: "Oscurare i metadati dell'oggetto da un file POTM in Java"
...
############################# Header ############################
title: "Oscurare i metadati dell'oggetto da un file POTM in Java"
...
steps:
    ...
    - title_left: "Aggiornamento dei metadati dell'oggetto in Java"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento POTM. È possibile impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.Subject. Lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Oggetto»: 
    ...
    - title_left: "Cancellare un campo di metadati in Java"
      ...
      title_right: "Rimuovi POTM metadati tramite GroupDocs.Redaction"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file POTM
