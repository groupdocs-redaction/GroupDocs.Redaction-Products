...
draft: false
path: "de/redaction/java/metadata/subject/ppsm"
...
ad_description: "Betreff-Metadaten aus einer PPSM -Datei in Java redigieren"
############################# Head ############################
head_title: "Betreff-Metadaten aus einer PPSM -Datei in Java redigieren"
...
############################# Header ############################
title: "Betreff-Metadaten aus einer PPSM -Datei in Java redigieren"
...
steps:
    ...
    - title_left: "Aktualisierung der Betreff-Metadaten in Java"
      content_left: |
        Mit dem folgenden Code können Sie vertrauliche Daten in einem PPSM -Dokument suchen und redigieren. Sie können den Umfang der Schwärzung festlegen, indem Sie den Filter setzen, z. B. auf MetadataFilter.Subject. Die Treffer mit regulären Ausdrücken werden in allen Metadatenelementen außer der Eigenschaft „Subject“ rückgängig gemacht: 
    ...
    - title_left: "Lösche ein Metadatenfeld in Java"
      ...
      title_right: "PPSM Metadaten entfernen über GroupDocs.Redaction"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei PPSM hoch
