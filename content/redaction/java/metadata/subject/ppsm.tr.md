...
draft: false
path: "tr/redaction/java/metadata/subject/ppsm"
...
ad_description: "Java içindeki PPSM Dosyasından Konu Meta Verilerini Redakte Edin"
############################# Head ############################
head_title: "Java içindeki PPSM Dosyasından Konu Meta Verilerini Redakte Edin"
...
############################# Header ############################
title: "Java içindeki PPSM Dosyasından Konu Meta Verilerini Redakte Edin"
...
steps:
    ...
    - title_left: "Java içindeki bir Meta Veri Alanını Sil"
      ...
      title_right: "PPSM Meta Verileri GroupDocs.Redaction Üzerinden Kaldır"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve PPSM dosyasını yükleyin
