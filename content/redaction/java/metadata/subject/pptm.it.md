...
draft: false
path: "it/redaction/java/metadata/subject/pptm"
...
ad_description: "Oscura i metadati dell'oggetto da un file PPTM in Java"
############################# Head ############################
head_title: "Oscurare i metadati dell'oggetto da un file PPTM in Java"
...
############################# Header ############################
title: "Oscurare i metadati dell'oggetto da un file PPTM in Java"
...
steps:
    ...
    - title_left: "Cancellare un campo di metadati in Java"
      ...
      title_right: "Rimuovi PPTM metadati tramite GroupDocs.Redaction"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file PPTM
