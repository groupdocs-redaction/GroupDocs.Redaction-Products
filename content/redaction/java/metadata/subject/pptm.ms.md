...
draft: false
path: "ms/redaction/java/metadata/subject/pptm"
...
ad_description: "Sunting Metadata Subjek daripada Fail PPTM dalam Java"
############################# Head ############################
head_title: "Sunting Metadata Subjek dari Fail PPTM di Java"
...
############################# Header ############################
title: "Sunting Metadata Subjek dari Fail PPTM di Java"
...
steps:
    ...
    - title_left: "Mengemas kini Metadata Subjek dalam Java"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen PPTM. Anda boleh menetapkan skop untuk redaksi dengan menetapkan penapis, mis. ke Metadatafilter.subject. Ia akan meninggalkan padanan ungkapan biasa dibatalkan dalam semua item metadata, kecuali harta “Subjek”: 
    ...
    - title_left: "Padamkan Medan Metadata dalam Java"
      ...
      title_right: "Alih Keluar Metadata PPTM Melalui GroupDocs.Redaction"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail PPTM
