...
draft: false
path: "nl/redaction/java/metadata/subject/pptm"
...
ad_description: "Metagegevens van een onderwerp redigeren uit een PPTM bestand in Java"
############################# Head ############################
head_title: "Metagegevens van een onderwerp redigeren uit een PPTM -bestand in Java"
...
############################# Header ############################
title: "Metagegevens van een onderwerp redigeren uit een PPTM -bestand in Java"
...
steps:
    ...
    - title_left: "Een metadataveld wissen in Java"
      ...
      title_right: "PPTM Metagegevens verwijderen via GroupDocs.Redaction"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het PPTM -bestand
