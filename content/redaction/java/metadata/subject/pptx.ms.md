...
draft: false
path: "ms/redaction/java/metadata/subject/pptx"
...
ad_description: "Sunting Metadata Subjek daripada Fail PPTX dalam Java"
############################# Head ############################
head_title: "Sunting Metadata Subjek dari Fail PPTX di Java"
...
############################# Header ############################
title: "Sunting Metadata Subjek dari Fail PPTX di Java"
...
steps:
    ...
    - title_left: "Padamkan Medan Metadata dalam Java"
      ...
      title_right: "Alih Keluar Metadata PPTX Melalui GroupDocs.Redaction"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail PPTX
