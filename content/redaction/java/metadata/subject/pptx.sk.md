...
draft: false
path: "sk/redaction/java/metadata/subject/pptx"
...
ad_description: "Redigovať metadáta predmetu zo súboru PPTX v Java"
############################# Head ############################
head_title: "Redigovať metadáta predmetu zo súboru PPTX v Java"
...
############################# Header ############################
title: "Redigovať metadáta predmetu zo súboru PPTX v Java"
...
steps:
    ...
    - title_left: "Vymazanie poľa metaúdajov v Java"
      ...
      title_right: "Odstrániť PPTX Metadáta Cez GroupDocs.Redaction"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPTX
