...
draft: false
path: "de/redaction/java/metadata/subject/xls"
...
ad_description: "Betreff-Metadaten aus einer XLS -Datei in Java redigieren"
############################# Head ############################
head_title: "Betreff-Metadaten aus einer XLS -Datei in Java redigieren"
...
############################# Header ############################
title: "Betreff-Metadaten aus einer XLS -Datei in Java redigieren"
...
steps:
    ...
    - title_left: "Lösche ein Metadatenfeld in Java"
      ...
      title_right: "XLS Metadaten entfernen über GroupDocs.Redaction"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei XLS hoch
