...
draft: false
path: "lv/redaction/java/metadata/subject/xls"
...
ad_description: "Realizēt tēmas metadatus no XLS faila Java"
############################# Head ############################
head_title: "Realizēt tēmas metadatus no XLS faila Java"
...
############################# Header ############################
title: "Realizēt tēmas metadatus no XLS faila Java"
...
steps:
    ...
    - title_left: "Tēma metadatu atjaunināšana Java"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLS dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.Subject. Tas atstās regulāro izteiksmju atbilstības atsaukt visos metadatu vienumos, izņemot rekvizītu “Tēma”: 
    ...
    - title_left: "Metadatu lauka dzēšana Java"
      ...
      title_right: "Noņemt XLS metadatus, izmantojot GroupDocs.Redaction"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLS faila instanci
