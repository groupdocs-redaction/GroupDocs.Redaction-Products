...
draft: false
path: "it/redaction/java/metadata/subject/xlsm"
...
ad_description: "Oscura i metadati dell'oggetto da un file XLSM in Java"
############################# Head ############################
head_title: "Oscurare i metadati dell'oggetto da un file XLSM in Java"
...
############################# Header ############################
title: "Oscurare i metadati dell'oggetto da un file XLSM in Java"
...
steps:
    ...
    - title_left: "Cancellare un campo di metadati in Java"
      ...
      title_right: "Rimuovi XLSM metadati tramite GroupDocs.Redaction"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLSM
