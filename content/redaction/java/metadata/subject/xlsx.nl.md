...
draft: false
path: "nl/redaction/java/metadata/subject/xlsx"
...
ad_description: "Metagegevens van een onderwerp redigeren uit een XLSX bestand in Java"
############################# Head ############################
head_title: "Metagegevens van een onderwerp redigeren uit een XLSX -bestand in Java"
...
############################# Header ############################
title: "Metagegevens van een onderwerp redigeren uit een XLSX -bestand in Java"
...
steps:
    ...
    - title_left: "Metagegevens voor onderwerpen bijwerken in Java"
      content_left: |
        Met de volgende code kunt u gevoelige gegevens in een XLSX -document doorzoeken en redigeren. U kunt het bereik voor de redactie instellen door een filter in te stellen, bijvoorbeeld op MetadataFilter.Subject. De overeenkomsten met reguliere expressies blijven in alle metagegevensitems ongedaan, met uitzondering van de eigenschap „Onderwerp”: 
    ...
    - title_left: "Een metadataveld wissen in Java"
      ...
      title_right: "XLSX Metagegevens verwijderen via GroupDocs.Redaction"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLSX -bestand
