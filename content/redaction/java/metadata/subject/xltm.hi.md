...
draft: false
path: "hi/redaction/java/metadata/subject/xltm"
...
ad_description: "Java में XLTM फ़ाइल से विषय मेटाडेटा को संपादित करें"
############################# Head ############################
head_title: "Java में XLTM फ़ाइल से विषय मेटाडेटा को संपादित करें"
...
############################# Header ############################
title: "Java में XLTM फ़ाइल से विषय मेटाडेटा को संपादित करें"
...
steps:
    ...
    - title_left: "Java में मेटाडेटा फ़ील्ड मिटाएं"
      ...
      title_right: "GroupDocs.Redaction के ज़रिए XLTM मेटाडेटा हटाएं"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) वर्ग का एक उदाहरण बनाएं और XLTM फ़ाइल अपलोड करें
