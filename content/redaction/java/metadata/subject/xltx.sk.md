...
draft: false
path: "sk/redaction/java/metadata/subject/xltx"
...
ad_description: "Redigovať metadáta predmetu zo súboru XLTX v Java"
############################# Head ############################
head_title: "Redigovať metadáta predmetu zo súboru XLTX v Java"
...
############################# Header ############################
title: "Redigovať metadáta predmetu zo súboru XLTX v Java"
...
steps:
    ...
    - title_left: "Vymazanie poľa metaúdajov v Java"
      ...
      title_right: "Odstrániť XLTX Metadáta Cez GroupDocs.Redaction"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLTX
