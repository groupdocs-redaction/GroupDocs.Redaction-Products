...
draft: false
path: "lv/redaction/java/metadata/title/bmp"
...
ad_description: "Redakts virsraksts no BMP metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no BMP Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no BMP Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Noņemt BMP metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no BMP faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt BMP faila instanci
