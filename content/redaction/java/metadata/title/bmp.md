...
ad_description: "Redact Title from BMP Metadata in Java"

############################# Head ############################
head_title: "Redact Title from BMP File in Java Using GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Title from BMP File in Java Using GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Remove BMP Metadata in Java"
      ...
      title_right: "Erase Title Metadata from BMP File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload BMP file
