...
draft: false
path: "sl/redaction/java/metadata/title/bmp"
...
ad_description: "Uredij naslov iz metapodatkov BMP v Java"
############################# Head ############################
head_title: "Preuredite naslov iz datoteke BMP v Java Uporaba API-ja GroupDocs.Redaction"
...
############################# Header ############################
title: "Preuredite naslov iz datoteke BMP v Java Uporaba API-ja GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Odstrani BMP metapodatke v Java"
      ...
      title_right: "Izbrišite metapodatke naslova iz datoteke BMP"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko BMP
