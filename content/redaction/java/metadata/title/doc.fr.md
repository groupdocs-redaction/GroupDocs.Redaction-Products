...
draft: false
path: "fr/redaction/java/metadata/title/doc"
...
ad_description: "Rédiger le titre des métadonnées DOC dans Java"
############################# Head ############################
head_title: "Rédiger le titre du fichier DOC dans Java à l'aide de l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Rédiger le titre du fichier DOC dans Java à l'aide de l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Supprimer DOC métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées du titre du fichier DOC"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOC
