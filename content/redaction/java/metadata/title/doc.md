...
ad_description: "Redact Title from DOC Metadata in Java"

############################# Head ############################
head_title: "Redact Title from DOC File in Java Using GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Title from DOC File in Java Using GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Remove DOC Metadata in Java"
      ...
      title_right: "Erase Title Metadata from DOC File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOC file
