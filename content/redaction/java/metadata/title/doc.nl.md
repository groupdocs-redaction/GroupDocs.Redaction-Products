...
draft: false
path: "nl/redaction/java/metadata/title/doc"
...
ad_description: "Titel redigeren op basis van DOC metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit DOC -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit DOC -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "DOC metagegevens verwijderen in Java"
      content_left: |
      ...
      title_right: "Titelmetagegevens uit het DOC -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOC -bestand
