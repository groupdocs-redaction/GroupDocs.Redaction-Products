...
draft: false
path: "ru/redaction/java/metadata/title/doc"
...
ad_description: "Исправить заголовок из метаданных DOC в Java"

############################# Head ############################
head_title: "Редактировать заголовок из файла DOC в Java с использованием API GroupDocs.Redaction"
...
############################# Header ############################
title: "Редактировать заголовок из файла DOC в Java с использованием API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Редактировать метаданные Title в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа DOC. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Title. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Title": 
