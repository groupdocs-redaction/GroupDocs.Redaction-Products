...
draft: false
path: "de/redaction/java/metadata/title/docm"
...
ad_description: "Titel aus DOCM Metadaten in Java redigieren"
############################# Head ############################
head_title: "Redigieren Sie den Titel aus der DOCM -Datei in Java mithilfe der GroupDocs.Redaction -API"
...
############################# Header ############################
title: "Redigieren Sie den Titel aus der DOCM -Datei in Java mithilfe der GroupDocs.Redaction -API"
...
steps:
    ...
    - title_left: "DOCM Metadaten in Java entfernen"
      ...
      title_right: "Titel-Metadaten aus DOCM -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei DOCM hoch
