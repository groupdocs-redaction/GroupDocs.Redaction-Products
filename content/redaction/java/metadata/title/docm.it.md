...
draft: false
path: "it/redaction/java/metadata/title/docm"
...
ad_description: "Modifica il titolo dai metadati DOCM in Java"
############################# Head ############################
head_title: "Modifica il titolo dal file DOCM in Java utilizzando l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Modifica il titolo dal file DOCM in Java utilizzando l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Modifica i metadati del titolo in Java"
      ...
      content_right: |
        ...
        * Imposta l'ambito di redazione impostando il filtro, ad esempio usa MetadataFilters.title nel codice seguente
