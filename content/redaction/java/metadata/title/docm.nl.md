...
draft: false
path: "nl/redaction/java/metadata/title/docm"
...
ad_description: "Titel redigeren op basis van DOCM metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit DOCM -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit DOCM -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "DOCM metagegevens verwijderen in Java"
      content_left: |
      ...
      title_right: "Titelmetagegevens uit het DOCM -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOCM -bestand
