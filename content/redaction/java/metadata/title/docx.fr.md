...
draft: false
path: "fr/redaction/java/metadata/title/docx"
...
ad_description: "Rédiger le titre des métadonnées DOCX dans Java"
############################# Head ############################
head_title: "Rédiger le titre du fichier DOCX dans Java à l'aide de l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Rédiger le titre du fichier DOCX dans Java à l'aide de l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Supprimer DOCX métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées du titre du fichier DOCX"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOCX
