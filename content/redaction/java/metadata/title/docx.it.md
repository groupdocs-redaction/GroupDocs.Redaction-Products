...
draft: false
path: "it/redaction/java/metadata/title/docx"
...
ad_description: "Modifica il titolo dai metadati DOCX in Java"
############################# Head ############################
head_title: "Modifica il titolo dal file DOCX in Java utilizzando l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Modifica il titolo dal file DOCX in Java utilizzando l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Modifica i metadati del titolo in Java"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento DOCX. Puoi impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.title. Lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Titolo»: 
    ...
    - title_left: "Rimuovi DOCX metadati in Java"
      content_left: |
      ...
      title_right: "Cancella i metadati del titolo dal file DOCX"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file DOCX
