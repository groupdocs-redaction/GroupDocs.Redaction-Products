...
draft: false
path: "lv/redaction/java/metadata/title/docx"
...
ad_description: "Redakts virsraksts no DOCX metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no DOCX Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no DOCX Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Noņemt DOCX metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no DOCX faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt DOCX faila instanci
