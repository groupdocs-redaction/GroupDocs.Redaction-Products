...
draft: false
path: "de/redaction/java/metadata/title/dot"
...
ad_description: "Titel aus DOT Metadaten in Java redigieren"
############################# Head ############################
head_title: "Redigieren Sie den Titel aus der DOT -Datei in Java mithilfe der GroupDocs.Redaction -API"
...
############################# Header ############################
title: "Redigieren Sie den Titel aus der DOT -Datei in Java mithilfe der GroupDocs.Redaction -API"
...
steps:
    ...
    - title_left: "DOT Metadaten in Java entfernen"
      ...
      title_right: "Titel-Metadaten aus DOT -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei DOT hoch
