...
draft: false
path: "fr/redaction/java/metadata/title/dot"
...
ad_description: "Rédiger le titre des métadonnées DOT dans Java"
############################# Head ############################
head_title: "Rédiger le titre du fichier DOT dans Java à l'aide de l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Rédiger le titre du fichier DOT dans Java à l'aide de l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Supprimer DOT métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées du titre du fichier DOT"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOT
