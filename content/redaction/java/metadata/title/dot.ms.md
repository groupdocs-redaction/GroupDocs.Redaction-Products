...
draft: false
path: "ms/redaction/java/metadata/title/dot"
...
ad_description: "Tajuk Redact dari DOT Metadata dalam Java"
############################# Head ############################
head_title: "Redact Tajuk dari DOT Fail dalam Java Menggunakan GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Tajuk dari DOT Fail dalam Java Menggunakan GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Keluarkan Metadata DOT dalam Java"
      ...
      title_right: "Padamkan Metadata Tajuk dari Fail DOT"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail DOT
