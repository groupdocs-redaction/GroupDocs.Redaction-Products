...
draft: false
path: "ru/redaction/java/metadata/title/dot"
...
ad_description: "Исправить заголовок из метаданных DOT в Java"
############################# Head ############################
head_title: "Редактировать заголовок из файла DOT в Java с использованием API GroupDocs.Redaction"
...
############################# Header ############################
title: "Редактировать заголовок из файла DOT в Java с использованием API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Редактировать метаданные Title в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа DOT. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Title. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Title": 
    ...
    - title_left: "Удалить метаданные DOT в Java"
      content_left: |
      ...
      title_right: "Удалить метаданные заголовка из файла DOT"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл DOT
