...
draft: false
path: "uk/redaction/java/metadata/title/dot"
...
ad_description: "Відредагувати назву з DOT Метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву з DOT файлу в Java Використовуючи GroupDocs.Redaction API"
...
############################# Header ############################
title: "Відредагувати назву з DOT файлу в Java Використовуючи GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Видалити метадані DOT в Java"
      ...
      title_right: "Видалити метадані заголовка з файлу DOT"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл DOT
