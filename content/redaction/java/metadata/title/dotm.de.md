...
draft: false
path: "de/redaction/java/metadata/title/dotm"
...
ad_description: "Titel aus DOTM Metadaten in Java redigieren"
############################# Head ############################
head_title: "Redigieren Sie den Titel aus der DOTM -Datei in Java mithilfe der GroupDocs.Redaction -API"
...
############################# Header ############################
title: "Redigieren Sie den Titel aus der DOTM -Datei in Java mithilfe der GroupDocs.Redaction -API"
...
steps:
    ...
    - title_left: "DOTM Metadaten in Java entfernen"
      ...
      title_right: "Titel-Metadaten aus DOTM -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei DOTM hoch
