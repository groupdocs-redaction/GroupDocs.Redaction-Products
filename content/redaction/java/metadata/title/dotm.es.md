...
draft: false
path: "es/redaction/java/metadata/title/dotm"
...
ad_description: "Redactar el título de los metadatos de DOTM en Java"
############################# Head ############################
head_title: "Redacte el título del archivo DOTM en Java con la API GroupDocs.Redaction"
...
############################# Header ############################
title: "Redacte el título del archivo DOTM en Java con la API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Eliminar DOTM metadatos en Java"
      ...
      title_right: "Borrar los metadatos del título del archivo DOTM"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo DOTM
