...
draft: false
path: "fr/redaction/java/metadata/title/dotm"
...
ad_description: "Rédiger le titre des métadonnées DOTM dans Java"
############################# Head ############################
head_title: "Rédiger le titre du fichier DOTM dans Java à l'aide de l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Rédiger le titre du fichier DOTM dans Java à l'aide de l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Supprimer DOTM métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées du titre du fichier DOTM"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier DOTM
