...
draft: false
path: "hi/redaction/java/metadata/title/dotm"
...
ad_description: "Java में DOTM मेटाडेटा से टाइटल रिएक्ट करें"
############################# Head ############################
head_title: "GroupDocs.Redaction API का उपयोग करके Java में DOTM फ़ाइल से शीर्षक को संपादित करें"
...
############################# Header ############################
title: "GroupDocs.Redaction API का उपयोग करके Java में DOTM फ़ाइल से शीर्षक को संपादित करें"
...
steps:
    ...
    - title_left: "Java में टाइटल मेटाडेटा को फिर से बनाएँ"
      content_left: |
        निम्नलिखित कोड से आप DOTM दस्तावेज़ से संवेदनशील डेटा खोज सकते हैं और उसे संपादित कर सकते हैं। आप फ़िल्टर सेट करके रिडक्शन के लिए स्कोप सेट कर सकते हैं, उदाहरण के लिए metadataFilter.title। यह “शीर्षक” संपत्ति को छोड़कर, सभी मेटाडेटा आइटम में नियमित अभिव्यक्तियों के मिलान को पूर्ववत कर देगा: 
    ...
    - title_left: "Java में DOTM मेटाडेटा हटाएं"
      ...
      title_right: "DOTM फ़ाइल से टाइटल मेटाडेटा मिटाएँ"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) वर्ग का एक उदाहरण बनाएं और DOTM फ़ाइल अपलोड करें
