...
draft: false
path: "nl/redaction/java/metadata/title/dotm"
...
ad_description: "Titel redigeren op basis van DOTM metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit DOTM -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit DOTM -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "DOTM metagegevens verwijderen in Java"
      ...
      title_right: "Titelmetagegevens uit het DOTM -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOTM -bestand
