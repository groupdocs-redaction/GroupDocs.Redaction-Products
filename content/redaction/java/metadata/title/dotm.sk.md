...
draft: false
path: "sk/redaction/java/metadata/title/dotm"
...
ad_description: "Redigovať názov z DOTM Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov zo súboru DOTM v Java pomocou GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redigovať názov zo súboru DOTM v Java pomocou GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Redigovať metaúdaje názvu v Java"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu DOTM. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadataFilter.title. Zhody regulárnych výrazov ponechá nedokončené vo všetkých položkách metaúdajov, okrem vlastnosti „Názov“: 
    ...
    - title_left: "Odstrániť DOTM metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta názvu zo súboru DOTM"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOTM
