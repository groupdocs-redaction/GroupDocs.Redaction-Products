...
draft: false
path: "tr/redaction/java/metadata/title/dotm"
...
ad_description: "Java içindeki DOTM Meta Verilerden Başlığı Redakt Et"
############################# Head ############################
head_title: "GroupDocs.Redaction API kullanarak Java dosyasındaki DOTM Dosyasından Başlığı Redakt"
...
############################# Header ############################
title: "GroupDocs.Redaction API kullanarak Java dosyasındaki DOTM Dosyasından Başlığı Redakt"
...
steps:
    ...
    - title_left: "Java dosyasında Başlık Meta Verilerini Redakt"
      content_left: |
        Aşağıdaki kod, DOTM belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak, örneğin MetadataFilter.title öğesi olarak redaksiyon kapsamını ayarlayabilirsiniz. “Title” özelliği hariç, tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri alır: 
    ...
    - title_left: "Java içindeki DOTM Meta Verileri Kaldır"
      ...
      title_right: "DOTM Dosyasından Başlık Meta Verilerini Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve DOTM dosyasını yükleyin
