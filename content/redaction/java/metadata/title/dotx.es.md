...
draft: false
path: "es/redaction/java/metadata/title/dotx"
...
ad_description: "Redactar el título de los metadatos de DOTX en Java"
############################# Head ############################
head_title: "Redacte el título del archivo DOTX en Java con la API GroupDocs.Redaction"
...
############################# Header ############################
title: "Redacte el título del archivo DOTX en Java con la API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Eliminar DOTX metadatos en Java"
      ...
      title_right: "Borrar los metadatos del título del archivo DOTX"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo DOTX
