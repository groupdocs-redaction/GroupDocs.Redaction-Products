...
draft: false
path: "it/redaction/java/metadata/title/dotx"
...
ad_description: "Modifica il titolo dai metadati DOTX in Java"
############################# Head ############################
head_title: "Modifica il titolo dal file DOTX in Java utilizzando l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Modifica il titolo dal file DOTX in Java utilizzando l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Rimuovi DOTX metadati in Java"
      ...
      title_right: "Cancella i metadati del titolo dal file DOTX"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file DOTX
