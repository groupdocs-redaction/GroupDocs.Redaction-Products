...
draft: false
path: "ms/redaction/java/metadata/title/dotx"
...
ad_description: "Tajuk Redact dari DOTX Metadata dalam Java"
############################# Head ############################
head_title: "Redact Tajuk dari DOTX Fail dalam Java Menggunakan GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Tajuk dari DOTX Fail dalam Java Menggunakan GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Sunting Metadata Tajuk dalam Java"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen DOTX. Anda boleh menetapkan skop untuk redaksi dengan menetapkan penapis, cth. kepada Metadatafilter.title. Ia akan meninggalkan padanan ungkapan biasa dibatalkan dalam semua item metadata, kecuali harta “Tajuk”: 
    ...
    - title_left: "Keluarkan Metadata DOTX dalam Java"
      content_left: |
      ...
      title_right: "Padamkan Metadata Tajuk dari Fail DOTX"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail DOTX
