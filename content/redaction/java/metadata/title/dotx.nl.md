...
draft: false
path: "nl/redaction/java/metadata/title/dotx"
...
ad_description: "Titel redigeren op basis van DOTX metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit DOTX -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit DOTX -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "DOTX metagegevens verwijderen in Java"
      ...
      title_right: "Titelmetagegevens uit het DOTX -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het DOTX -bestand
