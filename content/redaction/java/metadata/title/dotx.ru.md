...
draft: false
path: "ru/redaction/java/metadata/title/dotx"
...
ad_description: "Исправить заголовок из метаданных DOTX в Java"

############################# Head ############################
head_title: "Редактировать заголовок из файла DOTX в Java с использованием API GroupDocs.Redaction"
...
############################# Header ############################
title: "Редактировать заголовок из файла DOTX в Java с использованием API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Редактировать метаданные Title в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа DOTX. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Title. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Title": 

      title_right: "Как редактировать метаданные DOTX"
      content_right: |
    ...
    - title_left: "Удалить метаданные DOTX в Java"
      content_left: |
      ...
      title_right: "Удалить метаданные заголовка из файла DOTX"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл DOTX
