...
draft: false
path: "sl/redaction/java/metadata/title/dotx"
...
ad_description: "Uredij naslov iz metapodatkov DOTX v Java"
############################# Head ############################
head_title: "Preuredite naslov iz datoteke DOTX v Java Uporaba API-ja GroupDocs.Redaction"
...
############################# Header ############################
title: "Preuredite naslov iz datoteke DOTX v Java Uporaba API-ja GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Odstrani DOTX metapodatke v Java"
      ...
      title_right: "Izbrišite metapodatke naslova iz datoteke DOTX"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko DOTX
