...
draft: false
path: "uk/redaction/java/metadata/title/dotx"
...
ad_description: "Відредагувати назву з DOTX Метаданих у Java"
############################# Head ############################
head_title: "Відредагувати назву з DOTX файлу в Java Використовуючи GroupDocs.Redaction API"
...
############################# Header ############################
title: "Відредагувати назву з DOTX файлу в Java Використовуючи GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Редагувати метадані заголовка в Java"
      content_left: |
        Наступний код дозволяє шукати та редагувати конфіденційні дані з документа DOTX. Ви можете встановити область редагування, встановивши фільтр, наприклад, MetadataFilter.title. Він залишить збіги регулярних виразів скасованими у всіх елементах метаданих, крім властивості «Title»: 
    ...
    - title_left: "Видалити метадані DOTX в Java"
      content_left: |
      ...
      title_right: "Видалити метадані заголовка з файлу DOTX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) та завантажте файл DOTX
