...
draft: false
path: "nl/redaction/java/metadata/title/pdf"
...
ad_description: "Titel redigeren op basis van PDF metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit PDF -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit PDF -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "PDF metagegevens verwijderen in Java"
      ...
      title_right: "Titelmetagegevens uit het PDF -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het PDF -bestand
