...
ad_description: "Redact Title from POT Metadata in Java"
############################# Head ############################
head_title: "Redact Title from POT File in Java Using GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Title from POT File in Java Using GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Remove POT Metadata in Java"
      ...
      title_right: "Erase Title Metadata from POT File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload POT file
