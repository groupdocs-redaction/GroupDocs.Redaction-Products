...
draft: false
path: "nl/redaction/java/metadata/title/pot"
...
ad_description: "Titel redigeren op basis van POT metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit POT -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit POT -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "POT metagegevens verwijderen in Java"
      ...
      title_right: "Titelmetagegevens uit het POT -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het POT -bestand
