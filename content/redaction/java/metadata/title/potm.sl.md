...
draft: false
path: "sl/redaction/java/metadata/title/potm"
...
ad_description: "Uredij naslov iz metapodatkov POTM v Java"
############################# Head ############################
head_title: "Preuredite naslov iz datoteke POTM v Java Uporaba API-ja GroupDocs.Redaction"
...
############################# Header ############################
title: "Preuredite naslov iz datoteke POTM v Java Uporaba API-ja GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Odstrani POTM metapodatke v Java"
      ...
      title_right: "Izbrišite metapodatke naslova iz datoteke POTM"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko POTM
