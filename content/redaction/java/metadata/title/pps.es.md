...
draft: false
path: "es/redaction/java/metadata/title/pps"
...
ad_description: "Redactar el título de los metadatos de PPS en Java"
############################# Head ############################
head_title: "Redacte el título del archivo PPS en Java con la API GroupDocs.Redaction"
...
############################# Header ############################
title: "Redacte el título del archivo PPS en Java con la API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Eliminar PPS metadatos en Java"
      ...
      title_right: "Borrar los metadatos del título del archivo PPS"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo PPS
