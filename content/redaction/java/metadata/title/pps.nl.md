...
draft: false
path: "nl/redaction/java/metadata/title/pps"
...
ad_description: "Titel redigeren op basis van PPS metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit PPS -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit PPS -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "PPS metagegevens verwijderen in Java"
      ...
      title_right: "Titelmetagegevens uit het PPS -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het PPS -bestand
