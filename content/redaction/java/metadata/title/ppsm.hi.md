...
draft: false
path: "hi/redaction/java/metadata/title/ppsm"
...
ad_description: "Java में PPSM मेटाडेटा से टाइटल रिएक्ट करें"
############################# Head ############################
head_title: "GroupDocs.Redaction API का उपयोग करके Java में PPSM फ़ाइल से शीर्षक को संपादित करें"
...
############################# Header ############################
title: "GroupDocs.Redaction API का उपयोग करके Java में PPSM फ़ाइल से शीर्षक को संपादित करें"
...
steps:
    ...
    - title_left: "Java में PPSM मेटाडेटा हटाएं"
      ...
      title_right: "PPSM फ़ाइल से टाइटल मेटाडेटा मिटाएँ"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) वर्ग का एक उदाहरण बनाएं और PPSM फ़ाइल अपलोड करें
