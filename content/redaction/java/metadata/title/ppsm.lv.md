...
draft: false
path: "lv/redaction/java/metadata/title/ppsm"
...
ad_description: "Redakts virsraksts no PPSM metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no PPSM Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no PPSM Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Noņemt PPSM metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no PPSM faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPSM faila instanci
