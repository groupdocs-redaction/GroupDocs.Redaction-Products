...
draft: false
path: "lv/redaction/java/metadata/title/ppsx"
...
ad_description: "Redakts virsraksts no PPSX metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no PPSX Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no PPSX Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Noņemt PPSX metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no PPSX faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPSX faila instanci
