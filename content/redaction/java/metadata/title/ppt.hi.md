...
draft: false
path: "hi/redaction/java/metadata/title/ppt"
...
ad_description: "Java में PPT मेटाडेटा से टाइटल रिएक्ट करें"
############################# Head ############################
head_title: "GroupDocs.Redaction API का उपयोग करके Java में PPT फ़ाइल से शीर्षक को संपादित करें"
...
############################# Header ############################
title: "GroupDocs.Redaction API का उपयोग करके Java में PPT फ़ाइल से शीर्षक को संपादित करें"
...
steps:
    ...
    - title_left: "Java में PPT मेटाडेटा हटाएं"
      ...
      title_right: "PPT फ़ाइल से टाइटल मेटाडेटा मिटाएँ"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) वर्ग का एक उदाहरण बनाएं और PPT फ़ाइल अपलोड करें
