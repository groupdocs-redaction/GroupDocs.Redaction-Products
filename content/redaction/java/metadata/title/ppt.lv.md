...
draft: false
path: "lv/redaction/java/metadata/title/ppt"
...
ad_description: "Redakts virsraksts no PPT metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no PPT Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no PPT Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Noņemt PPT metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no PPT faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPT faila instanci
