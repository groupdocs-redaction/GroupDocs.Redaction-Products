...
############################# Head ############################
head_title: "Redact Title from PPT File in Java Using GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Title from PPT File in Java Using GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Remove PPT Metadata in Java"
      ...
      title_right: "Erase Title Metadata from PPT File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPT file
