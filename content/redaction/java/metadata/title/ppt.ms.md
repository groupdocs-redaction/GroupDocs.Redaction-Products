...
draft: false
path: "ms/redaction/java/metadata/title/ppt"
...
ad_description: "Tajuk Redact dari PPT Metadata dalam Java"
############################# Head ############################
head_title: "Redact Tajuk dari PPT Fail dalam Java Menggunakan GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Tajuk dari PPT Fail dalam Java Menggunakan GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Keluarkan Metadata PPT dalam Java"
      ...
      title_right: "Padamkan Metadata Tajuk dari Fail PPT"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & muat naik fail PPT
