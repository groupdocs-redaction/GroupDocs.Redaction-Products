...
draft: false
path: "nl/redaction/java/metadata/title/ppt"
...
ad_description: "Titel redigeren op basis van PPT metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit PPT -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit PPT -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "PPT metagegevens verwijderen in Java"
      ...
      title_right: "Titelmetagegevens uit het PPT -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het PPT -bestand
