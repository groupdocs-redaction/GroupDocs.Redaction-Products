...
draft: false
path: "de/redaction/java/metadata/title/pptm"
...
ad_description: "Titel aus PPTM Metadaten in Java redigieren"
############################# Head ############################
head_title: "Redigieren Sie den Titel aus der PPTM -Datei in Java mithilfe der GroupDocs.Redaction -API"
...
############################# Header ############################
title: "Redigieren Sie den Titel aus der PPTM -Datei in Java mithilfe der GroupDocs.Redaction -API"
...
steps:
    ...
    - title_left: "PPTM Metadaten in Java entfernen"
      ...
      title_right: "Titel-Metadaten aus PPTM -Datei löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) und laden Sie die Datei PPTM hoch
