...
draft: false
path: "lv/redaction/java/metadata/title/pptm"
...
ad_description: "Redakts virsraksts no PPTM metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no PPTM Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no PPTM Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Realizēt virsraksta metadatus Java"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPTM dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.Title. Tas atstās regulāro izteiksmju atbilstības atsaukt visos metadatu vienumos, izņemot rekvizītu “Nosaukums”: 
    ...
    - title_left: "Noņemt PPTM metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no PPTM faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt PPTM faila instanci
