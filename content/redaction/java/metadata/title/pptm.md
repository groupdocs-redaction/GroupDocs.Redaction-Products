...
ad_description: "Redact Title from PPTM Metadata in Java"

############################# Head ############################
head_title: "Redact Title from PPTM File in Java Using GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Title from PPTM File in Java Using GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Remove PPTM Metadata in Java"
      ...
      title_right: "Erase Title Metadata from PPTM File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPTM file
