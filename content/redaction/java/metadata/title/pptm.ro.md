...
draft: false
path: "ro/redaction/java/metadata/title/pptm"
...
ad_description: "Redactă titlul din PPTM metadate în Java"
############################# Head ############################
head_title: "Redactă titlul din fișierul PPTM în Java folosind API GroupDocs.Redaction"
...
############################# Header ############################
title: "Redactă titlul din fișierul PPTM în Java folosind API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Eliminați PPTM metadate în Java"
      ...
      title_right: "Ștergeți metadatele titlului din fișierul PPTM"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) și încărcați fișierul PPTM
