...
draft: false
path: "sk/redaction/java/metadata/title/pptm"
...
ad_description: "Redigovať názov z PPTM Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať názov zo súboru PPTM v Java pomocou GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redigovať názov zo súboru PPTM v Java pomocou GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Odstrániť PPTM metaúdaje v Java"
      ...
      title_right: "Vymazať metadáta názvu zo súboru PPTM"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload PPTM
