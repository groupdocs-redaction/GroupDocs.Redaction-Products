...
draft: false
path: "ro/redaction/java/metadata/title/pptx"
...
ad_description: "Redactă titlul din PPTX metadate în Java"
############################# Head ############################
head_title: "Redactă titlul din fișierul PPTX în Java folosind API GroupDocs.Redaction"
...
############################# Header ############################
title: "Redactă titlul din fișierul PPTX în Java folosind API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Eliminați PPTX metadate în Java"
      ...
      title_right: "Ștergeți metadatele titlului din fișierul PPTX"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) și încărcați fișierul PPTX
