...
draft: false
path: "fr/redaction/java/metadata/title/rtf"
...
ad_description: "Rédiger le titre des métadonnées RTF dans Java"
############################# Head ############################
head_title: "Rédiger le titre du fichier RTF dans Java à l'aide de l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Rédiger le titre du fichier RTF dans Java à l'aide de l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Supprimer RTF métadonnées dans Java"
      ...
      title_right: "Effacer les métadonnées du titre du fichier RTF"
      content_right: |
        * Créez une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et téléchargez le fichier RTF
