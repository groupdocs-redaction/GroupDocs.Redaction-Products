...
draft: false
path: "id/redaction/java/metadata/title/rtf"
...
############################# Head ############################
head_title: "Redact Judul dari File RTF di Java Menggunakan GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Judul dari File RTF di Java Menggunakan GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Hapus RTF Metadata di Java"
      ...
      title_right: "Hapus Metadata Judul dari File RTF"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & unggah file RTF
