...
draft: false
path: "lv/redaction/java/metadata/title/rtf"
...
ad_description: "Redakts virsraksts no RTF metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no RTF Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no RTF Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Noņemt RTF metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no RTF faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt RTF faila instanci
