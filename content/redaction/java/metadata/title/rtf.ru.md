...
draft: false
path: "ru/redaction/java/metadata/title/rtf"
...
ad_description: "Исправить заголовок из метаданных RTF в Java"

############################# Head ############################
head_title: "Редактировать заголовок из файла RTF в Java с использованием API GroupDocs.Redaction"
...
############################# Header ############################
title: "Редактировать заголовок из файла RTF в Java с использованием API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Редактировать метаданные Title в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа RTF. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Title. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Title": 
    ...
    - title_left: "Удалить метаданные RTF в Java"
      ...
      title_right: "Удалить метаданные заголовка из файла RTF"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл RTF
