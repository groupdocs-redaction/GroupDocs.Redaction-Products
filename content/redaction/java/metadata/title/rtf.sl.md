...
draft: false
path: "sl/redaction/java/metadata/title/rtf"
...
ad_description: "Uredij naslov iz metapodatkov RTF v Java"
############################# Head ############################
head_title: "Preuredite naslov iz datoteke RTF v Java Uporaba API-ja GroupDocs.Redaction"
...
############################# Header ############################
title: "Preuredite naslov iz datoteke RTF v Java Uporaba API-ja GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Odstrani RTF metapodatke v Java"
      content_left: |
      ...
      title_right: "Izbrišite metapodatke naslova iz datoteke RTF"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko RTF
