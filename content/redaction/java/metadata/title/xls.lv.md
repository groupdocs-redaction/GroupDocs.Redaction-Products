...
draft: false
path: "lv/redaction/java/metadata/title/xls"
...
ad_description: "Redakts virsraksts no XLS metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no XLS Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no XLS Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Noņemt XLS metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no XLS faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLS faila instanci
