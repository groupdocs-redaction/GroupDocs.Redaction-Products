...
draft: false
path: "es/redaction/java/metadata/title/xlsm"
...
ad_description: "Redactar el título de los metadatos de XLSM en Java"
############################# Head ############################
head_title: "Redacte el título del archivo XLSM en Java con la API GroupDocs.Redaction"
...
############################# Header ############################
title: "Redacte el título del archivo XLSM en Java con la API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Eliminar XLSM metadatos en Java"
      ...
      title_right: "Borrar los metadatos del título del archivo XLSM"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo XLSM
