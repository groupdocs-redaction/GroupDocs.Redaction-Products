...
draft: false
path: "lv/redaction/java/metadata/title/xlsm"
...
ad_description: "Redakts virsraksts no XLSM metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no XLSM Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no XLSM Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Realizēt virsraksta metadatus Java"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLSM dokumenta. Redakcijas tvērumu var iestatīt, iestatot filtru, piemēram, uz MetadaFilter.Title. Tas atstās regulāro izteiksmju atbilstības atsaukt visos metadatu vienumos, izņemot rekvizītu “Nosaukums”: 
    ...
    - title_left: "Noņemt XLSM metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no XLSM faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLSM faila instanci
