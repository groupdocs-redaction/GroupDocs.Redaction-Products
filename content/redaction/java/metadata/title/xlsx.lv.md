...
draft: false
path: "lv/redaction/java/metadata/title/xlsx"
...
ad_description: "Redakts virsraksts no XLSX metadatiem Java"
############################# Head ############################
head_title: "Redakts nosaukums no XLSX Fails Java Izmantojot GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redakts nosaukums no XLSX Fails Java Izmantojot GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Noņemt XLSX metadatus Java"
      ...
      title_right: "Dzēst virsraksta metadatus no XLSX faila"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt XLSX faila instanci
