...
draft: false
path: "nl/redaction/java/metadata/title/xlsx"
...
ad_description: "Titel redigeren op basis van XLSX metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit XLSX -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit XLSX -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "XLSX metagegevens verwijderen in Java"
      ...
      title_right: "Titelmetagegevens uit het XLSX -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLSX -bestand
