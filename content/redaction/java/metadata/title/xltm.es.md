...
draft: false
path: "es/redaction/java/metadata/title/xltm"
...
ad_description: "Redactar el título de los metadatos de XLTM en Java"
############################# Head ############################
head_title: "Redacte el título del archivo XLTM en Java con la API GroupDocs.Redaction"
...
############################# Header ############################
title: "Redacte el título del archivo XLTM en Java con la API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Eliminar XLTM metadatos en Java"
      ...
      title_right: "Borrar los metadatos del título del archivo XLTM"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo XLTM
