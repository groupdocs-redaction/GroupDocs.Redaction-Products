...
draft: false
path: "it/redaction/java/metadata/title/xltm"
...
ad_description: "Modifica il titolo dai metadati XLTM in Java"
############################# Head ############################
head_title: "Modifica il titolo dal file XLTM in Java utilizzando l'API GroupDocs.Redaction"
...
############################# Header ############################
title: "Modifica il titolo dal file XLTM in Java utilizzando l'API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Rimuovi XLTM metadati in Java"
      ...
      title_right: "Cancella i metadati del titolo dal file XLTM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) e carica il file XLTM
