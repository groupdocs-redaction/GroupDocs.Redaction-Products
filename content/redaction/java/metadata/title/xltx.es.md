...
draft: false
path: "es/redaction/java/metadata/title/xltx"
...
ad_description: "Redactar el título de los metadatos de XLTX en Java"
############################# Head ############################
head_title: "Redacte el título del archivo XLTX en Java con la API GroupDocs.Redaction"
...
############################# Header ############################
title: "Redacte el título del archivo XLTX en Java con la API GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Eliminar XLTX metadatos en Java"
      ...
      title_right: "Borrar los metadatos del título del archivo XLTX"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y sube el archivo XLTX
