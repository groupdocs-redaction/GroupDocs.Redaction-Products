...
draft: false
path: "id/redaction/java/metadata/title/xltx"
...
ad_description: ""
############################# Head ############################
head_title: "Redact Judul dari File XLTX di Java Menggunakan GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Judul dari File XLTX di Java Menggunakan GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Hapus XLTX Metadata di Java"
      ...
      title_right: "Hapus Metadata Judul dari File XLTX"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & unggah file XLTX
