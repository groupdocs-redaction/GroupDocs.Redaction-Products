...
draft: false
path: "nl/redaction/java/metadata/title/xltx"
...
ad_description: "Titel redigeren op basis van XLTX metagegevens in Java"
############################# Head ############################
head_title: "Titel redigeren uit XLTX -bestand in Java met behulp van de GroupDocs.Redaction API"
...
############################# Header ############################
title: "Titel redigeren uit XLTX -bestand in Java met behulp van de GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "XLTX metagegevens verwijderen in Java"
      ...
      title_right: "Titelmetagegevens uit het XLTX -bestand wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) en upload het XLTX -bestand
