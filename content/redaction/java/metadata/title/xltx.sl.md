...
draft: false
path: "sl/redaction/java/metadata/title/xltx"
...
ad_description: "Uredij naslov iz metapodatkov XLTX v Java"
############################# Head ############################
head_title: "Preuredite naslov iz datoteke XLTX v Java Uporaba API-ja GroupDocs.Redaction"
...
############################# Header ############################
title: "Preuredite naslov iz datoteke XLTX v Java Uporaba API-ja GroupDocs.Redaction"
...
steps:
    ...
    - title_left: "Odstrani XLTX metapodatke v Java"
      content_left: |
      ...
      title_right: "Izbrišite metapodatke naslova iz datoteke XLTX"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko XLTX
