...
draft: false
path: "tr/redaction/java/metadata/title/xltx"
...
ad_description: "Java içindeki XLTX Meta Verilerden Başlığı Redakt Et"
############################# Head ############################
head_title: "GroupDocs.Redaction API kullanarak Java dosyasındaki XLTX Dosyasından Başlığı Redakt"
...
############################# Header ############################
title: "GroupDocs.Redaction API kullanarak Java dosyasındaki XLTX Dosyasından Başlığı Redakt"
...
steps:
    ...
    - title_left: "Java içindeki XLTX Meta Verileri Kaldır"
      ...
      title_right: "XLTX Dosyasından Başlık Meta Verilerini Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) sınıfının bir örneğini oluşturun ve XLTX dosyasını yükleyin
