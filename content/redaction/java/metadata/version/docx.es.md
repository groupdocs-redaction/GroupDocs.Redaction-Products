...
draft: false
path: "es/redaction/java/metadata/version/docx"
...
ad_description: "Redacte la versión de los metadatos de DOCX en Java"
############################# Head ############################
head_title: "Redacte los metadatos de la versión del documento DOCX en Java"
...
############################# Header ############################
title: "Redacte los metadatos de la versión del documento DOCX en Java"
...
steps:
    ...
    - title_left: "Redacte los metadatos de DOCX en Java"
      content_left: |
        El siguiente código te permite buscar y eliminar datos confidenciales de un documento DOCX. Puedes establecer el alcance de la redacción configurando un filtro, por ejemplo, en MetadataFilter.VERSION. Dejará sin efecto las coincidencias de las expresiones regulares en todos los elementos de metadatos, excepto en la propiedad «Version»: 
