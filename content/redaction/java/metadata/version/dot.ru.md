...
draft: false
path: "ru/redaction/java/metadata/version/dot"
...
ad_description: "Редактировать версию из метаданных DOT в Java"

############################# Head ############################
head_title: "Редактировать метаданные версии из документа DOT в Java"
...
############################# Header ############################
title: "Редактировать метаданные версии из документа DOT в Java"
...
steps:
    ...
    - title_left: "Редактировать метаданные DOT в Java"
      content_left: |
        Следующий код позволяет вам искать и редактировать конфиденциальные данные из документа DOT. Вы можете установить область редактирования, установив фильтр, например. в MetadataFilter.Version. Это оставит совпадения регулярных выражений во всех элементах метаданных, кроме свойства "Версия": 
