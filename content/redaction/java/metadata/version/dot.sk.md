...
draft: false
path: "sk/redaction/java/metadata/version/dot"
...
ad_description: "Redigovať verziu z DOT Metaúdajov v Java"
############################# Head ############################
head_title: "Redigovať metadáta verzie z dokumentu DOT v Java"
...
############################# Header ############################
title: "Redigovať metadáta verzie z dokumentu DOT v Java"
...
steps:
    ...
    - title_left: "Redigovať DOT Metaúdaje v Java"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu DOT. Rozsah redigovania môžete nastaviť nastavením filtra, napr. na MetadataFilter.version. Zhody regulárnych výrazov ponechá nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Verzia“: 
