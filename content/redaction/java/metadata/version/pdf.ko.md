...
draft: false
path: "ko/redaction/java/metadata/version/pdf"
...
ad_description: "Java 에 있는 PDF 메타데이터에서 버전 삭제"
############################# Head ############################
head_title: "Java 의 PDF 문서에서 버전 메타데이터를 수정하십시오."
head_description: "GroupDocs.Redaction 는 30개 이상의 문서 유형에서 기밀 정보를 제거하거나 편집할 수 있는 강력한 삭제 API입니다."

############################# Header ############################
title: "Java 의 PDF 문서에서 버전 메타데이터를 수정하십시오."
...
steps:
    ...
    - title_left: "Java 에서 PDF 메타데이터를 수정했습니다."
      content_left: |
        다음 코드를 사용하면 PDF 문서에서 민감한 데이터를 검색하고 삭제할 수 있습니다.필터 (예: MetadataFilter.version) 를 설정하여 교정 범위를 설정할 수 있습니다.그러면 “Version” 속성을 제외한 모든 메타데이터 항목에서 정규 표현식 일치가 취소된 상태로 남습니다. 
