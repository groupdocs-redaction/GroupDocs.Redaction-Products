...
draft: false
path: "it/redaction/java/metadata/version/potm"
...
ad_description: "Redigere la versione dai metadati POTM in Java"
############################# Head ############################
head_title: "Redigere i metadati della versione dal documento POTM in Java"
...
############################# Header ############################
title: "Redigere i metadati della versione dal documento POTM in Java"
...
steps:
    ...
    - title_left: "Modificare i metadati POTM in Java"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento POTM. È possibile impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.version. Lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Versione»: 
