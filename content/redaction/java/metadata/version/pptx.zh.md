...
draft: false
path: "zh/redaction/java/metadata/version/pptx"
...
ad_description: "从 Java 中的 PPTX 元数据编辑版本"
############################# Head ############################
head_title: "编辑 Java 中 PPTX 文档中的版本元数据"
head_description: "GroupDocs.Redaction 是一个功能强大的清理 API，可让您从 30 多种文档类型中删除或编辑机密信息。"

############################# Header ############################
title: "编辑 Java 中 PPTX 文档中的版本元数据"
