...
draft: false
path: "sl/redaction/java/metadata/version/xlsx"
...
ad_description: "Predeluj različico iz XLSX metapodatkov v Java"
############################# Head ############################
head_title: "Preuredite metapodatke različice iz dokumenta XLSX v Java"
...
############################# Header ############################
title: "Preuredite metapodatke različice iz dokumenta XLSX v Java"
...
steps:
    ...
    - title_left: "Uredij XLSX Metapodatke v Java"
      content_left: |
        Naslednja koda omogoča iskanje in redigiranje občutljivih podatkov iz dokumenta XLSX. Obseg za redigiranje lahko nastavite tako, da nastavite filter, npr. na MetaTAfilter.version. To bo pustil regularnih izrazov ujemanja razveljavljena v vseh metapodatkovnih elementih, razen lastnosti« Različica »: 
