...
draft: false
path: "tr/redaction/java/metadata/version/xlsx"
...
ad_description: "Java içindeki XLSX Meta Verilerden Sürümü Redakt"
############################# Head ############################
head_title: "Java içindeki XLSX Belgesinden Sürüm Meta Verilerini Redakt Et"
...
############################# Header ############################
title: "Java içindeki XLSX Belgesinden Sürüm Meta Verilerini Redakt Et"
...
steps:
    ...
    - title_left: "Java içindeki Meta Verileri Redact XLSX"
      content_left: |
        Aşağıdaki kod, XLSX belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. MetadataFilter.version. “Sürüm” özelliği hariç, tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri alır: 
