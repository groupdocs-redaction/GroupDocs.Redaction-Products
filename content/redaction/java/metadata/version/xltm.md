...
ad_description: "Redact Version from XLTM Metadata in Java"

############################# Head ############################
head_title: "Redact Version Metadata from XLTM Document in Java"
...
############################# Header ############################
title: "Redact Version Metadata from XLTM Document in Java"
...
steps:
    ...
    - title_left: "Redact XLTM Metadata in Java"
      content_left: |
        Following code allows you to search and redact sensitive data from a XLTM document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Version. It will leave the regular expressions matches undone in all metadata items, except “Version” property:
