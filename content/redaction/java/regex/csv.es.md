...
############################# Header ############################
title: "Cómo eliminar texto de archivos CSV usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar CSV usando expresiones regulares en Java"
      content_left: |
