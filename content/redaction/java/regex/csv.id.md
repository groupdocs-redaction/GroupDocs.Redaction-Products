...
############################# Header ############################
title: "Cara Menghapus Teks dari File CSV menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact CSV menggunakan Regular Expressions di Java"
      content_left: |
      ...
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) & upload CSV file
