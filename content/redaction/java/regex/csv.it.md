...
############################# Header ############################
title: "Come rimuovere il testo dai file CSV utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura CSV utilizzando le espressioni regolari in Java"
      content_left: |
