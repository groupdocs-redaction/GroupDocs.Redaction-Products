...
############################# Header ############################
title: "Ako odstrániť text zo súborov CSV pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte CSV pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) a nahrajte súbor CSV
