...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek CSV z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi CSV z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz CSV"
      content_right: |
