...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak CSV Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak CSV'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri CSV'ten Kaldırın"
      content_right: |
