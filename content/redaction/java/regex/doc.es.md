...
############################# Header ############################
title: "Cómo eliminar texto de archivos DOC usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOC usando expresiones regulares en Java"
      content_left: |
