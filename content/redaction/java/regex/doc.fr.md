...
############################# Header ############################
title: "Comment supprimer du texte de fichiers DOC à l'aide d'expressions régulières et de Java"
...
steps:
    enable: true
    block:
    - title_left: "Caviardez DOC à l'aide d'expressions régulières dans Java"
      content_left: |
