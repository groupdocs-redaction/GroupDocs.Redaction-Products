...
############################# Header ############################
title: "Come rimuovere il testo dai file DOC utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura DOC utilizzando le espressioni regolari in Java"
      content_left: |
