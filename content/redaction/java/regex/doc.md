...
############################# Header ############################
title: "How to Remove Text from DOC Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOC using Regular Expressions in Java"
      content_left: |
