...
############################# Header ############################
title: "Как удалить текст из файлов DOC с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить DOC с помощью регулярных выражений в Java"
      content_left: |
