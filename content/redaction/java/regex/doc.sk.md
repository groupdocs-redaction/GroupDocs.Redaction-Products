...
############################# Header ############################
title: "Ako odstrániť text zo súborov DOC pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte DOC pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z DOC"
      content_right: |
