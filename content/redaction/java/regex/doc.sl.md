...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek DOC z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi DOC z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz DOC"
      content_right: |
