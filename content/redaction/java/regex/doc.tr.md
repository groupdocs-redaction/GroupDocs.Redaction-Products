...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak DOC Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak DOC'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri DOC'ten Kaldırın"
      content_right: |
