...
############################# Header ############################
title: "Cómo eliminar texto de archivos DOCM usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOCM usando expresiones regulares en Java"
      content_left: |
