...
############################# Header ############################
title: "Cara Menghapus Teks dari File DOCM menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCM menggunakan Regular Expressions di Java"
      content_left: |
