...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail DOCM menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi DOCM menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada DOCM"
      content_right: |
