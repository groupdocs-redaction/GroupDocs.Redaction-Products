...
############################# Header ############################
title: "Как удалить текст из файлов DOCM с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить DOCM с помощью регулярных выражений в Java"
      content_left: |
