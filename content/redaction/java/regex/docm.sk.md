...
############################# Header ############################
title: "Ako odstrániť text zo súborov DOCM pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte DOCM pomocou regulárnych výrazov v Java"
      content_left: |
