...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak DOCM Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak DOCM'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri DOCM'ten Kaldırın"
      content_right: |
