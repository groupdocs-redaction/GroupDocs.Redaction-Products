...
############################# Header ############################
title: "Cómo eliminar texto de archivos DOCX usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOCX usando expresiones regulares en Java"
      content_left: |
