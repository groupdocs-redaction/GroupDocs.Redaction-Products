...
############################# Header ############################
title: "Cara Menghapus Teks dari File DOCX menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCX menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari DOCX"
      content_right: |
