...
############################# Header ############################
title: "Come rimuovere il testo dai file DOCX utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura DOCX utilizzando le espressioni regolari in Java"
      content_left: |
