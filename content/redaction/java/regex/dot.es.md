...
############################# Header ############################
title: "Cómo eliminar texto de archivos DOT usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOT usando expresiones regulares en Java"
      content_left: |
