...
############################# Header ############################
title: "Kā noņemt tekstu no DOT failiem, izmantojot regulārās izteiksmes un Java"
...
steps:
    enable: true
    block:
    - title_left: "Rediģēt DOT, izmantojot regulārās izteiksmes pakalpojumā Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvos datus no DOT"
      content_right: |
