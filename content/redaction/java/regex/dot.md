...
############################# Header ############################
title: "How to Remove Text from DOT Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOT using Regular Expressions in Java"
      content_left: |
