...
############################# Header ############################
title: "Как удалить текст из файлов DOT с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить DOT с помощью регулярных выражений в Java"
      content_left: |
