...
############################# Header ############################
title: "Ako odstrániť text zo súborov DOT pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte DOT pomocou regulárnych výrazov v Java"
      content_left: |
