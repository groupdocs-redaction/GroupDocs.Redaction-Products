...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek DOT z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi DOT z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz DOT"
      content_right: |
