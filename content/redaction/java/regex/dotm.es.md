...
############################# Header ############################
title: "Cómo eliminar texto de archivos DOTM usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOTM usando expresiones regulares en Java"
      content_left: |
