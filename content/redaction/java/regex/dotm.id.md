...
############################# Header ############################
title: "Cara Menghapus Teks dari File DOTM menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOTM menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari DOTM"
      content_right: |
