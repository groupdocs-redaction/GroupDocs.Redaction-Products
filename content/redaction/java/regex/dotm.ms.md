...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail DOTM menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi DOTM menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada DOTM"
      content_right: |
