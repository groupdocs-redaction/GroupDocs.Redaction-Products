...
############################# Header ############################
title: "Tekst verwijderen uit DOTM-bestanden met reguliere expressies en Java"
...
steps:
    enable: true
    block:
    - title_left: "Bewerk DOTM met reguliere expressies in Java"
      content_left: |
