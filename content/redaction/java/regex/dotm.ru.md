...
############################# Header ############################
title: "Как удалить текст из файлов DOTM с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить DOTM с помощью регулярных выражений в Java"
      content_left: |
