...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek DOTM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi DOTM z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz DOTM"
      content_right: |
