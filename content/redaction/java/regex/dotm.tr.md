...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak DOTM Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak DOTM'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri DOTM'ten Kaldırın"
      content_right: |
