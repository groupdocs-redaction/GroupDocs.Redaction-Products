...
############################# Header ############################
title: "Cómo eliminar texto de archivos DOTX usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOTX usando expresiones regulares en Java"
      content_left: |
