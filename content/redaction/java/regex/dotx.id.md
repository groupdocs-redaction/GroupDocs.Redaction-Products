...
############################# Header ############################
title: "Cara Menghapus Teks dari File DOTX menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOTX menggunakan Regular Expressions di Java"
      content_left: |
