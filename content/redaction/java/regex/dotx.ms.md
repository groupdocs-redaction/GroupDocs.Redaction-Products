...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail DOTX menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi DOTX menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada DOTX"
      content_right: |
