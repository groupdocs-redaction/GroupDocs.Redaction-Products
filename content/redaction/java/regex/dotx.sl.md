...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek DOTX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi DOTX z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz DOTX"
      content_right: |
