...
############################# Header ############################
title: "Cómo eliminar texto de archivos PDF usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar PDF usando expresiones regulares en Java"
      content_left: |
