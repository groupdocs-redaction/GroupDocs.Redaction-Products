...
############################# Header ############################
title: "Cara Menghapus Teks dari File PDF menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PDF menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari PDF"
      content_right: |
