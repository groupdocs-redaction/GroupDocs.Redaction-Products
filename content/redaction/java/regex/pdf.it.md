...
############################# Header ############################
title: "Come rimuovere il testo dai file PDF utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura PDF utilizzando le espressioni regolari in Java"
      content_left: |
