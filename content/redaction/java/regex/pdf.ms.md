...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail PDF menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi PDF menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada PDF"
      content_right: |
