...
############################# Header ############################
title: "Tekst verwijderen uit PDF-bestanden met reguliere expressies en Java"
...
steps:
    enable: true
    block:
    - title_left: "Bewerk PDF met reguliere expressies in Java"
      content_left: |
      ...
      title_right: "Gevoelige gegevens verwijderen uit PDF"
      content_right: |
