...
############################# Header ############################
title: "Ako odstrániť text zo súborov PDF pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte PDF pomocou regulárnych výrazov v Java"
      content_left: |
