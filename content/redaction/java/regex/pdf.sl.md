...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek PDF z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi PDF z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz PDF"
      content_right: |
