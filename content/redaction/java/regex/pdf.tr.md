...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PDF Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak PDF'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri PDF'ten Kaldırın"
      content_right: |
