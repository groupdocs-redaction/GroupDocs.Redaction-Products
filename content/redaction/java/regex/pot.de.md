...
############################# Header ############################
title: "So entfernen Sie Text aus POT-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie POT mithilfe regulärer Ausdrücke in Java"
      content_left: |
