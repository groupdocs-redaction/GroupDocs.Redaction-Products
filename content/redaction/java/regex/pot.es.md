...
############################# Header ############################
title: "Cómo eliminar texto de archivos POT usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar POT usando expresiones regulares en Java"
      content_left: |
