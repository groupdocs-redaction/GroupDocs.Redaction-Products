...
############################# Header ############################
title: "Cara Menghapus Teks dari File POT menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact POT menggunakan Regular Expressions di Java"
      content_left: |
