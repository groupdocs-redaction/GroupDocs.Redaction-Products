...
############################# Header ############################
title: "Come rimuovere il testo dai file POT utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura POT utilizzando le espressioni regolari in Java"
      content_left: |
