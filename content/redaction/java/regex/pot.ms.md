...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail POT menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi POT menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada POT"
      content_right: |
