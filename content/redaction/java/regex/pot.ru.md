...
############################# Header ############################
title: "Как удалить текст из файлов POT с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить POT с помощью регулярных выражений в Java"
      content_left: |
