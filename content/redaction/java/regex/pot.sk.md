...
############################# Header ############################
title: "Ako odstrániť text zo súborov POT pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte POT pomocou regulárnych výrazov v Java"
      content_left: |
