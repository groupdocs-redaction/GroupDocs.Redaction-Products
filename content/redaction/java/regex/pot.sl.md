...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek POT z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi POT z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz POT"
      content_right: |
