...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak POT Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak POT'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri POT'ten Kaldırın"
      content_right: |
