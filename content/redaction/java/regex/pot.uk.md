...
############################# Header ############################
title: "Як видалити текст із файлів POT за допомогою регулярних виразів і Java"
...
steps:
    enable: true
    block:
    - title_left: "Редагувати POT за допомогою регулярних виразів у Java"
      content_left: |
      ...
      title_right: "Видалити конфіденційні дані з POT"
      content_right: |
