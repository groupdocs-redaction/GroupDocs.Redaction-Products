...
############################# Header ############################
title: "Cómo eliminar texto de archivos POTM usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar POTM usando expresiones regulares en Java"
      content_left: |
