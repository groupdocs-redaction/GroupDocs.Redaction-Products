...
############################# Header ############################
title: "How to Remove Text from POTM Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact POTM using Regular Expressions in Java"
      content_left: |
