...
############################# Header ############################
title: "Ako odstrániť text zo súborov POTM pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte POTM pomocou regulárnych výrazov v Java"
      content_left: |
