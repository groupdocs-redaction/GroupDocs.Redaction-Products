...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek POTM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi POTM z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz POTM"
      content_right: |
