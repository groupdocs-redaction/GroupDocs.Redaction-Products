...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak POTM Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak POTM'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri POTM'ten Kaldırın"
      content_right: |
