...
############################# Header ############################
title: "So entfernen Sie Text aus PPS-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PPS mithilfe regulärer Ausdrücke in Java"
      content_left: |
