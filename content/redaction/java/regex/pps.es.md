...
############################# Header ############################
title: "Cómo eliminar texto de archivos PPS usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar PPS usando expresiones regulares en Java"
      content_left: |
