...
############################# Header ############################
title: "रेगुलर एक्सप्रेशन और Java का उपयोग करके PPS फ़ाइलों से टेक्स्ट कैसे हटाएं"
...
steps:
    enable: true
    block:
    - title_left: "Java में रेगुलर एक्सप्रेशन का उपयोग करके PPS को संशोधित करें"
      content_left: |
      ...
      title_right: "PPS से संवेदनशील डेटा हटाएँ"
      content_right: |
