...
############################# Header ############################
title: "Cara Menghapus Teks dari File PPS menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPS menggunakan Regular Expressions di Java"
      content_left: |
