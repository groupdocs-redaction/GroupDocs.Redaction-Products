...
############################# Header ############################
title: "How to Remove Text from PPS Files using Regular Expressions and Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPS using Regular Expressions in Java"
      content_left: |
