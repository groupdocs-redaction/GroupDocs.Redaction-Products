...
############################# Header ############################
title: "Ako odstrániť text zo súborov PPS pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte PPS pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z PPS"
      content_right: |
