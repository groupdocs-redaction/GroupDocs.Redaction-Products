...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek PPS z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi PPS z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz PPS"
      content_right: |
