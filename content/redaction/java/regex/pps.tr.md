...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PPS Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak PPS'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri PPS'ten Kaldırın"
      content_right: |
