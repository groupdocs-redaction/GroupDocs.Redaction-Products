...
############################# Header ############################
title: "Cara Menghapus Teks dari File PPSM menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPSM menggunakan Regular Expressions di Java"
      content_left: |
