...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail PPSM menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi PPSM menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada PPSM"
      content_right: |
