...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek PPSM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi PPSM z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz PPSM"
      content_right: |
