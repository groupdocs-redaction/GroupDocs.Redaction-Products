...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PPSM Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak PPSM'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri PPSM'ten Kaldırın"
      content_right: |
