...
############################# Header ############################
title: "Come rimuovere il testo dai file PPSX utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura PPSX utilizzando le espressioni regolari in Java"
      content_left: |
