...
############################# Header ############################
title: "正規表現と Java を使用して PPSX ファイルからテキストを削除する方法"
...
steps:
    enable: true
    block:
    - title_left: "Java で正規表現を使用して PPSX を秘匿化する"
      content_left: |
