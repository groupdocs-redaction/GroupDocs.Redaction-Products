...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail PPSX menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi PPSX menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada PPSX"
      content_right: |
