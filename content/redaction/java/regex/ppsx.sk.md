...
############################# Header ############################
title: "Ako odstrániť text zo súborov PPSX pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte PPSX pomocou regulárnych výrazov v Java"
      content_left: |
