...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek PPSX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi PPSX z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz PPSX"
      content_right: |
