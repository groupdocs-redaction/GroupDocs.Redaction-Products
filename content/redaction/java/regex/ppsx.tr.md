...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PPSX Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak PPSX'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri PPSX'ten Kaldırın"
      content_right: |
