...
############################# Header ############################
title: "Cómo eliminar texto de archivos PPT usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar PPT usando expresiones regulares en Java"
      content_left: |
