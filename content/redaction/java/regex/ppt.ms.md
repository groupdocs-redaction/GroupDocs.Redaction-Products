...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail PPT menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi PPT menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada PPT"
      content_right: |
