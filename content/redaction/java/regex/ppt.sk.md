...
############################# Header ############################
title: "Ako odstrániť text zo súborov PPT pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte PPT pomocou regulárnych výrazov v Java"
      content_left: |
