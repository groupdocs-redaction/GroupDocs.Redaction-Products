...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek PPT z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi PPT z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz PPT"
      content_right: |
