...
############################# Header ############################
title: "Come rimuovere il testo dai file PPTM utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura PPTM utilizzando le espressioni regolari in Java"
      content_left: |
