...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail PPTM menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi PPTM menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada PPTM"
      content_right: |
