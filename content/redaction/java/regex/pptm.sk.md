...
############################# Header ############################
title: "Ako odstrániť text zo súborov PPTM pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte PPTM pomocou regulárnych výrazov v Java"
      content_left: |
