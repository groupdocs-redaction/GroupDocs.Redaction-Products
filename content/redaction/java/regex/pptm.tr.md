...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak PPTM Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak PPTM'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri PPTM'ten Kaldırın"
      content_right: |
