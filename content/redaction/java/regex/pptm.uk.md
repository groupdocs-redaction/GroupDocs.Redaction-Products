...
############################# Header ############################
title: "Як видалити текст із файлів PPTM за допомогою регулярних виразів і Java"
...
steps:
    enable: true
    block:
    - title_left: "Редагувати PPTM за допомогою регулярних виразів у Java"
      content_left: |
      ...
      title_right: "Видалити конфіденційні дані з PPTM"
      content_right: |
