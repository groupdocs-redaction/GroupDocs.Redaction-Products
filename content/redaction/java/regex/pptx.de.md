...
############################# Header ############################
title: "So entfernen Sie Text aus PPTX-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PPTX mithilfe regulärer Ausdrücke in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus PPTX entfernen"
      content_right: |
