...
############################# Header ############################
title: "Cómo eliminar texto de archivos PPTX usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar PPTX usando expresiones regulares en Java"
      content_left: |
