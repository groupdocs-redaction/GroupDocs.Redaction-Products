...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail PPTX menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi PPTX menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada PPTX"
      content_right: |
