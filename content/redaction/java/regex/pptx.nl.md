...
############################# Header ############################
title: "Tekst verwijderen uit PPTX-bestanden met reguliere expressies en Java"
...
steps:
    enable: true
    block:
    - title_left: "Bewerk PPTX met reguliere expressies in Java"
      content_left: |
      ...
      title_right: "Gevoelige gegevens verwijderen uit PPTX"
      content_right: |
