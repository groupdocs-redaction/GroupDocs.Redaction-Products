...
############################# Header ############################
title: "Ako odstrániť text zo súborov PPTX pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte PPTX pomocou regulárnych výrazov v Java"
      content_left: |
