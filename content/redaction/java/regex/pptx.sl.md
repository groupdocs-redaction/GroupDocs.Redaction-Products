...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek PPTX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi PPTX z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz PPTX"
      content_right: |
