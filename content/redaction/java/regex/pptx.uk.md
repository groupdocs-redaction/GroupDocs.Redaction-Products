...
############################# Header ############################
title: "Як видалити текст із файлів PPTX за допомогою регулярних виразів і Java"
...
steps:
    enable: true
    block:
    - title_left: "Редагувати PPTX за допомогою регулярних виразів у Java"
      content_left: |
      ...
      title_right: "Видалити конфіденційні дані з PPTX"
      content_right: |
