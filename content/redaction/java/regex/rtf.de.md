...
############################# Header ############################
title: "So entfernen Sie Text aus RTF-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie RTF mithilfe regulärer Ausdrücke in Java"
      content_left: |
