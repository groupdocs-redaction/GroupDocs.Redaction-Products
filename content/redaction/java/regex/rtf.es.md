...
############################# Header ############################
title: "Cómo eliminar texto de archivos RTF usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar RTF usando expresiones regulares en Java"
      content_left: |
