...
############################# Header ############################
title: "Kā noņemt tekstu no RTF failiem, izmantojot regulārās izteiksmes un Java"
...
steps:
    enable: true
    block:
    - title_left: "Rediģēt RTF, izmantojot regulārās izteiksmes pakalpojumā Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvos datus no RTF"
      content_right: |
        * Izveidojiet klases [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) gadījumu un augšupielādējiet RTF failu
