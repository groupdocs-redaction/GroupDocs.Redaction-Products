...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail RTF menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi RTF menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada RTF"
      content_right: |
