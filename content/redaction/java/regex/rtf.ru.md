...
############################# Header ############################
title: "Как удалить текст из файлов RTF с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить RTF с помощью регулярных выражений в Java"
      content_left: |
