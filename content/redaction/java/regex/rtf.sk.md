...
############################# Header ############################
title: "Ako odstrániť text zo súborov RTF pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte RTF pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z RTF"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) a nahrajte súbor RTF
