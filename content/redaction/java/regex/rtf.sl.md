...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek RTF z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi RTF z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz RTF"
      content_right: |
