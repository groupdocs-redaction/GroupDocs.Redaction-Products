...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak RTF Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak RTF'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri RTF'ten Kaldırın"
      content_right: |
