...
############################# Header ############################
title: "Cara Menghapus Teks dari File XLS menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLS menggunakan Regular Expressions di Java"
      content_left: |
