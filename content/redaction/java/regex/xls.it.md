...
############################# Header ############################
title: "Come rimuovere il testo dai file XLS utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura XLS utilizzando le espressioni regolari in Java"
      content_left: |
