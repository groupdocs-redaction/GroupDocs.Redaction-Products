...
############################# Header ############################
title: "Tekst verwijderen uit XLS-bestanden met reguliere expressies en Java"
...
steps:
    enable: true
    block:
    - title_left: "Bewerk XLS met reguliere expressies in Java"
      content_left: |
