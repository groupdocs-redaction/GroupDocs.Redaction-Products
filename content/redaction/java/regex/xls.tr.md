...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLS Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak XLS'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri XLS'ten Kaldırın"
      content_right: |
