...
############################# Header ############################
title: "Cómo eliminar texto de archivos XLSM usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar XLSM usando expresiones regulares en Java"
      content_left: |
