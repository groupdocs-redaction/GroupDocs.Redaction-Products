...
draft: false
path: "hi/redaction/java/regex/xlsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Java में रेगुलर एक्सप्रेशन के माध्यम से टेक्स्ट को संपादित करें XLSM"
...
############################# Header ############################
title: "रेगुलर एक्सप्रेशन और Java का उपयोग करके XLSM फ़ाइलों से टेक्स्ट कैसे हटाएं"
...
steps:
    enable: true
    block:
    - title_left: "Java में रेगुलर एक्सप्रेशन का उपयोग करके XLSM को संशोधित करें"
      content_left: |
      ...
      title_right: "XLSM से संवेदनशील डेटा हटाएँ"
      content_right: |
