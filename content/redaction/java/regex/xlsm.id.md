...
############################# Header ############################
title: "Cara Menghapus Teks dari File XLSM menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSM menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari XLSM"
      content_right: |
