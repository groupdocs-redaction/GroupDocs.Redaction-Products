...
############################# Header ############################
title: "Come rimuovere il testo dai file XLSM utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura XLSM utilizzando le espressioni regolari in Java"
      content_left: |
