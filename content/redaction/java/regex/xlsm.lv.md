...
############################# Header ############################
title: "Kā noņemt tekstu no XLSM failiem, izmantojot regulārās izteiksmes un Java"
...
steps:
    enable: true
    block:
    - title_left: "Rediģēt XLSM, izmantojot regulārās izteiksmes pakalpojumā Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvos datus no XLSM"
      content_right: |
