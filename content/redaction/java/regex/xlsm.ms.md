...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail XLSM menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi XLSM menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada XLSM"
      content_right: |
