...
############################# Header ############################
title: "Cum să eliminați text din fișierele XLSM folosind expresii regulate și Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactați XLSM folosind expresii regulate în Java"
      content_left: |
