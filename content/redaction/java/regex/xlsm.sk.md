...
############################# Header ############################
title: "Ako odstrániť text zo súborov XLSM pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte XLSM pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z XLSM"
      content_right: |
