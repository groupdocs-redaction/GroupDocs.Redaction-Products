...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek XLSM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi XLSM z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz XLSM"
      content_right: |
