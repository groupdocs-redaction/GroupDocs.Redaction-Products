...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLSM Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak XLSM'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri XLSM'ten Kaldırın"
      content_right: |
