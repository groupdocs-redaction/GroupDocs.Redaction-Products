...
############################# Header ############################
title: "Cara Menghapus Teks dari File XLSX menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSX menggunakan Regular Expressions di Java"
      content_left: |
