...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail XLSX menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi XLSX menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada XLSX"
      content_right: |
