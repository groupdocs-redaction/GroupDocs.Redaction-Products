...
############################# Header ############################
title: "Как удалить текст из файлов XLSX с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить XLSX с помощью регулярных выражений в Java"
      content_left: |
