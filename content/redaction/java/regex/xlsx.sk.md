...
############################# Header ############################
title: "Ako odstrániť text zo súborov XLSX pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte XLSX pomocou regulárnych výrazov v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z XLSX"
      content_right: |
