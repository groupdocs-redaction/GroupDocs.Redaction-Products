...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek XLSX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi XLSX z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz XLSX"
      content_right: |
