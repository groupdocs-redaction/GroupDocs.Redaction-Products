...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLSX Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak XLSX'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri XLSX'ten Kaldırın"
      content_right: |
