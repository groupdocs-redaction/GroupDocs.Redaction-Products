...
############################# Header ############################
title: "Cómo eliminar texto de archivos XLT usando expresiones regulares y Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar XLT usando expresiones regulares en Java"
      content_left: |
