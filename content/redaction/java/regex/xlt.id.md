...
############################# Header ############################
title: "Cara Menghapus Teks dari File XLT menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLT menggunakan Regular Expressions di Java"
      content_left: |
