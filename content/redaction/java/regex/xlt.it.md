...
############################# Header ############################
title: "Come rimuovere il testo dai file XLT utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura XLT utilizzando le espressioni regolari in Java"
      content_left: |
