...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail XLT menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi XLT menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada XLT"
      content_right: |
