...
############################# Header ############################
title: "Cum să eliminați text din fișierele XLT folosind expresii regulate și Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactați XLT folosind expresii regulate în Java"
      content_left: |
