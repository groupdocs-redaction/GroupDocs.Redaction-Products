...
############################# Header ############################
title: "Ako odstrániť text zo súborov XLT pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte XLT pomocou regulárnych výrazov v Java"
      content_left: |
