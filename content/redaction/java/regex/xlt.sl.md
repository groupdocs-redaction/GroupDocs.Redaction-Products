...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek XLT z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi XLT z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz XLT"
      content_right: |
