...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLT Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak XLT'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri XLT'ten Kaldırın"
      content_right: |
