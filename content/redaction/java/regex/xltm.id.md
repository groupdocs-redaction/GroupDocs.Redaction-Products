...
############################# Header ############################
title: "Cara Menghapus Teks dari File XLTM menggunakan Ekspresi Reguler dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLTM menggunakan Regular Expressions di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari XLTM"
      content_right: |
