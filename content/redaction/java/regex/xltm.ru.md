...
############################# Header ############################
title: "Как удалить текст из файлов XLTM с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить XLTM с помощью регулярных выражений в Java"
      content_left: |
