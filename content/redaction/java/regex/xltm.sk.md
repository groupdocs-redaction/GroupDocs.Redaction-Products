...
############################# Header ############################
title: "Ako odstrániť text zo súborov XLTM pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte XLTM pomocou regulárnych výrazov v Java"
      content_left: |
