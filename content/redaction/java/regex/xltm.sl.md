...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek XLTM z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi XLTM z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz XLTM"
      content_right: |
