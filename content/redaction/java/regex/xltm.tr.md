...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLTM Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak XLTM'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri XLTM'ten Kaldırın"
      content_right: |
