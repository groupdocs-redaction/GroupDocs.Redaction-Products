...
############################# Header ############################
title: "So entfernen Sie Text aus XLTX-Dateien mit regulären Ausdrücken und Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie XLTX mithilfe regulärer Ausdrücke in Java"
      content_left: |
