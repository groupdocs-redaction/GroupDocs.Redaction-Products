...
draft: false
path: "hi/redaction/java/regex/xltx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM  

############################# Head ############################
head_title: "Java में रेगुलर एक्सप्रेशन के माध्यम से टेक्स्ट को संपादित करें XLTX"
...
############################# Header ############################
title: "रेगुलर एक्सप्रेशन और Java का उपयोग करके XLTX फ़ाइलों से टेक्स्ट कैसे हटाएं"
...
steps:
    enable: true
    block:
    - title_left: "Java में रेगुलर एक्सप्रेशन का उपयोग करके XLTX को संशोधित करें"
      content_left: |
      ...
      title_right: "XLTX से संवेदनशील डेटा हटाएँ"
      content_right: |
