...
############################# Header ############################
title: "Come rimuovere il testo dai file XLTX utilizzando espressioni regolari e Java"
...
steps:
    enable: true
    block:
    - title_left: "Oscura XLTX utilizzando le espressioni regolari in Java"
      content_left: |
