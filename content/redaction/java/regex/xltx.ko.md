...
############################# Header ############################
title: "정규 표현식 및 Java을 사용하여 XLTX 파일에서 텍스트를 제거하는 방법"
...
steps:
    enable: true
    block:
    - title_left: "Java에서 정규 표현식을 사용하여 XLTX 수정"
      content_left: |
