...
############################# Header ############################
title: "Cara Mengalih Keluar Teks daripada Fail XLTX menggunakan Ungkapan Biasa dan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redaksi XLTX menggunakan Ungkapan Biasa dalam Java"
      content_left: |
      ...
      title_right: "Alih keluar Data Sensitif daripada XLTX"
      content_right: |
