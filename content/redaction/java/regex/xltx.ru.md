...
############################# Header ############################
title: "Как удалить текст из файлов XLTX с помощью регулярных выражений и Java"
...
steps:
    enable: true
    block:
    - title_left: "Исправить XLTX с помощью регулярных выражений в Java"
      content_left: |
