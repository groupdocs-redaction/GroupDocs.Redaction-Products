...
############################# Header ############################
title: "Ako odstrániť text zo súborov XLTX pomocou regulárnych výrazov a Java"
...
steps:
    enable: true
    block:
    - title_left: "Upravte XLTX pomocou regulárnych výrazov v Java"
      content_left: |
