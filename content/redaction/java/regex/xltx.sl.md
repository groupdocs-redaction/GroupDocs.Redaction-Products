...
############################# Header ############################
title: "Kako odstraniti besedilo iz datotek XLTX z uporabo regularnih izrazov in Java"
...
steps:
    enable: true
    block:
    - title_left: "Uredi XLTX z uporabo regularnih izrazov v Java"
      content_left: |
      ...
      title_right: "Odstrani občutljive podatke iz XLTX"
      content_right: |
