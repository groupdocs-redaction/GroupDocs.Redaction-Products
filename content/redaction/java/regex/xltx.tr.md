...
############################# Header ############################
title: "Normal İfadeler ve Java Kullanılarak XLTX Dosyalarından Metin Nasıl Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Java içinde Normal İfadeler kullanarak XLTX'i yeniden düzenleyin"
      content_left: |
      ...
      title_right: "Hassas Verileri XLTX'ten Kaldırın"
      content_right: |
