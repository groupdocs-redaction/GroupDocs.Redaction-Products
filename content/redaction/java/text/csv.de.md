...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus CSV-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie CSV exakte Phrase in Java"
      content_left: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in CSV"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in CSV über das Farbfeld"
      content_left: |
