...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов CSV с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактировать CSV точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из CSV"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) и загрузите файл CSV
    ...
    - title_left: "Редактирование текста с учетом регистра в CSV"
      content_left: |
    ...
    - title_left: "Редактировать текст в CSV с помощью Color Box"
      content_left: |
