...
############################# Header ############################
title: "Javaを使用して CSVファイルからテキストを編集、非表示、または削除する方法"
...
steps:
    enable: true
    block:
    - title_left: "CSV Javaの正確なフレーズを編集"
      content_left: |
      ...
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) クラスのインスタンスを作成し、CSV ファイルをアップロードします
    ...
    - title_left: "CSV での大文字と小文字を区別するテキストの編集"
      content_left: |
    ...
    - title_left: "カラーボックスを介してCSVのテキストを編集"
      content_left: |
