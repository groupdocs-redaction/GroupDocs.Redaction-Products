...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no CSV failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts CSV precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no CSV"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) klases un augšupielādēt CSV faila instanci
    ...
    - title_left: "Reģistrjutīga teksta redakcija CSV"
      content_left: |
    ...
    - title_left: "Realizēt tekstu CSV, izmantojot krāsu lodziņu"
      content_left: |
