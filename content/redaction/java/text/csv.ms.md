...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada CSV Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact CSV Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada CSV"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di CSV"
      content_left: |
    ...
    - title_left: "Redact Teks dalam CSV melalui Kotak Warna"
      content_left: |
