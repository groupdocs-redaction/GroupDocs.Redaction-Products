...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek CSV z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt CSV Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz CSV"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) in naložite datoteko CSV
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v CSV"
      content_left: |
    ...
    - title_left: "Besedilo uredi v CSV prek barvnega polja"
      content_left: |
