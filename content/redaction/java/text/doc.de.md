...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus DOC-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie DOC exakte Phrase in Java"
      content_left: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in DOC"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in DOC über das Farbfeld"
      content_left: |
