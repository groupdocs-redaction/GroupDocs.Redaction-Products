...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari DOC File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOC Exact Phrase di Java"
      content_left: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di DOC"
      content_left: |
    ...
    - title_left: "Redact Teks di DOC melalui Kotak Warna"
      content_left: |
