...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no DOC failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts DOC precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no DOC"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija DOC"
      content_left: |
    ...
    - title_left: "Realizēt tekstu DOC, izmantojot krāsu lodziņu"
      content_left: |
