...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from DOC Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOC Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from DOC"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in DOC"
      content_left: |
    ...
    - title_left: "Redact Text in DOC via Color Box"
      content_left: |
