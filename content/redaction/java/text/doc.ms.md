...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada DOC Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOC Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada DOC"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di DOC"
      content_left: |
    ...
    - title_left: "Redact Teks dalam DOC melalui Kotak Warna"
      content_left: |
