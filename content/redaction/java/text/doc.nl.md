...
############################# Header ############################
title: "Hoe kan ik tekst uit DOC bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "DOC Exacte zin redigeren in Java"
      content_left: |
      ...
      title_right: "Gevoelige gegevens verwijderen uit DOC"
      content_right: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in DOC"
      content_left: |
    ...
    - title_left: "Tekst redigeren in DOC via het kleurvak"
      content_left: |
