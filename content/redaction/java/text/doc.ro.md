...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele DOC folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă DOC Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din DOC"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în DOC"
      content_left: |
    ...
    - title_left: "Redacta textul în DOC prin Caseta de culori"
      content_left: |
