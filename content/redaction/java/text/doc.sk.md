...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z DOC súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt DOC Presná fráza v Java"
      content_left: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v DOC"
      content_left: |
    ...
    - title_left: "Redigovanie textu v DOC pomocou farebného poľa"
      content_left: |
