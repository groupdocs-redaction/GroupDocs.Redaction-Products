...
draft: false
path: "uk/redaction/java/text/doc"
otherformats: CSV DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Редагувати текст DOC за допомогою точної фрази/регулярного виразу в Java"
...
############################# Header ############################
title: "Як редагувати, приховати або видалити текст із файлів DOC за допомогою Java"
...
steps:
    enable: true
    block:
    - title_left: "Редагувати DOC Точну фразу в Java"
      content_left: |
      ...
      title_right: "Видалення конфіденційних даних з DOC"
      content_right: |
    ...
    - title_left: "Редаговання тексту з урахуванням регістру в DOC"
      content_left: |
    ...
    - title_left: "Редагувати текст у DOC за допомогою кольорового поля"
      content_left: |
