...
draft: false
path: "de/redaction/java/text/docm/"
otherformats: PDF DOC DOT DOCX DOTX DOTM RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM PPSM POTM 

############################# Head ############################
head_title: "Schwärzen Sie DOCM Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus DOCM-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie DOCM exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus DOCM entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in DOCM"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in DOCM über das Farbfeld"
      content_left: |
