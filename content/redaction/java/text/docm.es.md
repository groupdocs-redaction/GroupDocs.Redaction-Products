...
draft: false
path: "es/redaction/java/text/docm/"
otherformats: PPSX DOCM PPSM XLT POT PDF PPTM XLSX CSV DOT RTF PPTX 

############################# Head ############################
head_title: "Redactar DOCM Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos DOCM usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOCM Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de DOCM"
      content_right: |
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en DOCM"
      content_left: |
    ...
    - title_left: "Redactar texto en DOCM a través de Color Box"
      content_left: |
