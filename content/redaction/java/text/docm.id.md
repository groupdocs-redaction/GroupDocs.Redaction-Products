...
title: "Cara Redact, Sembunyikan atau Hapus Teks dari DOCM File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCM Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari DOCM"
      content_right: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di DOCM"
      content_left: |
    ...
    - title_left: "Redact Teks di DOCM melalui Kotak Warna"
      content_left: |
