...
draft: false
path: "it/redaction/java/text/docm"
otherformats: CSV DOC DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modificare DOCM testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da DOCM file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere DOCM Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da DOCM"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in DOCM"
      content_left: |
    ...
    - title_left: "Modifica il testo in DOCM tramite Color Box"
      content_left: |
