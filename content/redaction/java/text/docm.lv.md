...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no DOCM failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts DOCM precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no DOCM"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija DOCM"
      content_left: |
    ...
    - title_left: "Realizēt tekstu DOCM, izmantojot krāsu lodziņu"
      content_left: |
