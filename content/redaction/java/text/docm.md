...
############################# Head ############################
head_title: "Redact DOCM Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from DOCM Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCM Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from DOCM"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in DOCM"
      content_left: |
    ...
    - title_left: "Redact Text in DOCM via Color Box"
      content_left: |
