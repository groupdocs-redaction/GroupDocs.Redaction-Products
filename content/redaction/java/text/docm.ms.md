...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada DOCM Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCM Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada DOCM"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di DOCM"
      content_left: |
    ...
    - title_left: "Redact Teks dalam DOCM melalui Kotak Warna"
      content_left: |
