...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele DOCM folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă DOCM Frază exactă în Java"
      content_left: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în DOCM"
      content_left: |
    ...
    - title_left: "Redacta textul în DOCM prin Caseta de culori"
      content_left: |
