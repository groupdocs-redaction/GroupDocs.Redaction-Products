...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek DOCM z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt DOCM Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz DOCM"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v DOCM"
      content_left: |
    ...
    - title_left: "Besedilo uredi v DOCM prek barvnega polja"
      content_left: |
