...
############################# Header ############################
title: "Java kullanarak DOCM Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCM Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "DOCM 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "DOCM 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla DOCM içindeki Metni Redakt"
      content_left: |
