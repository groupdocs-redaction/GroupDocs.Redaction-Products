...
draft: false
path: "es/redaction/java/text/docx/"
otherformats: PPSM DOT DOCX POTM PPT DOTM PPSX RTF XLSM XLT PPTM DOCM 

############################# Head ############################
head_title: "Redactar DOCX Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos DOCX usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOCX Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de DOCX"
      content_right: |
        * Cree una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y cargue el archivo DOCX
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en DOCX"
      content_left: |
    ...
    - title_left: "Redactar texto en DOCX a través de Color Box"
      content_left: |
