...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari DOCX File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCX Exact Phrase di Java"
      content_left: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di DOCX"
      content_left: |
    ...
    - title_left: "Redact Teks di DOCX melalui Kotak Warna"
      content_left: |
