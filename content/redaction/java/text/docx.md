...
############################# Head ############################
head_title: "Redact DOCX Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from DOCX Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCX Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from DOCX"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in DOCX"
      content_left: |
    ...
    - title_left: "Redact Text in DOCX via Color Box"
      content_left: |
