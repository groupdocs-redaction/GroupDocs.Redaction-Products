...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele DOCX folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă DOCX Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din DOCX"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în DOCX"
      content_left: |
    ...
    - title_left: "Redacta textul în DOCX prin Caseta de culori"
      content_left: |
