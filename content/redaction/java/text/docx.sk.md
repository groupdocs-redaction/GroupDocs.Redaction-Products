...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z DOCX súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt DOCX Presná fráza v Java"
      content_left: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v DOCX"
      content_left: |
    ...
    - title_left: "Redigovanie textu v DOCX pomocou farebného poľa"
      content_left: |
