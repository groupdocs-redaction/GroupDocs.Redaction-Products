...
############################# Header ############################
title: "Java kullanarak DOCX Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOCX Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "DOCX 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "DOCX 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla DOCX içindeki Metni Redakt"
      content_left: |
