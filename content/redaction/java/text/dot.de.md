...
draft: false
path: "de/redaction/java/text/dot/"
otherformats: POT PPSM DOCX POTM XLS XLT PPSX PPTM DOTM PDF DOCM PPTX 

############################# Head ############################
head_title: "Schwärzen Sie DOT Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus DOT-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie DOT exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus DOT entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in DOT"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in DOT über das Farbfeld"
      content_left: |
