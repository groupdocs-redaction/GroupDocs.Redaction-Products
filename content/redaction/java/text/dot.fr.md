...
############################# Head ############################
head_title: "Редактировать текст DOT с помощью точной фразы/регулярного выражения в Java"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов DOT с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактировать DOT точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из DOT"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в DOT"
      content_left: |
    ...
    - title_left: "Редактировать текст в DOT с помощью Color Box"
      content_left: |
