...
draft: false
path: "fr/redaction/java/text/dot"
otherformats: CSV DOC DOCM DOCX DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modifier le texte DOT avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers DOT à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte DOT en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de DOT"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier DOT
    ...
    - title_left: "Édition de texte sensible à la casse dans DOT"
      content_left: |
    ...
    - title_left: "Modifier le texte dans DOT avec Color Box"
      content_left: |
