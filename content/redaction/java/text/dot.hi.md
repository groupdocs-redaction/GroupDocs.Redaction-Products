...
draft: false
path: "hi/redaction/java/text/dot"
otherformats: CSV DOC DOCM DOCX DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Java में सटीक वाक्यांश/नियमित अभिव्यक्ति के माध्यम से DOT टेक्स्ट को संपादित करें"
...
############################# Header ############################
title: "Java का उपयोग करके DOT फ़ाइलों से टेक्स्ट को कैसे संपादित करें, छिपाएं या निकालें"
...
steps:
    enable: true
    block:
    - title_left: "Java में DOT सटीक वाक्यांश को फिर से लिखें"
      content_left: |
      ...
      title_right: "DOT से संवेदनशील डेटा हटाएं"
      content_right: |
    ...
    - title_left: "DOT में केस सेंसिटिव टेक्स्ट रिडक्शन"
      content_left: |
    ...
    - title_left: "Color Box के माध्यम से DOT में टेक्स्ट संपादित करें"
      content_left: |
