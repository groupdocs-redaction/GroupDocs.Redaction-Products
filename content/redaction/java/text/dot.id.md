...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari DOT File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOT Exact Phrase di Java"
      content_left: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di DOT"
      content_left: |
    ...
    - title_left: "Redact Teks di DOT melalui Kotak Warna"
      content_left: |
