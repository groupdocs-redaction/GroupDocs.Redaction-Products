...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da DOT file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere DOT Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da DOT"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in DOT"
      content_left: |
    ...
    - title_left: "Modifica il testo in DOT tramite Color Box"
      content_left: |
