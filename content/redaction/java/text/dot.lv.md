...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no DOT failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts DOT precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no DOT"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija DOT"
      content_left: |
    ...
    - title_left: "Realizēt tekstu DOT, izmantojot krāsu lodziņu"
      content_left: |
