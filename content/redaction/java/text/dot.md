...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from DOT Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOT Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from DOT"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in DOT"
      content_left: |
    ...
    - title_left: "Redact Text in DOT via Color Box"
      content_left: |
