...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada DOT Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOT Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada DOT"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di DOT"
      content_left: |
    ...
    - title_left: "Redact Teks dalam DOT melalui Kotak Warna"
      content_left: |
