...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z DOT súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt DOT Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z DOT"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v DOT"
      content_left: |
    ...
    - title_left: "Redigovanie textu v DOT pomocou farebného poľa"
      content_left: |
