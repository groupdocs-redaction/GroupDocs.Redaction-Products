...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek DOT z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt DOT Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz DOT"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v DOT"
      content_left: |
    ...
    - title_left: "Besedilo uredi v DOT prek barvnega polja"
      content_left: |
