...
############################# Header ############################
title: "Java kullanarak DOT Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOT Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "DOT 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "DOT 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla DOT içindeki Metni Redakt"
      content_left: |
