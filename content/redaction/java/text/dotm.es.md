...
draft: false
path: "es/redaction/java/text/dotm"
otherformats: CSV DOC DOCM DOCX DOT DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactar DOTM Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos DOTM usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOTM Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de DOTM"
      content_right: |
        * Cree una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y cargue el archivo DOTM
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en DOTM"
      content_left: |
    ...
    - title_left: "Redactar texto en DOTM a través de Color Box"
      content_left: |
