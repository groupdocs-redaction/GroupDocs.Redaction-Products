...
draft: false
path: "fr/redaction/java/text/dotm"
otherformats: CSV DOC DOCM DOCX DOT DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modifier le texte DOTM avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers DOTM à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte DOTM en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de DOTM"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier DOTM
    ...
    - title_left: "Édition de texte sensible à la casse dans DOTM"
      content_left: |
    ...
    - title_left: "Modifier le texte dans DOTM avec Color Box"
      content_left: |
