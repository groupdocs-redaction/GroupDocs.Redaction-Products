...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari DOTM File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOTM Exact Phrase di Java"
      content_left: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di DOTM"
      content_left: |
    ...
    - title_left: "Redact Teks di DOTM melalui Kotak Warna"
      content_left: |
