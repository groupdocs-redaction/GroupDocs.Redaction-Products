...
draft: false
path: "it/redaction/java/text/dotm"
otherformats: CSV DOC DOCM DOCX DOT DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modificare DOTM testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da DOTM file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere DOTM Frase esatta in Java"
      content_left: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in DOTM"
      content_left: |
    ...
    - title_left: "Modifica il testo in DOTM tramite Color Box"
      content_left: |
