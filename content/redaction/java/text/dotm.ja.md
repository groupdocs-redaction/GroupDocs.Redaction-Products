...
draft: false
path: "ja/redaction/java/text/dotm/"
otherformats: POT PDF PPTM PPSX POTM DOTM PPSM XLSX CSV XLT DOCM RTF 

############################# Head ############################
head_title: "Javaでの正確なフレーズ/正規表現によるDOTM テキストの編集"
...
############################# Header ############################
title: "Javaを使用して DOTMファイルからテキストを編集、非表示、または削除する方法"
...
steps:
    enable: true
    block:
    - title_left: "DOTM Javaの正確なフレーズを編集"
      content_left: |
    ...
    - title_left: "DOTM での大文字と小文字を区別するテキストの編集"
      content_left: |
    ...
    - title_left: "カラーボックスを介してDOTMのテキストを編集"
      content_left: |
