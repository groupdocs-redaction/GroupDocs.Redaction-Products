...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no DOTM failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts DOTM precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no DOTM"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija DOTM"
      content_left: |
    ...
    - title_left: "Realizēt tekstu DOTM, izmantojot krāsu lodziņu"
      content_left: |
