...
############################# Head ############################
head_title: "Redact DOTM Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from DOTM Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOTM Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from DOTM"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in DOTM"
      content_left: |
    ...
    - title_left: "Redact Text in DOTM via Color Box"
      content_left: |
