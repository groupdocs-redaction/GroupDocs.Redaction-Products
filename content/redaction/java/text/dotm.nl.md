...
############################# Header ############################
title: "Hoe kan ik tekst uit DOTM bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "DOTM Exacte zin redigeren in Java"
      content_left: |
      ...
      title_right: "Gevoelige gegevens verwijderen uit DOTM"
      content_right: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in DOTM"
      content_left: |
    ...
    - title_left: "Tekst redigeren in DOTM via het kleurvak"
      content_left: |
