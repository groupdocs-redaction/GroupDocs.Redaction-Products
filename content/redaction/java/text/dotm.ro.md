...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele DOTM folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă DOTM Frază exactă în Java"
      content_left: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în DOTM"
      content_left: |
    ...
    - title_left: "Redacta textul în DOTM prin Caseta de culori"
      content_left: |
