...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z DOTM súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt DOTM Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z DOTM"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v DOTM"
      content_left: |
    ...
    - title_left: "Redigovanie textu v DOTM pomocou farebného poľa"
      content_left: |
