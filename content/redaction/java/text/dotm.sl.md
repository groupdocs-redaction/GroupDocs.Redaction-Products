...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek DOTM z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt DOTM Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz DOTM"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v DOTM"
      content_left: |
    ...
    - title_left: "Besedilo uredi v DOTM prek barvnega polja"
      content_left: |
