...
draft: false
path: "es/redaction/java/text/dotx/"
otherformats: XLS XLT PPTM DOCM DOTX DOTM XLSM XLSX DOCX PPSX POTM PPTX 

############################# Head ############################
head_title: "Redactar DOTX Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos DOTX usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar DOTX Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de DOTX"
      content_right: |
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en DOTX"
      content_left: |
    ...
    - title_left: "Redactar texto en DOTX a través de Color Box"
      content_left: |
