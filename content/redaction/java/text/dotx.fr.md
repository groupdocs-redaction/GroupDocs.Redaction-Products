...
draft: false
path: "fr/redaction/java/text/dotx"
otherformats: CSV DOC DOCM DOCX DOT DOTM PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modifier le texte DOTX avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers DOTX à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte DOTX en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de DOTX"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier DOTX
    ...
    - title_left: "Édition de texte sensible à la casse dans DOTX"
      content_left: |
    ...
    - title_left: "Modifier le texte dans DOTX avec Color Box"
      content_left: |
