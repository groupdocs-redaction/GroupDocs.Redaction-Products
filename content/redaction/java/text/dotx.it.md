...
draft: false
path: "it/redaction/java/text/dotx"
otherformats: CSV DOC DOCM DOCX DOT DOTM PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modificare DOTX testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da DOTX file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere DOTX Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da DOTX"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in DOTX"
      content_left: |
    ...
    - title_left: "Modifica il testo in DOTX tramite Color Box"
      content_left: |
