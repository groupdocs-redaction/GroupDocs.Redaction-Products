...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from DOTX Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOTX Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from DOTX"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in DOTX"
      content_left: |
    ...
    - title_left: "Redact Text in DOTX via Color Box"
      content_left: |
