...
############################# Header ############################
title: "Hoe kan ik tekst uit DOTX bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "DOTX Exacte zin redigeren in Java"
      content_left: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in DOTX"
      content_left: |
    ...
    - title_left: "Tekst redigeren in DOTX via het kleurvak"
      content_left: |
