...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele DOTX folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă DOTX Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din DOTX"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în DOTX"
      content_left: |
    ...
    - title_left: "Redacta textul în DOTX prin Caseta de culori"
      content_left: |
