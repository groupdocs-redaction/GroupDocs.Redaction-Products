...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek DOTX z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt DOTX Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz DOTX"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v DOTX"
      content_left: |
    ...
    - title_left: "Besedilo uredi v DOTX prek barvnega polja"
      content_left: |
