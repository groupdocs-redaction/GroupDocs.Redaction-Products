...
draft: false
path: "uk/redaction/java/text/dotx"
otherformats: CSV DOC DOCM DOCX DOT DOTM PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Редагувати текст DOTX за допомогою точної фрази/регулярного виразу в Java"
...
############################# Header ############################
title: "Як редагувати, приховати або видалити текст із файлів DOTX за допомогою Java"
...
steps:
    enable: true
    block:
    - title_left: "Редагувати DOTX Точну фразу в Java"
      content_left: |
      ...
      title_right: "Видалення конфіденційних даних з DOTX"
      content_right: |
    ...
    - title_left: "Редаговання тексту з урахуванням регістру в DOTX"
      content_left: |
    ...
    - title_left: "Редагувати текст у DOTX за допомогою кольорового поля"
      content_left: |
