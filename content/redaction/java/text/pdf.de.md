...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus PDF-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PDF exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus PDF entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in PDF"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in PDF über das Farbfeld"
      content_left: |
