...
############################# Head ############################
head_title: "Modifier le texte PDF avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers PDF à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte PDF en Java"
      content_left: |
      ...
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier PDF
    ...
    - title_left: "Édition de texte sensible à la casse dans PDF"
      content_left: |
    ...
    - title_left: "Modifier le texte dans PDF avec Color Box"
      content_left: |
