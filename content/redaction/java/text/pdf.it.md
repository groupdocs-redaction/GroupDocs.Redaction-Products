...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da PDF file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere PDF Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da PDF"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in PDF"
      content_left: |
    ...
    - title_left: "Modifica il testo in PDF tramite Color Box"
      content_left: |
