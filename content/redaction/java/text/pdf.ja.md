...
############################# Header ############################
title: "Javaを使用して PDFファイルからテキストを編集、非表示、または削除する方法"
...
steps:
    enable: true
    block:
    - title_left: "PDF Javaの正確なフレーズを編集"
      content_left: |
      ...
      title_right: "PDFから機密データを削除する"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) クラスのインスタンスを作成し、PDF ファイルをアップロードします
    ...
    - title_left: "PDF での大文字と小文字を区別するテキストの編集"
      content_left: |
    ...
    - title_left: "カラーボックスを介してPDFのテキストを編集"
      content_left: |
