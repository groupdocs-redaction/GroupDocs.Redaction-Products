...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no PDF failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts PDF precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no PDF"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija PDF"
      content_left: |
    ...
    - title_left: "Realizēt tekstu PDF, izmantojot krāsu lodziņu"
      content_left: |
