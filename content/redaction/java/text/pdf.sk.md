...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z PDF súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PDF Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z PDF"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v PDF"
      content_left: |
    ...
    - title_left: "Redigovanie textu v PDF pomocou farebného poľa"
      content_left: |
