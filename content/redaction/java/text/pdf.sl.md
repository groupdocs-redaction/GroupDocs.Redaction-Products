...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek PDF z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PDF Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz PDF"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v PDF"
      content_left: |
    ...
    - title_left: "Besedilo uredi v PDF prek barvnega polja"
      content_left: |
