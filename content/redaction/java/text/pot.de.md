...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus POT-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie POT exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus POT entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in POT"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in POT über das Farbfeld"
      content_left: |
