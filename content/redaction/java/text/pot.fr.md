...
steps:
    enable: true
    block:
    - title_left: "Редактировать POT точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из POT"
      content_right: |
    ...
    - title_left: "Редактировать текст в POT с помощью Color Box"
      content_left: |
