...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari POT File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact POT Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari POT"
      content_right: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di POT"
      content_left: |
    ...
    - title_left: "Redact Teks di POT melalui Kotak Warna"
      content_left: |
