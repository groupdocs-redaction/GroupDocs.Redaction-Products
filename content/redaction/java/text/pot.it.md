...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da POT file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere POT Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da POT"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in POT"
      content_left: |
    ...
    - title_left: "Modifica il testo in POT tramite Color Box"
      content_left: |
