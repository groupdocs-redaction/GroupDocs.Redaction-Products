...
############################# Header ############################
title: "Javaを使用して POTファイルからテキストを編集、非表示、または削除する方法"
...
steps:
    enable: true
    block:
    - title_left: "POT Javaの正確なフレーズを編集"
      content_left: |
    ...
    - title_left: "POT での大文字と小文字を区別するテキストの編集"
      content_left: |
    ...
    - title_left: "カラーボックスを介してPOTのテキストを編集"
      content_left: |
