...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no POT failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts POT precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no POT"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija POT"
      content_left: |
    ...
    - title_left: "Realizēt tekstu POT, izmantojot krāsu lodziņu"
      content_left: |
