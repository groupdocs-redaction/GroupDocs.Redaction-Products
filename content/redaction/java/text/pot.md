...
############################# Head ############################
head_title: "Redact POT Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from POT Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact POT Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from POT"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in POT"
      content_left: |
    ...
    - title_left: "Redact Text in POT via Color Box"
      content_left: |
