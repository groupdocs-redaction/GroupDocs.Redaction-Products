...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada POT Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact POT Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada POT"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di POT"
      content_left: |
    ...
    - title_left: "Redact Teks dalam POT melalui Kotak Warna"
      content_left: |
