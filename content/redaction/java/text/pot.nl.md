...
############################# Header ############################
title: "Hoe kan ik tekst uit POT bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "POT Exacte zin redigeren in Java"
      content_left: |
      ...
      title_right: "Gevoelige gegevens verwijderen uit POT"
      content_right: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in POT"
      content_left: |
    ...
    - title_left: "Tekst redigeren in POT via het kleurvak"
      content_left: |
