...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z POT súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt POT Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z POT"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v POT"
      content_left: |
    ...
    - title_left: "Redigovanie textu v POT pomocou farebného poľa"
      content_left: |
