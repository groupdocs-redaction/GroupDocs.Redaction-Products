...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek POT z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt POT Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz POT"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v POT"
      content_left: |
    ...
    - title_left: "Besedilo uredi v POT prek barvnega polja"
      content_left: |
