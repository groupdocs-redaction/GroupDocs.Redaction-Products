...
draft: false
path: "de/redaction/java/text/potm/"
otherformats: PPSX PPTM RTF PDF XLS PPSM POT POTM DOCX CSV PPTX XLSM 

############################# Head ############################
head_title: "Schwärzen Sie POTM Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus POTM-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie POTM exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus POTM entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in POTM"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in POTM über das Farbfeld"
      content_left: |
