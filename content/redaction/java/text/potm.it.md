...
draft: false
path: "it/redaction/java/text/potm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modificare POTM testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da POTM file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere POTM Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da POTM"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in POTM"
      content_left: |
    ...
    - title_left: "Modifica il testo in POTM tramite Color Box"
      content_left: |
