...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no POTM failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts POTM precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no POTM"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija POTM"
      content_left: |
    ...
    - title_left: "Realizēt tekstu POTM, izmantojot krāsu lodziņu"
      content_left: |
