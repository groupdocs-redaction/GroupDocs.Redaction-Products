...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele POTM folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă POTM Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din POTM"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în POTM"
      content_left: |
    ...
    - title_left: "Redacta textul în POTM prin Caseta de culori"
      content_left: |
