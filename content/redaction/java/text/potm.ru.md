...
draft: false
path: "ru/redaction/java/text/potm/"
otherformats: PPSX PPTM RTF PDF XLS PPSM POT POTM DOCX CSV PPTX XLSM 

############################# Head ############################
head_title: "Редактировать текст POTM с помощью точной фразы/регулярного выражения в Java"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов POTM с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Изменить POTM точную фразу в Java"
      content_left: |
    ...
    - title_left: "Редактирование текста с учетом регистра в POTM"
      content_left: |
    ...
    - title_left: "Редактировать текст в POTM с помощью Color Box"
      content_left: |
