...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z POTM súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt POTM Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z POTM"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v POTM"
      content_left: |
    ...
    - title_left: "Redigovanie textu v POTM pomocou farebného poľa"
      content_left: |
