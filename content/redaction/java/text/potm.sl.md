...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek POTM z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt POTM Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz POTM"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v POTM"
      content_left: |
    ...
    - title_left: "Besedilo uredi v POTM prek barvnega polja"
      content_left: |
