...
############################# Header ############################
title: "Java kullanarak POTM Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact POTM Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "POTM 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "POTM 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla POTM içindeki Metni Redakt"
      content_left: |
