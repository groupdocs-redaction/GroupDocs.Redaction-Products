...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus PPS-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PPS exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus PPS entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in PPS"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in PPS über das Farbfeld"
      content_left: |
