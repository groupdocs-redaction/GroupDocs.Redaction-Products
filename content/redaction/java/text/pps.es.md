...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos PPS usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar PPS Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de PPS"
      content_right: |
        * Cree una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y cargue el archivo PPS
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en PPS"
      content_left: |
    ...
    - title_left: "Redactar texto en PPS a través de Color Box"
      content_left: |
