...
############################# Head ############################
head_title: "Редактировать текст PPS с помощью точной фразы/регулярного выражения в Java"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов PPS с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактировать PPS точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из PPS"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в PPS"
      content_left: |
    ...
    - title_left: "Редактировать текст в PPS с помощью Color Box"
      content_left: |
