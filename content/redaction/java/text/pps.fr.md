...
draft: false
path: "fr/redaction/java/text/pps"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modifier le texte PPS avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers PPS à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte PPS en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de PPS"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier PPS
    ...
    - title_left: "Édition de texte sensible à la casse dans PPS"
      content_left: |
    ...
    - title_left: "Modifier le texte dans PPS avec Color Box"
      content_left: |
