...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari PPS File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPS Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari PPS"
      content_right: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di PPS"
      content_left: |
    ...
    - title_left: "Redact Teks di PPS melalui Kotak Warna"
      content_left: |
