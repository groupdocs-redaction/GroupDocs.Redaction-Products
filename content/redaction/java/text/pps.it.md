...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da PPS file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere PPS Frase esatta in Java"
      content_left: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in PPS"
      content_left: |
    ...
    - title_left: "Modifica il testo in PPS tramite Color Box"
      content_left: |
