...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no PPS failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts PPS precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no PPS"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija PPS"
      content_left: |
    ...
    - title_left: "Realizēt tekstu PPS, izmantojot krāsu lodziņu"
      content_left: |
