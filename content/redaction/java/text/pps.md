...
############################# Head ############################
head_title: "Redact PPS Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from PPS Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPS Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from PPS"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in PPS"
      content_left: |
    ...
    - title_left: "Redact Text in PPS via Color Box"
      content_left: |
