...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada PPS Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPS Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada PPS"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di PPS"
      content_left: |
    ...
    - title_left: "Redact Teks dalam PPS melalui Kotak Warna"
      content_left: |
