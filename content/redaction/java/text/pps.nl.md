...
############################# Header ############################
title: "Hoe kan ik tekst uit PPS bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "PPS Exacte zin redigeren in Java"
      content_left: |
      ...
      title_right: "Gevoelige gegevens verwijderen uit PPS"
      content_right: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in PPS"
      content_left: |
    ...
    - title_left: "Tekst redigeren in PPS via het kleurvak"
      content_left: |
