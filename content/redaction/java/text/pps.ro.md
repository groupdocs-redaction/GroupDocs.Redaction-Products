...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele PPS folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă PPS Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din PPS"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în PPS"
      content_left: |
    ...
    - title_left: "Redacta textul în PPS prin Caseta de culori"
      content_left: |
