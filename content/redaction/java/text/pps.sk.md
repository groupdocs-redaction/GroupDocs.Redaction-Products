...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z PPS súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PPS Presná fráza v Java"
      content_left: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v PPS"
      content_left: |
    ...
    - title_left: "Redigovanie textu v PPS pomocou farebného poľa"
      content_left: |
