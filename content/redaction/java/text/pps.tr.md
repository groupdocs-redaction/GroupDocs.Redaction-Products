...
############################# Header ############################
title: "Java kullanarak PPS Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPS Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "PPS 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "PPS 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla PPS içindeki Metni Redakt"
      content_left: |
