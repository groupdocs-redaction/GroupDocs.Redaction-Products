...
draft: false
path: "de/redaction/java/text/ppsm/"
otherformats: PDF DOC DOT DOCX DOCM DOTX DOTM RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM POTM 

############################# Head ############################
head_title: "Schwärzen Sie PPSM Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus PPSM-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PPSM exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus PPSM entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in PPSM"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in PPSM über das Farbfeld"
      content_left: |
