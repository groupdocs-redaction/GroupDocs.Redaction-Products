...
head_title: "Redact PPSM Text melalui Exact Phrase/Regular Expression di Java"
...
title: "Cara Redact, Sembunyikan atau Hapus Teks dari PPSM File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPSM Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari PPSM"
      content_right: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di PPSM"
      content_left: |
    ...
    - title_left: "Redact Teks di PPSM melalui Kotak Warna"
      content_left: |
