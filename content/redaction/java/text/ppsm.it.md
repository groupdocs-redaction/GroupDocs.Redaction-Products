...
draft: false
path: "it/redaction/java/text/ppsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modificare PPSM testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da PPSM file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere PPSM Frase esatta in Java"
      content_left: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in PPSM"
      content_left: |
    ...
    - title_left: "Modifica il testo in PPSM tramite Color Box"
      content_left: |
