...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no PPSM failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts PPSM precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no PPSM"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija PPSM"
      content_left: |
    ...
    - title_left: "Realizēt tekstu PPSM, izmantojot krāsu lodziņu"
      content_left: |
