...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada PPSM Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPSM Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada PPSM"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di PPSM"
      content_left: |
    ...
    - title_left: "Redact Teks dalam PPSM melalui Kotak Warna"
      content_left: |
