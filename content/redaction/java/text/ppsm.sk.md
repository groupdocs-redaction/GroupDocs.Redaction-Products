...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z PPSM súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PPSM Presná fráza v Java"
      content_left: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v PPSM"
      content_left: |
    ...
    - title_left: "Redigovanie textu v PPSM pomocou farebného poľa"
      content_left: |
