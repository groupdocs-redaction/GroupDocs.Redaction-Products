...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek PPSM z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PPSM Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz PPSM"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v PPSM"
      content_left: |
    ...
    - title_left: "Besedilo uredi v PPSM prek barvnega polja"
      content_left: |
