...
############################# Header ############################
title: "Java kullanarak PPSM Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPSM Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "PPSM 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "PPSM 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla PPSM içindeki Metni Redakt"
      content_left: |
