...
draft: false
path: "de/redaction/java/text/ppsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Schwärzen Sie PPSX Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus PPSX-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PPSX exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus PPSX entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in PPSX"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in PPSX über das Farbfeld"
      content_left: |
