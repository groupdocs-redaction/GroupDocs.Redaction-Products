...
############################# Head ############################
head_title: "Modifier le texte PPSX avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers PPSX à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte PPSX en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de PPSX"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier PPSX
    ...
    - title_left: "Édition de texte sensible à la casse dans PPSX"
      content_left: |
    ...
    - title_left: "Modifier le texte dans PPSX avec Color Box"
      content_left: |
