...
draft: false
path: "ja/redaction/java/text/ppsx/"
otherformats: DOCM PDF PPSX DOTX CSV RTF PPTM XLS XLSM XLT DOCX POT 

############################# Head ############################
head_title: "Javaでの正確なフレーズ/正規表現によるPPSX テキストの編集"
...
############################# Header ############################
title: "Javaを使用して PPSXファイルからテキストを編集、非表示、または削除する方法"
...
steps:
    enable: true
    block:
    - title_left: "PPSX Javaの正確なフレーズを編集"
      content_left: |
      ...
      title_right: "PPSXから機密データを削除する"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) クラスのインスタンスを作成し、PPSX ファイルをアップロードします
    ...
    - title_left: "PPSX での大文字と小文字を区別するテキストの編集"
      content_left: |
    ...
    - title_left: "カラーボックスを介してPPSXのテキストを編集"
      content_left: |
