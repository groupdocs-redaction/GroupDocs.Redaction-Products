...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from PPSX Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPSX Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from PPSX"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in PPSX"
      content_left: |
    ...
    - title_left: "Redact Text in PPSX via Color Box"
      content_left: |
