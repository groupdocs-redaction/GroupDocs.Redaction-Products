...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada PPSX Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPSX Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada PPSX"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di PPSX"
      content_left: |
    ...
    - title_left: "Redact Teks dalam PPSX melalui Kotak Warna"
      content_left: |
