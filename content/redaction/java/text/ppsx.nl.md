...
############################# Header ############################
title: "Hoe kan ik tekst uit PPSX bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "PPSX Exacte zin redigeren in Java"
      content_left: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in PPSX"
      content_left: |
    ...
    - title_left: "Tekst redigeren in PPSX via het kleurvak"
      content_left: |
