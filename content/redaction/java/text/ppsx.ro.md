...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele PPSX folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă PPSX Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din PPSX"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în PPSX"
      content_left: |
    ...
    - title_left: "Redacta textul în PPSX prin Caseta de culori"
      content_left: |
