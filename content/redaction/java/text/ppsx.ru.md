...
draft: false
path: "ru/redaction/java/text/ppsx"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов PPSX с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Изменить PPSX точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из PPSX"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в PPSX"
      content_left: |
    ...
    - title_left: "Редактировать текст в PPSX с помощью Color Box"
      content_left: |
