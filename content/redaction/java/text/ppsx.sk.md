...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z PPSX súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PPSX Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z PPSX"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v PPSX"
      content_left: |
    ...
    - title_left: "Redigovanie textu v PPSX pomocou farebného poľa"
      content_left: |
