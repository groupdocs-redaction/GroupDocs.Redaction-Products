...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek PPSX z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PPSX Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz PPSX"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v PPSX"
      content_left: |
    ...
    - title_left: "Besedilo uredi v PPSX prek barvnega polja"
      content_left: |
