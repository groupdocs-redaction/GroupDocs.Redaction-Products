...
############################# Header ############################
title: "Java kullanarak PPSX Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPSX Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "PPSX 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "PPSX 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla PPSX içindeki Metni Redakt"
      content_left: |
