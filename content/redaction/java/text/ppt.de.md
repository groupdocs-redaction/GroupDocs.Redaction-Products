...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus PPT-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PPT exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus PPT entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in PPT"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in PPT über das Farbfeld"
      content_left: |
