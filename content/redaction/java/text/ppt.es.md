...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos PPT usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar PPT Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de PPT"
      content_right: |
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en PPT"
      content_left: |
    ...
    - title_left: "Redactar texto en PPT a través de Color Box"
      content_left: |
