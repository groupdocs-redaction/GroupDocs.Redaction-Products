...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari PPT File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPT Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari PPT"
      content_right: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di PPT"
      content_left: |
    ...
    - title_left: "Redact Teks di PPT melalui Kotak Warna"
      content_left: |
