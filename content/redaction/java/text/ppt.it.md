...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da PPT file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere PPT Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da PPT"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in PPT"
      content_left: |
    ...
    - title_left: "Modifica il testo in PPT tramite Color Box"
      content_left: |
