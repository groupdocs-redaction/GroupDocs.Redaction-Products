...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no PPT failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts PPT precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no PPT"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija PPT"
      content_left: |
    ...
    - title_left: "Realizēt tekstu PPT, izmantojot krāsu lodziņu"
      content_left: |
