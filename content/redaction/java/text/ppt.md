...
############################# Head ############################
head_title: "Redact PPT Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from PPT Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPT Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from PPT"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in PPT"
      content_left: |
    ...
    - title_left: "Redact Text in PPT via Color Box"
      content_left: |
