...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada PPT Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPT Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada PPT"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di PPT"
      content_left: |
    ...
    - title_left: "Redact Teks dalam PPT melalui Kotak Warna"
      content_left: |
