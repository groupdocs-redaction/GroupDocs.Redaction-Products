...
############################# Header ############################
title: "Hoe kan ik tekst uit PPT bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "PPT Exacte zin redigeren in Java"
      content_left: |
      ...
      title_right: "Gevoelige gegevens verwijderen uit PPT"
      content_right: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in PPT"
      content_left: |
    ...
    - title_left: "Tekst redigeren in PPT via het kleurvak"
      content_left: |
