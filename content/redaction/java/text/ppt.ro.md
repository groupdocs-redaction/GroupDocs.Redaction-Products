...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele PPT folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă PPT Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din PPT"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în PPT"
      content_left: |
    ...
    - title_left: "Redacta textul în PPT prin Caseta de culori"
      content_left: |
