...
############################# Header ############################
title: "Java kullanarak PPT Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPT Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "PPT 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "PPT 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla PPT içindeki Metni Redakt"
      content_left: |
