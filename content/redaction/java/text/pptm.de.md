...
draft: false
path: "de/redaction/java/text/pptm/"
otherformats: DOT PDF POT XLSX DOCM DOCX PPSX PPTM CSV XLSM PPTX RTF 

############################# Head ############################
head_title: "Schwärzen Sie PPTM Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus PPTM-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PPTM exakte Phrase in Java"
      content_left: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in PPTM"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in PPTM über das Farbfeld"
      content_left: |
