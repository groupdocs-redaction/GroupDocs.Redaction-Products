...
############################# Head ############################
head_title: "Modifier le texte PPTM avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers PPTM à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte PPTM en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de PPTM"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier PPTM
    ...
    - title_left: "Édition de texte sensible à la casse dans PPTM"
      content_left: |
    ...
    - title_left: "Modifier le texte dans PPTM avec Color Box"
      content_left: |
