...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari PPTM File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPTM Exact Phrase di Java"
      content_left: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di PPTM"
      content_left: |
    ...
    - title_left: "Redact Teks di PPTM melalui Kotak Warna"
      content_left: |
