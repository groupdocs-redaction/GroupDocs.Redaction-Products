...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no PPTM failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts PPTM precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no PPTM"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija PPTM"
      content_left: |
    ...
    - title_left: "Realizēt tekstu PPTM, izmantojot krāsu lodziņu"
      content_left: |
