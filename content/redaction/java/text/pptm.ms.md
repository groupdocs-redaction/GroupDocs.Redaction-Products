...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada PPTM Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPTM Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada PPTM"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di PPTM"
      content_left: |
    ...
    - title_left: "Redact Teks dalam PPTM melalui Kotak Warna"
      content_left: |
