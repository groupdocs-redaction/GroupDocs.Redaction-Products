...
############################# Header ############################
title: "Hoe kan ik tekst uit PPTM bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "PPTM Exacte zin redigeren in Java"
      content_left: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in PPTM"
      content_left: |
    ...
    - title_left: "Tekst redigeren in PPTM via het kleurvak"
      content_left: |
