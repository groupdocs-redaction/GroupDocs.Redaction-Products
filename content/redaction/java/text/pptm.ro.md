...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele PPTM folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă PPTM Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din PPTM"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în PPTM"
      content_left: |
    ...
    - title_left: "Redacta textul în PPTM prin Caseta de culori"
      content_left: |
