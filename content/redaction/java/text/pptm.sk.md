...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z PPTM súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PPTM Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z PPTM"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v PPTM"
      content_left: |
    ...
    - title_left: "Redigovanie textu v PPTM pomocou farebného poľa"
      content_left: |
