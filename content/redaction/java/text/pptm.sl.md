...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek PPTM z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PPTM Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz PPTM"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v PPTM"
      content_left: |
    ...
    - title_left: "Besedilo uredi v PPTM prek barvnega polja"
      content_left: |
