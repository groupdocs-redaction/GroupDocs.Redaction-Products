...
############################# Header ############################
title: "Java kullanarak PPTM Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPTM Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "PPTM 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "PPTM 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla PPTM içindeki Metni Redakt"
      content_left: |
