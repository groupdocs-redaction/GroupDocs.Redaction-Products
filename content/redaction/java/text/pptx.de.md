...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus PPTX-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie PPTX exakte Phrase in Java"
      content_left: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in PPTX"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in PPTX über das Farbfeld"
      content_left: |
