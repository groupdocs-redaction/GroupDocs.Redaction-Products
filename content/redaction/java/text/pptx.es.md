...
draft: false
path: "es/redaction/java/text/pptx/"
otherformats: POTM XLSX PPTX RTF PPSX DOTX PDF DOCM XLSM PPSM DOCX PPTM 

############################# Head ############################
head_title: "Redactar PPTX Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos PPTX usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar PPTX Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de PPTX"
      content_right: |
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en PPTX"
      content_left: |
    ...
    - title_left: "Redactar texto en PPTX a través de Color Box"
      content_left: |
