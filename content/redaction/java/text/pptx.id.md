...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari PPTX File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPTX Exact Phrase di Java"
      content_left: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di PPTX"
      content_left: |
    ...
    - title_left: "Redact Teks di PPTX melalui Kotak Warna"
      content_left: |
