...
draft: false
path: "it/redaction/java/text/pptx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modificare PPTX testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da PPTX file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere PPTX Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da PPTX"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in PPTX"
      content_left: |
    ...
    - title_left: "Modifica il testo in PPTX tramite Color Box"
      content_left: |
