...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no PPTX failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts PPTX precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no PPTX"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija PPTX"
      content_left: |
    ...
    - title_left: "Realizēt tekstu PPTX, izmantojot krāsu lodziņu"
      content_left: |
