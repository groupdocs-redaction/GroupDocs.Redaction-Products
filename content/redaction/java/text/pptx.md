...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from PPTX Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPTX Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from PPTX"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in PPTX"
      content_left: |
    ...
    - title_left: "Redact Text in PPTX via Color Box"
      content_left: |
