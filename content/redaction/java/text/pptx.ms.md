...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada PPTX Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact PPTX Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada PPTX"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di PPTX"
      content_left: |
    ...
    - title_left: "Redact Teks dalam PPTX melalui Kotak Warna"
      content_left: |
