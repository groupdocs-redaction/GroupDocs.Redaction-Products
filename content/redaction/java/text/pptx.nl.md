...
############################# Header ############################
title: "Hoe kan ik tekst uit PPTX bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "PPTX Exacte zin redigeren in Java"
      content_left: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in PPTX"
      content_left: |
    ...
    - title_left: "Tekst redigeren in PPTX via het kleurvak"
      content_left: |
