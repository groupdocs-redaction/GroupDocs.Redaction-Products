...
draft: false
path: "ru/redaction/java/text/pptx/"
otherformats: PDF DOC DOT DOCX DOCM DOTX DOTM RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPTX  PPS POT PPSX PPTM PPSM POTM 

############################# Head ############################
head_title: "Редактировать текст PPTX с помощью точной фразы/регулярного выражения в Java"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов PPTX с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Изменить PPTX точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из PPTX"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в PPTX"
      content_left: |
    ...
    - title_left: "Редактировать текст в PPTX с помощью Color Box"
      content_left: |
