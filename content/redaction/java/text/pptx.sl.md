...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek PPTX z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt PPTX Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz PPTX"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v PPTX"
      content_left: |
    ...
    - title_left: "Besedilo uredi v PPTX prek barvnega polja"
      content_left: |
