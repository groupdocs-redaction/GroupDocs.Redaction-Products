...
draft: false
path: "uk/redaction/java/text/pptx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Редагувати текст PPTX за допомогою точної фрази/регулярного виразу в Java"
...
############################# Header ############################
title: "Як редагувати, приховати або видалити текст із файлів PPTX за допомогою Java"
...
steps:
    enable: true
    block:
    - title_left: "Редагувати PPTX Точну фразу в Java"
      content_left: |
      ...
      title_right: "Видалення конфіденційних даних з PPTX"
      content_right: |
    ...
    - title_left: "Редаговання тексту з урахуванням регістру в PPTX"
      content_left: |
    ...
    - title_left: "Редагувати текст у PPTX за допомогою кольорового поля"
      content_left: |
