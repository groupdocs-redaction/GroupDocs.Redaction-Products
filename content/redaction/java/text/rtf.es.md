...
draft: false
path: "es/redaction/java/text/rtf/"
otherformats: RTF XLT PPTM POTM DOT PPSX PPSM XLSX DOC CSV PPTX DOCX 

############################# Head ############################
head_title: "Redactar RTF Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos RTF usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar RTF Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de RTF"
      content_right: |
        * Cree una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y cargue el archivo RTF
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en RTF"
      content_left: |
    ...
    - title_left: "Redactar texto en RTF a través de Color Box"
      content_left: |
