...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari RTF File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact RTF Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari RTF"
      content_right: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di RTF"
      content_left: |
    ...
    - title_left: "Redact Teks di RTF melalui Kotak Warna"
      content_left: |
