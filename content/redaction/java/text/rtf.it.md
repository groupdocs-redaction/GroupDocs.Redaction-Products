...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da RTF file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere RTF Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da RTF"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in RTF"
      content_left: |
    ...
    - title_left: "Modifica il testo in RTF tramite Color Box"
      content_left: |
