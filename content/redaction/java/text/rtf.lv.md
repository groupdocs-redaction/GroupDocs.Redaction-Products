...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no RTF failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts RTF precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no RTF"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija RTF"
      content_left: |
    ...
    - title_left: "Realizēt tekstu RTF, izmantojot krāsu lodziņu"
      content_left: |
