...
############################# Head ############################
head_title: "Redact RTF Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from RTF Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact RTF Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from RTF"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in RTF"
      content_left: |
    ...
    - title_left: "Redact Text in RTF via Color Box"
      content_left: |
