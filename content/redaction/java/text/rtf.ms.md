...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada RTF Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact RTF Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada RTF"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di RTF"
      content_left: |
    ...
    - title_left: "Redact Teks dalam RTF melalui Kotak Warna"
      content_left: |
