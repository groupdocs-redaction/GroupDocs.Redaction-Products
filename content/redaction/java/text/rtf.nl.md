...
############################# Header ############################
title: "Hoe kan ik tekst uit RTF bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "RTF Exacte zin redigeren in Java"
      content_left: |
      ...
      title_right: "Gevoelige gegevens verwijderen uit RTF"
      content_right: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in RTF"
      content_left: |
    ...
    - title_left: "Tekst redigeren in RTF via het kleurvak"
      content_left: |
