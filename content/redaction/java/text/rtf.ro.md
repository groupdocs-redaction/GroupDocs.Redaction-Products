...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele RTF folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă RTF Frază exactă în Java"
      content_left: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în RTF"
      content_left: |
    ...
    - title_left: "Redacta textul în RTF prin Caseta de culori"
      content_left: |
