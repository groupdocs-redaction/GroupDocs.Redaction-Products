...
draft: false
path: "ru/redaction/java/text/rtf"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов RTF с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Изменить RTF точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из RTF"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в RTF"
      content_left: |
    ...
    - title_left: "Редактировать текст в RTF с помощью Color Box"
      content_left: |
