...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z RTF súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt RTF Presná fráza v Java"
      content_left: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v RTF"
      content_left: |
    ...
    - title_left: "Redigovanie textu v RTF pomocou farebného poľa"
      content_left: |
