...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek RTF z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt RTF Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz RTF"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v RTF"
      content_left: |
    ...
    - title_left: "Besedilo uredi v RTF prek barvnega polja"
      content_left: |
