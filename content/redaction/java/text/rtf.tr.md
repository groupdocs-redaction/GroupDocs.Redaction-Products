...
############################# Header ############################
title: "Java kullanarak RTF Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact RTF Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "RTF 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "RTF 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla RTF içindeki Metni Redakt"
      content_left: |
