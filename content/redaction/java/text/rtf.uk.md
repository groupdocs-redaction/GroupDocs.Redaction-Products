...
draft: false
path: "uk/redaction/java/text/rtf"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Редагувати текст RTF за допомогою точної фрази/регулярного виразу в Java"
...
############################# Header ############################
title: "Як редагувати, приховати або видалити текст із файлів RTF за допомогою Java"
...
steps:
    enable: true
    block:
    - title_left: "Редагувати RTF Точну фразу в Java"
      content_left: |
      ...
      title_right: "Видалення конфіденційних даних з RTF"
      content_right: |
    ...
    - title_left: "Редаговання тексту з урахуванням регістру в RTF"
      content_left: |
    ...
    - title_left: "Редагувати текст у RTF за допомогою кольорового поля"
      content_left: |
