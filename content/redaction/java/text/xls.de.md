...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus XLS-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie XLS exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus XLS entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in XLS"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in XLS über das Farbfeld"
      content_left: |
