...
draft: false
path: "es/redaction/java/text/xls/"
otherformats: DOCX PPTX XLS POT XLT PPTM DOTX RTF PPSM PPSX CSV XLSM 

############################# Head ############################
head_title: "Redactar XLS Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos XLS usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar XLS Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de XLS"
      content_right: |
        * Cree una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) y cargue el archivo XLS
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en XLS"
      content_left: |
    ...
    - title_left: "Redactar texto en XLS a través de Color Box"
      content_left: |
