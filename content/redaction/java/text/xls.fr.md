...
############################# Head ############################
head_title: "Редактировать текст XLS с помощью точной фразы/регулярного выражения в Java"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов XLS с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактировать XLS точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из XLS"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в XLS"
      content_left: |
    ...
    - title_left: "Редактировать текст в XLS с помощью Color Box"
      content_left: |
