...
draft: false
path: "fr/redaction/java/text/xls"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modifier le texte XLS avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers XLS à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte XLS en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de XLS"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier XLS
    ...
    - title_left: "Édition de texte sensible à la casse dans XLS"
      content_left: |
    ...
    - title_left: "Modifier le texte dans XLS avec Color Box"
      content_left: |
