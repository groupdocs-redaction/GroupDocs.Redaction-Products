...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari XLS File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLS Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari XLS"
      content_right: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di XLS"
      content_left: |
    ...
    - title_left: "Redact Teks di XLS melalui Kotak Warna"
      content_left: |
