...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da XLS file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere XLS Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da XLS"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in XLS"
      content_left: |
    ...
    - title_left: "Modifica il testo in XLS tramite Color Box"
      content_left: |
