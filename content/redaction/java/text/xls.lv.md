...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no XLS failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts XLS precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no XLS"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija XLS"
      content_left: |
    ...
    - title_left: "Realizēt tekstu XLS, izmantojot krāsu lodziņu"
      content_left: |
