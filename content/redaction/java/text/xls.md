...
############################# Head ############################
head_title: "Redact XLS Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from XLS Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLS Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from XLS"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in XLS"
      content_left: |
    ...
    - title_left: "Redact Text in XLS via Color Box"
      content_left: |
