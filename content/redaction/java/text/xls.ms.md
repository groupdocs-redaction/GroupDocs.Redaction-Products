...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada XLS Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLS Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada XLS"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di XLS"
      content_left: |
    ...
    - title_left: "Redact Teks dalam XLS melalui Kotak Warna"
      content_left: |
