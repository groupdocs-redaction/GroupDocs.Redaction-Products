...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele XLS folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă XLS Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din XLS"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în XLS"
      content_left: |
    ...
    - title_left: "Redacta textul în XLS prin Caseta de culori"
      content_left: |
