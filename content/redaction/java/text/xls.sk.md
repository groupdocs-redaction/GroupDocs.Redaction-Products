...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z XLS súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLS Presná fráza v Java"
      content_left: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v XLS"
      content_left: |
    ...
    - title_left: "Redigovanie textu v XLS pomocou farebného poľa"
      content_left: |
