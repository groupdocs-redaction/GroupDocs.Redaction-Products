...
############################# Header ############################
title: "Java kullanarak XLS Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLS Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "XLS 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "XLS 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla XLS içindeki Metni Redakt"
      content_left: |
