...
draft: false
path: "de/redaction/java/text/xlsm/"
otherformats: PDF POT RTF PPSM PPSX DOT XLT DOTM DOC PPTX XLSX DOCX 

############################# Head ############################
head_title: "Schwärzen Sie XLSM Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus XLSM-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie XLSM exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus XLSM entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in XLSM"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in XLSM über das Farbfeld"
      content_left: |
