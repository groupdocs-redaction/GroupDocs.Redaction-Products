...
draft: false
path: "es/redaction/java/text/xlsm/"
otherformats: PDF POT RTF PPSM PPSX DOT XLT DOTM DOC PPTX XLSX DOCX 

############################# Head ############################
head_title: "Redactar XLSM Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos XLSM usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar XLSM Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de XLSM"
      content_right: |
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en XLSM"
      content_left: |
    ...
    - title_left: "Redactar texto en XLSM a través de Color Box"
      content_left: |
