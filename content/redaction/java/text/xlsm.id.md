...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari XLSM File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSM Exact Phrase di Java"
      content_left: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di XLSM"
      content_left: |
    ...
    - title_left: "Redact Teks di XLSM melalui Kotak Warna"
      content_left: |
