...
draft: false
path: "it/redaction/java/text/xlsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Modificare XLSM testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da XLSM file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere XLSM Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da XLSM"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in XLSM"
      content_left: |
    ...
    - title_left: "Modifica il testo in XLSM tramite Color Box"
      content_left: |
