...
draft: false
path: "ko/redaction/java/text/xlsm/"
otherformats: PDF POT RTF PPSM PPSX DOT XLT DOTM DOC PPTX XLSX DOCX 

############################# Head ############################
head_title: "Java 의 정확한 구문/정규 표현식을 통해 XLSM 텍스트 수정"
...
############################# Header ############################
title: "Java를 사용하여 XLSM 파일에서 텍스트를 수정, 숨기거나 제거하는 방법"
...
steps:
    enable: true
    block:
    - title_left: "자바에서 XLSM 정확한 구문 수정"
      content_left: |
      ...
      title_right: "XLSM에서 민감한 정보 삭제"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) 클래스의 인스턴스 생성 및 XLSM 파일 업로드
    ...
    - title_left: "XLSM에서 대소문자를 구분하는 텍스트 수정"
      content_left: |
    ...
    - title_left: "색상 상자를 통해 XLSM 의 텍스트 수정"
      content_left: |
