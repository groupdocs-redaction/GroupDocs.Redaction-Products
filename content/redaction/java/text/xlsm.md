...
############################# Head ############################
head_title: "Redact XLSM Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from XLSM Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSM Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from XLSM"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in XLSM"
      content_left: |
    ...
    - title_left: "Redact Text in XLSM via Color Box"
      content_left: |
