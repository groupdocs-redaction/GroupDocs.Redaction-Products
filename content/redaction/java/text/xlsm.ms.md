...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada XLSM Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSM Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada XLSM"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di XLSM"
      content_left: |
    ...
    - title_left: "Redact Teks dalam XLSM melalui Kotak Warna"
      content_left: |
