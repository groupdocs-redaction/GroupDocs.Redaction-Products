...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele XLSM folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă XLSM Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din XLSM"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în XLSM"
      content_left: |
    ...
    - title_left: "Redacta textul în XLSM prin Caseta de culori"
      content_left: |
