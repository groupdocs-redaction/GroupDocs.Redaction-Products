...
draft: false
path: "ru/redaction/java/text/xlsm/"
otherformats: PDF POT RTF PPSM PPSX DOT XLT DOTM DOC PPTX XLSX DOCX 

############################# Head ############################
head_title: "Редактировать текст XLSM с помощью точной фразы/регулярного выражения в Java"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов XLSM с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Изменить XLSM точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из XLSM"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в XLSM"
      content_left: |
    ...
    - title_left: "Редактировать текст в XLSM с помощью Color Box"
      content_left: |
