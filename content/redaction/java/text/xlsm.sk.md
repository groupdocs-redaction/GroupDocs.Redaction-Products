...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z XLSM súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLSM Presná fráza v Java"
      content_left: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v XLSM"
      content_left: |
    ...
    - title_left: "Redigovanie textu v XLSM pomocou farebného poľa"
      content_left: |
