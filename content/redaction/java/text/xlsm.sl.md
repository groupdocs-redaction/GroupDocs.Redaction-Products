...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek XLSM z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLSM Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz XLSM"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v XLSM"
      content_left: |
    ...
    - title_left: "Besedilo uredi v XLSM prek barvnega polja"
      content_left: |
