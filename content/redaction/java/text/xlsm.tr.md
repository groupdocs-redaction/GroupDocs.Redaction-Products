...
############################# Header ############################
title: "Java kullanarak XLSM Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSM Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "XLSM 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "XLSM 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla XLSM içindeki Metni Redakt"
      content_left: |
