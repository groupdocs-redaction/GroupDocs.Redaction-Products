...
draft: false
path: "de/redaction/java/text/xlsx/"
otherformats: DOCM DOCX RTF XLS DOTM POT PPTM PPSX DOTX XLSM PPTX PPSM 

############################# Head ############################
head_title: "Schwärzen Sie XLSX Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus XLSX-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie XLSX exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus XLSX entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in XLSX"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in XLSX über das Farbfeld"
      content_left: |
