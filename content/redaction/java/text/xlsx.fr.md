...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов XLSX с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактировать XLSX точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из XLSX"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в XLSX"
      content_left: |
    ...
    - title_left: "Редактировать текст в XLSX с помощью Color Box"
      content_left: |
