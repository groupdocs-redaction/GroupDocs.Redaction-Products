...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari XLSX File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSX Exact Phrase di Java"
      content_left: |
      ...
      title_right: "Hapus Data Sensitif dari XLSX"
      content_right: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di XLSX"
      content_left: |
    ...
    - title_left: "Redact Teks di XLSX melalui Kotak Warna"
      content_left: |
