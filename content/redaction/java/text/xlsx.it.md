...
draft: false
path: "it/redaction/java/text/xlsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLT XLTM XLTX  

############################# Head ############################
head_title: "Modificare XLSX testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da XLSX file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere XLSX Frase esatta in Java"
      content_left: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in XLSX"
      content_left: |
    ...
    - title_left: "Modifica il testo in XLSX tramite Color Box"
      content_left: |
