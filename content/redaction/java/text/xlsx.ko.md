...
############################# Header ############################
title: "Java를 사용하여 XLSX 파일에서 텍스트를 수정, 숨기거나 제거하는 방법"
...
steps:
    enable: true
    block:
    - title_left: "자바에서 XLSX 정확한 구문 수정"
      content_left: |
      ...
      title_right: "XLSX에서 민감한 정보 삭제"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) 클래스의 인스턴스 생성 및 XLSX 파일 업로드
    ...
    - title_left: "XLSX에서 대소문자를 구분하는 텍스트 수정"
      content_left: |
    ...
    - title_left: "색상 상자를 통해 XLSX 의 텍스트 수정"
      content_left: |
