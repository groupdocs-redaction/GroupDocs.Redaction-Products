...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no XLSX failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts XLSX precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no XLSX"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija XLSX"
      content_left: |
    ...
    - title_left: "Realizēt tekstu XLSX, izmantojot krāsu lodziņu"
      content_left: |
