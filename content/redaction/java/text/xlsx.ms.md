...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada XLSX Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSX Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada XLSX"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di XLSX"
      content_left: |
    ...
    - title_left: "Redact Teks dalam XLSX melalui Kotak Warna"
      content_left: |
