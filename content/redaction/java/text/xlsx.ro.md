...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele XLSX folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă XLSX Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din XLSX"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în XLSX"
      content_left: |
    ...
    - title_left: "Redacta textul în XLSX prin Caseta de culori"
      content_left: |
