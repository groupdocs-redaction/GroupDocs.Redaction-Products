...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z XLSX súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLSX Presná fráza v Java"
      content_left: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v XLSX"
      content_left: |
    ...
    - title_left: "Redigovanie textu v XLSX pomocou farebného poľa"
      content_left: |
