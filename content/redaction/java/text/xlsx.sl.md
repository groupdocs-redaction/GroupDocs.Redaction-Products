...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek XLSX z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLSX Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz XLSX"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v XLSX"
      content_left: |
    ...
    - title_left: "Besedilo uredi v XLSX prek barvnega polja"
      content_left: |
