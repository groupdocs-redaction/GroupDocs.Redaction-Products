...
############################# Header ############################
title: "Java kullanarak XLSX Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLSX Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "XLSX 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "XLSX 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla XLSX içindeki Metni Redakt"
      content_left: |
