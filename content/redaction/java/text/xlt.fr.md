...
############################# Head ############################
head_title: "Редактировать текст XLT с помощью точной фразы/регулярного выражения в Java"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов XLT с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактировать XLT точную фразу в Java"
      content_left: |
    ...
    - title_left: "Редактирование текста с учетом регистра в XLT"
      content_left: |
    ...
    - title_left: "Редактировать текст в XLT с помощью Color Box"
      content_left: |
