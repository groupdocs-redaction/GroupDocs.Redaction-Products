...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da XLT file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere XLT Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da XLT"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in XLT"
      content_left: |
    ...
    - title_left: "Modifica il testo in XLT tramite Color Box"
      content_left: |
