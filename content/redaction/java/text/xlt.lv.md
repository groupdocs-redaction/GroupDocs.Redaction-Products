...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no XLT failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts XLT precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no XLT"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija XLT"
      content_left: |
    ...
    - title_left: "Realizēt tekstu XLT, izmantojot krāsu lodziņu"
      content_left: |
