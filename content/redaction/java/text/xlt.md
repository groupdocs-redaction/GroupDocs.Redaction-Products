...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from XLT Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLT Exact Phrase in Java"
      content_left: |
    ...
    - title_left: "Case Sensitive Text Redaction in XLT"
      content_left: |
    ...
    - title_left: "Redact Text in XLT via Color Box"
      content_left: |
