...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele XLT folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă XLT Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din XLT"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în XLT"
      content_left: |
    ...
    - title_left: "Redacta textul în XLT prin Caseta de culori"
      content_left: |
