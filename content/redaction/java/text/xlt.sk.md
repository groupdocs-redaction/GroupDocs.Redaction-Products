...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z XLT súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLT Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z XLT"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v XLT"
      content_left: |
    ...
    - title_left: "Redigovanie textu v XLT pomocou farebného poľa"
      content_left: |
