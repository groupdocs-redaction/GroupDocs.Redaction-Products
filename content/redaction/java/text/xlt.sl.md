...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek XLT z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLT Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz XLT"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v XLT"
      content_left: |
    ...
    - title_left: "Besedilo uredi v XLT prek barvnega polja"
      content_left: |
