...
############################# Header ############################
title: "Java kullanarak XLT Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLT Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "XLT 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "XLT 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla XLT içindeki Metni Redakt"
      content_left: |
