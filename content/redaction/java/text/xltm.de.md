...
draft: false
path: "de/redaction/java/text/xltm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTX  

############################# Head ############################
head_title: "Schwärzen Sie XLTM Text über exakte Phrase/regulären Ausdruck in Java"
...
############################# Header ############################
title: "So schwärzen, verbergen oder entfernen Sie Text aus XLTM-Dateien mit Java"
...
steps:
    enable: true
    block:
    - title_left: "Schwärzen Sie XLTM exakte Phrase in Java"
      content_left: |
      ...
      title_right: "Sensible Daten aus XLTM entfernen"
      content_right: |
    ...
    - title_left: "Groß- und Kleinschreibung von Text in XLTM"
      content_left: |
    ...
    - title_left: "Schwärzen Sie Text in XLTM über das Farbfeld"
      content_left: |
