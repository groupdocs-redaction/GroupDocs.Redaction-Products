...
draft: false
path: "es/redaction/java/text/xltm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTX  

############################# Head ############################
head_title: "Redactar XLTM Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos XLTM usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar XLTM Frase exacta en Java"
      content_left: |
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en XLTM"
      content_left: |
    ...
    - title_left: "Redactar texto en XLTM a través de Color Box"
      content_left: |
