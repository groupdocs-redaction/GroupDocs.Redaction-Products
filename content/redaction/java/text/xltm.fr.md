...
draft: false
path: "fr/redaction/java/text/xltm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTX  

############################# Head ############################
head_title: "Modifier le texte XLTM avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers XLTM à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte XLTM en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de XLTM"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier XLTM
    ...
    - title_left: "Édition de texte sensible à la casse dans XLTM"
      content_left: |
    ...
    - title_left: "Modifier le texte dans XLTM avec Color Box"
      content_left: |
