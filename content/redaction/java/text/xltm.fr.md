...
############################# Head ############################
head_title: "Редактировать текст XLTM с помощью точной фразы/регулярного выражения в Java"
...
############################# Header ############################
title: "Как отредактировать, скрыть или удалить текст из файлов XLTM с помощью Java"
...
steps:
    enable: true
    block:
    - title_left: "Редактировать XLTM точную фразу в Java"
      content_left: |
      ...
      title_right: "Удалить конфиденциальные данные из XLTM"
      content_right: |
    ...
    - title_left: "Редактирование текста с учетом регистра в XLTM"
      content_left: |
    ...
    - title_left: "Редактировать текст в XLTM с помощью Color Box"
      content_left: |
