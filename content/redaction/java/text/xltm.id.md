...
############################# Header ############################
title: "Cara Redact, Sembunyikan atau Hapus Teks dari XLTM File menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLTM Exact Phrase di Java"
      content_left: |
    ...
    - title_left: "Redaksi Teks Peka Huruf Besar-kecil di XLTM"
      content_left: |
    ...
    - title_left: "Redact Teks di XLTM melalui Kotak Warna"
      content_left: |
