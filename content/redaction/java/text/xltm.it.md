...
draft: false
path: "it/redaction/java/text/xltm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTX  

############################# Head ############################
head_title: "Modificare XLTM testo tramite frase esatta/espressione regolare in Java"
...
############################# Header ############################
title: "Come oscurare, nascondere o rimuovere testo da XLTM file utilizzando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redigere XLTM Frase esatta in Java"
      content_left: |
      ...
      title_right: "Rimuovi dati sensibili da XLTM"
      content_right: |
    ...
    - title_left: "Redazione del testo con distinzione tra maiuscole e minuscole in XLTM"
      content_left: |
    ...
    - title_left: "Modifica il testo in XLTM tramite Color Box"
      content_left: |
