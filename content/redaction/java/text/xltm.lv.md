...
############################# Header ############################
title: "Kā rediģēt, paslēpt vai noņemt tekstu no XLTM failiem, izmantojot Java"
...
steps:
    enable: true
    block:
    - title_left: "Reakts XLTM precīza frāze Java"
      content_left: |
      ...
      title_right: "Noņemt sensitīvus datus no XLTM"
      content_right: |
    ...
    - title_left: "Reģistrjutīga teksta redakcija XLTM"
      content_left: |
    ...
    - title_left: "Realizēt tekstu XLTM, izmantojot krāsu lodziņu"
      content_left: |
