...
############################# Head ############################
head_title: "Redact XLTM Text via Exact Phrase/Regular Expression in Java"
...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from XLTM Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLTM Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from XLTM"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in XLTM"
      content_left: |
    ...
    - title_left: "Redact Text in XLTM via Color Box"
      content_left: |
