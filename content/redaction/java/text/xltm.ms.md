...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada XLTM Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLTM Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada XLTM"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di XLTM"
      content_left: |
    ...
    - title_left: "Redact Teks dalam XLTM melalui Kotak Warna"
      content_left: |
