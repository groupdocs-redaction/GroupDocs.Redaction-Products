...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele XLTM folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă XLTM Frază exactă în Java"
      content_left: |
      ...
      title_right: "Eliminați datele sensibile din XLTM"
      content_right: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în XLTM"
      content_left: |
    ...
    - title_left: "Redacta textul în XLTM prin Caseta de culori"
      content_left: |
