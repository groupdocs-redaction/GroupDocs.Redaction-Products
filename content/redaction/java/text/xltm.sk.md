...
############################# Header ############################
title: "Ako redigovať, skryť alebo odstrániť text z XLTM súborov pomocou Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLTM Presná fráza v Java"
      content_left: |
      ...
      title_right: "Odstrániť citlivé údaje z XLTM"
      content_right: |
    ...
    - title_left: "Redakcia textu citlivá na veľké a veľké písmená v XLTM"
      content_left: |
    ...
    - title_left: "Redigovanie textu v XLTM pomocou farebného poľa"
      content_left: |
