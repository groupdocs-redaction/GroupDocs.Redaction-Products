...
############################# Header ############################
title: "Kako redigirati, skriti ali odstraniti besedilo iz datotek XLTM z uporabo Java"
...
steps:
    enable: true
    block:
    - title_left: "Redakt XLTM Natančen stavek v Java"
      content_left: |
      ...
      title_right: "Odstranite občutljive podatke iz XLTM"
      content_right: |
    ...
    - title_left: "Redakcija besedila, občutljiva na velike črke v XLTM"
      content_left: |
    ...
    - title_left: "Besedilo uredi v XLTM prek barvnega polja"
      content_left: |
