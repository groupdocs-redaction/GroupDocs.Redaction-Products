...
############################# Header ############################
title: "Java kullanarak XLTM Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLTM Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "XLTM 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "XLTM 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla XLTM içindeki Metni Redakt"
      content_left: |
