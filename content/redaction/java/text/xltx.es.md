...
draft: false
path: "es/redaction/java/text/xltx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM  

############################# Head ############################
head_title: "Redactar XLTX Text a través de Exact Phrase/Regular Expression en Java"
...
############################# Header ############################
title: "Cómo redactar, ocultar o eliminar texto de archivos XLTX usando Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactar XLTX Frase exacta en Java"
      content_left: |
      ...
      title_right: "Eliminar datos confidenciales de XLTX"
      content_right: |
    ...
    - title_left: "Redacción de texto con distinción entre mayúsculas y minúsculas en XLTX"
      content_left: |
    ...
    - title_left: "Redactar texto en XLTX a través de Color Box"
      content_left: |
