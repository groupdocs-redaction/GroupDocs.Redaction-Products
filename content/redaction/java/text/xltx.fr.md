...
draft: false
path: "fr/redaction/java/text/xltx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM  

############################# Head ############################
head_title: "Modifier le texte XLTX avec une phrase exacte/expression régulière en Java"
...
############################# Header ############################
title: "Comment modifier, masquer ou supprimer du texte des fichiers XLTX à l'aide de Java"
...
steps:
    enable: true
    block:
    - title_left: "Modifier la phrase exacte XLTX en Java"
      content_left: |
      ...
      title_right: "Supprimer les données sensibles de XLTX"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) et chargez le fichier XLTX
    ...
    - title_left: "Édition de texte sensible à la casse dans XLTX"
      content_left: |
    ...
    - title_left: "Modifier le texte dans XLTX avec Color Box"
      content_left: |
