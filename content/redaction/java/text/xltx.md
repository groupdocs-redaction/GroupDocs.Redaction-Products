...
############################# Header ############################
title: "How to Redact, Hide or Remove Text from XLTX Files using Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLTX Exact Phrase in Java"
      content_left: |
      ...
      title_right: "Remove Sensitive Data from XLTX"
      content_right: |
    ...
    - title_left: "Case Sensitive Text Redaction in XLTX"
      content_left: |
    ...
    - title_left: "Redact Text in XLTX via Color Box"
      content_left: |
