...
############################# Header ############################
title: "Cara Menyunting, Menyembunyikan atau Mengalih Keluar Teks daripada XLTX Fail menggunakan Java"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLTX Frasa Tepat dalam Java"
      content_left: |
      ...
      title_right: "Keluarkan Data Sensitif daripada XLTX"
      content_right: |
    ...
    - title_left: "Redaksi Teks Sensitif Kes di XLTX"
      content_left: |
    ...
    - title_left: "Redact Teks dalam XLTX melalui Kotak Warna"
      content_left: |
