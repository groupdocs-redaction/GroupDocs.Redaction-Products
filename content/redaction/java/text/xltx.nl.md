...
############################# Header ############################
title: "Hoe kan ik tekst uit XLTX bestanden redigeren, verbergen of verwijderen met Java"
...
steps:
    enable: true
    block:
    - title_left: "XLTX Exacte zin redigeren in Java"
      content_left: |
    ...
    - title_left: "Redactie van hoofdlettergevoelige tekst in XLTX"
      content_left: |
    ...
    - title_left: "Tekst redigeren in XLTX via het kleurvak"
      content_left: |
