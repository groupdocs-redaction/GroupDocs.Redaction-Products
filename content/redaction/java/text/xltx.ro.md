...
############################# Header ############################
title: "Cum să redactați, să ascundeți sau să eliminați textul din fișierele XLTX folosind Java"
...
steps:
    enable: true
    block:
    - title_left: "Redactă XLTX Frază exactă în Java"
      content_left: |
    ...
    - title_left: "Redactare text sensibil la majuscule și minuscule în XLTX"
      content_left: |
    ...
    - title_left: "Redacta textul în XLTX prin Caseta de culori"
      content_left: |
