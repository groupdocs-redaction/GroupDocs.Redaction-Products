...
############################# Header ############################
title: "Java kullanarak XLTX Dosyalarından Metin Nasıl Redakte Edact Edilir, Gizlenir veya Kaldırılır"
...
steps:
    enable: true
    block:
    - title_left: "Redact XLTX Java içindeki Tam İfade"
      content_left: |
      ...
      title_right: "XLTX 'den Hassas Verileri Kaldır"
      content_right: |
    ...
    - title_left: "XLTX 'de Büyük/Büyük/Büyük/küçük harf Duyarlı Metin Redaksiyonu"
      content_left: |
    ...
    - title_left: "Renk Kutusu aracılığıyla XLTX içindeki Metni Redakt"
      content_left: |
