...
draft: false
path: "de/redaction/net/annotation/docm"
otherformats: CSV DOC DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redigieren Sie Anmerkungen in DOCM-Dokumenten mit regulären Ausdrücken über .NET Core"
...
############################# Header ############################
title: "Redigieren Sie DOCM Dateianmerkungen über C# und reguläre Ausdrücke in .NET Core Apps"
...
steps:
    enable: true
    title_left: "Anmerkungen aus DOCM mithilfe regulärer Ausdrücke über C# schwärzen"
    content_left: |
