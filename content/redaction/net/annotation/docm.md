...
draft: false
path: "redaction/net/annotation/docm"
otherformats: CSV DOC DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redact Annotations in DOCM Documents using Regular Expressions via .NET Core"
...
############################# Header ############################
title: "Redact DOCM Files Annotations via C# and Regular Expressions in .NET Core Apps"
...
steps:
    enable: true
    title_left: "Redact Annotations from DOCM using Regular Expressions via C#"
    content_left: |
