...
draft: false
path: "id/redaction/net/annotation/docx"
otherformats: CSV DOC DOCM DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redact Anotasi dalam DOCX Dokumen menggunakan Ekspresi Reguler melalui .NET Inti"
...
############################# Header ############################
title: "Redact DOCX Anotasi File melalui C# dan Ekspresi Reguler di .NET Aplikasi Inti"
...
steps:
    enable: true
    title_left: "Sunting Anotasi dari DOCX menggunakan Ekspresi Reguler melalui C#"
    content_left: |
