...
draft: false
path: "it/redaction/net/annotation/docx"
otherformats: CSV DOC DOCM DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Oscura le annotazioni nei documenti DOCX utilizzando le espressioni regolari tramite .NET Core"
...
############################# Header ############################
title: "Oscura DOCX le annotazioni dei file tramite C# e le espressioni regolari nelle .NET app principali"
...
steps:
    enable: true
    title_left: "Oscura le annotazioni da DOCX utilizzando le espressioni regolari tramite C#"
    content_left: |
