...
layout: "autogen"
draft: false
path: "ms/redaction/net/annotation/dotx"
otherformats: CSV DOC DOCM DOCX DOT DOTM PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Sunting Anotasi dalam DOTX Dokumen menggunakan Ungkapan Biasa melalui .NET Teras"
...
############################# Header ############################
title: "Redaksi DOTX Anotasi Fail melalui C# dan Ungkapan Biasa dalam .NET Apl Teras"
...
steps:
    enable: true
    title_left: "Sunting Anotasi daripada DOTX menggunakan Ungkapan Biasa melalui C#"
    content_left: |
