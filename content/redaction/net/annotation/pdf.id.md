...
draft: false
path: "id/redaction/net/annotation/pdf"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redact Anotasi dalam PDF Dokumen menggunakan Ekspresi Reguler melalui .NET Inti"
...
############################# Header ############################
title: "Redact PDF Anotasi File melalui C# dan Ekspresi Reguler di .NET Aplikasi Inti"
...
steps:
    enable: true
    title_left: "Sunting Anotasi dari PDF menggunakan Ekspresi Reguler melalui C#"
    content_left: |
