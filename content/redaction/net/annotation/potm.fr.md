...
draft: false
path: "fr/redaction/net/annotation/potm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Masquer les annotations dans les documents POTM à l'aide d'expressions régulières via .NET Core"
...
############################# Header ############################
title: "Masquer les annotations de fichiers POTM via C# et les expressions régulières dans les applications principales .NET"
...
steps:
    enable: true
    title_left: "Masquer les annotations de POTM à l'aide d'expressions régulières via C#"
    content_left: |
