...
layout: "autogen"
draft: false
path: "ro/redaction/net/annotation/pps"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactați adnotările în PPS documente folosind expresii regulate prin .NET Core"
...
############################# Header ############################
title: "Redactați PPS Fișiere Adnotări prin C# și expresii regulate în .NET Aplicațiile de bază"
...
steps:
    enable: true
    title_left: "Redactați adnotările din PPS folosind expresii regulate prin C#"
    content_left: |
