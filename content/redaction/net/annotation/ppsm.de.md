...
draft: false
path: "de/redaction/net/annotation/ppsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redigieren Sie Anmerkungen in PPSM-Dokumenten mit regulären Ausdrücken über .NET Core"
...
############################# Header ############################
title: "Redigieren Sie PPSM Dateianmerkungen über C# und reguläre Ausdrücke in .NET Core Apps"
...
steps:
    enable: true
    title_left: "Anmerkungen aus PPSM mithilfe regulärer Ausdrücke über C# schwärzen"
    content_left: |
