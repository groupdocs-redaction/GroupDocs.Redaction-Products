...
layout: "autogen"
draft: false
path: "es/redaction/net/annotation/ppsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactar anotaciones en documentos PPSM usando expresiones regulares a través de .NET Core"
...
############################# Header ############################
title: "Redactar anotaciones de archivos PPSM a través de C# y expresiones regulares en .NET aplicaciones principales"
...
steps:
    enable: true
    title_left: "Redactar anotaciones de PPSM usando expresiones regulares a través de C#"
    content_left: |
