...
draft: false
path: "id/redaction/net/annotation/ppsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redact Anotasi dalam PPSM Dokumen menggunakan Ekspresi Reguler melalui .NET Inti"
...
############################# Header ############################
title: "Redact PPSM Anotasi File melalui C# dan Ekspresi Reguler di .NET Aplikasi Inti"
...
steps:
    enable: true
    title_left: "Sunting Anotasi dari PPSM menggunakan Ekspresi Reguler melalui C#"
    content_left: |
