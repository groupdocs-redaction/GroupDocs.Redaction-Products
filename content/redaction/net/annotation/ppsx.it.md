...
draft: false
path: "it/redaction/net/annotation/ppsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Oscura le annotazioni nei documenti PPSX utilizzando le espressioni regolari tramite .NET Core"
...
############################# Header ############################
title: "Oscura PPSX le annotazioni dei file tramite C# e le espressioni regolari nelle .NET app principali"
...
steps:
    enable: true
    title_left: "Oscura le annotazioni da PPSX utilizzando le espressioni regolari tramite C#"
    content_left: |
