...
layout: "autogen"
draft: false
path: "ro/redaction/net/annotation/ppsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactați adnotările în PPSX documente folosind expresii regulate prin .NET Core"
...
############################# Header ############################
title: "Redactați PPSX Fișiere Adnotări prin C# și expresii regulate în .NET Aplicațiile de bază"
...
steps:
    enable: true
    title_left: "Redactați adnotările din PPSX folosind expresii regulate prin C#"
    content_left: |
