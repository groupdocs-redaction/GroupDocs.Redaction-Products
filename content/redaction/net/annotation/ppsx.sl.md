...
draft: false
path: "sl/redaction/net/annotation/ppsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Uredite opombe v PPSX dokumentih z uporabo regularnih izrazov prek .NET Core"
...
############################# Header ############################
title: "Uredite PPSX opombe datotek prek C# in regularnih izrazov v .NET osnovnih aplikacijah"
...
steps:
    enable: true
    title_left: "Uredite opombe iz PPSX z uporabo regularnih izrazov prek C#"
    content_left: |
