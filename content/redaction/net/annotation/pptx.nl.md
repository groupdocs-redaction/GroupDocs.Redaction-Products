...
layout: "autogen"
draft: false
path: "nl/redaction/net/annotation/pptx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Annotaties in PPTX-documenten redigeren met reguliere expressies via .NET Core"
...
############################# Header ############################
title: "Annotaties van PPTX-bestanden redigeren via C# en reguliere expressies in .NET-kernapps"
...
steps:
    enable: true
    title_left: "Annotaties van PPTX redigeren met reguliere expressies via C#"
    content_left: |
