...
layout: "autogen"
draft: false
path: "id/redaction/net/annotation/xlsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redact Anotasi dalam XLSM Dokumen menggunakan Ekspresi Reguler melalui .NET Inti"
...
############################# Header ############################
title: "Redact XLSM Anotasi File melalui C# dan Ekspresi Reguler di .NET Aplikasi Inti"
description: "Temukan dan hapus informasi sensitif dari Dokumen, Spreadsheet & Presentasi Office & OpenOffice serta XLSM di Windows, Linux & macOS"
...
steps:
    enable: true
    title_left: "Sunting Anotasi dari XLSM menggunakan Ekspresi Reguler melalui C#"
    content_left: |
        [GroupDocs.Redaction](id//redaction/net/) memungkinkan pengembang .NET menggunakan kekuatan penuh ekspresi reguler untuk menyunting file XLSM dengan beberapa langkah mudah.

        *   Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & muat XLSM file
