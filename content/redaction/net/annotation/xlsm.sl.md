...
layout: "autogen"
draft: false
path: "sl/redaction/net/annotation/xlsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Uredite opombe v XLSM dokumentih z uporabo regularnih izrazov prek .NET Core"
...
############################# Header ############################
title: "Uredite XLSM opombe datotek prek C# in regularnih izrazov v .NET osnovnih aplikacijah"
description: "Poiščite in odstranite občutljive podatke iz dokumentov Office in OpenOffice, preglednic in predstavitev ter XLSM v Windows, Linux in macOS"
...
steps:
    enable: true
    title_left: "Uredite opombe iz XLSM z uporabo regularnih izrazov prek C#"
    content_left: |
        [GroupDocs.Redaction](sl//redaction/net/) razvijalcem .NET omogoča uporabo polne moči regularnih izrazov za urejanje datoteke XLSM z nekaj preprostimi koraki.
