...
draft: false
path: "ro/redaction/net/annotation/xlt"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLTM XLTX  

############################# Head ############################
head_title: "Redactați adnotările în XLT documente folosind expresii regulate prin .NET Core"
...
############################# Header ############################
title: "Redactați XLT Fișiere Adnotări prin C# și expresii regulate în .NET Aplicațiile de bază"
...
steps:
    enable: true
    title_left: "Redactați adnotările din XLT folosind expresii regulate prin C#"
    content_left: |
