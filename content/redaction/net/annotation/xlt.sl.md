...
draft: false
path: "sl/redaction/net/annotation/xlt"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLTM XLTX  

############################# Head ############################
head_title: "Uredite opombe v XLT dokumentih z uporabo regularnih izrazov prek .NET Core"
...
############################# Header ############################
title: "Uredite XLT opombe datotek prek C# in regularnih izrazov v .NET osnovnih aplikacijah"
...
steps:
    enable: true
    title_left: "Uredite opombe iz XLT z uporabo regularnih izrazov prek C#"
    content_left: |
