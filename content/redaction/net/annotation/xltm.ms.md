...
draft: false
path: "ms/redaction/net/annotation/xltm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTX  

############################# Head ############################
head_title: "Sunting Anotasi dalam XLTM Dokumen menggunakan Ungkapan Biasa melalui .NET Teras"
...
############################# Header ############################
title: "Redaksi XLTM Anotasi Fail melalui C# dan Ungkapan Biasa dalam .NET Apl Teras"
...
steps:
    enable: true
    title_left: "Sunting Anotasi daripada XLTM menggunakan Ungkapan Biasa melalui C#"
    content_left: |
