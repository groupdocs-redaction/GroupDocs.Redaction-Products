...
draft: false
path: "lv/redaction/net/annotation/xltx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM  

############################# Head ############################
head_title: "Rediģēt anotācijas XLTX dokumentos, izmantojot regulārās izteiksmes, izmantojot .NET Core"
head_description: "Izņemiet sensitīvu informāciju anotācijās, izmantojot regulāro izteiksmi no dažādu formātu dokumentiem"

############################# Header ############################
title: "Rediģēt XLTX failu anotācijas, izmantojot C# un regulārās izteiksmes .NET galvenajās lietotnēs"
...
steps:
    enable: true
    title_left: "Rediģēt anotācijas no XLTX, izmantojot regulārās izteiksmes, izmantojot C#"
    content_left: |
