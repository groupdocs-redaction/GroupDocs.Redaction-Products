...
############################# Head ############################
head_title: "Redact Sensitive Metadata from BMP Documents in C#"
head_description: "Apply metadata redaction by applying filters for documents of different formats"

############################# Header ############################
title: "Redact Author Name from BMP Metadata in C#"
...
steps:
    ...
    - title_left: "Redact BMP Metadata in C#"
      content_left: |
        Following code allows you to search and redact sensitive data from a BMP document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Author. - it will leave the regular expressions matches undone in all metadata items, except "Author" property:
    ...
    - title_left: "Remove BMP Metadata in C#"
      content_left: |
      ...
      title_right: "Erase BMP Metadata"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class & upload BMP file
