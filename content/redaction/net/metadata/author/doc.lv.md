...
draft: false
path: "lv/redaction/net/metadata/author/doc"
...
############################# Header ############################
title: "Rediģēt autora vārdu no DOC metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt DOC Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOC dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadataFilter.author. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Autors”:
