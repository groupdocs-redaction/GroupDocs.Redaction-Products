...
draft: false
path: "sk/redaction/net/metadata/author/doc"
...
############################# Header ############################
title: "Redigovať meno autora z DOC Metaúdajov v C#"
...
steps:
    ...
    - title_left: "Redigovať DOC Metaúdaje v C#"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu DOC. Rozsah redigovania môžete nastaviť nastavením filtra, napr. na MetadataFilter.Author. - ponechá nezhody regulárnych výrazov nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Autor“:
