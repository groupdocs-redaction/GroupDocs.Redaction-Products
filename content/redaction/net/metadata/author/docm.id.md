...
draft: false
path: "redaction/net/metadata/author/docm"
...
title: "Redact Nama Penulis dari DOCM Metadata di C#"
...
steps:
    ...
    - title_left: "Redaksi DOCM Metadata di C#"
      content_left: |
        Kode berikut memungkinkan Anda untuk mencari dan menyunting data sensitif dari dokumen DOCM. Anda dapat mengatur ruang lingkup untuk redaksi dengan mengatur filter, mis. ke MetadataFilter.Author. - itu akan membiarkan kecocokan ekspresi reguler dibatalkan di semua item metadata, kecuali properti "Penulis":
