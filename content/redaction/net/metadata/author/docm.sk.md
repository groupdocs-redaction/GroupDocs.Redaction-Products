...
draft: false
path: "sk/redaction/net/metadata/author/docm"
...
############################# Header ############################
title: "Redigovať meno autora z DOCM Metaúdajov v C#"
...
steps:
    ...
    - title_left: "Redigovať DOCM Metaúdaje v C#"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu DOCM. Rozsah redigovania môžete nastaviť nastavením filtra, napr. na MetadataFilter.Author. - ponechá nezhody regulárnych výrazov nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Autor“:
