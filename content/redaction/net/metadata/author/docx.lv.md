...
draft: false
path: "lv/redaction/net/metadata/author/docx"
...
############################# Header ############################
title: "Rediģēt autora vārdu no DOCX metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt DOCX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOCX dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadataFilter.author. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Autors”:
