...
############################# Header ############################
title: "Redact Author Name from PDF Metadata in C#"
...
steps:
    ...
    - title_left: "Redact PDF Metadata in C#"
      content_left: |
        Following code allows you to search and redact sensitive data from a PDF document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Author. - it will leave the regular expressions matches undone in all metadata items, except "Author" property:
