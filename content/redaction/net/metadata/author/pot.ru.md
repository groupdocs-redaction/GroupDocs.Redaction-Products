...
draft: false
path: "ru/redaction/net/metadata/author/pot"
...
############################# Header ############################
title: "Редактировать имя автора из метаданных POT в C#"
