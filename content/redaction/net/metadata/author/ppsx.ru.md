...
draft: false
path: "ru/redaction/net/metadata/author/ppsx"
...
############################# Header ############################
title: "Редактировать имя автора из метаданных PPSX в C#"
