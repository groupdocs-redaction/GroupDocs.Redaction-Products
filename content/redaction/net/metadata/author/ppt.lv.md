...
draft: false
path: "lv/redaction/net/metadata/author/ppt"
...
############################# Header ############################
title: "Rediģēt autora vārdu no PPT metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt PPT Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPT dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadataFilter.author. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Autors”:
