...
draft: false
path: "tr/redaction/net/metadata/author/pptm"
...
############################# Header ############################
title: "C# içindeki PPTM Meta Verilerden Yazar Adını Redakt Edin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact PPTM"
      content_left: |
        Aşağıdaki kod, PPTM belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.Author. - “Author” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri bırakacaktır:
