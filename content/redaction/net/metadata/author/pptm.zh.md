...
draft: false
path: "zh/redaction/net/metadata/author/pptm"
...
steps:
    ...
    - title_left: "编辑 C# 中的 PPTM 元数据"
      content_left: |
        以下代码允许您搜索和编辑 PPTM 文档中的敏感数据。你可以通过设置过滤器来设置编辑范围，例如设置为 metadataFilter.Author。-它会撤消所有元数据项中的正则表达式匹配项，但 “Author” 属性除外：
