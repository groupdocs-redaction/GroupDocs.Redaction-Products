...
draft: false
path: "ru/redaction/net/metadata/author/xlsm"
...
############################# Header ############################
title: "Редактировать имя автора из метаданных XLSM в C#"
