...
draft: false
path: "tr/redaction/net/metadata/author/xlsx"
...
############################# Header ############################
title: "C# içindeki XLSX Meta Verilerden Yazar Adını Redakt Edin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact XLSX"
      content_left: |
        Aşağıdaki kod, XLSX belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.Author. - “Author” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri bırakacaktır:
