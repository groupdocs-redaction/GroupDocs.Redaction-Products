...
draft: false
path: "tr/redaction/net/metadata/author/xlt"
...
############################# Header ############################
title: "C# içindeki XLT Meta Verilerden Yazar Adını Redakt Edin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact XLT"
      content_left: |
        Aşağıdaki kod, XLT belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.Author. - “Author” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri bırakacaktır:
