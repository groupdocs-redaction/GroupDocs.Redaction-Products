...
draft: false
path: "lv/redaction/net/metadata/author/xltx"
...
############################# Header ############################
title: "Rediģēt autora vārdu no XLTX metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLTX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLTX dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadataFilter.author. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Autors”:
