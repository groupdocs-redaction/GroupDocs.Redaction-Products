...
draft: false
path: "sk/redaction/net/metadata/author/xltx"
...
############################# Header ############################
title: "Redigovať meno autora z XLTX Metaúdajov v C#"
...
steps:
    ...
    - title_left: "Redigovať XLTX Metaúdaje v C#"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu XLTX. Rozsah redigovania môžete nastaviť nastavením filtra, napr. na MetadataFilter.Author. - ponechá nezhody regulárnych výrazov nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Autor“:
