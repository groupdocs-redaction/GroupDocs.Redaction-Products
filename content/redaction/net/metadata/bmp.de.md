...
draft: false
path: "de/redaction/net/metadata /bmp/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem BMP-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei BMP anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der BMP-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus BMP-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
