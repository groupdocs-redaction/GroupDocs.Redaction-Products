...
draft: false
path: "ja/redaction/net/metadata /bmp/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでBMPドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "BMPファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でBMPファイルからメタデータを編集"
      content_left: |
