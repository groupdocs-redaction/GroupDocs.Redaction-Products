...
draft: false
path: "ko/redaction/net/metadata /bmp/"
...
steps:
    enable: true
    block:
    - title_left: "Java의 BMP 문서에서 메타데이터를 정리하는 방법"
      content_left: |
      ...
      title_right: "BMP 파일에 메타데이터 수정 적용"
      content_right: |
    ...
    - title_left: ".NET을 통해 BMP 파일에서 메타데이터 수정"
      content_left: |
