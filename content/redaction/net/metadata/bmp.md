...
draft: false
path: "redaction/net/metadata /bmp"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from BMP Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to BMP File"
      content_right: |
    ...
    - title_left: "Redact Metadata from BMP File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from BMP Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
