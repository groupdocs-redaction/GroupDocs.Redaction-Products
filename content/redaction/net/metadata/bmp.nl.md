...
draft: false
path: "nl/redaction/net/metadata/bmp"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit BMP document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op BMP-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit BMP bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit BMP bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
