...
draft: false
path: "sl/redaction/net/metadata/bmp"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta BMP v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za BMP datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke BMP prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek BMP"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
