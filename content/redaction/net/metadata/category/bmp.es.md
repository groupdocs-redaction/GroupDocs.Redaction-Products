...
draft: false
path: "es/redaction/net/metadata/category/bmp"
...
############################# Head ############################
head_title: "Redacte metadatos confidenciales de BMP documentos en C#"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de BMP en C#"
...
steps:
    enable: true
    block:
    - title_left: "Redacte los metadatos de BMP en C#"
      content_left: |
      ...
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo BMP
    ...
    - title_left: "Eliminar BMP metadatos en C#"
      content_left: |
      ...
      title_right: "Borrar BMP metadatos"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo BMP
