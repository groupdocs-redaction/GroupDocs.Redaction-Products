...
draft: false
path: "ru/redaction/net/metadata/category/bmp"
...
############################# Header ############################
title: "Редактировать название категории из метаданных BMP в C#"
