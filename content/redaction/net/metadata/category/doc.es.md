...
draft: false
path: "es/redaction/net/metadata/category/doc"
...
############################# Head ############################
head_title: "Redacte metadatos confidenciales de DOC documentos en C#"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de DOC en C#"
...
steps:
    ...
    - title_left: "Redacte los metadatos de DOC en C#"
      ...
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo DOC
    ...
    - title_left: "Eliminar DOC metadatos en C#"
      content_left: |
      ...
      title_right: "Borrar DOC metadatos"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo DOC
