...
draft: false
path: "id/redaction/net/metadata/category/docm"
...
############################# Header ############################
title: "Redact Nama kategori dari DOCM Metadata di C#"
...
steps:
    ...
    - title_left: "Redaksi DOCM Metadata di C#"
      content_left: |
        Kode berikut memungkinkan Anda untuk mencari dan menyunting data sensitif dari dokumen DOCM. Anda dapat mengatur ruang lingkup untuk redaksi dengan mengatur filter, mis. ke MetadataFilter.Category. - itu akan membiarkan kecocokan ekspresi reguler dibatalkan di semua item metadata, kecuali properti "Kategori":
      ...
      content_right: |
        ...
        * Tetapkan cakupan untuk redaksi dengan menyetel filter, mis. Gunakan MetadataFilter.Category dalam kode di bawah ini 
