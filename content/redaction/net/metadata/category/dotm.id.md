...
draft: false
path: "id/redaction/net/metadata/category/dotm"
...
############################# Header ############################
title: "Redact Nama kategori dari DOTM Metadata di C#"
...
steps:
    ...
    - title_left: "Redaksi DOTM Metadata di C#"
      content_left: |
        Kode berikut memungkinkan Anda untuk mencari dan menyunting data sensitif dari dokumen DOTM. Anda dapat mengatur ruang lingkup untuk redaksi dengan mengatur filter, mis. ke MetadataFilter.Category. - itu akan membiarkan kecocokan ekspresi reguler dibatalkan di semua item metadata, kecuali properti "Kategori":
