...
draft: false
path: "ro/redaction/net/metadata/category/dotx"
...
############################# Head ############################
head_title: "Redactează metadate sensibile din DOTX documente în C#"
head_description: "Aplicați redactarea metadatelor aplicând filtre pentru documente de diferite formate"

############################# Header ############################
title: "Redactă categoria Nume din DOTX Metadate în C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact DOTX metadate în C#"
      content_left: |
    ...
    - title_left: "Eliminați DOTX metadate în C#"
      content_left: |
