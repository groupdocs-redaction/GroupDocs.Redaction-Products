...
draft: false
path: "es/redaction/net/metadata/category/pot"
...
############################# Head ############################
head_title: "Redacte metadatos confidenciales de POT documentos en C#"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de POT en C#"
...
steps:
    ...
    - title_left: "Redacte los metadatos de POT en C#"
      ...
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo POT
    ...
    - title_left: "Eliminar POT metadatos en C#"
      content_left: |
      ...
      title_right: "Borrar POT metadatos"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo POT
