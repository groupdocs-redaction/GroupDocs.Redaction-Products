...
draft: false
path: "ru/redaction/net/metadata/category/pot"
...
############################# Header ############################
title: "Редактировать название категории из метаданных POT в C#"
