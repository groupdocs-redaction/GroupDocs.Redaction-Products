...
draft: false
path: "tr/redaction/net/metadata/category/pot"
...
############################# Header ############################
title: "C# içindeki POT Meta Verilerden kategori adını düzenle"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact POT"
      content_left: |
        Aşağıdaki kod, POT belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.category. - “Category” özelliği hariç tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri bırakacaktır:
