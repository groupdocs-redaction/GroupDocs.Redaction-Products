...
draft: false
path: "zh/redaction/net/metadata/category/pot"
...
############################# Head ############################
head_title: "编辑 C# 中 POT 个文档中的敏感元数据"
head_description: "通过对不同格式的文档应用过滤器来应用元数据密文"

############################# Header ############################
title: "从 C# 中的 POT 元数据中删除类别名称"
...
steps:
    ...
    - title_left: "编辑 C# 中的 POT 元数据"
      content_left: |
        以下代码允许您搜索和编辑 POT 文档中的敏感数据。你可以通过设置过滤器来设置密文范围，例如设置为 metadataFilter.Category。-它会取消所有元数据项中的正则表达式匹配项，但 “Category” 属性除外：
