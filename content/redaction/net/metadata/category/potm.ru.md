...
draft: false
path: "ru/redaction/net/metadata/category/potm"
...
############################# Header ############################
title: "Редактировать название категории из метаданных POTM в C#"
