...
draft: false
path: "es/redaction/net/metadata/category/ppsm"
...
############################# Head ############################
head_title: "Redacte metadatos confidenciales de PPSM documentos en C#"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de PPSM en C#"
...
steps:
    ...
    - title_left: "Redacte los metadatos de PPSM en C#"
      ...
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo PPSM
    ...
    - title_left: "Eliminar PPSM metadatos en C#"
      content_left: |
      ...
      title_right: "Borrar PPSM metadatos"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo PPSM
