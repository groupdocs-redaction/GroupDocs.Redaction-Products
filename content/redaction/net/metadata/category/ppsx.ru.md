...
draft: false
path: "ru/redaction/net/metadata/category/ppsx"
...
############################# Header ############################
title: "Редактировать название категории из метаданных PPSX в C#"
