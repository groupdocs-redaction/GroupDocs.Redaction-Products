...
draft: false
path: "es/redaction/net/metadata/category/ppt"
...
############################# Head ############################
head_title: "Redacte metadatos confidenciales de PPT documentos en C#"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de PPT en C#"
...
steps:
    ...
    - title_left: "Redacte los metadatos de PPT en C#"
      content_left: |
        El siguiente código te permite buscar y eliminar datos confidenciales de un documento PPT. Puedes establecer el alcance de la redacción configurando un filtro, por ejemplo, en MetadataFilter.Category. - Se dejarán sin hacer las coincidencias de las expresiones regulares en todos los elementos de metadatos, excepto en la propiedad «Categoría»:
    ...
    - title_left: "Eliminar PPT metadatos en C#"
      content_left: |
      ...
      title_right: "Borrar PPT metadatos"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo PPT
