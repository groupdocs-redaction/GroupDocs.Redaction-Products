...
draft: false
path: "sk/redaction/net/metadata/category/ppt"
...
############################# Header ############################
title: "Zredigovať kategóriu Názov z PPT Metaúdajov v C#"
...
steps:
    ...
    - title_left: "Redigovať PPT Metaúdaje v C#"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu PPT. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadataFilter.category. - ponechá nezhody regulárnych výrazov nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Kategória“:
