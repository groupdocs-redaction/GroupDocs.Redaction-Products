...
draft: false
path: "it/redaction/net/metadata/category/pptm"
...
############################# Header ############################
title: "Modifica il nome della categoria dai metadati PPTM in C#"
...
steps:
    ...
    - title_left: "Modificare i metadati PPTM in C#"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento PPTM. Puoi impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.Category. - lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Category»:
