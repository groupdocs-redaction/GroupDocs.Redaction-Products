...
draft: false
path: "ko/redaction/net/metadata/category/pptx"
...
############################# Head ############################
head_title: "C# 에 있는 PPTX 개 문서에서 민감한 메타데이터 수정"
head_description: "다양한 형식의 문서에 필터를 적용하여 메타데이터 수정 적용"

############################# Header ############################
title: "C# 에 있는 PPTX 메타데이터에서 카테고리 이름 삭제"
...
steps:
    ...
    - title_left: "C# 에서 PPTX 메타데이터를 수정했습니다."
      ...
      content_right: |
        * [편집자](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) 클래스 인스턴스 생성 및 PPTX 파일 업로드
        ...
        * 필터를 설정하여 수정 범위를 설정합니다 (예: 아래 코드에서 MetadataFilter.Category 사용).
    ...
    - title_left: "C# 에서 PPTX 개의 메타데이터를 제거합니다."
      content_left: |
