...
draft: false
path: "redaction/net/metadata/category/pptx"
...
############################# Head ############################
head_title: "Redact Sensitive Metadata from PPTX Documents in C#"
head_description: "Apply metadata redaction by applying filters for documents of different formats"

############################# Header ############################
title: "Redact category Name from PPTX Metadata in C#"
...
steps:
    ...
    - title_left: "Remove PPTX Metadata in C#"
      content_left: |
