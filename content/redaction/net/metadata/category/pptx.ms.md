...
draft: false
path: "ms/redaction/net/metadata/category/pptx"
...
############################# Header ############################
title: "Nama kategori Redact dari PPTX Metadata dalam C#"
...
steps:
    ...
    - title_left: "Sunting PPTX Metadata dalam C#"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen PPTX. Anda boleh menetapkan ruang lingkup untuk redaksi dengan menetapkan penapis, mis. Ke MetadataFilter.category. - ia akan membiarkan padanan ungkapan biasa dibatalkan di semua item metadata, kecuali harta “Kategori”:
