...
draft: false
path: "ru/redaction/net/metadata/category/pptx"
...
############################# Header ############################
title: "Редактировать название категории из метаданных PPTX в C#"
