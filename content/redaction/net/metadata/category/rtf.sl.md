...
draft: false
path: "sl/redaction/net/metadata/category/rtf"
...
############################# Header ############################
title: "Preuredi kategorijo Ime iz RTF Metapodatkov v C#"
...
steps:
    ...
    - title_left: "Uredij RTF Metapodatke v C#"
      content_left: |
        Naslednja koda omogoča iskanje in redigiranje občutljivih podatkov iz dokumenta RTF. Obseg za redigiranje lahko nastavite tako, da nastavite filter, npr. na metafilter.Category. - ujemanja regularnih izrazov bodo razveljavljena v vseh metapodatkovnih elementih, razen lastnosti« Kategorija »:
