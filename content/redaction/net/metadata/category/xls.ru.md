...
draft: false
path: "ru/redaction/net/metadata/category/xls"
...
############################# Header ############################
title: "Редактировать название категории из метаданных XLS в C#"
