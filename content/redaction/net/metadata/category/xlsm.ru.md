...
draft: false
path: "ru/redaction/net/metadata/category/xlsm"
...
############################# Header ############################
title: "Редактировать название категории из метаданных XLSM в C#"
