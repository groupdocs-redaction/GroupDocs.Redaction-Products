...
draft: false
path: "tr/redaction/net/metadata/category/xltx"
...
############################# Header ############################
title: "C# içindeki XLTX Meta Verilerden kategori adını düzenle"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact XLTX"
      content_left: |
        Aşağıdaki kod, XLTX belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.category. - “Category” özelliği hariç tüm meta veri öğelerinde normal ifadelerin eşleşmelerini geri bırakacaktır:
