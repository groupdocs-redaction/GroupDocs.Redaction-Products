...
draft: false
path: "fr/redaction/net/metadata/company/bmp"
...
############################# Header ############################
title: "Rédiger le nom de l'entreprise à partir des métadonnées BMP dans C#"
