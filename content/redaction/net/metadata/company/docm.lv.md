...
draft: false
path: "lv/redaction/net/metadata/company/docm"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no DOCM metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt DOCM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOCM dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
