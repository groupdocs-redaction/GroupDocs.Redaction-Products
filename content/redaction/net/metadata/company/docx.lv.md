...
draft: false
path: "lv/redaction/net/metadata/company/docx"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no DOCX metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt DOCX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOCX dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
