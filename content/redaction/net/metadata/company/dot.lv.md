...
draft: false
path: "lv/redaction/net/metadata/company/dot"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no DOT metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt DOT Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOT dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
