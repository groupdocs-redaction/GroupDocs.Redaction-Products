...
draft: false
path: "nl/redaction/net/metadata/company/dot"
...
############################# Head ############################
head_title: "Gevoelige metagegevens uit DOT documenten in C# redigeren"
...
############################# Header ############################
title: "Bedrijfsnaam redigeren uit DOT metagegevens in C#"
...
steps:
    ...
    - title_left: "DOT metagegevens verwijderen in C#"
      content_left: |
      ...
      title_right: "DOT metagegevens wissen"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) en upload het DOT -bestand
