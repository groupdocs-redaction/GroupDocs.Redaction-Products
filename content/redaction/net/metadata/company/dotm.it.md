...
draft: false
path: "it/redaction/net/metadata/company/dotm"
...
############################# Head ############################
head_title: "Oscura i metadati sensibili da DOTM documenti in C#"
head_description: "Applica la redazione dei metadati applicando filtri per documenti di diversi formati"

############################# Header ############################
title: "Modifica il nome della società dai metadati DOTM in C#"
...
steps:
    ...
    - title_left: "Modificare i metadati DOTM in C#"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento DOTM. Puoi impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.company. - lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Company»:
    ...
    - title_left: "Rimuovi DOTM metadati in C#"
      content_left: |
      ...
      title_right: "Cancella i metadati DOTM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) e carica il file DOTM
