...
draft: false
path: "lv/redaction/net/metadata/company/dotm"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no DOTM metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt DOTM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOTM dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
