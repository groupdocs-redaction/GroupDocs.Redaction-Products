...
draft: false
path: "it/redaction/net/metadata/company/pdf"
...
############################# Header ############################
title: "Modifica il nome della società dai metadati PDF in C#"
...
steps:
    ...
    - title_left: "Modificare i metadati PDF in C#"
      content_left: |
        Il codice seguente consente di cercare e redigere dati sensibili da un documento PDF. Puoi impostare l'ambito di redazione impostando il filtro, ad esempio su MetadataFilter.company. - lascerà le corrispondenze delle espressioni regolari annullate in tutti gli elementi dei metadati, ad eccezione della proprietà «Company»:
