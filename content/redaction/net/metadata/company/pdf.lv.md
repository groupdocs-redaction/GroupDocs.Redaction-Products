...
draft: false
path: "lv/redaction/net/metadata/company/pdf"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no PDF metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt PDF Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PDF dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
