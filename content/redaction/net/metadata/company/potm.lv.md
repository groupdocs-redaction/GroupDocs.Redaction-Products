...
draft: false
path: "lv/redaction/net/metadata/company/potm"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no POTM metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt POTM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no POTM dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
