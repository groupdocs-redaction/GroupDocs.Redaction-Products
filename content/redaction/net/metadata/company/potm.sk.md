...
draft: false
path: "sk/redaction/net/metadata/company/potm"
...
############################# Head ############################
head_title: "Redigovanie citlivých metaúdajov z POTM dokumentov v C#"
head_description: "Použite redigovanie metadát použitím filtrov pre dokumenty rôznych formátov"

############################# Header ############################
title: "Redigovať názov spoločnosti z POTM Metaúdajov v C#"
...
steps:
    ...
    - title_left: "Redigovať POTM Metaúdaje v C#"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu POTM. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na Metadatafilter.company. - ponechá nezodpovedané zhody regulárnych výrazov vo všetkých položkách metaúdajov okrem vlastnosti „Spoločnosť“:
    ...
    - title_left: "Odstrániť POTM metaúdaje v C#"
      content_left: |
      ...
      title_right: "Vymazať POTM Metaúdaje"
      content_right: |
        * Vytvorte inštanciu súboru [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class & upload POTM
