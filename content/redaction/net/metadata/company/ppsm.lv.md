...
draft: false
path: "lv/redaction/net/metadata/company/ppsm"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no PPSM metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt PPSM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPSM dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
