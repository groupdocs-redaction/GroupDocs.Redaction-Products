...
draft: false
path: "lv/redaction/net/metadata/company/ppsx"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no PPSX metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt PPSX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPSX dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
