...
draft: false
path: "zh/redaction/net/metadata/company/ppsx"
...
steps:
    ...
    - title_left: "编辑 C# 中的 PPSX 元数据"
      content_left: |
        以下代码允许您搜索和编辑 PPSX 文档中的敏感数据。你可以通过设置过滤器来设置密文范围，例如设置为 metadataFilter.Company。-它将取消所有元数据项中的正则表达式匹配项，但 “公司” 属性除外：
