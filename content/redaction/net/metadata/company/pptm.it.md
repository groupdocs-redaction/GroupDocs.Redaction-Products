...
draft: false
path: "it/redaction/net/metadata/company/pptm"
...
############################# Head ############################
head_title: "Oscura i metadati sensibili da PPTM documenti in C#"
head_description: "Applica la redazione dei metadati applicando filtri per documenti di diversi formati"

############################# Header ############################
title: "Modifica il nome della società dai metadati PPTM in C#"
...
steps:
    ...
    - title_left: "Modificare i metadati PPTM in C#"
      ...
      content_right: |
        ...
        * Imposta l'ambito di redazione impostando il filtro, ad esempio usa MetadataFilter.company nel codice seguente
