...
draft: false
path: "lv/redaction/net/metadata/company/rtf"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no RTF metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt RTF Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no RTF dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
