...
draft: false
path: "sl/redaction/net/metadata/company/rtf"
...
############################# Head ############################
head_title: "Spremenite občutljive metapodatke iz dokumentov RTF v C#"
head_description: "Uporabite redigiranje metapodatkov z uporabo filtrov za dokumente različnih formatov"

############################# Header ############################
title: "Spremenite ime podjetja iz RTF metapodatkov v C#"
...
steps:
    ...
    - title_left: "Uredij RTF Metapodatke v C#"
      content_left: |
        Naslednja koda omogoča iskanje in redigiranje občutljivih podatkov iz dokumenta RTF. Obseg za redigiranje lahko nastavite tako, da nastavite filter, npr. v Metadatafilter.Company. - ujemanja regularnih izrazov bo pustila razveljavljena v vseh metapodatkovnih elementih, razen lastnosti« Podjetje »:
