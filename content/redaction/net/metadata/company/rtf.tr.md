...
draft: false
path: "tr/redaction/net/metadata/company/rtf"
...
############################# Head ############################
head_title: "C# içindeki RTF Belgelerinden Hassas Meta Verileri Redakt Etme"
head_description: "Farklı biçimlerdeki belgeler için filtreler uygulayarak meta veri redaksiyonu uygulayın"

############################# Header ############################
title: "C# içindeki RTF Meta Verilerden Şirket Adını Redakt Etme"
...
steps:
    ...
    - title_left: "C# içindeki RTF Meta Verileri Kaldır"
      content_left: |
