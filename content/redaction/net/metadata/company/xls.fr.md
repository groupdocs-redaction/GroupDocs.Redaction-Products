...
draft: false
path: "fr/redaction/net/metadata/company/xls"
...
############################# Header ############################
title: "Rédiger le nom de l'entreprise à partir des métadonnées XLS dans C#"
