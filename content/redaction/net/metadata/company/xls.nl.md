...
draft: false
path: "nl/redaction/net/metadata/company/xls"
...
############################# Header ############################
title: "Bedrijfsnaam redigeren uit XLS metagegevens in C#"
...
steps:
    ...
    - title_left: "XLS Metagegevens redigeren in C#"
      content_left: |
        Met de volgende code kunt u gevoelige gegevens in een XLS -document doorzoeken en redigeren. U kunt het bereik voor redactie instellen door een filter in te stellen, bijvoorbeeld op MetadataFilter.company. - dan blijven de overeenkomsten met reguliere expressies ongedaan in alle metagegevensitems, behalve de eigenschap „Company”:
