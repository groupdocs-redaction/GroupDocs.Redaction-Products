...
draft: false
path: "lv/redaction/net/metadata/company/xlsx"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no XLSX metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLSX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLSX dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
