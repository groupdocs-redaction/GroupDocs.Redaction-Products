...
draft: false
path: "lv/redaction/net/metadata/company/xltm"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no XLTM metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLTM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLTM dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
