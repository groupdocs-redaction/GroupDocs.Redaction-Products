...
draft: false
path: "tr/redaction/net/metadata/company/xltm"
...
############################# Head ############################
head_title: "C# içindeki XLTM Belgelerinden Hassas Meta Verileri Redakt Etme"
head_description: "Farklı biçimlerdeki belgeler için filtreler uygulayarak meta veri redaksiyonu uygulayın"

############################# Header ############################
title: "C# içindeki XLTM Meta Verilerden Şirket Adını Redakt Etme"
...
steps:
    ...
    - title_left: "C# içindeki XLTM Meta Verileri Kaldır"
      content_left: |
