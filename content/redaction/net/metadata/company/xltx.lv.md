...
draft: false
path: "lv/redaction/net/metadata/company/xltx"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no XLTX metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLTX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLTX dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
