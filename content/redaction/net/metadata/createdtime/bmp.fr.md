...
draft: false
path: "fr/redaction/net/metadata/createdtime/bmp"
...
############################# Header ############################
title: "Rédiger les métadonnées createdtime du document BMP dans C#"
