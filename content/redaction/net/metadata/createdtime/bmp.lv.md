...
draft: false
path: "lv/redaction/net/metadata/createdtime/bmp"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no BMP Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt BMP Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no BMP dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
