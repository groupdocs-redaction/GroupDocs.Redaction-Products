...
draft: false
path: "ro/redaction/net/metadata/createdtime/doc"
...
############################# Header ############################
title: "Redact metadate în timp creat din DOC Document în C#"
...
steps:
    ...
    - title_left: "Redact DOC metadate în C#"
      content_left: |
        Codul următor vă permite să căutați și să redactați date sensibile dintr-un document DOC. Puteți seta domeniul de redactare setând filtrul, de exemplu la MetadataFilter.createdTime. - va lăsa nefăcute potrivirile expresiilor regulate în toate elementele de metadate, cu excepția proprietății „Createdtime”:
