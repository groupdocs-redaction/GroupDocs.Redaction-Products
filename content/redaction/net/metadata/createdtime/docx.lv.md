...
draft: false
path: "lv/redaction/net/metadata/createdtime/docx"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no DOCX Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt DOCX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOCX dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
