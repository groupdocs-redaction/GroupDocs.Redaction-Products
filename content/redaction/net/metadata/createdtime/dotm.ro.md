...
draft: false
path: "ro/redaction/net/metadata/createdtime/dotm"
...
############################# Header ############################
title: "Redact metadate în timp creat din DOTM Document în C#"
...
steps:
    ...
    - title_left: "Redact DOTM metadate în C#"
      content_left: |
        Codul următor vă permite să căutați și să redactați date sensibile dintr-un document DOTM. Puteți seta domeniul de redactare setând filtrul, de exemplu la MetadataFilter.createdTime. - va lăsa nefăcute potrivirile expresiilor regulate în toate elementele de metadate, cu excepția proprietății „Createdtime”:
