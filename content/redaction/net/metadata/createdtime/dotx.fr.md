...
draft: false
path: "fr/redaction/net/metadata/createdtime/dotx"
...
############################# Header ############################
title: "Rédiger les métadonnées createdtime du document DOTX dans C#"
