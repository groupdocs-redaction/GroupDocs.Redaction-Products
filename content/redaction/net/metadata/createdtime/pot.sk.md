...
draft: false
path: "sk/redaction/net/metadata/createdtime/pot"
...
############################# Header ############################
title: "Redakcia vytvorených metadát z POT dokumentu v C#"
...
steps:
    ...
    - title_left: "Redigovať POT Metaúdaje v C#"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu POT. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadaTafilter.CreatedTime. - ponechá zhody regulárnych výrazov nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Createdtime“:
