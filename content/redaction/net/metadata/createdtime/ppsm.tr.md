...
draft: false
path: "tr/redaction/net/metadata/createdtime/ppsm"
...
############################# Header ############################
title: "C# içindeki PPSM belgeden oluşturulan zaman Meta Verilerini yeniden düzenleyin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact PPSM"
      content_left: |
        Aşağıdaki kod, PPSM belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.createdTime. - “Createdtime” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri alır:
