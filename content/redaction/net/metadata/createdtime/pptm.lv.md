...
draft: false
path: "lv/redaction/net/metadata/createdtime/pptm"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no PPTM Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt PPTM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPTM dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
