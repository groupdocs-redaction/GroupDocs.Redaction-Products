...
draft: false
path: "lv/redaction/net/metadata/createdtime/pptx"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no PPTX Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt PPTX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPTX dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
