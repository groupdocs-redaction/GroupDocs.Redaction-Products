...
draft: false
path: "lv/redaction/net/metadata/createdtime/xlsm"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no XLSM Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt XLSM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLSM dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
