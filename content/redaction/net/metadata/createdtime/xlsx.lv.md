...
draft: false
path: "lv/redaction/net/metadata/createdtime/xlsx"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no XLSX Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt XLSX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLSX dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
