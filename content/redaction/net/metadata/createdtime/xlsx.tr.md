...
draft: false
path: "tr/redaction/net/metadata/createdtime/xlsx"
...
############################# Header ############################
title: "C# içindeki XLSX belgeden oluşturulan zaman Meta Verilerini yeniden düzenleyin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact XLSX"
      content_left: |
        Aşağıdaki kod, XLSX belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.createdTime. - “Createdtime” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri alır:
