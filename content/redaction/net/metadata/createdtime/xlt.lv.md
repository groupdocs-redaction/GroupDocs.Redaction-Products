...
draft: false
path: "lv/redaction/net/metadata/createdtime/xlt"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no XLT Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt XLT Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLT dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
