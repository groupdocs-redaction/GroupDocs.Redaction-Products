...
draft: false
path: "tr/redaction/net/metadata/createdtime/xltx"
...
############################# Header ############################
title: "C# içindeki XLTX belgeden oluşturulan zaman Meta Verilerini yeniden düzenleyin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact XLTX"
      content_left: |
        Aşağıdaki kod, XLTX belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.createdTime. - “Createdtime” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri alır:
        
        
      title_right: "XLTX Meta Veriler Nasıl Redakte Edilir"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun ve XLTX dosyasını yükleyin
