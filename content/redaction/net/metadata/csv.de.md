...
draft: false
path: "de/redaction/net/metadata /csv/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem CSV-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei CSV anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der CSV-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus CSV-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
