...
draft: false
path: "ja/redaction/net/metadata /csv/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでCSVドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "CSVファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でCSVファイルからメタデータを編集"
      content_left: |
