...
draft: false
path: "redaction/net/metadata /csv"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from CSV Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to CSV File"
      content_right: |
    ...
    - title_left: "Redact Metadata from CSV File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from CSV Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
