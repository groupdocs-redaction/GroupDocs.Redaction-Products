...
draft: false
path: "ro/redaction/net/metadata/csv"
otherformats:   
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul CSV din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul CSV"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul CSV prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere CSV"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
