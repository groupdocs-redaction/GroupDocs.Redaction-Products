...
draft: false
path: "sk/redaction/net/metadata/csv"
otherformats:   
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z CSV dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor CSV"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru CSV cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov CSV"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
