...
draft: false
path: "tr/redaction/net/metadata/csv"
otherformats:   
...
steps:
    enable: true
    block:
    - title_left: "C#'daki CSV Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "CSV Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "CSV Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "CSV Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
