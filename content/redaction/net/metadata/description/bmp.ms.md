...
draft: false
path: "ms/redaction/net/metadata/description/bmp"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada BMP Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from BMP Dokumen"
      content_left: |
