...
draft: false
path: "nl/redaction/net/metadata/description/bmp"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het BMP -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit BMP document redigeren"
      content_left: |
