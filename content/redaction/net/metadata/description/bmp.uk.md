...
draft: false
path: "uk/redaction/net/metadata/description/bmp"
...
############################# Header ############################
title: "Редагувати метадані опису з документа BMP в C#"
