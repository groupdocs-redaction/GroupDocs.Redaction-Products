...
draft: false
path: "id/redaction/net/metadata/description/doc"
...
############################# Header ############################
title: "Redact Metadata Deskripsi dari DOC Document di C#"
...
steps:
    ...
    - title_left: "Hapus DOC Metadata di C#"
      content_left: |
      ...
      title_right: "Hapus DOC Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & unggah file DOC
