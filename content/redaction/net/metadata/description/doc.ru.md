...
draft: false
path: "ru/redaction/net/metadata/description/doc"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа DOC на C#"
