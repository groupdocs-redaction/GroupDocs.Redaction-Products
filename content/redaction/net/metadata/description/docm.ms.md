...
draft: false
path: "ms/redaction/net/metadata/description/docm"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada DOCM Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from DOCM Dokumen"
      content_left: |
