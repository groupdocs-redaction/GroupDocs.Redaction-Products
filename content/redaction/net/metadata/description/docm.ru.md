...
draft: false
path: "ru/redaction/net/metadata/description/docm"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа DOCM на C#"
