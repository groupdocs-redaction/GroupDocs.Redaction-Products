...
draft: false
path: "nl/redaction/net/metadata/description/docx"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het DOCX -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit DOCX document redigeren"
      content_left: |
