...
draft: false
path: "ru/redaction/net/metadata/description/docx"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа DOCX на C#"
