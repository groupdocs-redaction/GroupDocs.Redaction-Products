...
draft: false
path: "de/redaction/net/metadata/description/dot"
...
############################# Header ############################
title: "Metadaten zur Beschreibung aus dem Dokument DOT in C# redigieren"
...
steps:
    ...
    - title_left: "DOT Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "DOT Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei DOT hoch
