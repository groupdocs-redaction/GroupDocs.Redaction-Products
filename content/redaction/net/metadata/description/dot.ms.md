...
draft: false
path: "ms/redaction/net/metadata/description/dot"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada DOT Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from DOT Dokumen"
      content_left: |
