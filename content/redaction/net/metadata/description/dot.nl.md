...
draft: false
path: "nl/redaction/net/metadata/description/dot"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het DOT -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit DOT document redigeren"
      content_left: |
