...
draft: false
path: "nl/redaction/net/metadata/description/dotm"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het DOTM -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit DOTM document redigeren"
      content_left: |
