...
draft: false
path: "nl/redaction/net/metadata/description/pdf"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het PDF -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit PDF document redigeren"
      content_left: |
