...
draft: false
path: "redaction/net/metadata/description/pdf"
...
############################# Header ############################
title: "Редактировать метаданные описания из PDF-документа в C#"
