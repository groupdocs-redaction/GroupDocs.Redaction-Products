...
draft: false
path: "ms/redaction/net/metadata/description/pot"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada POT Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from POT Dokumen"
      content_left: |
