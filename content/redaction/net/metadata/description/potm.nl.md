...
draft: false
path: "nl/redaction/net/metadata/description/potm"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het POTM -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit POTM document redigeren"
      content_left: |
