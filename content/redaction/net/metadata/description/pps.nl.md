...
draft: false
path: "nl/redaction/net/metadata/description/pps"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het PPS -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit PPS document redigeren"
      content_left: |
