...
draft: false
path: "ms/redaction/net/metadata/description/ppsx"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada PPSX Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from PPSX Dokumen"
      content_left: |
