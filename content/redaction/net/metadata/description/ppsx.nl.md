...
draft: false
path: "nl/redaction/net/metadata/description/ppsx"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het PPSX -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit PPSX document redigeren"
      content_left: |
