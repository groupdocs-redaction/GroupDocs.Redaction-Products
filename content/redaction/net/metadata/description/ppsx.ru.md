...
draft: false
path: "ru/redaction/net/metadata/description/ppsx"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа PPSX на C#"
