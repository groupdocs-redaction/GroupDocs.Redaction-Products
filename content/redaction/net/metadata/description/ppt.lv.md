...
draft: false
path: "lv/redaction/net/metadata/description/ppt"
...
############################# Header ############################
title: "Redakt apraksta metadatus no PPT dokumenta C#"
...
steps:
    ...
    - title_left: "Noņemt PPT metadatus C#"
      content_left: |
      ...
      title_right: "Dzēst PPT Metadatus"
      content_right: |
        * Izveidot [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) klases un augšupielādēt PPT faila instanci
