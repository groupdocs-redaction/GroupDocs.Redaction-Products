...
draft: false
path: "ms/redaction/net/metadata/description/ppt"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada PPT Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from PPT Dokumen"
      content_left: |
