...
draft: false
path: "ru/redaction/net/metadata/description/ppt"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа PPT на C#"
