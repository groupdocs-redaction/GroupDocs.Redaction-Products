...
draft: false
path: "uk/redaction/net/metadata/description/ppt"
...
############################# Header ############################
title: "Редагувати метадані опису з документа PPT в C#"
