...
draft: false
path: "nl/redaction/net/metadata/description/pptm"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het PPTM -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit PPTM document redigeren"
      content_left: |
