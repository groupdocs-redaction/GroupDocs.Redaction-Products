...
draft: false
path: "ru/redaction/net/metadata/description/pptm"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа PPTM на C#"
