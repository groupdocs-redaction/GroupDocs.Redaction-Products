...
draft: false
path: "de/redaction/net/metadata/description/pptx"
...
############################# Header ############################
title: "Metadaten zur Beschreibung aus dem Dokument PPTX in C# redigieren"
...
steps:
    ...
    - title_left: "Beschreibung aus PPTX -Dokument redigieren"
      ...
      content_right: |
        ...
        * Legen Sie den Umfang für die Schwärzung fest, indem Sie den Filter festlegen, z. B. Verwenden Sie MetadataFilter.description im folgenden Code
