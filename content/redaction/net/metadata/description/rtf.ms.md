...
draft: false
path: "ms/redaction/net/metadata/description/rtf"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada RTF Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from RTF Dokumen"
      content_left: |
