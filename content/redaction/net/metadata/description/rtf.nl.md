...
draft: false
path: "nl/redaction/net/metadata/description/rtf"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het RTF -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit RTF document redigeren"
      content_left: |
