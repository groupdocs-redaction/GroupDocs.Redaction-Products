...
draft: false
path: "ru/redaction/net/metadata/description/rtf"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа RTF на C#"
