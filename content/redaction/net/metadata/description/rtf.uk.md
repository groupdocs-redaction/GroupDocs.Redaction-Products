...
draft: false
path: "uk/redaction/net/metadata/description/rtf"
...
############################# Header ############################
title: "Редагувати метадані опису з документа RTF в C#"
