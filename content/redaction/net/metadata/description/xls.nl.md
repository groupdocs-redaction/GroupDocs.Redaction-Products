...
draft: false
path: "nl/redaction/net/metadata/description/xls"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het XLS -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit XLS document redigeren"
      content_left: |
