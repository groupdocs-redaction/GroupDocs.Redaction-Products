...
draft: false
path: "uk/redaction/net/metadata/description/xls"
...
############################# Header ############################
title: "Редагувати метадані опису з документа XLS в C#"
