...
draft: false
path: "ms/redaction/net/metadata/description/xlsm"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada XLSM Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from XLSM Dokumen"
      content_left: |
