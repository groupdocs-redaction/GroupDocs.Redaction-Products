...
draft: false
path: "ru/redaction/net/metadata/description/xlsx"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа XLSX на C#"
