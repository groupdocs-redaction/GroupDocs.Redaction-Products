...
draft: false
path: "redaction/net/metadata/description/xlt"
...
title: "Redact Metadata Deskripsi dari XLT Document di C#"
...
steps:
    ...
    - title_left: "Hapus XLT Metadata di C#"
      content_left: |
        Anda dapat mengganti semua atau metadata tertentu dalam dokumen dengan nilai kosong (kosong atau minimal) menggunakan kelas EraseMetadataRedaction. Kode berikut menunjukkan bagaimana Anda dapat memfilter dan kemudian menghapus properti metadata dari dokumen XLT. Contoh di bawah ini mengosongkan semua properti dokumen:
        
      title_right: "Hapus XLT Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & unggah file XLT
