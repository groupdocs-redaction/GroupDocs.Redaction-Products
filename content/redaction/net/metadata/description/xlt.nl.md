...
draft: false
path: "nl/redaction/net/metadata/description/xlt"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het XLT -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit XLT document redigeren"
      content_left: |
