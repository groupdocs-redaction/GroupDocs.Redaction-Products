...
draft: false
path: "ru/redaction/net/metadata/description/xlt"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа XLT на C#"
