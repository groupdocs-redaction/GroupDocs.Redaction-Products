...
draft: false
path: "de/redaction/net/metadata/description/xltm"
...
############################# Header ############################
title: "Metadaten zur Beschreibung aus dem Dokument XLTM in C# redigieren"
...
steps:
    ...
    - title_left: "XLTM Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "XLTM Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei XLTM hoch
