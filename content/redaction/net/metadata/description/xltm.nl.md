...
draft: false
path: "nl/redaction/net/metadata/description/xltm"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het XLTM -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit XLTM document redigeren"
      content_left: |
