...
draft: false
path: "ms/redaction/net/metadata/description/xltx"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada XLTX Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from XLTX Dokumen"
      content_left: |
