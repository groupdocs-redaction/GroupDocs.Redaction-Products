...
draft: false
path: "nl/redaction/net/metadata/description/xltx"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het XLTX -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit XLTX document redigeren"
      content_left: |
