...
draft: false
path: "de/redaction/net/metadata /doc/"
otherformats: PDF DOT DOCX DOCM DOTX DOTM RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM PPSM POTM JPEG TIFF PNG BMP GIF 
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem DOC-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei DOC anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der DOC-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus DOC-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
