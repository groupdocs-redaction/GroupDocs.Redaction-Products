...
draft: false
path: "id/redaction/net/metadata/doc"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen DOC di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File DOC"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File DOC melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari DOC File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
