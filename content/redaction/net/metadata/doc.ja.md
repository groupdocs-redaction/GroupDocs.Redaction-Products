...
draft: false
path: "ja/redaction/net/metadata /doc/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでDOCドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "DOCファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でDOCファイルからメタデータを編集"
      content_left: |
