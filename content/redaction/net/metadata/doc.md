...
draft: false
path: "redaction/net/metadata /doc"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from DOC Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to DOC File"
      content_right: |
    ...
    - title_left: "Redact Metadata from DOC File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from DOC Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
