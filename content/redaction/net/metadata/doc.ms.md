...
draft: false
path: "ms/redaction/net/metadata/doc"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada DOC Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail DOC."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada DOC Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada DOC Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
