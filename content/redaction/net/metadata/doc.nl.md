...
draft: false
path: "nl/redaction/net/metadata/doc"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit DOC document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op DOC-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit DOC bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit DOC bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
