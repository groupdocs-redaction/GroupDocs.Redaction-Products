...
draft: false
path: "de/redaction/net/metadata /docm/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem DOCM-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei DOCM anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der DOCM-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus DOCM-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
