...
draft: false
path: "ja/redaction/net/metadata /docm/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでDOCMドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "DOCMファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でDOCMファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "DOCMファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
