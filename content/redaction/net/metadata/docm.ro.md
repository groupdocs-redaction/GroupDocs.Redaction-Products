...
draft: false
path: "ro/redaction/net/metadata/docm"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul DOCM din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul DOCM"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul DOCM prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere DOCM"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
