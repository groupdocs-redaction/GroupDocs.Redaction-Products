...
draft: false
path: "sk/redaction/net/metadata/docm"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z DOCM dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor DOCM"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru DOCM cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov DOCM"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
