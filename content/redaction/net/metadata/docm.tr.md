...
draft: false
path: "tr/redaction/net/metadata/docm"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki DOCM Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "DOCM Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "DOCM Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "DOCM Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
