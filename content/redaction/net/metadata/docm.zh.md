...
draft: false
path: "zh/redaction/net/metadata/docm"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from DOCM Document in C#"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to DOCM File"
      content_right: |
    ...
    - title_left: "Redact Metadata from DOCM File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from DOCM Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
