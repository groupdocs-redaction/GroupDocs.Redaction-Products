...
draft: false
path: "de/redaction/net/metadata /docx/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem DOCX-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei DOCX anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der DOCX-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus DOCX-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
