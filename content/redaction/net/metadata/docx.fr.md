...
draft: false
path: "fr/redaction/net/metadata /docx/"
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document DOCX en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier DOCX"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier DOCX via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de docx_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
