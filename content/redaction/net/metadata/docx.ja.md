...
draft: false
path: "ja/redaction/net/metadata /docx/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでDOCXドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "DOCXファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でDOCXファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "DOCXファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
