...
draft: false
path: "nl/redaction/net/metadata/docx"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit DOCX document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op DOCX-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit DOCX bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit DOCX bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
