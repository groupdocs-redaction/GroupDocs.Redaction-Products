...
draft: false
path: "sk/redaction/net/metadata/docx"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z DOCX dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor DOCX"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru DOCX cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov DOCX"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
