...
draft: false
path: "uk/redaction/net/metadata/docx"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа DOCX у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу DOCX"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу DOCX через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів DOCX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
