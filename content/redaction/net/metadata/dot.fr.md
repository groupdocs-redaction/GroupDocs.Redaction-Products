...
draft: false
path: "fr/redaction/net/metadata /dot/"
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document DOT en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier DOT"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier DOT via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de dot_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
