...
draft: false
path: "ja/redaction/net/metadata /dot/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでDOTドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "DOTファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でDOTファイルからメタデータを編集"
      content_left: |
