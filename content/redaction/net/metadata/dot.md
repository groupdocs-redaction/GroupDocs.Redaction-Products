...
draft: false
path: "redaction/net/metadata /dot"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from DOT Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to DOT File"
      content_right: |
    ...
    - title_left: "Redact Metadata from DOT File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from DOT Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
