...
draft: false
path: "ms/redaction/net/metadata/dot"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada DOT Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail DOT."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada DOT Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada DOT Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
