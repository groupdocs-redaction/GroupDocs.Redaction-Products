...
draft: false
path: "nl/redaction/net/metadata/dot"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit DOT document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op DOT-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit DOT bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit DOT bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
