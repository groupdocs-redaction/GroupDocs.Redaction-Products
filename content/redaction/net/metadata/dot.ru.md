...
draft: false
path: "ru/redaction/net/metadata /dot/"
...
steps:
    enable: true
    block:
    - title_left: «Как очистить метаданные из документа DOT в Java"
      content_left: |
      ...
      title_right: "Применить редактирование метаданных к файлу DOT"
      content_right: |
    ...
    - title_left: "Редактировать метаданные из файла DOT через .NET"
      content_left: |
      ...
      title_right: "Редактирование метаданных из файлов DOT"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
