...
draft: false
path: "de/redaction/net/metadata /dotm/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem DOTM-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei DOTM anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der DOTM-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus DOTM-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
