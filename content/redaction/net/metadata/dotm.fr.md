...
draft: false
path: "fr/redaction/net/metadata /dotm/"
otherformats: PDF DOC DOT DOCX DOCM DOTX RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM PPSM POTM JPEG TIFF PNG BMP GIF 
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document DOTM en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier DOTM"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier DOTM via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de dotm_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
