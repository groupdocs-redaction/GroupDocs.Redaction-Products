...
draft: false
path: "ja/redaction/net/metadata /dotm/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでDOTMドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "DOTMファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でDOTMファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "DOTMファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
