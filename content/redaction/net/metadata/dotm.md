...
draft: false
path: "redaction/net/metadata /dotm"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from DOTM Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to DOTM File"
      content_right: |
    ...
    - title_left: "Redact Metadata from DOTM File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from DOTM Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
