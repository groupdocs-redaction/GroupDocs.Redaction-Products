...
draft: false
path: "ms/redaction/net/metadata/dotm"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada DOTM Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail DOTM."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada DOTM Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada DOTM Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
