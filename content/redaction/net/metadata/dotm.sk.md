...
draft: false
path: "sk/redaction/net/metadata/dotm"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z DOTM dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor DOTM"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru DOTM cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov DOTM"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
