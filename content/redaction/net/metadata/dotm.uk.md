...
draft: false
path: "uk/redaction/net/metadata/dotm"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа DOTM у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу DOTM"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу DOTM через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів DOTM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
