...
draft: false
path: "de/redaction/net/metadata /dotx/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem DOTX-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei DOTX anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der DOTX-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus DOTX-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
