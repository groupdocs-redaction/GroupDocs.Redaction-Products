...
draft: false
path: "ja/redaction/net/metadata /dotx/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでDOTXドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "DOTXファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でDOTXファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "DOTXファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
