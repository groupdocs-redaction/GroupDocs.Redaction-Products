...
draft: false
path: "redaction/net/metadata /dotx"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from DOTX Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to DOTX File"
      content_right: |
    ...
    - title_left: "Redact Metadata from DOTX File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from DOTX Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
