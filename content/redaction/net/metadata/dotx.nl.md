...
draft: false
path: "nl/redaction/net/metadata/dotx"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit DOTX document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op DOTX-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit DOTX bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit DOTX bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
