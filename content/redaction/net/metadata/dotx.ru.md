...
draft: false
path: "ru/redaction/net/metadata /dotx/"
...
steps:
    enable: true
    block:
    - title_left: «Как очистить метаданные из документа DOTX в Java"
      content_left: |
      ...
      title_right: "Применить редактирование метаданных к файлу DOTX"
      content_right: |
    ...
    - title_left: "Редактировать метаданные из файла DOTX через .NET"
      content_left: |
      ...
      title_right: "Редактирование метаданных из файлов DOTX"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
