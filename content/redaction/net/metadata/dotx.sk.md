...
draft: false
path: "sk/redaction/net/metadata/dotx"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z DOTX dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor DOTX"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru DOTX cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov DOTX"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
