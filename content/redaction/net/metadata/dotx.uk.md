...
draft: false
path: "uk/redaction/net/metadata/dotx"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа DOTX у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу DOTX"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу DOTX через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів DOTX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
