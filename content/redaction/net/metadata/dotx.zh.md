...
draft: false
path: "zh/redaction/net/metadata /dotx/"
...
steps:
    enable: true
    block:
    - title_left: "如何从 Java 中的 DOTX 文档中清除元数据"
      content_left: |
    ...
    - title_left: "通过 .NET 编辑来自 DOTX 文件的元数据"
      content_left: |
