...
draft: false
path: "de/redaction/net/metadata /gif/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem GIF-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei GIF anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der GIF-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus GIF-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
