...
draft: false
path: "ja/redaction/net/metadata /gif/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでGIFドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "GIFファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でGIFファイルからメタデータを編集"
      content_left: |
