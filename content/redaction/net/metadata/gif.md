...
draft: false
path: "redaction/net/metadata /gif"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from GIF Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to GIF File"
      content_right: |
    ...
    - title_left: "Redact Metadata from GIF File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from GIF Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
