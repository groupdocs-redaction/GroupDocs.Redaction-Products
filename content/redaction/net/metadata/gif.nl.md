...
draft: false
path: "nl/redaction/net/metadata/gif"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit GIF document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op GIF-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit GIF bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit GIF bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
