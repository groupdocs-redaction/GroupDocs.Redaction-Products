...
draft: false
path: "ro/redaction/net/metadata/gif"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul GIF din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul GIF"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul GIF prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere GIF"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
