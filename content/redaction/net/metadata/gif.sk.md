...
draft: false
path: "sk/redaction/net/metadata/gif"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z GIF dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor GIF"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru GIF cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov GIF"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
