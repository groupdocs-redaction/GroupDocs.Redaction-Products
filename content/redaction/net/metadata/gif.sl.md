...
draft: false
path: "sl/redaction/net/metadata/gif"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta GIF v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za GIF datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke GIF prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek GIF"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
