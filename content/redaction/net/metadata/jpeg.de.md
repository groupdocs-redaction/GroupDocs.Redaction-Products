...
draft: false
path: "de/redaction/net/metadata /jpeg/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem JPEG-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei JPEG anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der JPEG-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus JPEG-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
