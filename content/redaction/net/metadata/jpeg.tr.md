...
draft: false
path: "tr/redaction/net/metadata/jpeg"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki JPEG Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "JPEG Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "JPEG Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "JPEG Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
