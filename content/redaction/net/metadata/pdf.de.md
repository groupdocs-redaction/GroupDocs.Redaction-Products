...
draft: false
path: "de/redaction/net/metadata /pdf/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem PDF-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei PDF anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der PDF-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus PDF-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
