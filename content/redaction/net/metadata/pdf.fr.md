...
draft: false
path: "fr/redaction/net/metadata /pdf/"
otherformats: DOC DOT DOCX DOCM DOTX DOTM RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM PPSM POTM JPEG TIFF PNG BMP GIF 
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document PDF en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier PDF"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier PDF via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de pdf_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
