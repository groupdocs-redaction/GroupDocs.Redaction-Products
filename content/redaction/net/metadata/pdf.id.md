...
draft: false
path: "id/redaction/net/metadata/pdf"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen PDF di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File PDF"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File PDF melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari PDF File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
