...
draft: false
path: "it/redaction/net/metadata/pdf"
...
steps:
    enable: true
    block:
    - title_left: "Come pulire i metadati dal documento PDF in C#"
      content_left: |
      ...
      title_right: "Applica la redazione dei metadati al file PDF"
      content_right: |
    ...
    - title_left: "Oscura metadati dal file PDF tramite .NET"
      content_left: |
      ...
      title_right: "Oscuramento dei metadati dai file PDF"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
