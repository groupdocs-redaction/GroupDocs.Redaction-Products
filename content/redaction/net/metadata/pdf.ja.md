...
draft: false
path: "ja/redaction/net/metadata /pdf/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでPDFドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "PDFファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でPDFファイルからメタデータを編集"
      content_left: |
