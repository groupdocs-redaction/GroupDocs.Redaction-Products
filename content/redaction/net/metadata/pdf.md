...
draft: false
path: "redaction/net/metadata /pdf"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from PDF Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to PDF File"
      content_right: |
    ...
    - title_left: "Redact Metadata from PDF File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from PDF Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
