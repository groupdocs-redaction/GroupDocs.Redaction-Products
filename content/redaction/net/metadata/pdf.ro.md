...
draft: false
path: "ro/redaction/net/metadata/pdf"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul PDF din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul PDF"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul PDF prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere PDF"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
