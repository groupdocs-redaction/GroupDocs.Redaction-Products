...
draft: false
path: "it/redaction/net/metadata/png"
...
steps:
    enable: true
    block:
    - title_left: "Come pulire i metadati dal documento PNG in C#"
      content_left: |
      ...
      title_right: "Applica la redazione dei metadati al file PNG"
      content_right: |
    ...
    - title_left: "Oscura metadati dal file PNG tramite .NET"
      content_left: |
      ...
      title_right: "Oscuramento dei metadati dai file PNG"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
