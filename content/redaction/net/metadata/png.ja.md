...
draft: false
path: "ja/redaction/net/metadata /png/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでPNGドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "PNGファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でPNGファイルからメタデータを編集"
      content_left: |
