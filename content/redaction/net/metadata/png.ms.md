...
draft: false
path: "ms/redaction/net/metadata/png"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada PNG Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail PNG."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada PNG Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada PNG Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
