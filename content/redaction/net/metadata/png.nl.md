...
draft: false
path: "nl/redaction/net/metadata/png"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit PNG document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op PNG-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit PNG bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit PNG bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
