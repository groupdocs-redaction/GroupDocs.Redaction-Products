...
draft: false
path: "zh/redaction/net/metadata/png"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from PNG Document in C#"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to PNG File"
      content_right: |
    ...
    - title_left: "Redact Metadata from PNG File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from PNG Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
