...
draft: false
path: "de/redaction/net/metadata /pot/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem POT-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei POT anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der POT-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus POT-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
