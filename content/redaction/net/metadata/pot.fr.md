...
draft: false
path: "fr/redaction/net/metadata /pot/"
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document POT en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier POT"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier POT via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de pot_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
