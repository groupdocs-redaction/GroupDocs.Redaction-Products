...
draft: false
path: "ja/redaction/net/metadata /pot/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでPOTドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "POTファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でPOTファイルからメタデータを編集"
      content_left: |
