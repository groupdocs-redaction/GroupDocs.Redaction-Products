...
draft: false
path: "ko/redaction/net/metadata /pot/"
...
steps:
    enable: true
    block:
    - title_left: "Java의 POT 문서에서 메타데이터를 정리하는 방법"
      content_left: |
      ...
      title_right: "POT 파일에 메타데이터 수정 적용"
      content_right: |
    ...
    - title_left: ".NET을 통해 POT 파일에서 메타데이터 수정"
      content_left: |
