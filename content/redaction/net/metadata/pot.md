...
draft: false
path: "redaction/net/metadata /pot"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from POT Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to POT File"
      content_right: |
    ...
    - title_left: "Redact Metadata from POT File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from POT Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
