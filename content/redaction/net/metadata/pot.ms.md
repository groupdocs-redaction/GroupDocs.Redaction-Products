...
draft: false
path: "ms/redaction/net/metadata/pot"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada POT Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail POT."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada POT Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada POT Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
