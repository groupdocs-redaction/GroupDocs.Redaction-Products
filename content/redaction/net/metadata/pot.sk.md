...
draft: false
path: "sk/redaction/net/metadata/pot"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z POT dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor POT"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru POT cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov POT"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
