...
draft: false
path: "de/redaction/net/metadata /potm/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem POTM-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei POTM anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der POTM-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus POTM-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
