...
draft: false
path: "fr/redaction/net/metadata /potm/"
otherformats: PDF DOC DOT DOCX DOCM DOTX DOTM RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM PPSM JPEG TIFF PNG BMP GIF 
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document POTM en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier POTM"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier POTM via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de potm_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
