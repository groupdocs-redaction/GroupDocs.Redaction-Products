...
draft: false
path: "redaction/net/metadata /potm"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from POTM Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to POTM File"
      content_right: |
    ...
    - title_left: "Redact Metadata from POTM File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from POTM Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
