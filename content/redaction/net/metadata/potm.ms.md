...
draft: false
path: "ms/redaction/net/metadata/potm"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada POTM Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail POTM."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada POTM Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada POTM Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
