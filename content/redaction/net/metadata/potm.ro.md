...
draft: false
path: "ro/redaction/net/metadata/potm"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul POTM din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul POTM"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul POTM prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere POTM"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
