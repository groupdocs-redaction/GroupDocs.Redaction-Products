...
draft: false
path: "uk/redaction/net/metadata/potm"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа POTM у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу POTM"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу POTM через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів POTM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
