...
draft: false
path: "ja/redaction/net/metadata /pps/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでPPSドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "PPSファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でPPSファイルからメタデータを編集"
      content_left: |
