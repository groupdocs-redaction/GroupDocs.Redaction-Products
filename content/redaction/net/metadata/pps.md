...
draft: false
path: "redaction/net/metadata /pps"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from PPS Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to PPS File"
      content_right: |
    ...
    - title_left: "Redact Metadata from PPS File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from PPS Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
