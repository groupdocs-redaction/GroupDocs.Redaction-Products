...
draft: false
path: "ms/redaction/net/metadata/pps"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada PPS Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail PPS."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada PPS Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada PPS Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
