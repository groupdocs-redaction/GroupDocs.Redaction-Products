...
draft: false
path: "nl/redaction/net/metadata/pps"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit PPS document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op PPS-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit PPS bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit PPS bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
