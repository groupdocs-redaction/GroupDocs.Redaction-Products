...
draft: false
path: "sk/redaction/net/metadata/pps"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z PPS dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor PPS"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru PPS cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov PPS"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
