...
draft: false
path: "de/redaction/net/metadata /ppsm/"
otherformats: PDF DOC DOT DOCX DOCM DOTX DOTM RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM POTM JPEG TIFF PNG BMP GIF 
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem PPSM-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei PPSM anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der PPSM-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus PPSM-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
