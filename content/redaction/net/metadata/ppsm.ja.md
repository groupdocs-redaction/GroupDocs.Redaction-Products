...
draft: false
path: "ja/redaction/net/metadata /ppsm/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでPPSMドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "PPSMファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でPPSMファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "PPSMファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
