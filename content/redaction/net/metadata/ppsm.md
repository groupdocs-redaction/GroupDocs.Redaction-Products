...
draft: false
path: "redaction/net/metadata /ppsm"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from PPSM Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to PPSM File"
      content_right: |
    ...
    - title_left: "Redact Metadata from PPSM File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from PPSM Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
