...
draft: false
path: "sl/redaction/net/metadata/ppsm"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta PPSM v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za PPSM datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke PPSM prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek PPSM"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
