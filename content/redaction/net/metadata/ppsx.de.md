...
draft: false
path: "de/redaction/net/metadata /ppsx/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem PPSX-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei PPSX anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der PPSX-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus PPSX-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
