...
draft: false
path: "ja/redaction/net/metadata /ppsx/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでPPSXドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "PPSXファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でPPSXファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "PPSXファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
