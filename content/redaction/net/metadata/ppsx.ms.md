...
draft: false
path: "ms/redaction/net/metadata/ppsx"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada PPSX Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail PPSX."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada PPSX Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada PPSX Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
