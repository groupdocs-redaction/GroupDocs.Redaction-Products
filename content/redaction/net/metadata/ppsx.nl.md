...
draft: false
path: "nl/redaction/net/metadata/ppsx"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit PPSX document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op PPSX-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit PPSX bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit PPSX bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
