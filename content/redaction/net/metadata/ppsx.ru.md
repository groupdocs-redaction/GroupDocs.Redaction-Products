...
draft: false
path: "ru/redaction/net/metadata /ppsx/"
...
steps:
    enable: true
    block:
    - title_left: «Как очистить метаданные из документа PPSX в Java"
      content_left: |
      ...
      title_right: "Применить редактирование метаданных к файлу PPSX"
      content_right: |
    ...
    - title_left: "Редактировать метаданные из файла PPSX через .NET"
      content_left: |
      ...
      title_right: "Редактирование метаданных из файлов PPSX"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
