...
draft: false
path: "sk/redaction/net/metadata/ppsx"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z PPSX dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor PPSX"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru PPSX cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov PPSX"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
