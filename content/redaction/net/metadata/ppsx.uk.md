...
draft: false
path: "uk/redaction/net/metadata/ppsx"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа PPSX у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу PPSX"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу PPSX через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів PPSX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
