...
draft: false
path: "de/redaction/net/metadata /ppt/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem PPT-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei PPT anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der PPT-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus PPT-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
