...
draft: false
path: "zh/redaction/net/metadata/ppt"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from PPT Document in C#"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to PPT File"
      content_right: |
    ...
    - title_left: "Redact Metadata from PPT File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from PPT Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
