...
draft: false
path: "de/redaction/net/metadata /pptm/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem PPTM-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei PPTM anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der PPTM-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus PPTM-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
