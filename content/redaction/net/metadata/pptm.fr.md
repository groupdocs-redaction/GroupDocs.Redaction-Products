...
draft: false
path: "fr/redaction/net/metadata /pptm/"
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document PPTM en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier PPTM"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier PPTM via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de pptm_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
