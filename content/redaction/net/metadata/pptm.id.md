...
draft: false
path: "id/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen PPTM di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File PPTM"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File PPTM melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari PPTM File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
