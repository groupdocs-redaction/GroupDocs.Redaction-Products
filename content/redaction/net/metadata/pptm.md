...
draft: false
path: "redaction/net/metadata /pptm"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from PPTM Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to PPTM File"
      content_right: |
    ...
    - title_left: "Redact Metadata from PPTM File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from PPTM Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
