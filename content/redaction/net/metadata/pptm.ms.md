...
draft: false
path: "ms/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada PPTM Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail PPTM."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada PPTM Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada PPTM Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
