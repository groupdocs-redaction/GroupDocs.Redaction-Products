...
draft: false
path: "nl/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit PPTM document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op PPTM-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit PPTM bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit PPTM bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
