...
draft: false
path: "sk/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z PPTM dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor PPTM"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru PPTM cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov PPTM"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
