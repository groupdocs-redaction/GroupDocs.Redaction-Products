...
draft: false
path: "tr/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki PPTM Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "PPTM Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "PPTM Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "PPTM Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
