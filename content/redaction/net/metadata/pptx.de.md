...
draft: false
path: "de/redaction/net/metadata /pptx/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem PPTX-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei PPTX anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der PPTX-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus PPTX-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
