...
draft: false
path: "sk/redaction/net/metadata/pptx"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z PPTX dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor PPTX"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru PPTX cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov PPTX"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
