...
draft: false
path: "zh/redaction/net/metadata/pptx"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from PPTX Document in C#"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to PPTX File"
      content_right: |
    ...
    - title_left: "Redact Metadata from PPTX File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from PPTX Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
