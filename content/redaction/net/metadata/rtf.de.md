...
draft: false
path: "de/redaction/net/metadata /rtf/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem RTF-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei RTF anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der RTF-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus RTF-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
