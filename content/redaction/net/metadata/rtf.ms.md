...
draft: false
path: "ms/redaction/net/metadata/rtf"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada RTF Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail RTF."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada RTF Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada RTF Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
