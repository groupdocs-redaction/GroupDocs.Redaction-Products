...
draft: false
path: "ro/redaction/net/metadata/rtf"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul RTF din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul RTF"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul RTF prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere RTF"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
