...
draft: false
path: "zh/redaction/net/metadata/rtf"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from RTF Document in C#"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to RTF File"
      content_right: |
    ...
    - title_left: "Redact Metadata from RTF File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from RTF Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
