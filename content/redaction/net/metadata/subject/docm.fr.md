...
draft: false
path: "fr/redaction/net/metadata/subject/docm"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document DOCM dans C#"
