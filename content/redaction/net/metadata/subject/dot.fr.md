...
draft: false
path: "fr/redaction/net/metadata/subject/dot"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document DOT dans C#"
