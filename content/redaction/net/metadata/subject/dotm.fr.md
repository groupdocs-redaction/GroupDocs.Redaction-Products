...
draft: false
path: "fr/redaction/net/metadata/subject/dotm"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document DOTM dans C#"
