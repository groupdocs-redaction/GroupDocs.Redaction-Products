...
draft: false
path: "fr/redaction/net/metadata/subject/pdf"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document PDF dans C#"
