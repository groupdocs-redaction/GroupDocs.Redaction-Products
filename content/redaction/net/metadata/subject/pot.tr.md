...
draft: false
path: "tr/redaction/net/metadata/subject/pot"
...
############################# Header ############################
title: "C# içindeki POT Belgesinden Meta Veri Redaksiyonu"
...
steps:
    ...
    - title_left: "POT Belgeden Konuyu Redakt Etme"
      ...
      content_right: |
        ...
        * Filtreyi ayarlayarak redaksiyon kapsamını ayarlayın, örn. Aşağıdaki kodda MetadataFilter.subject kullanın
      ...
      gistfile: "RedactSubjectMetadata.cs dosyası"
