...
draft: false
path: "fr/redaction/net/metadata/subject/potm"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document POTM dans C#"
