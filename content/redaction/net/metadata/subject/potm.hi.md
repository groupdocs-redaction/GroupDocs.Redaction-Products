...
draft: false
path: "hi/redaction/net/metadata/subject/potm"
...
############################# Header ############################
title: "C# में POTM दस्तावेज़ से मेटाडेटा रिडक्शन"
...
steps:
    ...
    - title_left: "POTM दस्तावेज़ से विषय को संपादित करें"
      ...
      content_right: |
        ...
        * फ़िल्टर सेट करके रिडक्शन के लिए स्कोप सेट करें, उदाहरण के लिए नीचे दिए गए कोड में metadataFilter.subject का उपयोग करें
