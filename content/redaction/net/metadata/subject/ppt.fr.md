...
draft: false
path: "fr/redaction/net/metadata/subject/ppt"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document PPT dans C#"
