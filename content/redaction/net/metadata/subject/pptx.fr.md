...
draft: false
path: "fr/redaction/net/metadata/subject/pptx"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document PPTX dans C#"
