...
draft: false
path: "fr/redaction/net/metadata/subject/rtf"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document RTF dans C#"
