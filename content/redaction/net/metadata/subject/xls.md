...
steps:
    ...
    - title_left: "Redact Subject from XLS Document"
      content_left: |
        Following code allows you to search and redact sensitive data from a XLS document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Subject. It will leave the regular expressions matches undone in all metadata items, except "Subject" property:
