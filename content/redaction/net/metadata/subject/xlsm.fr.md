...
draft: false
path: "fr/redaction/net/metadata/subject/xlsm"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document XLSM dans C#"
