...
draft: false
path: "redaction/net/metadata/subject/xlsx"
...
title: "Redaksi Metadata dari Dokumen XLSX di C#"
...
steps:
    ...
    - title_left: "Hapus XLSX Metadata di C#"
      content_left: |
      ...
      title_right: "Hapus XLSX Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & unggah file XLSX
