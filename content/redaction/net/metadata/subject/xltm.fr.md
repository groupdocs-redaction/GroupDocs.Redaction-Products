...
draft: false
path: "fr/redaction/net/metadata/subject/xltm"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document XLTM dans C#"
