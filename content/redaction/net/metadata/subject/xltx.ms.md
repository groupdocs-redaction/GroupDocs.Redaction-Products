...
draft: false
path: "ms/redaction/net/metadata/subject/xltx"
...
############################# Header ############################
title: "Redaksi Metadata dari XLTX Dokumen dalam C#"
...
steps:
    ...
    - title_left: "Keluarkan Metadata XLTX dalam C#"
      content_left: |
      ...
      title_right: "Padamkan Metadata XLTX"
      content_right: |
        * Buat contoh [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) kelas & muat naik fail XLTX
