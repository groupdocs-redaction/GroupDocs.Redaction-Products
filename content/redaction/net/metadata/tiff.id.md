...
draft: false
path: "id/redaction/net/metadata/tiff"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen TIFF di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File TIFF"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File TIFF melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari TIFF File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
