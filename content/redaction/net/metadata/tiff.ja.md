...
draft: false
path: "ja/redaction/net/metadata /tiff/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでTIFFドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "TIFFファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でTIFFファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "TIFFファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
