...
draft: false
path: "ru/redaction/net/metadata /tiff/"
...
steps:
    enable: true
    block:
    - title_left: «Как очистить метаданные из документа TIFF в Java"
      content_left: |
      ...
      title_right: "Применить редактирование метаданных к файлу TIFF"
      content_right: |
    ...
    - title_left: "Редактировать метаданные из файла TIFF через .NET"
      content_left: |
      ...
      title_right: "Редактирование метаданных из файлов TIFF"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
