...
draft: false
path: "sl/redaction/net/metadata/tiff"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta TIFF v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za TIFF datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke TIFF prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek TIFF"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
