...
draft: false
path: "hi/redaction/net/metadata/title/bmp"
...
############################# Header ############################
title: "C# में BMP दस्तावेज़ से टाइटल मेटाडेटा को संपादित करें"
