...
draft: false
path: "ru/redaction/net/metadata/title/bmp"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа BMP в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные BMP в C#"
      content_left: |
