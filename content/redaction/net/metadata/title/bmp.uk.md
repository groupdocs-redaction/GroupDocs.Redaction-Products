...
draft: false
path: "uk/redaction/net/metadata/title/bmp"
...
############################# Header ############################
title: "Відредагувати метадані заголовка з BMP документа в C#"
