...
draft: false
path: "nl/redaction/net/metadata/title/doc"
...
############################# Header ############################
title: "Titelmetagegevens uit DOC -document redigeren in C#"
...
steps:
    enable: true
    block:
    - title_left: "Titel redigeren uit DOC document"
      content_left: |
        Met de volgende code kunt u gevoelige gegevens in een DOC -document doorzoeken en redigeren. U kunt het bereik voor de redactie instellen door een filter in te stellen, bijvoorbeeld op MetadataFilter.title. De overeenkomsten met reguliere expressies blijven in alle metagegevensitems ongedaan, met uitzondering van de eigenschap „Title”:
