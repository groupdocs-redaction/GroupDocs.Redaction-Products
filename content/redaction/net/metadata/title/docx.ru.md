...
draft: false
path: "ru/redaction/net/metadata/title/docx"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа DOCX в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные DOCX в C#"
      content_left: |
      ...
      title_right: "Удалить метаданные DOCX"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) и загрузите файл DOCX.
