...
draft: false
path: "ru/redaction/net/metadata/title/dot"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа DOT в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные DOT в C#"
      content_left: |
      ...
      title_right: "Удалить метаданные DOT"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) и загрузите файл DOT.
