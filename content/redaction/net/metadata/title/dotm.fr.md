...
draft: false
path: "fr/redaction/net/metadata/title/dotm"
...
############################# Header ############################
title: "Rédiger les métadonnées du titre du document DOTM dans C#"
