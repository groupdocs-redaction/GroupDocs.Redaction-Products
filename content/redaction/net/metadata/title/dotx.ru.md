...
draft: false
path: "ru/redaction/net/metadata/title/dotx"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа DOTX в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные DOTX в C#"
      content_left: |
      ...
      title_right: "Удалить метаданные DOTX"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) и загрузите файл DOTX.
