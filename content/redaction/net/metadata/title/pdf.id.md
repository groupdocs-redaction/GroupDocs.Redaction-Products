...
draft: false
path: "id/redaction/net/metadata/title/pdf"
...
############################# Header ############################
title: "Redact Judul Metadata dari PDF Document di C#"
...
steps:
    ...
    - title_left: "Hapus PDF Metadata di C#"
      content_left: |
      ...
      title_right: "Hapus PDF Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & unggah file PDF
