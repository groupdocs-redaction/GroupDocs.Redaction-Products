...
draft: false
path: "ru/redaction/net/metadata/title/pdf"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа PDF в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные PDF в C#"
      content_left: |
