...
draft: false
path: "fr/redaction/net/metadata/title/pot"
...
############################# Header ############################
title: "Rédiger les métadonnées du titre du document POT dans C#"
