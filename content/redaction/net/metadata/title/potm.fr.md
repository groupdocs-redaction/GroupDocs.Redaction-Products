...
draft: false
path: "fr/redaction/net/metadata/title/potm"
...
############################# Header ############################
title: "Rédiger les métadonnées du titre du document POTM dans C#"
