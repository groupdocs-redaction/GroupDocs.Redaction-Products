...
draft: false
path: "nl/redaction/net/metadata/title/potm"
...
############################# Header ############################
title: "Titelmetagegevens uit POTM -document redigeren in C#"
...
steps:
    ...
    - title_left: "Titel redigeren uit POTM document"
      ...
      content_right: |
        ...
        * Stel het bereik voor redactie in door een filter in te stellen, bijvoorbeeld gebruik MetadataFilter.title in onderstaande code
