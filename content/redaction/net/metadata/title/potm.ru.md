...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа POTM в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные POTM в C#"
      content_left: |
      ...
      title_right: "Стереть метаданные POTM"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) и загрузите файл POTM.
