...
draft: false
path: "fr/redaction/net/metadata/title/pps"
...
############################# Header ############################
title: "Rédiger les métadonnées du titre du document PPS dans C#"
