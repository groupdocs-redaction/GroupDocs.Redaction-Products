...
draft: false
path: "uk/redaction/net/metadata/title/pps"
...
############################# Header ############################
title: "Відредагувати метадані заголовка з PPS документа в C#"
