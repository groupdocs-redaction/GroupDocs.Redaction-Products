...
draft: false
path: "fr/redaction/net/metadata/title/ppsm"
...
############################# Header ############################
title: "Rédiger les métadonnées du titre du document PPSM dans C#"
