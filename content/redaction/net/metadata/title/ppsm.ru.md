...
draft: false
path: "redaction/net/metadata/title/ppsm"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа PPSM в C#"
