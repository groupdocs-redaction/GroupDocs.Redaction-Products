...
draft: false
path: "ko/redaction/net/metadata/title/ppsx"
...
############################# Header ############################
title: "C# 에 있는 PPSX 문서의 제목 메타데이터 수정"
...
steps:
    ...
    - title_left: "PPSX 문서에서 제목 수정하기"
      ...
      content_right: |
        ...
        * 필터를 설정하여 수정 범위를 설정합니다 (예: 아래 코드에서 MetadataFilter.title 사용).
