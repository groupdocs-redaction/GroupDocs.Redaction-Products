...
draft: false
path: "hi/redaction/net/metadata/title/ppt"
...
############################# Header ############################
title: "C# में PPT दस्तावेज़ से टाइटल मेटाडेटा को संपादित करें"
