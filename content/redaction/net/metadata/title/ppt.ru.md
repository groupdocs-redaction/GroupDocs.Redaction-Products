...
draft: false
path: "ru/redaction/net/metadata/title/ppt"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа PPT в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные PPT в C#"
      content_left: |
