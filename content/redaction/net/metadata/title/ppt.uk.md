...
draft: false
path: "uk/redaction/net/metadata/title/ppt"
...
############################# Header ############################
title: "Відредагувати метадані заголовка з PPT документа в C#"
