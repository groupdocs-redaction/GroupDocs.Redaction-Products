...
draft: false
path: "fr/redaction/net/metadata/title/pptm"
...
############################# Header ############################
title: "Rédiger les métadonnées du titre du document PPTM dans C#"
