...
steps:
    ...
    - title_left: "Redact Title from PPTM Document"
      content_left: |
        Following code allows you to search and redact sensitive data from a PPTM document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Title. It will leave the regular expressions matches undone in all metadata items, except "Title" property:
