...
draft: false
path: "ru/redaction/net/metadata/title/pptx"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа PPTX в C#"
