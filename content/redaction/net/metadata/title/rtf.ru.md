...
draft: false
path: "ru/redaction/net/metadata/title/rtf"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа RTF в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные RTF в C#"
      content_left: |
      ...
      title_right: "Удалить метаданные RTF"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) и загрузите файл RTF.
