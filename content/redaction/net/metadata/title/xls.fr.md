...
draft: false
path: "fr/redaction/net/metadata/title/xls"
...
############################# Header ############################
title: "Rédiger les métadonnées du titre du document XLS dans C#"
