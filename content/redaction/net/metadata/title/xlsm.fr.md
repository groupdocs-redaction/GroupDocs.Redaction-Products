...
draft: false
path: "fr/redaction/net/metadata/title/xlsm"
...
############################# Header ############################
title: "Rédiger les métadonnées du titre du document XLSM dans C#"
