...
draft: false
path: "id/redaction/net/metadata/title/xlsm"
...
############################# Header ############################
title: "Redact Judul Metadata dari XLSM Document di C#"
...
steps:
    ...
    - title_left: "Hapus XLSM Metadata di C#"
      content_left: |
      ...
      title_right: "Hapus XLSM Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & unggah file XLSM
