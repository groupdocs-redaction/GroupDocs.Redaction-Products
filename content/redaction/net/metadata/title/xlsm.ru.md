...
draft: false
path: "ru/redaction/net/metadata/title/xlsm"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа XLSM в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные XLSM в C#"
      content_left: |
