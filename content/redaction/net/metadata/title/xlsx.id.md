...
draft: false
path: "id/redaction/net/metadata/title/xlsx"
...
steps:
    ...
    - title_left: "Redact Judul dari XLSX Document"
      content_left: |
        Kode berikut memungkinkan Anda untuk mencari dan menyunting data sensitif dari dokumen XLSX. Anda dapat mengatur ruang lingkup untuk redaksi dengan mengatur filter, mis. ke MetadataFilter.Title. - itu akan membiarkan kecocokan ekspresi reguler dibatalkan di semua item metadata, kecuali properti "Judul":
