...
draft: false
path: "ru/redaction/net/metadata/title/xlt"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа XLT в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные XLT в C#"
      content_left: |
