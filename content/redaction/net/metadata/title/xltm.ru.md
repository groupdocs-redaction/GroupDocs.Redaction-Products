...
draft: false
path: "ru/redaction/net/metadata/title/xltm"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа XLTM в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные XLTM в C#"
      content_left: |
