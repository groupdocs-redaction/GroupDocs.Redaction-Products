...
draft: false
path: "id/redaction/net/metadata/title/xltx"
...
############################# Header ############################
title: "Redact Judul Metadata dari XLTX Document di C#"
...
steps:
    ...
    - title_left: "Hapus XLTX Metadata di C#"
      content_left: |
      ...
      title_right: "Hapus XLTX Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & unggah file XLTX
