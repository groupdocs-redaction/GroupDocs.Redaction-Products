...
draft: false
path: "ru/redaction/net/metadata/version/bmp"
...
############################# Header ############################
title: "Редактировать версию метаданных файла BMP на C#"
