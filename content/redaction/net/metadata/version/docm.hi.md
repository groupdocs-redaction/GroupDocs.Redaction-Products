...
draft: false
path: "hi/redaction/net/metadata/version/docm"
...
############################# Header ############################
title: "C# में DOCM फ़ाइल के मेटाडेटा के संस्करण को संशोधित करें"
...
steps:
    ...
    - title_left: "C# में DOCM फ़ाइल का संस्करण संपादित करें"
      ...
      content_right: |
        ...
        * फ़िल्टर सेट करके रिडक्शन के लिए स्कोप सेट करें, उदाहरण के लिए नीचे दिए गए कोड में metadataFilter.version का उपयोग करें
    ...
    - title_left: "C# में DOCM मेटाडेटा हटाएं"
      content_left: |
      ...
      title_right: "DOCM मेटाडेटा मिटाएं"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) वर्ग का एक उदाहरण बनाएं और DOCM फ़ाइल अपलोड करें
