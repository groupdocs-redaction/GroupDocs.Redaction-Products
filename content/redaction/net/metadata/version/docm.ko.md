...
draft: false
path: "ko/redaction/net/metadata/version/docm"
...
############################# Header ############################
title: "C# 에서 DOCM 파일 메타데이터의 버전을 수정했습니다."
