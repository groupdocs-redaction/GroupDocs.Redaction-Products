...
draft: false
path: "de/redaction/net/metadata/version/dotm"
...
############################# Header ############################
title: "Version der Metadaten der DOTM -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "DOTM Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "DOTM Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei DOTM hoch
