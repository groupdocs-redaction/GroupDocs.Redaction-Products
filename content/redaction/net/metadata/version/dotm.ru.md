...
draft: false
path: "ru/redaction/net/metadata/version/dotm"
...
############################# Header ############################
title: "Редактировать версию метаданных файла DOTM на C#"
