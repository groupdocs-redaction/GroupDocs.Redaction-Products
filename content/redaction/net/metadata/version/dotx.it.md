...
draft: false
path: "it/redaction/net/metadata/version/dotx"
...
############################# Header ############################
title: "Modifica la versione dei metadati del file DOTX in C#"
...
steps:
    enable: true
    block:
    - title_left: "Redigere la versione del file DOTX in C#"
      content_left: |
