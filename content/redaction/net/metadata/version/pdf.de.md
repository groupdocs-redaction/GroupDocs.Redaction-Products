...
draft: false
path: "de/redaction/net/metadata/version/pdf"
...
############################# Header ############################
title: "Version der Metadaten der PDF -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "PDF Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "PDF Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei PDF hoch
