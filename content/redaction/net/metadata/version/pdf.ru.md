...
draft: false
path: "ru/redaction/net/metadata/version/pdf"
...
############################# Header ############################
title: "Редактировать версию метаданных файла PDF на C#"
