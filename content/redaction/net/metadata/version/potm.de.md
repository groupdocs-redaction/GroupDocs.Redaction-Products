...
draft: false
path: "de/redaction/net/metadata/version/potm"
...
############################# Header ############################
title: "Version der Metadaten der POTM -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "Version der Datei POTM in C# redigieren"
      ...
      content_right: |
        ...
        * Legen Sie den Umfang für die Schwärzung fest, indem Sie den Filter festlegen, z. B. Verwenden Sie MetadataFilter.Version im folgenden Code
    ...
    - title_left: "POTM Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "POTM Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei POTM hoch
