...
draft: false
path: "hi/redaction/net/metadata/version/potm"
...
############################# Header ############################
title: "C# में POTM फ़ाइल के मेटाडेटा के संस्करण को संशोधित करें"
...
steps:
    ...
    - title_left: "C# में POTM मेटाडेटा हटाएं"
      content_left: |
      ...
      title_right: "POTM मेटाडेटा मिटाएं"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) वर्ग का एक उदाहरण बनाएं और POTM फ़ाइल अपलोड करें
