...
draft: false
path: "hi/redaction/net/metadata/version/ppsm"
...
############################# Header ############################
title: "C# में PPSM फ़ाइल के मेटाडेटा के संस्करण को संशोधित करें"
...
steps:
    ...
    - title_left: "C# में PPSM मेटाडेटा हटाएं"
      content_left: |
      ...
      title_right: "PPSM मेटाडेटा मिटाएं"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) वर्ग का एक उदाहरण बनाएं और PPSM फ़ाइल अपलोड करें
