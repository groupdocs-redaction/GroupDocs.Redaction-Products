...
draft: false
path: "it/redaction/net/metadata/version/ppsx"
...
############################# Header ############################
title: "Modifica la versione dei metadati del file PPSX in C#"
...
steps:
    enable: true
    block:
    - title_left: "Redigere la versione del file PPSX in C#"
      content_left: |
