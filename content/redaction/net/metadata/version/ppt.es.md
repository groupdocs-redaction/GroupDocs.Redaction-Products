...
draft: false
path: "es/redaction/net/metadata/version/ppt"
...
############################# Header ############################
title: "Redacte la versión de los metadatos del archivo PPT en C#"
