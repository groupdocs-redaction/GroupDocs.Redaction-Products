...
draft: false
path: "hi/redaction/net/metadata/version/ppt"
...
############################# Header ############################
title: "C# में PPT फ़ाइल के मेटाडेटा के संस्करण को संशोधित करें"
...
steps:
    ...
    - title_left: "C# में PPT मेटाडेटा हटाएं"
      content_left: |
      ...
      title_right: "PPT मेटाडेटा मिटाएं"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) वर्ग का एक उदाहरण बनाएं और PPT फ़ाइल अपलोड करें
