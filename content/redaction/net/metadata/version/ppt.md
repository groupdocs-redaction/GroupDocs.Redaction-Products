...
steps:
    ...
    - title_left: "Redact Version of PPT File in C#"
      content_left: |
        Following code allows you to search and redact sensitive data from a PPT document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Version. It will leave the regular expressions matches undone in all metadata items, except "Version" property:
