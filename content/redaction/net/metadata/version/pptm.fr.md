...
draft: false
path: "fr/redaction/net/metadata/version/pptm"
...
############################# Header ############################
title: "Version expurgée des métadonnées du fichier PPTM dans C#"
