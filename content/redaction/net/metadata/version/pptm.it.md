...
draft: false
path: "it/redaction/net/metadata/version/pptm"
...
############################# Header ############################
title: "Modifica la versione dei metadati del file PPTM in C#"
...
steps:
    ...
    - title_left: "Redigere la versione del file PPTM in C#"
      ...
      content_right: |
        ...
        * Imposta l'ambito di redazione impostando il filtro, ad esempio usa MetadataFilter.version nel codice seguente
