...
draft: false
path: "de/redaction/net/metadata/version/pptx"
...
############################# Header ############################
title: "Version der Metadaten der PPTX -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "PPTX Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "PPTX Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei PPTX hoch
