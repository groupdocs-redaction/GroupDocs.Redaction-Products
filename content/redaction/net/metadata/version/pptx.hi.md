...
draft: false
path: "hi/redaction/net/metadata/version/pptx"
...
############################# Header ############################
title: "C# में PPTX फ़ाइल के मेटाडेटा के संस्करण को संशोधित करें"
...
steps:
    ...
    - title_left: "C# में PPTX मेटाडेटा हटाएं"
      content_left: |
