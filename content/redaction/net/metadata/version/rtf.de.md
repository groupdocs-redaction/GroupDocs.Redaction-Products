...
draft: false
path: "de/redaction/net/metadata/version/rtf"
...
############################# Header ############################
title: "Version der Metadaten der RTF -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "RTF Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "RTF Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei RTF hoch
