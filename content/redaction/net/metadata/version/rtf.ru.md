...
draft: false
path: "ru/redaction/net/metadata/version/rtf"
...
############################# Header ############################
title: "Редактировать версию метаданных файла RTF на C#"
