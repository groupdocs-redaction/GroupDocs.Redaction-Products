...
draft: false
path: "fr/redaction/net/metadata/version/xlsm"
...
############################# Header ############################
title: "Version expurgée des métadonnées du fichier XLSM dans C#"
