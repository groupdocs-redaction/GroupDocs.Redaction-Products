...
draft: false
path: "de/redaction/net/metadata/version/xlsx"
...
############################# Header ############################
title: "Version der Metadaten der XLSX -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "XLSX Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "XLSX Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei XLSX hoch
