...
draft: false
path: "ko/redaction/net/metadata/version/xlsx"
...
############################# Header ############################
title: "C# 에서 XLSX 파일 메타데이터의 버전을 수정했습니다."
