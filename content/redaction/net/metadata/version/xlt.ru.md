...
draft: false
path: "ru/redaction/net/metadata/version/xlt"
...
############################# Header ############################
title: "Редактировать версию метаданных файла XLT на C#"
