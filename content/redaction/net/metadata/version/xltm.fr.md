...
draft: false
path: "fr/redaction/net/metadata/version/xltm"
...
############################# Header ############################
title: "Version expurgée des métadonnées du fichier XLTM dans C#"
