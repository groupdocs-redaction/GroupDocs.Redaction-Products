...
draft: false
path: "de/redaction/net/metadata /xls/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem XLS-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei XLS anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der XLS-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus XLS-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
