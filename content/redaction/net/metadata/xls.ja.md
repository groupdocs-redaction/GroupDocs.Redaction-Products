...
draft: false
path: "ja/redaction/net/metadata /xls/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでXLSドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "XLSファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でXLSファイルからメタデータを編集"
      content_left: |
