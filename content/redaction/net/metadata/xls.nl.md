...
draft: false
path: "nl/redaction/net/metadata/xls"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit XLS document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op XLS-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit XLS bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit XLS bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
