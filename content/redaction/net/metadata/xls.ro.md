...
draft: false
path: "ro/redaction/net/metadata/xls"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul XLS din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul XLS"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul XLS prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere XLS"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
