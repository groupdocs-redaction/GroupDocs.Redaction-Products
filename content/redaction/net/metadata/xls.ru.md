...
draft: false
path: "ru/redaction/net/metadata /xls/"
...
steps:
    enable: true
    block:
    - title_left: «Как очистить метаданные из документа XLS в Java"
      content_left: |
      ...
      title_right: "Применить редактирование метаданных к файлу XLS"
      content_right: |
    ...
    - title_left: "Редактировать метаданные из файла XLS через .NET"
      content_left: |
      ...
      title_right: "Редактирование метаданных из файлов XLS"
      content_right: |
        * Создайте экземпляр класса [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
