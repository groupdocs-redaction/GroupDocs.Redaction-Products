...
draft: false
path: "sl/redaction/net/metadata/xls"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta XLS v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za XLS datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke XLS prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek XLS"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
