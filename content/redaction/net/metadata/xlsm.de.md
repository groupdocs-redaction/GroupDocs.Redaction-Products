...
draft: false
path: "de/redaction/net/metadata /xlsm/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem XLSM-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei XLSM anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der XLSM-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus XLSM-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
