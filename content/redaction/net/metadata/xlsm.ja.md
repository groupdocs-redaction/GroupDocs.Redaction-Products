...
draft: false
path: "ja/redaction/net/metadata /xlsm/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでXLSMドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "XLSMファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でXLSMファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "XLSMファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
