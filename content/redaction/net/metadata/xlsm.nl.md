...
draft: false
path: "nl/redaction/net/metadata/xlsm"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit XLSM document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op XLSM-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit XLSM bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit XLSM bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
