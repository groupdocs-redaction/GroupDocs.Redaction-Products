...
draft: false
path: "sk/redaction/net/metadata/xlsm"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z XLSM dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor XLSM"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru XLSM cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov XLSM"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
