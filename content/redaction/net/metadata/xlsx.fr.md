...
draft: false
path: "fr/redaction/net/metadata /xlsx/"
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document XLSX en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier XLSX"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier XLSX via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de xlsx_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
