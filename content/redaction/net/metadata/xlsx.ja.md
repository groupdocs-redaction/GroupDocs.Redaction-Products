...
draft: false
path: "ja/redaction/net/metadata /xlsx/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでXLSXドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "XLSXファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でXLSXファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "XLSXファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
