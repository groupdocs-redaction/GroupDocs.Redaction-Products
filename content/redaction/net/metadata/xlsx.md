...
draft: false
path: "redaction/net/metadata /xlsx"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from XLSX Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to XLSX File"
      content_right: |
    ...
    - title_left: "Redact Metadata from XLSX File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from XLSX Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
