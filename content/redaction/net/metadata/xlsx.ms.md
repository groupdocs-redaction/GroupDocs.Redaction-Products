...
draft: false
path: "ms/redaction/net/metadata/xlsx"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada XLSX Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail XLSX."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada XLSX Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada XLSX Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
