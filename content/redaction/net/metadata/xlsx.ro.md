...
draft: false
path: "ro/redaction/net/metadata/xlsx"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul XLSX din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul XLSX"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul XLSX prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere XLSX"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
