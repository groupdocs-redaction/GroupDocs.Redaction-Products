...
draft: false
path: "sl/redaction/net/metadata/xlsx"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta XLSX v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za XLSX datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke XLSX prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek XLSX"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
