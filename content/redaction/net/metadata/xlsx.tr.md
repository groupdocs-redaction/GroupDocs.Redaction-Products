...
draft: false
path: "tr/redaction/net/metadata/xlsx"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki XLSX Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "XLSX Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "XLSX Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "XLSX Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
