...
draft: false
path: "ms/redaction/net/metadata/xlt"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada XLT Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail XLT."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada XLT Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada XLT Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
