...
draft: false
path: "sk/redaction/net/metadata/xlt"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z XLT dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor XLT"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru XLT cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov XLT"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
