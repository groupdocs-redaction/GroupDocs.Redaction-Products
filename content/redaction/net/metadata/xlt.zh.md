...
draft: false
path: "zh/redaction/net/metadata/xlt"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from XLT Document in C#"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to XLT File"
      content_right: |
    ...
    - title_left: "Redact Metadata from XLT File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from XLT Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
