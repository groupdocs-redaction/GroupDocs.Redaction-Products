...
draft: false
path: "de/redaction/net/metadata /xltm/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem XLTM-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei XLTM anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der XLTM-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus XLTM-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
