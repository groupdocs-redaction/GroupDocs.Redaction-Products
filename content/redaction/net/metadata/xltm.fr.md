...
draft: false
path: "fr/redaction/net/metadata /xltm/"
otherformats: PDF DOC DOT DOCX DOCM DOTX DOTM RTF XLSX XLSM XLTX XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM PPSM POTM JPEG TIFF PNG BMP GIF 
...
steps:
    enable: true
    block:
    - title_left: "Comment nettoyer les métadonnées du document XLTM en Java"
      content_left: |
      ...
      title_right: "Appliquer la suppression des métadonnées au fichier XLTM"
      content_right: |
    ...
    - title_left: "Masquer les métadonnées du fichier XLTM via .NET"
      content_left: |
      ...
      title_right: "Suppression des métadonnées à partir de xltm_fichiers UPPER"
      content_right: |
        * Créer une instance de la classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
