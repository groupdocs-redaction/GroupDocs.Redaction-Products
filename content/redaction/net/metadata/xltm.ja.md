...
draft: false
path: "ja/redaction/net/metadata /xltm/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでXLTMドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "XLTMファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でXLTMファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "XLTMファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
