...
draft: false
path: "redaction/net/metadata /xltm"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from XLTM Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to XLTM File"
      content_right: |
    ...
    - title_left: "Redact Metadata from XLTM File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from XLTM Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
