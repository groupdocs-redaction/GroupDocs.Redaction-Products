...
draft: false
path: "sk/redaction/net/metadata/xltm"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z XLTM dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor XLTM"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru XLTM cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov XLTM"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
