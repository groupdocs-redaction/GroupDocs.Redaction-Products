...
draft: false
path: "de/redaction/net/metadata /xltx/"
...
steps:
    enable: true
    block:
    - title_left: "So bereinigen Sie Metadaten aus dem XLTX-Dokument in Java"
      content_left: |
      ...
      title_right: "Metadatenschwärzung auf Datei XLTX anwenden"
      content_right: |
    ...
    - title_left: "Entfernen Sie Metadaten aus der XLTX-Datei über .NET"
      content_left: |
      ...
      title_right: "Metadatenschwärzung aus XLTX-Dateien"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor).
