...
draft: false
path: "es/redaction/net/metadata /xltx/"
...
steps:
    enable: true
    block:
    - title_left: "Cómo limpiar metadatos del documento XLTX en Java"
      content_left: |
      ...
      title_right: "Aplicar redacción de metadatos al archivo XLTX"
      content_right: |
    ...
    - title_left: "Redactar metadatos del archivo XLTX a través de .NET"
      content_left: |
      ...
      title_right: "Redacción de metadatos de archivos XLTX"
      content_right: |
        * Cree una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
