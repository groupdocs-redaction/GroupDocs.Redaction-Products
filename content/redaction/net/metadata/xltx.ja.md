...
draft: false
path: "ja/redaction/net/metadata /xltx/"
...
steps:
    enable: true
    block:
    - title_left: "JavaでXLTXドキュメントからメタデータを削除する方法"
      content_left: |
      ...
      title_right: "XLTXファイルにメタデータ編集を適用する"
      content_right: |
    ...
    - title_left: ".NET経由でXLTXファイルからメタデータを編集"
      content_left: |
      ...
      title_right: "XLTXファイルからのメタデータ編集"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) クラスのインスタンスを作成します
