...
draft: false
path: "redaction/net/metadata /xltx"
...
steps:
    enable: true
    block:
    - title_left: "How to Clean Metadata from XLTX Document in Java"
      content_left: |
      ...
      title_right: "Apply Metadata Redaction to XLTX File"
      content_right: |
    ...
    - title_left: "Redact Metadata from XLTX File via .NET"
      content_left: |
      ...
      title_right: "Metadata Redaction from XLTX Files"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) class 
