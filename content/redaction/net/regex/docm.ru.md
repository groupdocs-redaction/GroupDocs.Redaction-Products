...
steps:
    enable: true
    title_left: "Редактировать текст из DOCM с помощью регулярных выражений через C#"
    content_left: |
