...
steps:
    enable: true
    title_left: "Відредагуйте текст із DOCM за допомогою регулярних виразів через C#"
    content_left: |
