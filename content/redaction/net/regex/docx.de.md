...
############################# Header ############################
title: "Bereinigen Sie DOCX-Dateien über C# und reguläre Ausdrücke in .NET-Kernanwendungen"
...
steps:
    enable: true
    title_left: "Text aus DOCX mithilfe regulärer Ausdrücke über C# schwärzen"
    content_left: |
