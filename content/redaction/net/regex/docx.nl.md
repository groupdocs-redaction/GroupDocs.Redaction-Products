...
############################# Header ############################
title: "Schoon DOCX bestanden op via C# en reguliere expressies in .NET kernapps"
...
steps:
    enable: true
    title_left: "Tekst uit DOCX redigeren met reguliere expressies via C#"
    content_left: |
