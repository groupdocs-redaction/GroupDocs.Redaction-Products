...
steps:
    enable: true
    title_left: "Редактировать текст из DOCX с помощью регулярных выражений через C#"
    content_left: |
