...
steps:
    enable: true
    title_left: "Відредагуйте текст із DOCX за допомогою регулярних виразів через C#"
    content_left: |
