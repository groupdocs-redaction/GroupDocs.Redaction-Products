...
############################# Header ############################
title: "Schoon DOT bestanden op via C# en reguliere expressies in .NET kernapps"
...
steps:
    enable: true
    title_left: "Tekst uit DOT redigeren met reguliere expressies via C#"
    content_left: |
