...
steps:
    enable: true
    title_left: "Редактировать текст из DOT с помощью регулярных выражений через C#"
    content_left: |
