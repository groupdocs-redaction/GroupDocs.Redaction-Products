...
steps:
    enable: true
    title_left: "Редактировать текст из DOTM с помощью регулярных выражений через C#"
    content_left: |
