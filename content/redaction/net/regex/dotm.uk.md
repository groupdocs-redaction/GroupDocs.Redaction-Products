...
steps:
    enable: true
    title_left: "Відредагуйте текст із DOTM за допомогою регулярних виразів через C#"
    content_left: |
