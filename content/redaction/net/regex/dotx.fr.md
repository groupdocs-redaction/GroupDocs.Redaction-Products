...
draft: false
path: "fr/redaction/net/regex/dotx"
otherformats: CSV DOC DOCM DOCX DOT DOTM PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Masquer DOTX documents à l'aide d'expressions régulières via .NET Core"
...
############################# Header ############################
title: "Nettoyer les fichiers DOTX via C# et les expressions régulières dans les applications principales .NET"
...
steps:
    enable: true
    title_left: "Masquer le texte de DOTX à l'aide d'expressions régulières via C#"
    content_left: |
