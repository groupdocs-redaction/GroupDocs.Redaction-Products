...
steps:
    enable: true
    title_left: "Редактировать текст из DOTX с помощью регулярных выражений через C#"
    content_left: |
