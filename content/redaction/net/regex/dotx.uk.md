...
steps:
    enable: true
    title_left: "Відредагуйте текст із DOTX за допомогою регулярних виразів через C#"
    content_left: |
