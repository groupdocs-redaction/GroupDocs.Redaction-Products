...
steps:
    enable: true
    title_left: "Редактировать текст из PDF с помощью регулярных выражений через C#"
    content_left: |
