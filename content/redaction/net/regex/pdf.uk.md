...
steps:
    enable: true
    title_left: "Відредагуйте текст із PDF за допомогою регулярних виразів через C#"
    content_left: |
