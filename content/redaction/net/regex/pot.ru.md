...
steps:
    enable: true
    title_left: "Редактировать текст из POT с помощью регулярных выражений через C#"
    content_left: |
