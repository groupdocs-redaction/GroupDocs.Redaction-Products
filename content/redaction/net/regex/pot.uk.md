...
steps:
    enable: true
    title_left: "Відредагуйте текст із POT за допомогою регулярних виразів через C#"
    content_left: |
