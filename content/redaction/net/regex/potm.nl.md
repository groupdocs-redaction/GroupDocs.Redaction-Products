...
############################# Header ############################
title: "Schoon POTM bestanden op via C# en reguliere expressies in .NET kernapps"
...
steps:
    enable: true
    title_left: "Tekst uit POTM redigeren met reguliere expressies via C#"
    content_left: |
