...
steps:
    enable: true
    title_left: "Редактировать текст из POTM с помощью регулярных выражений через C#"
    content_left: |
