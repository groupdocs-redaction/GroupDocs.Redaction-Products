...
steps:
    enable: true
    title_left: "Відредагуйте текст із PPS за допомогою регулярних виразів через C#"
    content_left: |
