...
steps:
    enable: true
    title_left: "Редактировать текст из PPSM с помощью регулярных выражений через C#"
    content_left: |
