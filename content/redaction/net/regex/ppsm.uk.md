...
steps:
    enable: true
    title_left: "Відредагуйте текст із PPSM за допомогою регулярних виразів через C#"
    content_left: |
