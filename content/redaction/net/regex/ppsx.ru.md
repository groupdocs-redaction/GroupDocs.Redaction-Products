...
steps:
    enable: true
    title_left: "Редактировать текст из PPSX с помощью регулярных выражений через C#"
    content_left: |
