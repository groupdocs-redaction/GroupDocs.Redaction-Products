...
steps:
    enable: true
    title_left: "Відредагуйте текст із PPSX за допомогою регулярних виразів через C#"
    content_left: |
