...
############################# Header ############################
title: "Bereinigen Sie PPT-Dateien über C# und reguläre Ausdrücke in .NET-Kernanwendungen"
...
steps:
    enable: true
    title_left: "Text aus PPT mithilfe regulärer Ausdrücke über C# schwärzen"
    content_left: |
