...
steps:
    enable: true
    title_left: "Редактировать текст из PPT с помощью регулярных выражений через C#"
    content_left: |
