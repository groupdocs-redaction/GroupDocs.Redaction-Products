...
############################# Header ############################
title: "Bereinigen Sie PPTM-Dateien über C# und reguläre Ausdrücke in .NET-Kernanwendungen"
...
steps:
    enable: true
    title_left: "Text aus PPTM mithilfe regulärer Ausdrücke über C# schwärzen"
    content_left: |
