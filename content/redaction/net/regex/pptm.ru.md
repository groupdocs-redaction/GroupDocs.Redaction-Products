...
steps:
    enable: true
    title_left: "Редактировать текст из PPTM с помощью регулярных выражений через C#"
    content_left: |
