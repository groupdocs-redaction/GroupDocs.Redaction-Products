...
steps:
    enable: true
    title_left: "Відредагуйте текст із PPTM за допомогою регулярних виразів через C#"
    content_left: |
