...
draft: false
path: "fr/redaction/net/regex/pptx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Masquer PPTX documents à l'aide d'expressions régulières via .NET Core"
...
############################# Header ############################
title: "Nettoyer les fichiers PPTX via C# et les expressions régulières dans les applications principales .NET"
...
steps:
    enable: true
    title_left: "Masquer le texte de PPTX à l'aide d'expressions régulières via C#"
    content_left: |
