...
############################# Header ############################
title: "Schoon XLS bestanden op via C# en reguliere expressies in .NET kernapps"
...
steps:
    enable: true
    title_left: "Tekst uit XLS redigeren met reguliere expressies via C#"
    content_left: |
