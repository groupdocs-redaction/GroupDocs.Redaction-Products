...
steps:
    enable: true
    title_left: "Редактировать текст из XLS с помощью регулярных выражений через C#"
    content_left: |
