...
steps:
    enable: true
    title_left: "Відредагуйте текст із XLS за допомогою регулярних виразів через C#"
    content_left: |
