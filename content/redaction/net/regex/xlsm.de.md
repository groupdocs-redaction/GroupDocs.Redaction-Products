...
############################# Header ############################
title: "Bereinigen Sie XLSM-Dateien über C# und reguläre Ausdrücke in .NET-Kernanwendungen"
...
steps:
    enable: true
    title_left: "Text aus XLSM mithilfe regulärer Ausdrücke über C# schwärzen"
    content_left: |
