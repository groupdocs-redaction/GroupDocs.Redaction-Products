...
############################# Header ############################
title: "Schoon XLSM bestanden op via C# en reguliere expressies in .NET kernapps"
...
steps:
    enable: true
    title_left: "Tekst uit XLSM redigeren met reguliere expressies via C#"
    content_left: |
