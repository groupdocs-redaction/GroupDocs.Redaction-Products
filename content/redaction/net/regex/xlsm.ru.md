...
steps:
    enable: true
    title_left: "Редактировать текст из XLSM с помощью регулярных выражений через C#"
    content_left: |
