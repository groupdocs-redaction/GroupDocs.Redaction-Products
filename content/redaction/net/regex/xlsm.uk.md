...
steps:
    enable: true
    title_left: "Відредагуйте текст із XLSM за допомогою регулярних виразів через C#"
    content_left: |
