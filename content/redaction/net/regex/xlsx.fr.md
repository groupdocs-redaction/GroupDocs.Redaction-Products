...
layout: "autogen"
draft: false
path: "fr/redaction/net/regex/xlsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLT XLTM XLTX  

############################# Head ############################
head_title: "Masquer XLSX documents à l'aide d'expressions régulières via .NET Core"
...
############################# Header ############################
title: "Nettoyer les fichiers XLSX via C# et les expressions régulières dans les applications principales .NET"
...
steps:
    enable: true
    title_left: "Masquer le texte de XLSX à l'aide d'expressions régulières via C#"
    content_left: |
