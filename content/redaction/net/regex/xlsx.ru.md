...
steps:
    enable: true
    title_left: "Редактировать текст из XLSX с помощью регулярных выражений через C#"
    content_left: |
