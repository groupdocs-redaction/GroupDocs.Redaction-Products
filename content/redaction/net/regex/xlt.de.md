...
############################# Header ############################
title: "Bereinigen Sie XLT-Dateien über C# und reguläre Ausdrücke in .NET-Kernanwendungen"
...
steps:
    enable: true
    title_left: "Text aus XLT mithilfe regulärer Ausdrücke über C# schwärzen"
    content_left: |
