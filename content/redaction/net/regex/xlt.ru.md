...
steps:
    enable: true
    title_left: "Редактировать текст из XLT с помощью регулярных выражений через C#"
    content_left: |
