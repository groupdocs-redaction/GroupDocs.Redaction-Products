...
steps:
    enable: true
    title_left: "Редактировать текст из XLTM с помощью регулярных выражений через C#"
    content_left: |
