...
steps:
    enable: true
    title_left: "Відредагуйте текст із XLTM за допомогою регулярних виразів через C#"
    content_left: |
