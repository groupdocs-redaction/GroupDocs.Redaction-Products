...
steps:
    enable: true
    title_left: "Редактировать текст из XLTX с помощью регулярных выражений через C#"
    content_left: |
