...
steps:
    enable: true
    title_left: "Відредагуйте текст із XLTX за допомогою регулярних виразів через C#"
    content_left: |
