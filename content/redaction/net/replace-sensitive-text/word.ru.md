...
############################# Head ############################
head_title: "Удалите частный текст из WORD с помощью C#"
head_description: "Сохраняйте ваши файлы WORD конфиденциальными с помощью GroupDocs.Redaction for .NET и C#. Быстрый и простой способ редактирования текста."

############################# Header ############################
title: "Найдите и удалите конфиденциальный текст в файлах WORD с помощью .NET" 
...
about:
    ...
    content: |
       GroupDocs.Redaction for .NET предоставляет пользователям C# инструменты для очистки документов WORD. Редактируйте текст, изображения, заметки и фоновую информацию.

############################# Steps ############################
steps:
    enable: true
    title: "Как редактировать файлы Word"
    content: |
      С помощью GroupDocs.Redaction for .NET легко находить и заменять частное содержание в приложениях .NET.
      
      1. Создайте Redactor и откройте ваш файл Word.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Шаги для редактирования содержимого в документе WORD
        ...
        using (Redactor redactor  = new Redactor("input.docx"))
        {
            ...
            // Запустите редактирование и сохраните ваш новый файл WORD
...
more_formats:
    enable: true
    title: "Как редактировать WORD с помощью .NET"
    exclude: "WORD"
    description: "Используйте .NET для очистки файлов WORD. Держите ваш контент конфиденциальным и защищенным от утечек."
    items: 
        # format loop 1
