...
############################# Header ############################
title: "Redactați fișierele CSV prin C# în .NET Core Apps"
description: "Căutați și înlocuiți text în documente Office și OpenOffice, foi de calcul și prezentări, precum și CSV pe Windows, Linux și macOS"
...
steps:
    enable: true
    title_left: "Redactați textul exact din CSV prin C#"
    content_left: |
        [GroupDocs.Redaction](ro//redaction/net/) facilitează pentru .NET dezvoltatorii să adauge CSV funcția de redactare a fișierelor cu câțiva pași simpli.
