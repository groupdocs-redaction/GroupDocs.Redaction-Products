...
############################# Head ############################
head_title: "Redact Sensitive Information from DOCM Documents via .NET Core"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](ms//redaction/net/) makes it easy for .NET developers to add DOCM file redaction feature with a few easy steps.
