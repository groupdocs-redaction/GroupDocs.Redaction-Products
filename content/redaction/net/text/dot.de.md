...
draft: false
path: "de/redaction/net/text/dot/"
...
############################# Header ############################
title: "Schwärzen Sie DOT-Dateien über C# in .NET Core-Apps"
description: "Suchen und ersetzen Sie Text in Office- und OpenOffice-Dokumenten, -Tabellen und -Präsentationen sowie dot_ UPPER unter Windows, Linux und macOS"
...
steps:
    enable: true
    block:
    - title_left: "Exakten Text von DOT über C# schwärzen"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) erleichtert .NET-Entwicklern das Hinzufügen der DOT-Dateischwärzungsfunktion in wenigen einfachen Schritten.
