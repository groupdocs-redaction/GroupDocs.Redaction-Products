...
draft: false
path: "sl/redaction/net/text/dot"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](sl//redaction/net/) makes it easy for .NET developers to add DOT file redaction feature with a few easy steps.
