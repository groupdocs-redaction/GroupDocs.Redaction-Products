...
draft: false
path: "tr/redaction/net/text/dot"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](tr//redaction/net/) makes it easy for .NET developers to add DOT file redaction feature with a few easy steps.
