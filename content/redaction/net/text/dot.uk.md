...
draft: false
path: "uk/redaction/net/text/dot"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](uk//redaction/net/) makes it easy for .NET developers to add DOT file redaction feature with a few easy steps.
