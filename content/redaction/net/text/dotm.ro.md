...
############################# Header ############################
title: "Redactați fișierele DOTM prin C# în .NET Core Apps"
description: "Căutați și înlocuiți text în documente Office și OpenOffice, foi de calcul și prezentări, precum și DOTM pe Windows, Linux și macOS"
...
steps:
    enable: true
    title_left: "Redactați textul exact din DOTM prin C#"
    content_left: |
        [GroupDocs.Redaction](ro//redaction/net/) facilitează pentru .NET dezvoltatorii să adauge DOTM funcția de redactare a fișierelor cu câțiva pași simpli.
