...
draft: false
path: "uk/redaction/net/text/dotm"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](uk//redaction/net/) makes it easy for .NET developers to add DOTM file redaction feature with a few easy steps.
