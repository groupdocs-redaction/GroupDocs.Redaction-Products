...
draft: false
path: "de/redaction/net/text/pdf/"
...
############################# Header ############################
title: "Schwärzen Sie PDF-Dateien über C# in .NET Core-Apps"
description: "Suchen und ersetzen Sie Text in Office- und OpenOffice-Dokumenten, -Tabellen und -Präsentationen sowie pdf_ UPPER unter Windows, Linux und macOS"
...
steps:
    enable: true
    block:
    - title_left: "Exakten Text von PDF über C# schwärzen"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) erleichtert .NET-Entwicklern das Hinzufügen der PDF-Dateischwärzungsfunktion in wenigen einfachen Schritten.
