...
draft: false
path: "de/redaction/net/text/pps/"
...
############################# Header ############################
title: "Schwärzen Sie PPS-Dateien über C# in .NET Core-Apps"
description: "Suchen und ersetzen Sie Text in Office- und OpenOffice-Dokumenten, -Tabellen und -Präsentationen sowie pps_ UPPER unter Windows, Linux und macOS"
...
steps:
    enable: true
    block:
    - title_left: "Exakten Text von PPS über C# schwärzen"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) erleichtert .NET-Entwicklern das Hinzufügen der PPS-Dateischwärzungsfunktion in wenigen einfachen Schritten.
