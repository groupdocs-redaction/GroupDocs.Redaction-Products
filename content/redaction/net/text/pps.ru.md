...
description: "Поиск и замена текста в документах, электронных таблицах и презентациях Office и OpenOffice, а также pps_ UPPER в Windows, Linux и macOS"
...
steps:
    ...
    - title_left: "Редактировать точный текст из PPS с помощью C#"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) позволяет разработчикам .NET добавить функцию редактирования файлов PPS, выполнив несколько простых действий.
