...
draft: false
path: "fr/redaction/net/text/ppsm/"
otherformats: PDF DOC DOT DOCX DOCM DOTX DOTM RTF XLSX XLSM XLTX XLTM XLS XLT CSV PPT PPTX  PPS POT PPSX PPTM POTM 
...
############################# Header ############################
title: "Masquer les fichiers PPSM via C# dans les applications .NET Core"
description: "Rechercher et remplacer du texte dans des documents, feuilles de calcul et présentations Office et OpenOffice, ainsi que ppsm_ UPPER sous Windows, Linux et macOS"
...
steps:
    enable: true
    block:
    - title_left: "Masquer le texte exact de PPSM via C#"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) permet aux développeurs .NET d'ajouter facilement la fonctionnalité de masquage de fichiers PPSM en quelques étapes simples.
