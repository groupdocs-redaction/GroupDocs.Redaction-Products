...
layout: "autogen"
draft: false
path: "redaction/net/text/ppsm"
otherformats: PPTX PPSX DOC RTF PPSM CSV DOTX DOCM XLT XLSX XLSM DOTM  
...
title: "Redact File PPSM melalui C# di .NET Core Apps"
description: "Cari & Ganti Teks di Dokumen Office & OpenOffice, Spreadsheet & Presentasi serta PPSM di Windows, Linux & macOS"
...
steps:
    enable: true
    title_left: "Redact Teks Tepat dari PPSM melalui C#"
    content_left: |
        [GroupDocs.Redaction](/id/redaction/net/) memudahkan pengembang .NET untuk menambahkan fitur redaksi file PPSM dengan beberapa langkah mudah.

        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & muat file PPSM
