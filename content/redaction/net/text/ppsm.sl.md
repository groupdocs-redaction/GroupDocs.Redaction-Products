...
############################# Header ############################
title: "Uredite PPSM datoteke prek C# v .NET osnovnih aplikacijah"
description: "Iskanje in zamenjava besedila v dokumentih Office in OpenOffice, preglednicah in predstavitvah ter PPSM v Windows, Linux in macOS"
...
steps:
    enable: true
    title_left: "Uredi natančno besedilo iz PPSM prek C#"
    content_left: |
        [GroupDocs.Redaction](sl//redaction/net/) razvijalcem .NET olajša dodajanje funkcije za urejanje datotek PPSM z nekaj preprostimi koraki.
