...
draft: false
path: "fr/redaction/net/text/ppsx/"
...
############################# Header ############################
title: "Masquer les fichiers PPSX via C# dans les applications .NET Core"
description: "Rechercher et remplacer du texte dans des documents, feuilles de calcul et présentations Office et OpenOffice, ainsi que ppsx_ UPPER sous Windows, Linux et macOS"
...
steps:
    enable: true
    block:
    - title_left: "Masquer le texte exact de PPSX via C#"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) permet aux développeurs .NET d'ajouter facilement la fonctionnalité de masquage de fichiers PPSX en quelques étapes simples.
