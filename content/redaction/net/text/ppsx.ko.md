...
draft: false
path: "ko/redaction/net/text/ppsx"
...
############################# Header ############################
title: ".NET Core 앱에서 C#을 통해 PPSX 파일 수정"
description: "Office 및 OpenOffice 문서, 스프레드시트 및 프레젠테이션의 텍스트 검색 및 바꾸기 및 Windows, Linux 및 macOS에서 ppsx_ UPPER"
...
steps:
    enable: true
    block:
    - title_left: "C#을 통해 PPSX에서 정확한 텍스트 수정"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/)을 사용하면 .NET 개발자가 몇 가지 간단한 단계를 통해 PPSX 파일 수정 기능을 쉽게 추가할 수 있습니다.
