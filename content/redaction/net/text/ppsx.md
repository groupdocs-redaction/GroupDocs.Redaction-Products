...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](/redaction/net/) makes it easy for .NET developers to add PPSX file redaction feature with a few easy steps.
