...
draft: false
path: "tr/redaction/net/text/ppsx"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](tr//redaction/net/) makes it easy for .NET developers to add PPSX file redaction feature with a few easy steps.
