...
############################# Header ############################
title: "Bewerk PPT bestanden via C# in .NET Core-apps"
description: "Zoek en vervang tekst in Office- en OpenOffice-documenten, -spreadsheets en -presentaties en in PPT op Windows, Linux en macOS"
...
steps:
    enable: true
    title_left: "Bewerk exacte tekst van PPT via C#"
    content_left: |
        [GroupDocs.Redaction](nl//redaction/net/) maakt het gemakkelijk voor .NET ontwikkelaars om PPT de functie voor het redigeren van bestanden toe te voegen in een paar eenvoudige stappen.
