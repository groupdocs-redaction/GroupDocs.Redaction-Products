...
description: "Поиск и замена текста в документах, электронных таблицах и презентациях Office и OpenOffice, а также ppt_ UPPER в Windows, Linux и macOS"
...
steps:
    ...
    - title_left: "Редактировать точный текст из PPT с помощью C#"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) позволяет разработчикам .NET добавить функцию редактирования файлов PPT, выполнив несколько простых действий.
