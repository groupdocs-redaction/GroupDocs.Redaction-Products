...
layout: "autogen"
draft: false
path: "ms/redaction/net/text/pptm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Sunting Maklumat Sensitif daripada PPTM Dokumen melalui .NET Teras"
head_description: "Guna redaksi teks menggunakan frasa tepat atau ungkapan biasa untuk dokumen dengan format yang berbeza"

############################# Header ############################
title: "Redaksi PPTM Fail melalui C# dalam .NET Apl Teras"
description: "Cari & Gantikan Teks dalam Dokumen Office & OpenOffice, Hamparan & Pembentangan serta PPTM pada Windows, Linux & macOS"
...
steps:
    enable: true
    title_left: "Sunting Teks Tepat daripada PPTM melalui C#"
    content_left: |
        [GroupDocs.Redaction](ms//redaction/net/) memudahkan .NET pembangun menambahkan PPTM ciri redaksi fail dengan beberapa langkah mudah.
