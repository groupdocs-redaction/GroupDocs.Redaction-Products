...
draft: false
path: "it/redaction/net/text/rtf"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](it//redaction/net/) makes it easy for .NET developers to add RTF file redaction feature with a few easy steps.
