...
draft: false
path: "nl/redaction/net/text/rtf"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](nl//redaction/net/) makes it easy for .NET developers to add RTF file redaction feature with a few easy steps.
