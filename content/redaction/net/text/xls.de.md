...
draft: false
path: "de/redaction/net/text/xls/"
...
############################# Header ############################
title: "Schwärzen Sie XLS-Dateien über C# in .NET Core-Apps"
description: "Suchen und ersetzen Sie Text in Office- und OpenOffice-Dokumenten, -Tabellen und -Präsentationen sowie xls_ UPPER unter Windows, Linux und macOS"
...
steps:
    enable: true
    block:
    - title_left: "Exakten Text von XLS über C# schwärzen"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) erleichtert .NET-Entwicklern das Hinzufügen der XLS-Dateischwärzungsfunktion in wenigen einfachen Schritten.
