...
############################# Head ############################
head_title: "Bewerk gevoelige informatie uit XLS-documenten via .NET Core"
...
############################# Header ############################
title: "Bewerk XLS bestanden via C# in .NET Core-apps"
description: "Zoek en vervang tekst in Office- en OpenOffice-documenten, -spreadsheets en -presentaties en in XLS op Windows, Linux en macOS"
...
steps:
    enable: true
    title_left: "Bewerk exacte tekst van XLS via C#"
    content_left: |
        [GroupDocs.Redaction](nl//redaction/net/) maakt het gemakkelijk voor .NET ontwikkelaars om XLS de functie voor het redigeren van bestanden toe te voegen in een paar eenvoudige stappen.
