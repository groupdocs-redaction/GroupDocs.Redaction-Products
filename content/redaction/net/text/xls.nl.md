...
draft: false
path: "nl/redaction/net/text/xls"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](nl//redaction/net/) makes it easy for .NET developers to add XLS file redaction feature with a few easy steps.
