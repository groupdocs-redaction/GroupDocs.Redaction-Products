...
draft: false
path: "ro/redaction/net/text/xls"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redact Sensitive Information from XLS Documents via .NET Core"
head_description: "Apply text redaction using exact phrase or regular expression for documents of different formats"

############################# Header ############################
title: "Redact XLS Files via C# in .NET Core Apps"
description: "Search & Replace Text in Office & OpenOffice Documents, Spreadsheets & Presentations as well as XLS on Windows, Linux & macOS"
...
steps:
    enable: true
    title_left: "Redact Exact Text from XLS via C#"
    content_left: |
        [GroupDocs.Redaction](ro//redaction/net/) makes it easy for .NET developers to add XLS file redaction feature with a few easy steps.
