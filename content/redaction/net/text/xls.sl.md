...
draft: false
path: "sl/redaction/net/text/xls"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](sl//redaction/net/) makes it easy for .NET developers to add XLS file redaction feature with a few easy steps.
