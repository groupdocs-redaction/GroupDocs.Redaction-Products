...
draft: false
path: "uk/redaction/net/text/xls"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](uk//redaction/net/) makes it easy for .NET developers to add XLS file redaction feature with a few easy steps.
