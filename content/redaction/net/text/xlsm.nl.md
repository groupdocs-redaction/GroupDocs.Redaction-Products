...
############################# Header ############################
title: "Bewerk XLSM bestanden via C# in .NET Core-apps"
description: "Zoek en vervang tekst in Office- en OpenOffice-documenten, -spreadsheets en -presentaties en in XLSM op Windows, Linux en macOS"
...
steps:
    enable: true
    title_left: "Bewerk exacte tekst van XLSM via C#"
    content_left: |
        [GroupDocs.Redaction](nl//redaction/net/) maakt het gemakkelijk voor .NET ontwikkelaars om XLSM de functie voor het redigeren van bestanden toe te voegen in een paar eenvoudige stappen.
