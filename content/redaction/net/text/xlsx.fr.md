...
draft: false
path: "fr/redaction/net/text/xlsx/"
...
############################# Header ############################
title: "Masquer les fichiers XLSX via C# dans les applications .NET Core"
description: "Rechercher et remplacer du texte dans des documents, feuilles de calcul et présentations Office et OpenOffice, ainsi que xlsx_ UPPER sous Windows, Linux et macOS"
...
steps:
    enable: true
    block:
    - title_left: "Masquer le texte exact de XLSX via C#"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) permet aux développeurs .NET d'ajouter facilement la fonctionnalité de masquage de fichiers XLSX en quelques étapes simples.
