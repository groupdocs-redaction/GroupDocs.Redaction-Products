...
############################# Head ############################
head_title: "Redact Sensitive Information from XLT Documents via .NET Core"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](uk//redaction/net/) makes it easy for .NET developers to add XLT file redaction feature with a few easy steps.
