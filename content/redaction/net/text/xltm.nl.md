...
draft: false
path: "nl/redaction/net/text/xltm"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](nl//redaction/net/) makes it easy for .NET developers to add XLTM file redaction feature with a few easy steps.
