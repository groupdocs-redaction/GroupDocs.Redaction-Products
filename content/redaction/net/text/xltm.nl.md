...
############################# Head ############################
head_title: "Bewerk gevoelige informatie uit XLTM-documenten via .NET Core"
...
############################# Header ############################
title: "Bewerk XLTM bestanden via C# in .NET Core-apps"
description: "Zoek en vervang tekst in Office- en OpenOffice-documenten, -spreadsheets en -presentaties en in XLTM op Windows, Linux en macOS"
...
steps:
    enable: true
    title_left: "Bewerk exacte tekst van XLTM via C#"
    content_left: |
        [GroupDocs.Redaction](nl//redaction/net/) maakt het gemakkelijk voor .NET ontwikkelaars om XLTM de functie voor het redigeren van bestanden toe te voegen in een paar eenvoudige stappen.
