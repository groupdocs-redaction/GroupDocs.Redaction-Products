...
draft: false
path: "tr/redaction/net/text/xltm"
...
steps:
    ...
    content_left: |
        [GroupDocs.Redaction](tr//redaction/net/) makes it easy for .NET developers to add XLTM file redaction feature with a few easy steps.
