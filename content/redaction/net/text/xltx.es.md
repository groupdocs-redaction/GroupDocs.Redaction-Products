...
draft: false
path: "es/redaction/net/text/xltx/"
...
############################# Header ############################
title: "Redactar archivos XLTX a través de C# en aplicaciones .NET Core"
description: "Buscar y reemplazar texto en documentos, hojas de cálculo y presentaciones de Office y OpenOffice, así como XLTX en Windows, Linux y macOS"
...
steps:
    enable: true
    block:
    - title_left: "Redactar texto exacto de XLTX a través de C#"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) facilita a los desarrolladores de .NET agregar la función de redacción de archivos XLTX con unos sencillos pasos.
