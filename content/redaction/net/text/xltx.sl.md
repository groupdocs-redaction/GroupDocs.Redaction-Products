...
############################# Header ############################
title: "Uredite XLTX datoteke prek C# v .NET osnovnih aplikacijah"
description: "Iskanje in zamenjava besedila v dokumentih Office in OpenOffice, preglednicah in predstavitvah ter XLTX v Windows, Linux in macOS"
...
steps:
    enable: true
    title_left: "Uredi natančno besedilo iz XLTX prek C#"
    content_left: |
        [GroupDocs.Redaction](sl//redaction/net/) razvijalcem .NET olajša dodajanje funkcije za urejanje datotek XLTX z nekaj preprostimi koraki.
