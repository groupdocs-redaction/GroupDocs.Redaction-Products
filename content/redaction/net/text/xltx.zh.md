...
draft: false
path: "zh/redaction/net/text/xltx"
...
############################# Header ############################
title: "在 .NET Core 应用程序中通过 C# 编辑 XLTX 文件"
...
steps:
    enable: true
    block:
    - title_left: "通过 C# 从 XLTX 编辑精确文本"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) 使 .NET 开发人员可以通过几个简单的步骤轻松添加 XLTX 文件编辑功能。 
