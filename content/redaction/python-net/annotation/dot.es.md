...
layout: "autogen"
draft: false
path: "es/redaction/net/annotation/dot"
otherformats: CSV DOC DOCM DOCX DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redactar anotaciones en documentos DOT usando expresiones regulares a través de .NET Core"
...
############################# Header ############################
title: "Redactar anotaciones de archivos DOT a través de C# y expresiones regulares en .NET aplicaciones principales"
...
steps:
    enable: true
    title_left: "Redactar anotaciones de DOT usando expresiones regulares a través de C#"
    content_left: |
