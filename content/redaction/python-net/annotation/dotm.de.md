...
layout: "autogen"
draft: false
path: "de/redaction/net/annotation/dotm"
otherformats: CSV DOC DOCM DOCX DOT DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Redigieren Sie Anmerkungen in DOTM-Dokumenten mit regulären Ausdrücken über .NET Core"
...
############################# Header ############################
title: "Redigieren Sie DOTM Dateianmerkungen über C# und reguläre Ausdrücke in .NET Core Apps"
...
steps:
    enable: true
    title_left: "Anmerkungen aus DOTM mithilfe regulärer Ausdrücke über C# schwärzen"
    content_left: |
