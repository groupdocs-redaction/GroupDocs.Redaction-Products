...
layout: "autogen"
draft: false
path: "it/redaction/net/annotation/xlsx"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLT XLTM XLTX  

############################# Head ############################
head_title: "Oscura le annotazioni nei documenti XLSX utilizzando le espressioni regolari tramite .NET Core"
...
############################# Header ############################
title: "Oscura XLSX le annotazioni dei file tramite C# e le espressioni regolari nelle .NET app principali"
...
steps:
    enable: true
    title_left: "Oscura le annotazioni da XLSX utilizzando le espressioni regolari tramite C#"
    content_left: |
