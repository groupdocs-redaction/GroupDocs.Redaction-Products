...
layout: "autogen"
draft: false
path: "ro/redaction/net/annotation/xltm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSM PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTX  

############################# Head ############################
head_title: "Redactați adnotările în XLTM documente folosind expresii regulate prin .NET Core"
...
############################# Header ############################
title: "Redactați XLTM Fișiere Adnotări prin C# și expresii regulate în .NET Aplicațiile de bază"
...
steps:
    enable: true
    title_left: "Redactați adnotările din XLTM folosind expresii regulate prin C#"
    content_left: |
