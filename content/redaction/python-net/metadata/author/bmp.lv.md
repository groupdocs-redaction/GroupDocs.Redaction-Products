...
draft: false
path: "lv/redaction/net/metadata/author/bmp"
...
############################# Header ############################
title: "Rediģēt autora vārdu no BMP metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt BMP Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no BMP dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadataFilter.author. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Autors”:
