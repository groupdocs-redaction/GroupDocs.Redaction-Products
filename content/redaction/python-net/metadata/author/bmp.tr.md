...
draft: false
path: "tr/redaction/net/metadata/author/bmp"
...
############################# Header ############################
title: "C# içindeki BMP Meta Verilerden Yazar Adını Redakt Edin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact BMP"
      content_left: |
        Aşağıdaki kod, BMP belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.Author. - “Author” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri bırakacaktır:
      ...
      content_right: |
        ...
        * Filtreyi ayarlayarak redaksiyon kapsamını ayarlayın, örn. Aşağıdaki kodda MetadataFilter.author kullanın
      ...
      gistfile: "RedactAuthorMetadata.cs dosyası"
