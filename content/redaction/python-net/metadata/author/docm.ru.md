...
draft: false
path: "ru/redaction/net/metadata/author/docm"
...
############################# Header ############################
title: "Редактировать имя автора из метаданных DOCM в C#"
