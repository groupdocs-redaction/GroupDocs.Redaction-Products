...
draft: false
path: "tr/redaction/net/metadata/author/docm"
...
############################# Header ############################
title: "C# içindeki DOCM Meta Verilerden Yazar Adını Redakt Edin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact DOCM"
      content_left: |
        Aşağıdaki kod, DOCM belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.Author. - “Author” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri bırakacaktır:
