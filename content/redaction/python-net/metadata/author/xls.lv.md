...
draft: false
path: "lv/redaction/net/metadata/author/xls"
...
############################# Header ############################
title: "Rediģēt autora vārdu no XLS metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLS Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLS dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadataFilter.author. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Autors”:
