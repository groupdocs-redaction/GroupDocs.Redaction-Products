...
draft: false
path: "lv/redaction/net/metadata/author/xltm"
...
############################# Header ############################
title: "Rediģēt autora vārdu no XLTM metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLTM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLTM dokumenta. Redakcijas jomu var iestatīt, iestatot filtru, piemēram, uz MetadataFilter.author. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Autors”:
