...
draft: false
path: "id/redaction/net/metadata/bmp"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen BMP di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File BMP"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File BMP melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari BMP File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
