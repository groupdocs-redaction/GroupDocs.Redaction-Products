...
draft: false
path: "ms/redaction/net/metadata/bmp"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada BMP Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail BMP."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada BMP Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada BMP Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
