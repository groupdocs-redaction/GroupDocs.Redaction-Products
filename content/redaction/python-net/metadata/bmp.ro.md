...
draft: false
path: "ro/redaction/net/metadata/bmp"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul BMP din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul BMP"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul BMP prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere BMP"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
