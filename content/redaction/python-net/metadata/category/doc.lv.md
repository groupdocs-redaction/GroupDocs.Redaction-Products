...
draft: false
path: "lv/redaction/net/metadata/category/doc"
...
############################# Head ############################
head_title: "Redakt sensitīvus metadatus no DOC dokumentiem C#"
head_description: "Lietot metadatu redakciju, lietojot filtrus dažāda formāta dokumentiem"

############################# Header ############################
title: "Realizēt kategorijas nosaukumu no DOC metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt DOC Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOC dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.category. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Kategorija”:
