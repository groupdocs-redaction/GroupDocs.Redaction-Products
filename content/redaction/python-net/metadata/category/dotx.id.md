...
draft: false
path: "id/redaction/net/metadata/category/dotx"
...
############################# Header ############################
title: "Redact Nama kategori dari DOTX Metadata di C#"
...
steps:
    ...
    - title_left: "Redaksi DOTX Metadata di C#"
      content_left: |
        Kode berikut memungkinkan Anda untuk mencari dan menyunting data sensitif dari dokumen DOTX. Anda dapat mengatur ruang lingkup untuk redaksi dengan mengatur filter, mis. ke MetadataFilter.Category. - itu akan membiarkan kecocokan ekspresi reguler dibatalkan di semua item metadata, kecuali properti "Kategori":
