...
draft: false
path: "ko/redaction/net/metadata/category/dotx"
...
############################# Header ############################
title: "C# 에 있는 DOTX 메타데이터에서 카테고리 이름 삭제"
