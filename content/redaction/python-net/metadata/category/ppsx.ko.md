...
draft: false
path: "ko/redaction/net/metadata/category/ppsx"
...
############################# Head ############################
head_title: "C# 에 있는 PPSX 개 문서에서 민감한 메타데이터 수정"
head_description: "다양한 형식의 문서에 필터를 적용하여 메타데이터 수정 적용"

############################# Header ############################
title: "C# 에 있는 PPSX 메타데이터에서 카테고리 이름 삭제"
...
steps:
    ...
    - title_left: "C# 에서 PPSX 메타데이터를 수정했습니다."
      ...
      content_right: |
        * [편집자](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) 클래스 인스턴스 생성 및 PPSX 파일 업로드
    ...
    - title_left: "C# 에서 PPSX 개의 메타데이터를 제거합니다."
      content_left: |
