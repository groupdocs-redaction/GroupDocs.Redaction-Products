...
draft: false
path: "es/redaction/net/metadata/category/xlsx"
...
############################# Head ############################
head_title: "Redacte metadatos confidenciales de XLSX documentos en C#"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de XLSX en C#"
...
steps:
    ...
    - title_left: "Redacte los metadatos de XLSX en C#"
      ...
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo XLSX
    ...
    - title_left: "Eliminar XLSX metadatos en C#"
      content_left: |
      ...
      title_right: "Borrar XLSX metadatos"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo XLSX
