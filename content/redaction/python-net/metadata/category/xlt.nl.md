...
draft: false
path: "nl/redaction/net/metadata/category/xlt"
...
############################# Header ############################
title: "Categorienaam redigeren uit XLT metagegevens in C#"
...
steps:
    ...
    - title_left: "XLT Metagegevens redigeren in C#"
      content_left: |
        Met de volgende code kunt u gevoelige gegevens in een XLT -document doorzoeken en redigeren. U kunt het bereik voor redactie instellen door een filter in te stellen, bijvoorbeeld op MetadataFilter.Category. - dan blijven de overeenkomsten met reguliere expressies ongedaan in alle metagegevensitems, met uitzondering van de eigenschap „Categorie”:
