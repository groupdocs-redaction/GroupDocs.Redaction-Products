...
draft: false
path: "ru/redaction/net/metadata/category/xlt"
...
############################# Header ############################
title: "Редактировать название категории из метаданных XLT в C#"
