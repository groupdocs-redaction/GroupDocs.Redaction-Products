...
draft: false
path: "es/redaction/net/metadata/category/xltm"
...
############################# Head ############################
head_title: "Redacte metadatos confidenciales de XLTM documentos en C#"
...
############################# Header ############################
title: "Redactar el nombre de la categoría de los metadatos de XLTM en C#"
...
steps:
    enable: true
    block:
    - title_left: "Redacte los metadatos de XLTM en C#"
      content_left: |
      ...
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo XLTM
    ...
    - title_left: "Eliminar XLTM metadatos en C#"
      content_left: |
      ...
      title_right: "Borrar XLTM metadatos"
      content_right: |
        * Crea una instancia de la clase [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) y sube el archivo XLTM
