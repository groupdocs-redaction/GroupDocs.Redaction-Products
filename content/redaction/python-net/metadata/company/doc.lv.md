...
draft: false
path: "lv/redaction/net/metadata/company/doc"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no DOC metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt DOC Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOC dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
