...
draft: false
path: "tr/redaction/net/metadata/company/docm"
...
############################# Head ############################
head_title: "C# içindeki DOCM Belgelerinden Hassas Meta Verileri Redakt Etme"
head_description: "Farklı biçimlerdeki belgeler için filtreler uygulayarak meta veri redaksiyonu uygulayın"

############################# Header ############################
title: "C# içindeki DOCM Meta Verilerden Şirket Adını Redakt Etme"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact DOCM"
      content_left: |
        Aşağıdaki kod, DOCM belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örneğin Metadatafilter.company. - “Company” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri bırakacaktır:
    ...
    - title_left: "C# içindeki DOCM Meta Verileri Kaldır"
      content_left: |
      ...
      title_right: "DOCM Meta Verileri Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun ve DOCM dosyasını yükleyin
