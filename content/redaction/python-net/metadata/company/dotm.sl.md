...
draft: false
path: "sl/redaction/net/metadata/company/dotm"
...
############################# Head ############################
head_title: "Spremenite občutljive metapodatke iz dokumentov DOTM v C#"
head_description: "Uporabite redigiranje metapodatkov z uporabo filtrov za dokumente različnih formatov"

############################# Header ############################
title: "Spremenite ime podjetja iz DOTM metapodatkov v C#"
...
steps:
    ...
    - title_left: "Uredij DOTM Metapodatke v C#"
      content_left: |
        Naslednja koda omogoča iskanje in redigiranje občutljivih podatkov iz dokumenta DOTM. Obseg za redigiranje lahko nastavite tako, da nastavite filter, npr. v Metadatafilter.Company. - ujemanja regularnih izrazov bo pustila razveljavljena v vseh metapodatkovnih elementih, razen lastnosti« Podjetje »:
