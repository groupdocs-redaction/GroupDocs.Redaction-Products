...
draft: false
path: "lv/redaction/net/metadata/company/pot"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no POT metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt POT Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no POT dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
