...
draft: false
path: "ms/redaction/net/metadata/company/potm"
...
############################# Header ############################
title: "Redact Nama Syarikat dari POTM Metadata dalam C#"
...
steps:
    ...
    - title_left: "Sunting POTM Metadata dalam C#"
      content_left: |
        Kod berikut membolehkan anda mencari dan menyunting data sensitif dari dokumen POTM. Anda boleh menetapkan skop untuk redaksi dengan menetapkan penapis, mis. Kepada MetadataFilter.company. - ia akan membiarkan padanan ungkapan biasa dibatalkan dalam semua item metadata, kecuali harta “Syarikat”:
