...
draft: false
path: "fr/redaction/net/metadata/company/pps"
...
############################# Header ############################
title: "Rédiger le nom de l'entreprise à partir des métadonnées PPS dans C#"
