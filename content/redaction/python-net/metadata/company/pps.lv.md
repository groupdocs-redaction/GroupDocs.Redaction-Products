...
draft: false
path: "lv/redaction/net/metadata/company/pps"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no PPS metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt PPS Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPS dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
