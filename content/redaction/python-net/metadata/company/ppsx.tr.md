...
draft: false
path: "tr/redaction/net/metadata/company/ppsx"
...
############################# Head ############################
head_title: "C# içindeki PPSX Belgelerinden Hassas Meta Verileri Redakt Etme"
head_description: "Farklı biçimlerdeki belgeler için filtreler uygulayarak meta veri redaksiyonu uygulayın"

############################# Header ############################
title: "C# içindeki PPSX Meta Verilerden Şirket Adını Redakt Etme"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact PPSX"
      content_left: |
        Aşağıdaki kod, PPSX belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örneğin Metadatafilter.company. - “Company” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri bırakacaktır:
