...
draft: false
path: "lv/redaction/net/metadata/company/pptm"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no PPTM metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt PPTM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no PPTM dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
