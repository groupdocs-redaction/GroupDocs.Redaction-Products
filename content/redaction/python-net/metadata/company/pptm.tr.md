...
draft: false
path: "tr/redaction/net/metadata/company/pptm"
...
############################# Head ############################
head_title: "C# içindeki PPTM Belgelerinden Hassas Meta Verileri Redakt Etme"
head_description: "Farklı biçimlerdeki belgeler için filtreler uygulayarak meta veri redaksiyonu uygulayın"

############################# Header ############################
title: "C# içindeki PPTM Meta Verilerden Şirket Adını Redakt Etme"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact PPTM"
      content_left: |
        Aşağıdaki kod, PPTM belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örneğin Metadatafilter.company. - “Company” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri bırakacaktır:
