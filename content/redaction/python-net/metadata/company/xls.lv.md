...
draft: false
path: "lv/redaction/net/metadata/company/xls"
...
############################# Head ############################
head_title: "Redakt sensitīvus metadatus no XLS dokumentiem C#"
head_description: "Lietot metadatu redakciju, lietojot filtrus dažāda formāta dokumentiem"

############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no XLS metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLS Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLS dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
