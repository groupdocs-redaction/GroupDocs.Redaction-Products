...
draft: false
path: "lv/redaction/net/metadata/company/xlsm"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no XLSM metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLSM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLSM dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
