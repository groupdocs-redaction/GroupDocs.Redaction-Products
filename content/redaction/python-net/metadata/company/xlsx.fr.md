...
draft: false
path: "fr/redaction/net/metadata/company/xlsx"
...
############################# Header ############################
title: "Rédiger le nom de l'entreprise à partir des métadonnées XLSX dans C#"
