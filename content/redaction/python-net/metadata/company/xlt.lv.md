...
draft: false
path: "lv/redaction/net/metadata/company/xlt"
...
############################# Header ############################
title: "Redakt uzņēmuma nosaukumu no XLT metadatiem C#"
...
steps:
    ...
    - title_left: "Realizēt XLT Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLT dokumenta. Jūs varat iestatīt rediģēšanas jomu, iestatot filtru, piemēram, uz MetadataFilter.company. - tas atstās regulāro izteiksmju atbilstības atsauktas visos metadatu vienumos, izņemot rekvizītu “Uzņēmums”:
