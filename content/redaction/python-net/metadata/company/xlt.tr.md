...
draft: false
path: "tr/redaction/net/metadata/company/xlt"
...
############################# Head ############################
head_title: "C# içindeki XLT Belgelerinden Hassas Meta Verileri Redakt Etme"
head_description: "Farklı biçimlerdeki belgeler için filtreler uygulayarak meta veri redaksiyonu uygulayın"

############################# Header ############################
title: "C# içindeki XLT Meta Verilerden Şirket Adını Redakt Etme"
...
steps:
    ...
    - title_left: "C# içindeki XLT Meta Verileri Kaldır"
      content_left: |
        EraseMetadatareDaction sınıfını kullanarak belgedeki tüm veya belirli meta verileri boş (boş veya minimal) değerlerle değiştirebilirsiniz. Aşağıdaki kod, bir meta veri özelliğinin bir XLT belgesinden nasıl filtreleyip kaldırılabileceğini gösterir. Aşağıdaki örnek, belgenin tüm özelliklerini boşa çıkarır:
        
        
      title_right: "XLT Meta Verileri Sil"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun ve XLT dosyasını yükleyin
