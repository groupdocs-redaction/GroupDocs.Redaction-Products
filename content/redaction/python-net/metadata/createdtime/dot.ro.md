...
draft: false
path: "ro/redaction/net/metadata/createdtime/dot"
...
############################# Header ############################
title: "Redact metadate în timp creat din DOT Document în C#"
...
steps:
    ...
    - title_left: "Redact DOT metadate în C#"
      content_left: |
        Codul următor vă permite să căutați și să redactați date sensibile dintr-un document DOT. Puteți seta domeniul de redactare setând filtrul, de exemplu la MetadataFilter.createdTime. - va lăsa nefăcute potrivirile expresiilor regulate în toate elementele de metadate, cu excepția proprietății „Createdtime”:
