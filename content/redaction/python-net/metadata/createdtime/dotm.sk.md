...
draft: false
path: "sk/redaction/net/metadata/createdtime/dotm"
...
############################# Header ############################
title: "Redakcia vytvorených metadát z DOTM dokumentu v C#"
...
steps:
    ...
    - title_left: "Redigovať DOTM Metaúdaje v C#"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu DOTM. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadaTafilter.CreatedTime. - ponechá zhody regulárnych výrazov nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Createdtime“:
