...
draft: false
path: "lv/redaction/net/metadata/createdtime/dotx"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no DOTX Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt DOTX Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no DOTX dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
