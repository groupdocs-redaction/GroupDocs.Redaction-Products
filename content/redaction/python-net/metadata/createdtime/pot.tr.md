...
draft: false
path: "tr/redaction/net/metadata/createdtime/pot"
...
############################# Header ############################
title: "C# içindeki POT belgeden oluşturulan zaman Meta Verilerini yeniden düzenleyin"
...
steps:
    ...
    - title_left: "C# içindeki Meta Verileri Redact POT"
      content_left: |
        Aşağıdaki kod, POT belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.createdTime. - “Createdtime” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri alır:
