...
draft: false
path: "lv/redaction/net/metadata/createdtime/potm"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no POTM Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt POTM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no POTM dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
