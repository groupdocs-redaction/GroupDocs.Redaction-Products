...
draft: false
path: "tr/redaction/net/metadata/createdtime/rtf"
...
############################# Header ############################
title: "C# içindeki RTF belgeden oluşturulan zaman Meta Verilerini yeniden düzenleyin"
...
steps:
    enable: true
    block:
    - title_left: "C# içindeki RTF öğesinden Meta Verileri Kaldır"
      content_left: |
        EraseMetadatareDaction sınıfını kullanarak RTF belgedeki tüm veya belirli meta verileri boş değerlerle değiştirebilirsiniz. Aşağıdaki kod, bir meta veri özelliğinin bir RTF belgesinden nasıl filtreleyip kaldırılabileceğini gösterir. Aşağıdaki örnek, belgenin tüm özelliklerini boşa çıkarır:
        

      title_right: "RTF belgesinin meta verilerini sil"
      content_right: |
    ...
    - title_left: "C# içindeki Meta Verileri Redact RTF"
      content_left: |
        Aşağıdaki kod, RTF belgedeki hassas verileri aramanıza ve çıkarmanıza olanak tanır. Filtreyi ayarlayarak redaksiyon kapsamını ayarlayabilirsiniz, örn. Metadatafilter.createdTime. - “Createdtime” özelliği hariç tüm meta veri öğelerinde normal ifadeler eşleşmelerini geri alır:
