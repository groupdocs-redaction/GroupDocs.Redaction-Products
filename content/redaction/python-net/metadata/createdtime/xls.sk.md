...
draft: false
path: "sk/redaction/net/metadata/createdtime/xls"
...
############################# Header ############################
title: "Redakcia vytvorených metadát z XLS dokumentu v C#"
...
steps:
    ...
    - title_left: "Redigovať XLS Metaúdaje v C#"
      content_left: |
        Nasledujúci kód umožňuje vyhľadávať a redigovať citlivé údaje z dokumentu XLS. Môžete nastaviť priestor pre redigovanie nastavením filtra, napr. na MetadaTafilter.CreatedTime. - ponechá zhody regulárnych výrazov nedokončené vo všetkých položkách metaúdajov okrem vlastnosti „Createdtime“:
