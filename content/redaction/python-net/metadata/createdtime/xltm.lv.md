...
draft: false
path: "lv/redaction/net/metadata/createdtime/xltm"
...
############################# Header ############################
title: "Rediģēt izveidotos laika metadatus no XLTM Dokumenta C#"
...
steps:
    ...
    - title_left: "Realizēt XLTM Metadatus C#"
      content_left: |
        Pēc koda ļauj meklēt un rediģēt sensitīvus datus no XLTM dokumenta. Jūs varat iestatīt redakcijas jomu, iestatot filtru, piemēram, uz MetadataFilter.CreatedTime. - tas atstās regulārās izteiksmes spēles atsaukt visos metadatu vienumos, izņemot “Createdtime” rekvizītu:
