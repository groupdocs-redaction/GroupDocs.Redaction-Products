...
draft: false
path: "nl/redaction/net/metadata/csv"
otherformats:   
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit CSV document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op CSV-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit CSV bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit CSV bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
