...
draft: false
path: "uk/redaction/net/metadata/csv"
otherformats:   
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа CSV у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу CSV"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу CSV через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів CSV"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
