...
draft: false
path: "nl/redaction/net/metadata/description/doc"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het DOC -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit DOC document redigeren"
      content_left: |
