...
draft: false
path: "de/redaction/net/metadata/description/docm"
...
############################# Header ############################
title: "Metadaten zur Beschreibung aus dem Dokument DOCM in C# redigieren"
...
steps:
    ...
    - title_left: "DOCM Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "DOCM Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei DOCM hoch
