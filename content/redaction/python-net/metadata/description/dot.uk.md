...
draft: false
path: "uk/redaction/net/metadata/description/dot"
...
############################# Header ############################
title: "Редагувати метадані опису з документа DOT в C#"
