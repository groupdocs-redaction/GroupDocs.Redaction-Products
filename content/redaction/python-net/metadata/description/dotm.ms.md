...
draft: false
path: "ms/redaction/net/metadata/description/dotm"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada DOTM Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from DOTM Dokumen"
      content_left: |
