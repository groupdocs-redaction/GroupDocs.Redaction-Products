...
draft: false
path: "nl/redaction/net/metadata/description/dotx"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het DOTX -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit DOTX document redigeren"
      content_left: |
