...
draft: false
path: "nl/redaction/net/metadata/description/pot"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het POT -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit POT document redigeren"
      content_left: |
