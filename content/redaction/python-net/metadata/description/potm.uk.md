...
draft: false
path: "uk/redaction/net/metadata/description/potm"
...
############################# Header ############################
title: "Редагувати метадані опису з документа POTM в C#"
