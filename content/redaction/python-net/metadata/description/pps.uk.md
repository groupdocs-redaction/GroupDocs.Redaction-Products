...
draft: false
path: "uk/redaction/net/metadata/description/pps"
...
############################# Header ############################
title: "Редагувати метадані опису з документа PPS в C#"
