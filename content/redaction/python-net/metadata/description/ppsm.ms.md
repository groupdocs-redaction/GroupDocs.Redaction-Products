...
draft: false
path: "ms/redaction/net/metadata/description/ppsm"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada PPSM Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from PPSM Dokumen"
      content_left: |
