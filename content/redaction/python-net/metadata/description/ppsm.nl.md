...
draft: false
path: "nl/redaction/net/metadata/description/ppsm"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het PPSM -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit PPSM document redigeren"
      content_left: |
