...
draft: false
path: "ms/redaction/net/metadata/description/pptm"
...
############################# Header ############################
title: "Redact Huraian Metadata daripada PPTM Dokumen dalam C#"
...
steps:
    enable: true
    block:
    - title_left: "Redact Description from PPTM Dokumen"
      content_left: |
