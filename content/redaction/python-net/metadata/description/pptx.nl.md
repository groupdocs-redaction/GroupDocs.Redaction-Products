...
draft: false
path: "nl/redaction/net/metadata/description/pptx"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het PPTX -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit PPTX document redigeren"
      content_left: |
