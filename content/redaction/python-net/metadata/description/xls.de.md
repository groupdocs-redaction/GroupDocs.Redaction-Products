...
draft: false
path: "de/redaction/net/metadata/description/xls"
...
############################# Header ############################
title: "Metadaten zur Beschreibung aus dem Dokument XLS in C# redigieren"
...
steps:
    ...
    - title_left: "XLS Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "XLS Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei XLS hoch
