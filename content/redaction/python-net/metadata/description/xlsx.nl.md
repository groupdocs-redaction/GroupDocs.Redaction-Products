...
draft: false
path: "nl/redaction/net/metadata/description/xlsx"
...
############################# Header ############################
title: "Bewerk de metagegevens van de beschrijving van het XLSX -document in C#"
...
steps:
    enable: true
    block:
    - title_left: "Beschrijving uit XLSX document redigeren"
      content_left: |
