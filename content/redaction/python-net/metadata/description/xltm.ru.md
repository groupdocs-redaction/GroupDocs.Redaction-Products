...
draft: false
path: "ru/redaction/net/metadata/description/xltm"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа XLTM на C#"
