...
draft: false
path: "ru/redaction/net/metadata/description/xltx"
...
############################# Header ############################
title: "Редактировать метаданные описания из документа XLTX на C#"
