...
draft: false
path: "ro/redaction/net/metadata/doc"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul DOC din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul DOC"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul DOC prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere DOC"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
