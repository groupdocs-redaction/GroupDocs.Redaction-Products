...
draft: false
path: "tr/redaction/net/metadata/doc"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki DOC Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "DOC Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "DOC Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "DOC Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
