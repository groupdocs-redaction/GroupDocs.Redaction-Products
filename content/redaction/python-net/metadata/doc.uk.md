...
draft: false
path: "uk/redaction/net/metadata/doc"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа DOC у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу DOC"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу DOC через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів DOC"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
