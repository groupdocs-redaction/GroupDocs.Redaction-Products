...
draft: false
path: "ms/redaction/net/metadata/docm"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada DOCM Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail DOCM."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada DOCM Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada DOCM Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
