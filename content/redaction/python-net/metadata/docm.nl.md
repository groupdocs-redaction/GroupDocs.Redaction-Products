...
draft: false
path: "nl/redaction/net/metadata/docm"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit DOCM document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op DOCM-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit DOCM bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit DOCM bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
