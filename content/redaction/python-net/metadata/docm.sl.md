...
draft: false
path: "sl/redaction/net/metadata/docm"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta DOCM v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za DOCM datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke DOCM prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek DOCM"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
