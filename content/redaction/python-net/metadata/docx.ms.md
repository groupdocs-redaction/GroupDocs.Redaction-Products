...
draft: false
path: "ms/redaction/net/metadata/docx"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada DOCX Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail DOCX."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada DOCX Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada DOCX Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
