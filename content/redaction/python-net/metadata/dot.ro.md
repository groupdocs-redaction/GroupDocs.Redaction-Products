...
draft: false
path: "ro/redaction/net/metadata/dot"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul DOT din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul DOT"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul DOT prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere DOT"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
