...
draft: false
path: "tr/redaction/net/metadata/dot"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki DOT Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "DOT Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "DOT Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "DOT Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
