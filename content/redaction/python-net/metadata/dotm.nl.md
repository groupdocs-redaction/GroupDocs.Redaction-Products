...
draft: false
path: "nl/redaction/net/metadata/dotm"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit DOTM document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op DOTM-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit DOTM bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit DOTM bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
