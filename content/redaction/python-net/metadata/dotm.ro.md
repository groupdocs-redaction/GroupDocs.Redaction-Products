...
draft: false
path: "ro/redaction/net/metadata/dotm"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul DOTM din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul DOTM"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul DOTM prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere DOTM"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
