...
draft: false
path: "tr/redaction/net/metadata/dotx"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki DOTX Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "DOTX Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "DOTX Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "DOTX Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
