...
draft: false
path: "ms/redaction/net/metadata/gif"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada GIF Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail GIF."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada GIF Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada GIF Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
