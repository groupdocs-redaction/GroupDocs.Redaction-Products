...
draft: false
path: "uk/redaction/net/metadata/gif"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа GIF у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу GIF"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу GIF через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів GIF"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
