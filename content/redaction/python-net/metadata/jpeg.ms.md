...
draft: false
path: "ms/redaction/net/metadata/jpeg"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada JPEG Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail JPEG."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada JPEG Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada JPEG Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
