...
draft: false
path: "sk/redaction/net/metadata/jpeg"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z JPEG dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor JPEG"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru JPEG cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov JPEG"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
