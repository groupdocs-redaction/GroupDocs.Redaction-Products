...
draft: false
path: "ms/redaction/net/metadata/pdf"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada PDF Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail PDF."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada PDF Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada PDF Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
