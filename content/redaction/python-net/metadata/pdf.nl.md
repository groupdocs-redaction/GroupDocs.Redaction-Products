...
draft: false
path: "nl/redaction/net/metadata/pdf"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit PDF document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op PDF-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit PDF bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit PDF bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
