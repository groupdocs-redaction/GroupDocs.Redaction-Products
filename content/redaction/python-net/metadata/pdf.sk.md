...
draft: false
path: "sk/redaction/net/metadata/pdf"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z PDF dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor PDF"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru PDF cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov PDF"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
