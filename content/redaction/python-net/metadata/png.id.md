...
draft: false
path: "id/redaction/net/metadata/png"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen PNG di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File PNG"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File PNG melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari PNG File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
