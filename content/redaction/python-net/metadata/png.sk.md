...
draft: false
path: "sk/redaction/net/metadata/png"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z PNG dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor PNG"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru PNG cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov PNG"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
