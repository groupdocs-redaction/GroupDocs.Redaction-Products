...
draft: false
path: "tr/redaction/net/metadata/png"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki PNG Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "PNG Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "PNG Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "PNG Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
