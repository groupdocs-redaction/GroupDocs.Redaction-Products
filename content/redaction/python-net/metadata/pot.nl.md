...
draft: false
path: "nl/redaction/net/metadata/pot"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit POT document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op POT-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit POT bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit POT bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
