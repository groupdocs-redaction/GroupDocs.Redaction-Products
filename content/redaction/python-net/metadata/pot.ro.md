...
draft: false
path: "ro/redaction/net/metadata/pot"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul POT din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul POT"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul POT prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere POT"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
