...
draft: false
path: "sk/redaction/net/metadata/potm"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z POTM dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor POTM"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru POTM cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov POTM"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
