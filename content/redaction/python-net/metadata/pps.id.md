...
draft: false
path: "id/redaction/net/metadata/pps"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen PPS di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File PPS"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File PPS melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari PPS File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
