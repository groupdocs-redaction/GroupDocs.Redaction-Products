...
draft: false
path: "ro/redaction/net/metadata/pps"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul PPS din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul PPS"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul PPS prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere PPS"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
