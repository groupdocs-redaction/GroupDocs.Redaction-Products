...
draft: false
path: "ms/redaction/net/metadata/ppsm"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada PPSM Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail PPSM."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada PPSM Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada PPSM Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
