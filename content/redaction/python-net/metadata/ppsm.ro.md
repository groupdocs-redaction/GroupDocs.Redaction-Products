...
draft: false
path: "ro/redaction/net/metadata/ppsm"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul PPSM din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul PPSM"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul PPSM prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere PPSM"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
