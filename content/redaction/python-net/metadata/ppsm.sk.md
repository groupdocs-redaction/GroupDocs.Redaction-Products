...
draft: false
path: "sk/redaction/net/metadata/ppsm"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z PPSM dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor PPSM"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru PPSM cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov PPSM"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
