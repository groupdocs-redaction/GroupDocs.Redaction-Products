...
draft: false
path: "tr/redaction/net/metadata/ppsm"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki PPSM Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "PPSM Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "PPSM Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "PPSM Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
