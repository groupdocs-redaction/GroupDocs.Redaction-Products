...
draft: false
path: "uk/redaction/net/metadata/ppsm"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа PPSM у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу PPSM"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу PPSM через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів PPSM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
