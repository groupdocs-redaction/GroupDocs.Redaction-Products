...
draft: false
path: "id/redaction/net/metadata/ppsx"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen PPSX di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File PPSX"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File PPSX melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari PPSX File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
