...
draft: false
path: "ro/redaction/net/metadata/ppsx"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul PPSX din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul PPSX"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul PPSX prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere PPSX"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
