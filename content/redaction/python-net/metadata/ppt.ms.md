...
draft: false
path: "ms/redaction/net/metadata/ppt"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada PPT Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail PPT."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada PPT Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada PPT Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
