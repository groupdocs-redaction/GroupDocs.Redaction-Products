...
draft: false
path: "nl/redaction/net/metadata/ppt"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit PPT document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op PPT-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit PPT bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit PPT bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
