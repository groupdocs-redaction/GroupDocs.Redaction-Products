...
draft: false
path: "ro/redaction/net/metadata/ppt"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul PPT din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul PPT"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul PPT prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere PPT"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
