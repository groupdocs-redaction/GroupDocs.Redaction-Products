...
draft: false
path: "uk/redaction/net/metadata/ppt"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа PPT у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу PPT"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу PPT через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів PPT"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
