...
draft: false
path: "lv/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "Kā notīrīt metadatus no PPTM dokumenta pakalpojumā C#"
      content_left: |
      ...
      title_right: "Lietojiet metadatu rediģēšanu PPTM failam"
      content_right: |
    ...
    - title_left: "Rediģēt metadatus no PPTM faila, izmantojot .NET"
      content_left: |
      ...
      title_right: "Metadatu rediģēšana no PPTM failiem"
      content_right: |
        * Izveidojiet klases [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) gadījumu
