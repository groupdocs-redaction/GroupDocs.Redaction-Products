...
draft: false
path: "ro/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul PPTM din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul PPTM"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul PPTM prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere PPTM"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
