...
draft: false
path: "sl/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta PPTM v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za PPTM datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke PPTM prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek PPTM"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
