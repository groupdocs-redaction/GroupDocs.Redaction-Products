...
draft: false
path: "uk/redaction/net/metadata/pptm"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа PPTM у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу PPTM"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу PPTM через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів PPTM"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
