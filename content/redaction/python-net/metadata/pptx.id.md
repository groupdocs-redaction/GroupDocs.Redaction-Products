...
draft: false
path: "id/redaction/net/metadata/pptx"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen PPTX di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File PPTX"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File PPTX melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari PPTX File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
