...
draft: false
path: "lv/redaction/net/metadata/pptx"
...
steps:
    enable: true
    block:
    - title_left: "Kā notīrīt metadatus no PPTX dokumenta pakalpojumā C#"
      content_left: |
      ...
      title_right: "Lietojiet metadatu rediģēšanu PPTX failam"
      content_right: |
    ...
    - title_left: "Rediģēt metadatus no PPTX faila, izmantojot .NET"
      content_left: |
      ...
      title_right: "Metadatu rediģēšana no PPTX failiem"
      content_right: |
        * Izveidojiet klases [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) gadījumu
