...
draft: false
path: "nl/redaction/net/metadata/pptx"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit PPTX document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op PPTX-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit PPTX bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit PPTX bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
