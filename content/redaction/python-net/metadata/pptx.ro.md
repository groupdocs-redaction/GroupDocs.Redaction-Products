...
draft: false
path: "ro/redaction/net/metadata/pptx"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul PPTX din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul PPTX"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul PPTX prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere PPTX"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
