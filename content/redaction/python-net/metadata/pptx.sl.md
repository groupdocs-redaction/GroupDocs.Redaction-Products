...
draft: false
path: "sl/redaction/net/metadata/pptx"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta PPTX v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za PPTX datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke PPTX prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek PPTX"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
