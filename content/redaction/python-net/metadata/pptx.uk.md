...
draft: false
path: "uk/redaction/net/metadata/pptx"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа PPTX у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу PPTX"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу PPTX через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів PPTX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
