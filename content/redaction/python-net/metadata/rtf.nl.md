...
draft: false
path: "nl/redaction/net/metadata/rtf"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit RTF document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op RTF-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit RTF bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit RTF bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
