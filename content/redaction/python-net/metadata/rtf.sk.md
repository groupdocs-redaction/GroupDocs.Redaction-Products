...
draft: false
path: "sk/redaction/net/metadata/rtf"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z RTF dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor RTF"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru RTF cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov RTF"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
