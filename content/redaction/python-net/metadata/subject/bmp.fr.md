...
draft: false
path: "fr/redaction/net/metadata/subject/bmp"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document BMP dans C#"
