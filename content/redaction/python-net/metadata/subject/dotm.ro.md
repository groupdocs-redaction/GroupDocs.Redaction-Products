...
draft: false
path: "ro/redaction/net/metadata/subject/dotm"
...
############################# Header ############################
title: "Redactarea metadatelor din DOTM Document în C#"
...
steps:
    ...
    - title_left: "Redactează subiectul din documentul DOTM"
      ...
      content_right: |
        ...
        * Setați domeniul de redactare prin setarea filtrului, de exemplu Utilizați metadatafilter.Subiect în codul de mai jos
