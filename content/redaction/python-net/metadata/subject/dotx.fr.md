...
draft: false
path: "fr/redaction/net/metadata/subject/dotx"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document DOTX dans C#"
