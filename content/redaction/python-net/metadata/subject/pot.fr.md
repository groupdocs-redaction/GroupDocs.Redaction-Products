...
draft: false
path: "fr/redaction/net/metadata/subject/pot"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document POT dans C#"
