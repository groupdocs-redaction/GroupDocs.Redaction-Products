...
draft: false
path: "uk/redaction/net/metadata/subject/potm"
...
############################# Header ############################
title: "Редагування метаданих з POTM документа в C#"
