...
draft: false
path: "fr/redaction/net/metadata/subject/pps"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document PPS dans C#"
