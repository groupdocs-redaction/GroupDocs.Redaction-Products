...
draft: false
path: "fr/redaction/net/metadata/subject/ppsx"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document PPSX dans C#"
