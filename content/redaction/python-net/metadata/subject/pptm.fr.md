...
draft: false
path: "fr/redaction/net/metadata/subject/pptm"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document PPTM dans C#"
