...
draft: false
path: "ms/redaction/net/metadata/subject/pptx"
...
############################# Header ############################
title: "Redaksi Metadata dari PPTX Dokumen dalam C#"
...
steps:
    ...
    - title_left: "Keluarkan Metadata PPTX dalam C#"
      content_left: |
      ...
      title_right: "Padamkan Metadata PPTX"
      content_right: |
        * Buat contoh [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) kelas & muat naik fail PPTX
