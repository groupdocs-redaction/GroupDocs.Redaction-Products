...
draft: false
path: "fr/redaction/net/metadata/subject/xls"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document XLS dans C#"
