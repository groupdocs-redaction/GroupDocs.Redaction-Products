...
draft: false
path: "fr/redaction/net/metadata/subject/xlt"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document XLT dans C#"
