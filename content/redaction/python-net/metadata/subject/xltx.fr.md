...
draft: false
path: "fr/redaction/net/metadata/subject/xltx"
...
############################# Header ############################
title: "Rédaction de métadonnées à partir d'un document XLTX dans C#"
