...
draft: false
path: "ms/redaction/net/metadata/tiff"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada TIFF Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail TIFF."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada TIFF Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada TIFF Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
