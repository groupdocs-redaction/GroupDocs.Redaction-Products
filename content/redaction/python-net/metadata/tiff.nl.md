...
draft: false
path: "nl/redaction/net/metadata/tiff"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit TIFF document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op TIFF-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit TIFF bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit TIFF bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
