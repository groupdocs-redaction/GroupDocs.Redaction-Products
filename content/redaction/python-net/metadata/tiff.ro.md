...
draft: false
path: "ro/redaction/net/metadata/tiff"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul TIFF din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul TIFF"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul TIFF prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere TIFF"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
