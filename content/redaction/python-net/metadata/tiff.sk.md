...
draft: false
path: "sk/redaction/net/metadata/tiff"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z TIFF dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor TIFF"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru TIFF cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov TIFF"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
