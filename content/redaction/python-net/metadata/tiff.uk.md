...
draft: false
path: "uk/redaction/net/metadata/tiff"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа TIFF у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу TIFF"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу TIFF через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів TIFF"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
