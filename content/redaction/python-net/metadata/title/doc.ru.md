...
draft: false
path: "ru/redaction/net/metadata/title/doc"
...
############################# Header ############################
title: "Редактировать метаданные заголовка из документа DOC в C#"
...
steps:
    ...
    - title_left: "Удалить метаданные DOC в C#"
      content_left: |
