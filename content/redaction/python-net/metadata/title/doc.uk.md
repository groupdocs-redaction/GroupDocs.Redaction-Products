...
draft: false
path: "uk/redaction/net/metadata/title/doc"
...
############################# Header ############################
title: "Відредагувати метадані заголовка з DOC документа в C#"
