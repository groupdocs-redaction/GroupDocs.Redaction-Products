...
draft: false
path: "id/redaction/net/metadata/title/pot"
...
############################# Header ############################
title: "Redact Judul Metadata dari POT Document di C#"
...
steps:
    ...
    - title_left: "Hapus POT Metadata di C#"
      content_left: |
      ...
      title_right: "Hapus POT Metadata"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) & unggah file POT
