...
draft: false
path: "uk/redaction/net/metadata/title/ppsm"
...
############################# Header ############################
title: "Відредагувати метадані заголовка з PPSM документа в C#"
