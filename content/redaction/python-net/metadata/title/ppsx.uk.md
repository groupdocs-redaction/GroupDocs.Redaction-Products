...
draft: false
path: "uk/redaction/net/metadata/title/ppsx"
...
############################# Header ############################
title: "Відредагувати метадані заголовка з PPSX документа в C#"
