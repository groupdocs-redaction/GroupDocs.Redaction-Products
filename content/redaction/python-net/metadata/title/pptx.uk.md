...
draft: false
path: "uk/redaction/net/metadata/title/pptx"
...
############################# Header ############################
title: "Відредагувати метадані заголовка з PPTX документа в C#"
