...
draft: false
path: "uk/redaction/net/metadata/title/rtf"
...
############################# Header ############################
title: "Відредагувати метадані заголовка з RTF документа в C#"
