...
draft: false
path: "es/redaction/net/metadata/title/xlt"
...
############################# Header ############################
title: "Redacte los metadatos del título del documento XLT en C#"
