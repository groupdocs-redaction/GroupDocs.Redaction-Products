...
draft: false
path: "de/redaction/net/metadata/version/bmp"
...
############################# Header ############################
title: "Version der Metadaten der BMP -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "BMP Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "BMP Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei BMP hoch
