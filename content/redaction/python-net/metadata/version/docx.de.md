...
draft: false
path: "de/redaction/net/metadata/version/docx"
...
############################# Header ############################
title: "Version der Metadaten der DOCX -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "DOCX Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "DOCX Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei DOCX hoch
