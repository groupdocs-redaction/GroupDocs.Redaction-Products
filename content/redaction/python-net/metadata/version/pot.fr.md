...
draft: false
path: "fr/redaction/net/metadata/version/pot"
...
############################# Header ############################
title: "Version expurgée des métadonnées du fichier POT dans C#"
