...
draft: false
path: "hi/redaction/net/metadata/version/pot"
...
############################# Header ############################
title: "C# में POT फ़ाइल के मेटाडेटा के संस्करण को संशोधित करें"
