...
draft: false
path: "it/redaction/net/metadata/version/potm"
...
############################# Header ############################
title: "Modifica la versione dei metadati del file POTM in C#"
...
steps:
    enable: true
    block:
    - title_left: "Redigere la versione del file POTM in C#"
      content_left: |
