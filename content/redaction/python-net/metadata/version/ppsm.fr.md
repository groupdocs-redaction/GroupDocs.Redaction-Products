...
draft: false
path: "fr/redaction/net/metadata/version/ppsm"
...
############################# Header ############################
title: "Version expurgée des métadonnées du fichier PPSM dans C#"
