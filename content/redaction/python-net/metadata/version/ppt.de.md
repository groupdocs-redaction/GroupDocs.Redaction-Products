...
draft: false
path: "de/redaction/net/metadata/version/ppt"
...
############################# Header ############################
title: "Version der Metadaten der PPT -Datei in C# redigieren"
...
steps:
    ...
    - title_left: "PPT Metadaten in C# entfernen"
      content_left: |
      ...
      title_right: "PPT Metadaten löschen"
      content_right: |
        * Erstellen Sie eine Instanz der Klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) und laden Sie die Datei PPT hoch
