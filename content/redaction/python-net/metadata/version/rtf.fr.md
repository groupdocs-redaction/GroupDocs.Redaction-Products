...
draft: false
path: "fr/redaction/net/metadata/version/rtf"
...
############################# Header ############################
title: "Version expurgée des métadonnées du fichier RTF dans C#"
