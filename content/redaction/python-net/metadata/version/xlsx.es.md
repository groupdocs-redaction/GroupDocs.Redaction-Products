...
draft: false
path: "es/redaction/net/metadata/version/xlsx"
...
############################# Header ############################
title: "Redacte la versión de los metadatos del archivo XLSX en C#"
