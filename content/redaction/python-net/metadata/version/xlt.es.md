...
draft: false
path: "es/redaction/net/metadata/version/xlt"
...
############################# Header ############################
title: "Redacte la versión de los metadatos del archivo XLT en C#"
