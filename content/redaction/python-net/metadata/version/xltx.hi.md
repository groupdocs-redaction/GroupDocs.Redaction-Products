...
draft: false
path: "hi/redaction/net/metadata/version/xltx"
...
############################# Header ############################
title: "C# में XLTX फ़ाइल के मेटाडेटा के संस्करण को संशोधित करें"
