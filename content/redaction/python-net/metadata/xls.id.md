...
draft: false
path: "id/redaction/net/metadata/xls"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen XLS di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File XLS"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File XLS melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari XLS File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
