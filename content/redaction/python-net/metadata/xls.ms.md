...
draft: false
path: "ms/redaction/net/metadata/xls"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata daripada XLS Dokumen dalam C#"
      content_left: |
      ...
      title_right: "Gunakan Redaksi Metadata pada Fail XLS."
      content_right: |
    ...
    - title_left: "Redact Metadata daripada XLS Fail melalui .NET"
      content_left: |
      ...
      title_right: "Penyuntingan Metadata daripada XLS Fail"
      content_right: |
        * Buat contoh kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
