...
draft: false
path: "tr/redaction/net/metadata/xlsm"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki XLSM Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "XLSM Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "XLSM Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "XLSM Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
