...
draft: false
path: "uk/redaction/net/metadata/xlsx"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа XLSX у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу XLSX"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу XLSX через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів XLSX"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
