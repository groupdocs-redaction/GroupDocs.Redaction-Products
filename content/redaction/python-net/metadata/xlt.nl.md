...
draft: false
path: "nl/redaction/net/metadata/xlt"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit XLT document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op XLT-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit XLT bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit XLT bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
