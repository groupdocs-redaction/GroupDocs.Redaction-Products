...
draft: false
path: "ro/redaction/net/metadata/xlt"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul XLT din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul XLT"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul XLT prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere XLT"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
