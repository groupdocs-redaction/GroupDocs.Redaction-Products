...
draft: false
path: "sl/redaction/net/metadata/xlt"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta XLT v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za XLT datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke XLT prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek XLT"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
