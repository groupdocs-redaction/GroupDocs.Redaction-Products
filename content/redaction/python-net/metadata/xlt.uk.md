...
draft: false
path: "uk/redaction/net/metadata/xlt"
...
steps:
    enable: true
    block:
    - title_left: "Як очистити метадані з документа XLT у C#"
      content_left: |
      ...
      title_right: "Застосувати редагування метаданих до файлу XLT"
      content_right: |
    ...
    - title_left: "Редагувати метадані з файлу XLT через .NET"
      content_left: |
      ...
      title_right: "Редагування метаданих із файлів XLT"
      content_right: |
        * Створіть екземпляр класу [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
