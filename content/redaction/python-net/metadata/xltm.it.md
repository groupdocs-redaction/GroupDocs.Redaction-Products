...
draft: false
path: "it/redaction/net/metadata/xltm"
...
steps:
    enable: true
    block:
    - title_left: "Come pulire i metadati dal documento XLTM in C#"
      content_left: |
      ...
      title_right: "Applica la redazione dei metadati al file XLTM"
      content_right: |
    ...
    - title_left: "Oscura metadati dal file XLTM tramite .NET"
      content_left: |
      ...
      title_right: "Oscuramento dei metadati dai file XLTM"
      content_right: |
        * Crea un'istanza della classe [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
