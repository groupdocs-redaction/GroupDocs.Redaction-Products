...
draft: false
path: "nl/redaction/net/metadata/xltm"
...
steps:
    enable: true
    block:
    - title_left: "Metagegevens opschonen uit XLTM document in C#"
      content_left: |
      ...
      title_right: "Pas metagegevensredactie toe op XLTM-bestand"
      content_right: |
    ...
    - title_left: "Metagegevens uit XLTM bestand redigeren via .NET"
      content_left: |
      ...
      title_right: "Redactie van metagegevens uit XLTM bestanden"
      content_right: |
        * Maak een exemplaar van de klasse [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
