...
draft: false
path: "ro/redaction/net/metadata/xltm"
...
steps:
    enable: true
    block:
    - title_left: "Cum să curățați metadatele din documentul XLTM din C#"
      content_left: |
      ...
      title_right: "Aplicați redarea metadatelor la fișierul XLTM"
      content_right: |
    ...
    - title_left: "Redactați metadatele din fișierul XLTM prin .NET"
      content_left: |
      ...
      title_right: "Redactarea metadatelor din fișiere XLTM"
      content_right: |
        * Creați o instanță a clasei [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
