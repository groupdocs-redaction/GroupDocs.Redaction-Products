...
draft: false
path: "tr/redaction/net/metadata/xltm"
...
steps:
    enable: true
    block:
    - title_left: "C#'daki XLTM Belgesinden Meta Veriler Nasıl Temizlenir?"
      content_left: |
      ...
      title_right: "XLTM Dosyasına Meta Veri Düzenlemesi Uygula"
      content_right: |
    ...
    - title_left: "XLTM Dosyasındaki Meta Verileri .NET aracılığıyla Çıkartın"
      content_left: |
      ...
      title_right: "XLTM Dosyadan Meta Veri Düzenlemesi"
      content_right: |
        * [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor) sınıfının bir örneğini oluşturun
