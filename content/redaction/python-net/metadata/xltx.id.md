...
draft: false
path: "id/redaction/net/metadata/xltx"
...
steps:
    enable: true
    block:
    - title_left: "Cara Membersihkan Metadata dari Dokumen XLTX di C#"
      content_left: |
      ...
      title_right: "Terapkan Redaksi Metadata ke File XLTX"
      content_right: |
    ...
    - title_left: "Sunting Metadata dari File XLTX melalui .NET"
      content_left: |
      ...
      title_right: "Redaksi Metadata dari XLTX File"
      content_right: |
        * Buat instance kelas [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
