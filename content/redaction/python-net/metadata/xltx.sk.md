...
draft: false
path: "sk/redaction/net/metadata/xltx"
...
steps:
    enable: true
    block:
    - title_left: "Ako vyčistiť metadáta z XLTX dokumentu v C#"
      content_left: |
      ...
      title_right: "Použiť úpravu metadát na súbor XLTX"
      content_right: |
    ...
    - title_left: "Úprava metadát zo súboru XLTX cez .NET"
      content_left: |
      ...
      title_right: "Úprava metadát zo súborov XLTX"
      content_right: |
        * Vytvorte inštanciu triedy [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
