...
draft: false
path: "sl/redaction/net/metadata/xltx"
...
steps:
    enable: true
    block:
    - title_left: "Kako očistiti metapodatke iz dokumenta XLTX v C#"
      content_left: |
      ...
      title_right: "Uporabi redakcijo metapodatkov za XLTX datoteko"
      content_right: |
    ...
    - title_left: "Uredi metapodatke iz datoteke XLTX prek .NET"
      content_left: |
      ...
      title_right: "Redakcija metapodatkov iz datotek XLTX"
      content_right: |
        * Ustvarite primerek razreda [Redactor](https://apireference.groupdocs.com/redaction/net/groupdocs.redaction/redactor)
