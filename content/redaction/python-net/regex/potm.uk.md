...
steps:
    enable: true
    title_left: "Відредагуйте текст із POTM за допомогою регулярних виразів через C#"
    content_left: |
