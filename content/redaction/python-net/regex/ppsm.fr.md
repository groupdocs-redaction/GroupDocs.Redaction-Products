...
layout: "autogen"
draft: false
path: "fr/redaction/net/regex/ppsm"
otherformats: CSV DOC DOCM DOCX DOT DOTM DOTX PDF POT POTM PPS PPSX PPT PPTM PPTX RTF XLS XLSM XLSX XLT XLTM XLTX  

############################# Head ############################
head_title: "Masquer PPSM documents à l'aide d'expressions régulières via .NET Core"
...
############################# Header ############################
title: "Nettoyer les fichiers PPSM via C# et les expressions régulières dans les applications principales .NET"
...
steps:
    enable: true
    title_left: "Masquer le texte de PPSM à l'aide d'expressions régulières via C#"
    content_left: |
