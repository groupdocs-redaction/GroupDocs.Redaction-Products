...
steps:
    enable: true
    title_left: "C# के माध्यम से रेगुलर एक्सप्रेशन का उपयोग करके PPT से टेक्स्ट को संपादित करें"
    content_left: |
