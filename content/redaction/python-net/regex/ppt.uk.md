...
steps:
    enable: true
    title_left: "Відредагуйте текст із PPT за допомогою регулярних виразів через C#"
    content_left: |
