...
steps:
    enable: true
    title_left: "Відредагуйте текст із PPTX за допомогою регулярних виразів через C#"
    content_left: |
