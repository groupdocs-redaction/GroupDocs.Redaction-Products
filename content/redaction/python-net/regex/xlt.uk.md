...
steps:
    enable: true
    title_left: "Відредагуйте текст із XLT за допомогою регулярних виразів через C#"
    content_left: |
