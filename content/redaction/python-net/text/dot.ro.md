...
############################# Header ############################
title: "Redactați fișierele DOT prin C# în .NET Core Apps"
description: "Căutați și înlocuiți text în documente Office și OpenOffice, foi de calcul și prezentări, precum și DOT pe Windows, Linux și macOS"
...
steps:
    enable: true
    title_left: "Redactați textul exact din DOT prin C#"
    content_left: |
        [GroupDocs.Redaction](ro//redaction/net/) facilitează pentru .NET dezvoltatorii să adauge DOT funcția de redactare a fișierelor cu câțiva pași simpli.
