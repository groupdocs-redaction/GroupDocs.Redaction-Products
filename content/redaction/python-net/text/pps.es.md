...
draft: false
path: "es/redaction/net/text/pps"
...
############################# Header ############################
title: "Redactar archivos PPS a través de C# en aplicaciones .NET Core"
description: "Buscar y reemplazar texto en documentos, hojas de cálculo y presentaciones de Office y OpenOffice, así como PPS en Windows, Linux y macOS"
...
steps:
    enable: true
    block:
    - title_left: "Redactar texto exacto de PPS a través de C#"
      content_left: |
        [GroupDocs.Redaction](/redaction/net/) facilita a los desarrolladores de .NET agregar la función de redacción de archivos PPS con unos sencillos pasos. 
