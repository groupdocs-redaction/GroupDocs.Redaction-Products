...
ad_description: "Redact Category Name from XLTX Metadata in Java"

############################# Head ############################
head_title: "Redact Category Name from XLTX Metadata in Java"
...
############################# Header ############################
title: "Redact Category Name from XLTX Metadata in Java"
...
steps:
    ...
    - title_left: "Remove XLTX Metadata in Java"
      content_left: |
      ...
      title_right: "Erase Category Metadata from XLTX File "
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLTX file
