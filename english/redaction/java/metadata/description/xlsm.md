...
ad_description: "Redact Description Metadata from a XLSM File in Java"

############################# Head ############################
head_title: "Redact Description Metadata from a XLSM File in Java"
...
############################# Header ############################
title: "Redact Description Metadata from a XLSM File in Java"
...
steps:
    ...
    - title_left: "Erase a Metadata Field in Java"
      ...
      title_right: "Remove XLSM Metadata Field"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLSM file
