...
ad_description: "Redact Subject Metadata from a DOC File in Java"

############################# Head ############################
head_title: "Redact Subject Metadata from a DOC File in Java"
...
############################# Header ############################
title: "Redact Subject Metadata from a DOC File in Java"
...
steps:
    ...
    - title_left: "Erase a Metadata Field in Java"
      ...
      title_right: "Remove DOC Metadata Via GroupDocs.Redaction"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload DOC file
