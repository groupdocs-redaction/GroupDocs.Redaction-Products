...
ad_description: "Redact Title from POTM Metadata in Java"

############################# Head ############################
head_title: "Redact Title from POTM File in Java Using GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Title from POTM File in Java Using GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Remove POTM Metadata in Java"
      content_left: |
      ...
      title_right: "Erase Title Metadata from POTM File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload POTM file
