...
ad_description: "Redact Title from XLSM Metadata in Java"

############################# Head ############################
head_title: "Redact Title from XLSM File in Java Using GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Title from XLSM File in Java Using GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Remove XLSM Metadata in Java"
      ...
      title_right: "Erase Title Metadata from XLSM File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLSM file
