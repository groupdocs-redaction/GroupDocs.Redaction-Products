...
ad_description: "Redact Title from XLSX Metadata in Java"

############################# Head ############################
head_title: "Redact Title from XLSX File in Java Using GroupDocs.Redaction API"
...
############################# Header ############################
title: "Redact Title from XLSX File in Java Using GroupDocs.Redaction API"
...
steps:
    ...
    - title_left: "Remove XLSX Metadata in Java"
      ...
      title_right: "Erase Title Metadata from XLSX File"
      content_right: |
        * Create an instance of [Redactor](https://apireference.groupdocs.com/redaction/java/com.groupdocs.redaction/Redactor) class & upload XLSX file
