...
############################# Header ############################
title: "Redact createdtime Metadata from XLT Document in C#"
...
steps:
    ...
    - title_left: "Redact XLT Metadata in C#"
      content_left: |
        Following code allows you to search and redact sensitive data from a XLT document. You can set scope for redaction by setting filter, e.g. to MetadataFilter.Createdtime. - it will leave the regular expressions matches undone in all metadata items, except “Createdtime” property:
